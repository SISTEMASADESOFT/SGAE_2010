...
namespace CapaDatos
{
    public class EmpleadoCD
    {
        ...
        public DataTable F_Empleado_Listar_Responsable_Inventario(EmpleadoCE objEntidadBE)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "PA_Empleado_Listar_Responsable_Inventario";
                        ...
                        if (objEntidadBE.FlagResponsableInventario > 0)
                            sql_comando.Parameters.Add("@FlagResponsableInventario", SqlDbType.Int).Value = objEntidadBE.FlagResponsableInventario;
        ...
        public DataTable F_TCDEPARTAMENTO_LISTAR()
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "PA_TCDEPARTAMENTO_LISTAR";
