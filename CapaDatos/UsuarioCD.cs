...
namespace CapaDatos
{
    public class UsuarioCD
    {
        ...
        public DataTable F_UsuarioMarca_Listar(UsuarioCE objEntidadusuario)
        {
            DataTable dta_consulta = null;
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_Usuario_Listar_Marca";

                        sql_comando.Parameters.Add("@CodAlmacen", SqlDbType.Int).Value = objEntidadusuario.CodAlmacen;

                        if (objEntidadusuario.CodEstado > 0)
                            sql_comando.Parameters.Add("@CodEstado", SqlDbType.Int).Value = objEntidadusuario.CodEstado;
        ...
        public DataTable F_UsuarioNP_Listar()
        {
            DataTable dta_consulta = null;
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_UsuarioNP_Listar";
        ...
        public DataTable F_UsuarioNP_Listar_Almacen(UsuarioCE objusuario)
        {
            DataTable dta_consulta = null;
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_UsuarioNP_Listar_Almacen";

                        sql_comando.Parameters.Add("@CodAlmacen", SqlDbType.Int).Value = objusuario.CodAlmacen;
