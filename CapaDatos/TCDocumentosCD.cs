   ...
   public class TCDocumentosCD
    {
        ...
        public DataTable F_TCDocumentos_ListarFacturacion_Antiguo()
        {
        ...
        public DataTable F_TCDocumentos_ListarFacturacion_Solo_Proforma()
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_TCDocumentos_ListarFacturacion_Solo_Proforma";
        ...
        public TCDocumentosCE F_VentaPerdida(TCDocumentosCE objEntidad)
        {
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_VentaPerdida_Agregar";

                        sql_comando.Parameters.Add("@CodAlmacen", SqlDbType.Int).Value = objEntidad.CodAlmacen;
                        sql_comando.Parameters.Add("@Cantidad", SqlDbType.Int).Value = objEntidad.Cantidad;
                        sql_comando.Parameters.Add("@CodUsuario", SqlDbType.Int).Value = objEntidad.CodUsuario;
                        sql_comando.Parameters.Add("@CodCliente", SqlDbType.Int).Value = objEntidad.CodCliente;
                        if (objEntidad.CodProducto != 0)
                        sql_comando.Parameters.Add("@CodProducto", SqlDbType.Int).Value = objEntidad.CodProducto;

                        sql_comando.Parameters.Add("@DescripcionVentaPerdida", SqlDbType.VarChar,200).Value = objEntidad.DescripcionVentaPerdida;
                        ...
                        objEntidad.Mensaje = MsgError.Value.ToString();
        ...
        public DataTable F_TCEMPRESA_LISTAR_DIRECCION_CLIENTE(int codEmpresa)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        // sql_comando.CommandText = "PA_TCEMPRESA_LISTAR_DIRECCION_CLIENTE";
                        sql_comando.CommandText = "PA_TCEMPRESA_DIRECCION_CLIENTE ";
                        sql_comando.Parameters.AddWithValue("@codEmpresa", codEmpresa);
                        dta_consulta = new DataTable();
