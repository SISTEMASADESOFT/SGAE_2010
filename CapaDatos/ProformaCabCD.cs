...
namespace CapaDatos
{
    public class ProformaCabCD
    {
        ...
        public DataTable F_ProformaCab_ObtenerXNumero_Proforma_Alvarado(ProformaCabCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_ProformaCab_Insert_Excel";
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@CodMovimiento", SqlDbType.Int).Value = objProformaCabCE.CodMovimiento;
                        sql_comando.Parameters.Add("@CodTipoFormato", SqlDbType.Int).Value = objProformaCabCE.CodTipoFormato;
                        dta_consulta = new DataTable();
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@ClavePermiso", SqlDbType.VarChar, 60).Value = objEntidadBE.ClavePermiso;
                        sql_comando.Parameters.Add("@ObservacionPermiso", SqlDbType.VarChar, 300).Value = objEntidadBE.ObservacionPermiso;
                        sql_comando.Parameters.Add("@Delivery", SqlDbType.VarChar, 15).Value = objEntidadBE.Delivery;
                        sql_comando.Parameters.Add("@CodCanalVenta", SqlDbType.Decimal).Value = objEntidadBE.CodCanalVenta;
