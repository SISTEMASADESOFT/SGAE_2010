...
namespace CapaDatos
{
    public class TCDistritoCD
    {
        ...
        public TCDistritoCE F_TCDireccion_Editar_Povis(TCDistritoCE objEntidadBE)
        {
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@GPSLong", SqlDbType.Decimal).Value = objEntidadBE.GPSLong;
                        sql_comando.Parameters.Add("@GPSLat", SqlDbType.Decimal).Value = objEntidadBE.GPSLat;
                        sql_comando.Parameters.Add("@Ciudad", SqlDbType.VarChar, 300).Value = objEntidadBE.Ciudad;
        ...
        public DataTable F_Proveedor_Listar(TCDistritoCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_TipoProveedor_Listar";
                        sql_comando.Parameters.Add("@Descripcion", SqlDbType.VarChar, 50).Value = objEntidadBE.Descripcion;
                        dta_consulta = new DataTable();
        ...
        public DataTable F_TCDireccion_ListarTemporal_Proforma(TCDistritoCE objEntidadBE)
        {
