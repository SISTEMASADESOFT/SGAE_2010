    ...
    public class DocumentoVentaDetCD
    {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        if (objEntidadBE.PrecioMecanico > 0)
                         sql_comando.Parameters.Add("@PrecioMecanico", SqlDbType.Decimal).Value = objEntidadBE.PrecioMecanico;

                        if (objEntidadBE.PrecioMecanico > 0)
                            sql_comando.Parameters.Add("@PrecioFinal", SqlDbType.Decimal).Value = objEntidadBE.PrecioFinal;
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@Margen2", SqlDbType.Decimal).Value = objEntidadBE.Margen2;
                        sql_comando.Parameters.Add("@Material", SqlDbType.VarChar, 250).Value = objEntidadBE.Material;
                        sql_comando.Parameters.Add("@FechaVencimiento", SqlDbType.DateTime, 250).Value = objEntidadBE.FechaVencimiento;
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "[pa_TemporalFacturacionDet_Update_Factura_Kuyay]";
                        ...
                        sql_comando.Parameters.Add("@Material", SqlDbType.VarChar, 250).Value = objEntidadBE.Material;
                        sql_comando.Parameters.Add("@FechaVencimiento", SqlDbType.DateTime, 250).Value = objEntidadBE.FechaVencimiento;
                        sql_comando.Parameters.Add("@Lote", SqlDbType.VarChar, 250).Value = objEntidadBE.Lote;
        ...
        public DataTable F_COBRANZASCAB_OBSERVACION(DocumentoVentaDetCE objEntidadBE)
        {
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    if (objEntidadBE.CodCobranzaCab==16)
                        sql_conexion.ConnectionString = ConfigurationManager.ConnectionStrings["BDPROFORMA"].ConnectionString;
                    else
                        sql_conexion.ConnectionString = ConfigurationManager.ConnectionStrings["BDCONEXION"].ConnectionString;
        ...
        public DataTable F_DOCUMENTOVENTACAB_OBSERVACION_Mantenimiento(DocumentoVentaCabCE objEntidadBE)
        {
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    if (objEntidadBE.CodTipoDoc == 16)
                    {
                        sql_conexion.ConnectionString = ConfigurationManager.ConnectionStrings[objEntidadBE.ConexionGeneral].ConnectionString;
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "PA_DOCUMENTOVENTACAB_OBSERVACION_MANTENIMIENTO";
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "PA_MOVIMIENTOS_LISTAR_AJUSTE_MASIVO_PRODUCTO";
