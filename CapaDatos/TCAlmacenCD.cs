...
namespace CapaDatos
{
    public class TCAlmacenCD
    {
        ...
        public DataTable F_TCALMACEN_LISTAR_TODOS_CLEVER(TCAlmacenCE objEntidad)
        {
            #region VARIABLES
            DataTable dta_consulta = null;
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "PA_TCALMACEN_LISTAR_SOLO_ALMACEN_LOGUEADO";
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_TCAlmacenNP_Listar";
        ...
        public DataTable F_TCAlmacen_Destino(TCAlmacenCE objEntidad)
        {
            #region VARIABLES
            DataTable dta_consulta = null;
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.CommandText = "pa_TCAlmacen_Destino";
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "PA_TCAlmacenesExternos_LISTADO";
