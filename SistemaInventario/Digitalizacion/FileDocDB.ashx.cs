    ...
    public class FileDocDB : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (Convert.ToInt32(context.Request.Params["Flag"]) == 1)
            {
                ...
                objEntidad.CodProducto = Convert.ToInt32(context.Request["CodProducto"]);
                //  objEntidad.CodProducto = Convert.ToInt32(context.Request["CodigoProducto"]);
                objEntidad.CodigoInterno = Convert.ToString(context.Request["CodigoInterno"]);
