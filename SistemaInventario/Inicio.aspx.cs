...
namespace SistemaInventario
{
    public partial class Inicio : System.Web.UI.Page
    {
        ...
        public String F_Buscar_NET(String arg)
        {
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_Buscar(obj_parametros, ref str_mensaje_operacion, ref PaginaInicio);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref String Mensaje, ref String PaginaInicio)
        {
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                Session["Empresa"] = dta_consulta.Rows[0]["Empresa"].ToString();
                 Session["CodSede"] = dta_consulta.Rows[0]["CodAlmacen"].ToString();
                Session["Almacen"] = dta_consulta.Rows[0]["DscAlmacen"].ToString();
                ...
                PaginaInicio = dta_consulta.Rows[0]["Pagina"].ToString(); // "Maestros/TipoCambio.aspx";

                Session["CodEmpresaGeneral"] = dta_consulta.Rows[0]["CodEmpresaGeneral"].ToString();
                Session["CodAlmacenGeneral"] = dta_consulta.Rows[0]["CodAlmacenGeneral"].ToString();
                //Session["ConexionGeneral"] = dta_consulta.Rows[0]["ConexionGeneral"].ToString();
