    ...
    public class PDF : System.Web.Services.WebService
    {
        ...
        public string F_Facturas_Pedido_Lote2_PDF(string Codigos, int CodTipoDoc)
        {
            ...
            switch (CodTipoDoc)
            {
                ...
                case 15:
                    ...
                    break;
                case 19:
                    outputPdfPath = System.Web.HttpContext.Current.Server.MapPath(@"..\files\temp\") + nombreBase + "_LETRAS.pdf"; //sFile = @"../files/download/" + nombre_doc; //PUBLICACION
                    DomainNameOutPut = @"../files/temp/" + nombreBase + "_LETRAS.pdf";
                    break;
                case 23:
                        ...
                        if (CodigoDocumento > 0)
                        {
                            ...
                            switch (CodTipoDoc)
                            {
                                ...
                                case 15:
                                    ...
                                    break;
                                case 19:
                                    pdfNuevo = pdf.GenerarLetras(CodigoDocumento, nombreRutaDocumentoTemp);
                                    break;
                                case 25:
        ...
        */
        ...
        private class cGeneraPDF
        {
            ...
            public string GenerarLetras(int CodDocumentoVenta, string nombreRutaDocumentoTemp)
            {
                ReportDocument rpt = new ReportDocument();
                try
                {
                    LetrasCabCE objEntidadFactura = new LetrasCabCE();
                    LetrasCabCN objOperacionFactura = new LetrasCabCN();
                    objEntidadFactura.CodLetra = Convert.ToInt32(CodDocumentoVenta);
                    DataTable dtTabla = objOperacionFactura.F_LetraCab_Imprimir(objEntidadFactura);
                    //int CodTipoDoc = Convert.ToInt32(dtTabla.Rows[0]["CodTipoDocumento"].ToString());
