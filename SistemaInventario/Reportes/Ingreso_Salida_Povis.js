var AppSession = "../Reportes/Ingreso_Salida_Povis.aspx";
...
function F_Buscar() {
  //  if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Consultar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    ...
    if ($('#MainContent_ChkFamilia').is(':checked'))
        Familia = 1;
    ...
    try { 
        var objParams = {        
            ...
            Filtro_ChkFamilia: Familia,
            Filtro_IdFamilia: $('#hfCodFamilia').val(),
...
function F_Reporte() {
    ...
    var Titulo = 'REPORTE INGRESO Y SALIDA DESDE ' + $('#MainContent_txtDesde').val() +' HASTA '+ $('#MainContent_txtHasta').val() ;
    ...
    rptURL = rptURL + 'Familia=' + Familia + '&';
    rptURL = rptURL + 'IdFamilia=' + $('#hfCodFamilia').val() + '&';
...
function F_Excel() {
    ...
    var TipoArchivo = 'application/pdf';
    var CodMenu = '712';
    var NombreArchivo = 'Xls_ReportexIngresoxMes.xlsx';
    var NombreHoja = 'Reporte';
    var Titulo = "Reporte de Ingreso x Mes";
    ...
    rptURL = rptURL + 'CodMarca=' + $('#hfCodMarca').val() + '&';
    rptURL = rptURL + 'Marca=' + Marca + '&';
    rptURL = rptURL + 'CodFamilia=' + $('#hfCodFamilia').val() + '&';
    rptURL = rptURL + 'Familia=' + Familia + '&';
