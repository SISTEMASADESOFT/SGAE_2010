var AppSession = "../Reportes/Compras_CompraXVendedor_Detallado_Reeim.aspx";
...
function F_ReporteIndividual_excel() {
    ...
    var CodMenu = 721;
    var Titulo = "REPORTE VENTAS POR VENDEDOR";
    var NombreArchivo = "Xls_CompraxVendedor.xlsx";
    var NombreHoja = "CompraVendedor";

    if ($('#MainContent_chkDetallado').is(':checked')) {
        CodMenu = 720;
        Titulo = "REPORTE COMPRAS POR VENDEDOR DETALLADO";
        var NombreArchivo = "Xls_CompraxVendedor_Detallado.xlsx";
        var NombreHoja = "ComprasVendedorDetallado";
    }
