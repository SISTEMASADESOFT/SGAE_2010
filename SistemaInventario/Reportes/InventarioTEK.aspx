<%@ Page Title="Inventario Stock Actual" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InventarioTEK.aspx.cs" Inherits="SistemaInventario.Reportes.InventarioTEK" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="InventarioTEK.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo" style="width: 930px">Reporte de Inventario Stock Actual</div> 
                                                ...
                                                <Columns>
                                                  ...
                                                  <asp:BoundField DataField="MARCA" HeaderText="MARCA">
                                                    ...
                                                    <ItemStyle HorizontalAlign="Right" />
                                                            ...
                                                            <asp:BoundField DataField="Precio" HeaderText="MAYORISTA">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                    </asp:BoundField>
