...
namespace SistemaInventario.Reportes
{
    public partial class Venta_UtilidadBruta : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_CalcularUtilidadBruta_NET);
        }
        ...
        public String F_CalcularUtilidadBruta_NET(String arg)
        {
        ...
        public void F_CalcularUtilidadBruta()
        {
            ...
            dta_consulta = objOperacion.F_CalcularUtilidadBruta();
