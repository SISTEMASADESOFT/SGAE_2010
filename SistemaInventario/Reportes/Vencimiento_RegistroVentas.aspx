<%@ Page Title="Vencimiento Ventas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vencimiento_RegistroVentas.aspx.cs" Inherits="SistemaInventario.Reportes.Vencimiento_RegistroVentas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Vencimiento_RegistroVentas.js" charset="UTF-8"></script>
    ...
    <div id='divConsulta' class="ui-jqgrid ui-widget ui-widget-content ui-corner-all"
        ...
        <div class="ui-jqdialog-content" style="width: 750px;">
            <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
               ...
               <%--                 <asp:ListItem Value="3">NOTA DE CREDITO</asp:ListItem>
                ...
                <tr>
                    <td style="font-weight: bold">
                        <asp:CheckBox ID="chkRango" runat="server" Text="Hasta" Font-Bold="True" />
                    </td>
                    <td colspan='4'>
        ...
        <div class="linea-button" >
         <asp:Button ID="btnBuscar" runat="server" Text="BUSCAR" Font-Names="Arial" Font-Bold="True"
           ...
           <asp:Button ID="btnExcel" runat="server" Text="Excel" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
            ...
            <asp:Button ID="btnPdf" runat="server" Text="Reporte" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                Font-Names="Arial" Font-Bold="True" Width="120" />
        </div>
    </div>
        ...
        <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="True"
            ...
            <asp:TemplateField HeaderText="Concepto" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                              <asp:HyperLink runat="server" ID="lblConcepto" Font-Underline="true" ForeColor="Black"
                                                Style="cursor: hand" Text='<%# Bind("Concepto") %>' onclick="F_PDF(this.is); return false;"
                                                ToolTip="Ver Cobranza" CssClass="detallesart" >
                                                <asp:HiddenField ID="hfFechaMin" runat="server" Value='<%# Bind("FechaMin") %>' />
                                                <asp:HiddenField ID="hfFechaMax" runat="server" Value='<%# Bind("FechaMax") %>' />
                                            </asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Soles" HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblSoles" Text='<%# Bind("Soles") %>'  ></asp:Label>                       
                                           </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Dolares" HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
