<%@ Page Title="Compras Detallado" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="Compras_Compra_Resumido_Detallado.aspx.cs" Inherits="SistemaInventario.Reportes.Compras_Compra_Resumido_Detallado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Compras_Compra_Resumido_Detallado.js" charset="UTF-8"></script>   
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 400px">
       REPORTE COMPRAS RESUMIDO - DETALLADO </div>
                    ...
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <td >
                                <asp:CheckBox runat="server" ID="chkClasificacion" Text="SOLO MERCADERIA" 
                                    Font-Bold="True" Checked="True"  />
                            </td>
                        </tr>
                    </table>
