<%@ Page Title="Movimiento de Productos" Language="C#" MasterPageFile="~/Site.Master"   AutoEventWireup="true" CodeBehind="Inventario_MovimientoProducto_Ventaperdida_Salcedo.aspx.cs" Inherits="SistemaInventario.Reportes.Inventario_MovimientoProducto_Ventaperdida_Salcedo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Inventario_MovimientoProducto_Ventaperdida_Salcedo.js" charset="UTF-8"></script>       
            ...
            <div id="divConsultaArticulo">
                <div class="ui-jqdialog-content">
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        ...
                        <tr id="trFamilia" style="font-weight: bold">
                            <td style="font-weight: bold;display: none">
                                Familia
                            </td>
                            <td style="padding-left: 5px;display: none" colspan="3">
