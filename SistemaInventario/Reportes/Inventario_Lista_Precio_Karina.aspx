<%@ Page Title="Reporte Lista Precio" Language="C#" MasterPageFile="~/Site.Master"    AutoEventWireup="true" CodeBehind="Inventario_Lista_Precio_Karina.aspx.cs" Inherits="SistemaInventario.Reportes.Inventario_Lista_Precio_Karina" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Inventario_Lista_Precio_Karina.js" charset="UTF-8"></script>
            ...
            <div id="divConsultaArticulo">
                <div class="ui-jqdialog-content">
                    <table width="450">
                        ...
                        <td>
                         <asp:TextBox ID="txtStock" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                        </td>
                        </tr>
