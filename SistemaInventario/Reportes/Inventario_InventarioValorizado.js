...
function F_VisualizarExcel() {
    ...
    var Params = 'width=' + (screen.width) + ', height=' + (screen.height) + ', top=0, left=0, directories=no, menubar=no, toolbar=no, location=no, resizable=yes, scrollbars=yes, titlebar=yes';
    var CodMenu = '198';
    var NombreArchivo = 'Xls_InventarioValorizado.xlsx';
    ...
    rptURL = rptURL + 'CodProcedencia=' + ddlProcedencia.selected()[0] + '&';
    rptURL = rptURL + 'CodMoneda=' + ddlMoneda.selected()[0] + '&';
    rptURL = rptURL + 'Familias=' + ddlProcedencia.selected()[0] + '&';
    ...
    rptURL = rptURL + 'Almacenes=' + Sys.Serialization.JavaScriptSerializer.serialize(arrAlmacens) + '&';
