...
$(document).ready(function () {
    ...
    $('#MainContent_btnCalcularUtilidad').click(function () {
        try {
            F_CalcularUtilidadBruta();
    ...
    $('#MainContent_btnReporteGeneral').prop("disabled", true);
    alertify.log("PRIMERO CALCULE LA UTILIDAD");
});
...
function F_CalcularUtilidadBruta() {
    if (!F_SesionRedireccionar(AppSession)) return false;
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                         alertify.log("Se Calculo Correctamente ");
                         
                        $('#MainContent_btnReporteGeneral').prop("disabled", false);
                    }
                    else {
