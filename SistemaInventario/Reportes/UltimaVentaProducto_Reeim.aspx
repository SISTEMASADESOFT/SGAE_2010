<%@ Page Title="Ultima Venta Producto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UltimaVentaProducto_Reeim.aspx.cs" Inherits="SistemaInventario.Reportes.UltimaVentaProducto_Reeim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="UltimaVentaProducto_Reeim.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 390px">Ultima Venta Producto</div> 
                                ...
                                <asp:TextBox ID="txtMarca" runat="server" Width="150px" Font-Names="Arial" ForeColor="Blue"
                                    Font-Bold="True"></asp:TextBox>
                                         ...
                                         <tr>    
                                               ...
                                               <td  >
                                <asp:CheckBox ID="chkDesde" runat="server" Text="DESDE" Font-Bold="True" />
                            </td>
                                                 <td>
