<%@ Page Title="Ventas Detallada" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="Ventas_Venta_Resumido_Detallado_Solo.aspx.cs" Inherits="SistemaInventario.Reportes.Ventas_Venta_Resumido_Detallado_Solo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Ventas_Venta_Resumido_Detallado_Solo.js" charset="UTF-8"></script>   
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 400px">
      REPORTE VENTAS RESUMIDO - DETALLADO</div>
            ...
            <div id="divConsultaArticulo">
                ...
                <div class="linea-button">
                    <asp:Button ID="btnExcel" runat="server" Text="Excel" Font-Names="Arial" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                      ...
                      <asp:Button ID="btnFormatoSimple" runat="server" Text="FormatoSimple" Font-Names="Arial" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        Width="120px" />
