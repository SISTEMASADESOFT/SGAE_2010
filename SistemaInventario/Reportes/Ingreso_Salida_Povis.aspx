<%@ Page Title="Reporte de Ingreso Salida" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ingreso_Salida_Povis.aspx.cs" Inherits="SistemaInventario.Reportes.Ingreso_Salida_Povis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="Ingreso_Salida_Povis.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 390px">Reporte de Ingreso Salida</div> 
               <div id="tabRegistro" style="width: 390px">
                        ...
                        <tr>
                         <td  >
                                <asp:CheckBox ID="ChkFamilia" runat="server" Text="Familia" Font-Bold="True" />
                            </td>
                            
                            <td>
                                <asp:TextBox ID="txtFamilia" runat="server" Width="150px" Font-Names="Arial" ForeColor="Blue"
                                    Font-Bold="True"></asp:TextBox>
                            </td>
                        </tr>
                                        <tr>    
                            ...
                            <td>
                                <asp:TextBox ID="txtCliente" runat="server" Width="150px" Font-Names="Arial" ForeColor="Blue"
                                    ...
                                    <div  class="linea-button">
                                      <asp:Button ID="btnBuscar" runat="server" Text="Busca" Font-Names="Arial"
