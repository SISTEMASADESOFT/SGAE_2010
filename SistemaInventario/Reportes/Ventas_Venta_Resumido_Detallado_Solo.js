var AppSession = "../Reportes/Ventas_Venta_Resumido_Detallado_Solo.aspx";
...
$(document).ready(function () {
    ...
    $('#MainContent_btnFormatoSimple').click(function () {
        var AppSession = "../Reportes/HistorialCobranzas.aspx";
        try {
            F_ReporteSimple('E');
...
function F_Reporte(Tipo) {
    ...
    if (Tipo === 'E') {
        ...
        if (Resumido == 1) {
            CodMenu = 4;
            NombreArchivo = 'Xls_VentasResumido.xlsx';
        }
        else { 
            CodMenu = 1504;
            NombreArchivo = 'Xls_VentasDetalladoSolo.xlsx';
        }            
    }
...
function F_ReporteSimple(Tipo) {
    ...
    if (Tipo === 'E') {
        ...
        if (Resumido == 1) {
            ...
            CodMenu = 1510;
            NombreArchivo = 'Xls_VentasDetalladoSoloSimple.xlsx';
        }
    }
