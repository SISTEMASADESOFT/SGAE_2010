...
{
    public partial class Web_Pagina_Crystal_Nuevo_antiguo : System.Web.UI.Page
    {
        ...
        private void Reportes()
        {
            ...
            switch (Convert.ToInt32(Request["CodMenu"]))
            {
                ...
                case 208:
                    ...
                    if (Convert.ToInt32(Request.QueryString["Resumido"]) == 1)
                    {
                ...
                case 403:
                    ...
                    dtTabla = objLGProductosCN.F_LGProductos_ListarProductosPrecios_Reporte_Roman(objLGProductosCE);
                    dtTabla.TableName = NombreTabla;
                ...
                case 406:
                    Parametro2.Value = Request.QueryString["Titulo"].ToString();
                    Parametro3.Value = Request.QueryString["SubTitulo"].ToString();
                    ...
                    dtTabla = objLGProductosCN.F_INGRESO_INVENTARIO_DESPACHO(objLGProductosCE);
                    dtTabla.TableName = NombreTabla;
                    ...
                    rpt.ParameterFields["Titulo"].CurrentValues.AddValue(Parametro2.Value);
                    rpt.ParameterFields["SubTitulo"].CurrentValues.Clear();
                    rpt.ParameterFields["SubTitulo"].CurrentValues.AddValue(Parametro3.Value);
                ...
                case 701:
                    ...
                    objDocumentoVentaCabCE.CodDoc = Convert.ToInt32(Request.QueryString["CodDoc"]);
                ...
                case 708:
                    ...
                    objDocumentoVentaCabCE.Hasta = Convert.ToDateTime(Request["Hasta"]);
                    objDocumentoVentaCabCE.CodCliente = Convert.ToInt32(Request["CodCtaCte"]);
                    objDocumentoVentaCabCE.Retraso = Convert.ToInt32(Request["Retraso"]);
