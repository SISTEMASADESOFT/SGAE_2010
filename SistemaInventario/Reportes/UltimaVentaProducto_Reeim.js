var AppSession = "../Reportes/UltimaVentaProducto_Reeim.aspx";
...
function F_Excel() {
    ...
    if ($('#MainContent_chkDesde').is(':checked'))
        Fecha = 1;

    if ($('#hfCodCtaCte').val() == 0) {
        alertify.log("Debe Elegir un cliente ");
        return false;
    }
    ...
    var NombreArchivo = 'Xls_UltimaVentaProducto.xlsx';
    var NombreHoja = 'Reporte';
    var Titulo = "REPORTE COMPRA PERIODO DESDE " + $("#MainContent_txtDesde").val() + " HASTA " + $('#MainContent_txtHasta').val();
    ...
    rptURL = rptURL + 'Cliente=' + $('#MainContent_txtCliente').val() + '&';
    rptURL = rptURL + 'Titulo=' + Titulo + '&';
    rptURL = rptURL + 'NombreArchivo=' + NombreArchivo + '&';
