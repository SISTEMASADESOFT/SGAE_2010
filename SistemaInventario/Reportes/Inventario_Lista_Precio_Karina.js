var AppSession = "../Reportes/Inventario_Lista_Precio_Karina.aspx";
...
function F_VisualizarExcel() {
    ...
    var CodMenu = 1507;
    var NombreArchivo = 'Xls_Lista_Precio_Karina.xlsx';
    var NombreHoja = 'PRODUCTO';
    var Stock = 0;

    if ($("#MainContent_txtStock").val() == '')
        Stock = -1;
    else
        Stock = $("#MainContent_txtStock").val();

    rptURL = '../Reportes/Web_Pagina_ConstruirExcel.aspx';
    rptURL = rptURL + '?';
    rptURL = rptURL + 'CodMenu=' + CodMenu + '&';
    rptURL = rptURL + 'DscProducto=' + $.trim($('#MainContent_txtDscProducto').val()) + '&';
    rptURL = rptURL + 'IdFamilia=' + $('#MainContent_ddlFamiliaConsulta').val() + '&';
    rptURL = rptURL + 'Stock=' + Stock + '&';
