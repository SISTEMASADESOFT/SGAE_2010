        ...
        private void Reportes()
        {
            ...
            switch (Convert.ToInt32(Request["CodMenu"]))
            {
                ...
                case 102:
                    ...
                    dtTabla = objTrasladosCabCN.F_TrasladosCab_Impresion(objTrasladosCabCE);
                    dtTabla.TableName = dtTabla.Rows[0]["Datatable"].ToString();
                    rpt.Load(Server.MapPath(dtTabla.Rows[0]["ImpresionArchivo"].ToString()));
                ...
                case 201:
                    ...
                    if (dtTabla.Rows[0]["GuiaRemision"].ToString() != "")
                    {
                        if (dtTabla.Rows[0]["GuiaRemision"].ToString().Substring(0, 1) == "T")
                        {
                            ...
                            rpt3.Load(Server.MapPath(dtTablaGE.Rows[0]["ImpresionArchivo"].ToString()));
                ...
                case 207:
                    ...
                    objDocumentoVentaCabCE.CodFormaPago = Convert.ToInt32(Request.QueryString["CodFormaPago"]);
                ...
                case 213:
                    ...
                    string ImpresionArchivoDespacho = dtTabla.Rows[0]["ImpresionArchivoDespacho"].ToString();                    
                    ...
                    if (ImpresionArchivoDespacho != "")
                    {
                        rpt2.Load(Server.MapPath(ImpresionArchivoDespacho));
                ...
                case 214:
                    ...
                    objDocumentoVentaCabCE.Desde = Convert.ToDateTime(Request.QueryString["Desde"]);
                    objDocumentoVentaCabCE.Hasta = Convert.ToDateTime(Request.QueryString["Hasta"]);
                    objDocumentoVentaCabCE.Placa1 = Convert.ToString(Request.QueryString["Placa"]);
                ...
                case 400:
                    ...
                    string filtroSucursales3 = Request.QueryString["Filtro_Sucursales"] ?? "";
                    objDocumentoVentaCabCE.FiltroSucursales = filtroSucursales3; 
                ...
                case 449:
                    ...
                    objDocumentoVentaCabCE.XmlDetalle = "";
                    dynamic jArr9 = Newtonsoft.Json.JsonConvert.DeserializeObject(Request["XmlCliente"]);
                    foreach (dynamic item in jArr9)
                    {
                        objDocumentoVentaCabCE.XmlDetalle = objDocumentoVentaCabCE.XmlDetalle + "<D ";
                        objDocumentoVentaCabCE.XmlDetalle = objDocumentoVentaCabCE.XmlDetalle + " CodCtaCte = '" + item.CodCtaCte + "'";
                        objDocumentoVentaCabCE.XmlDetalle = objDocumentoVentaCabCE.XmlDetalle + " />";
                    ...
                    dtTabla = objDocumentoVentaCabCN.F_Cobranzas_Producto_Reporte(objDocumentoVentaCabCE);
                    dtTabla.TableName = NombreTabla;
                ...
                case 450:
                    ...
                    objDocumentoVentaCabCE.CodMoneda = Convert.ToInt32(Request.QueryString["CodMoneda"]);
                    objDocumentoVentaCabCE.CodVendedor = Convert.ToInt32(Request.QueryString["CodVendedor"]);
                    objDocumentoVentaCabCE.CodDepartamento = Convert.ToInt32(Request.QueryString["CodDepartamento"]);
                    ...
                    objDocumentoVentaCabCE.XmlDetalle = "";
                    dynamic jArr20 = Newtonsoft.Json.JsonConvert.DeserializeObject(Request["XmlCliente"]);
                    foreach (dynamic item in jArr20)
                    {
                        objDocumentoVentaCabCE.XmlDetalle = objDocumentoVentaCabCE.XmlDetalle + "<D ";
                        objDocumentoVentaCabCE.XmlDetalle = objDocumentoVentaCabCE.XmlDetalle + " CodCtaCte = '" + item.CodCtaCte + "'";
                        objDocumentoVentaCabCE.XmlDetalle = objDocumentoVentaCabCE.XmlDetalle + " />";
                    ...
                    dtTabla = objDocumentoVentaCabCN.F_Cobranzas_Reporte_Ubicacion(objDocumentoVentaCabCE);
                    dtTabla.TableName = NombreTabla;
                ...
                case 451:
                    ...
                    objDocumentoVentaCabCE.XmlDetalle = "";
                    dynamic jArr21 = Newtonsoft.Json.JsonConvert.DeserializeObject(Request["XmlCliente"]);
                    foreach (dynamic item in jArr21)
                    {
                        objDocumentoVentaCabCE.XmlDetalle = objDocumentoVentaCabCE.XmlDetalle + "<D ";
                        objDocumentoVentaCabCE.XmlDetalle = objDocumentoVentaCabCE.XmlDetalle + " CodCtaCte = '" + item.CodCtaCte + "'";
                        objDocumentoVentaCabCE.XmlDetalle = objDocumentoVentaCabCE.XmlDetalle + " />";
                ...
                case 718:
                    ...
                    objDocumentoVentaCabCE.SerieDoc = Convert.ToString(Request.QueryString["SerieDoc"]);
                    objDocumentoVentaCabCE.CodAlmacen = Convert.ToInt32(Session["CodSede"]);
                    try { objDocumentoVentaCabCE.CodCliente = Convert.ToInt32(Request.QueryString["CodCliente"]); }
                    catch (Exception) { }
                    ...
                    {
                        case 0:
                            Parametro1.Value = "Factura, Boleta, Nota de Venta y Nota de Credito Desde " + Request.QueryString["Desde"].ToString() + " Hasta " + Request.QueryString["Hasta"].ToString();
                            break;
                        case 1:
                            Parametro1.Value = "Factura y Nota de Credito Desde " + Request.QueryString["Desde"].ToString() + " Hasta " + Request.QueryString["Hasta"].ToString();
                            break;
                        case 2:
                            Parametro1.Value = "Boleta y Nota de Credito Desde " + Request.QueryString["Desde"].ToString() + " Hasta " + Request.QueryString["Hasta"].ToString();
                            break;
                        case 16:
                            Parametro1.Value = "Nota de Venta y Nota de Credito Desde " + Request.QueryString["Desde"].ToString() + " Hasta " + Request.QueryString["Hasta"].ToString();
                            break;
                    }
                    ...
                    else
                    {
                        ...
                        NombreArchivo = "rptVentasReporte.rpt";
                    }
                ...
                case 3000:
                    objProformaCabCE.CodMovimiento = Convert.ToInt32(Request.QueryString["Codigo"]);
                    dtTabla = objProformaCabCN.F_OrdenCompraCab_VistaPreliminar(objProformaCabCE);
                    dtTabla.TableName = NombreTabla;
                ...
                case 3001:
                    ...
                    dtTabla = objDocumentoVentaCabCN.F_DOCUMENTOVENTACAB_REPORTE_VENTA_TIPODOCUMENTO_DETALLADO(objDocumentoVentaCabCE);
                    dtTabla.TableName = NombreTabla;
                    rpt.Load(Server.MapPath(NombreArchivo));
                ...
                case 3003:
                    ...
                    objNotaIngresoSalidaCabCE.CodEmpresa = Convert.ToInt32(Session["CodEmpresa"]);
                    objNotaIngresoSalidaCabCE.CodAlmacen = Convert.ToInt32(Session["CodSede"]);
                    objNotaIngresoSalidaCabCE.CodEstado = Convert.ToInt32(Request.QueryString["CodEstado"]);
                    objNotaIngresoSalidaCabCE.CodTipoDoc = Convert.ToInt32(Request.QueryString["CodTipoDoc"]);

                    objNotaIngresoSalidaCabCE.DesdeInt = Convert.ToInt32(Request.QueryString["Desde"]);
                    objNotaIngresoSalidaCabCE.HastaInt = Convert.ToInt32(Request.QueryString["Hasta"]);
                    objNotaIngresoSalidaCabCE.Serie = Request.QueryString["Serie"];

                    dtTabla = objNotaIngresoSalidaCabCN.F_NOTAINGRESO_REPORTE_ESTADOS(objNotaIngresoSalidaCabCE);
                ...
                case 3004:
                    ...
                    objNotaIngresoSalidaCabCE.DesdeInt = Convert.ToInt32(Request.QueryString["Desde"]);
                    objNotaIngresoSalidaCabCE.HastaInt = Convert.ToInt32(Request.QueryString["Hasta"]);
                    objNotaIngresoSalidaCabCE.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);

                    dtTabla = objNotaIngresoSalidaCabCN.F_TRASLADOSCAB_REPORTE(objNotaIngresoSalidaCabCE);
                ...
                case 3006:
                    ...
                    objNotaIngresoSalidaCabCE.CodAlmacen = Convert.ToInt32(Request.QueryString["CodAlmacen"]);           
                    objNotaIngresoSalidaCabCE.DesdeInt = Convert.ToInt32(Convert.ToDateTime(Request.QueryString["Desde"]).ToString("yyyyMMdd"));
                    objNotaIngresoSalidaCabCE.HastaInt = Convert.ToInt32(Convert.ToDateTime(Request.QueryString["Hasta"]).ToString("yyyyMMdd"));

                    dtTabla = objNotaIngresoSalidaCabCN.F_DOCUMENTOVENTACAB_NOTAINGRESOINVENTARIOCAB_SALIDAS_ALMACEN(objNotaIngresoSalidaCabCE);
                ...
                case 3007:
                    Parametro1.Value = Request.QueryString["Titulo"].ToString();

                    objDocumentoVentaCabCE.CodCobranza = Convert.ToInt32(Request.QueryString["Codigo"]);
                    dtTabla = objDocumentoVentaCabCN.F_Voucher_VistaPreliminar(objDocumentoVentaCabCE);
                    dtTabla.TableName = NombreTabla;
                    ...
                    rpt.ParameterFields["Titulo"].CurrentValues.Clear();
                    rpt.ParameterFields["Titulo"].CurrentValues.AddValue(Parametro1.Value);
                ...
                case 3008:
                    ...
                    objDocumentoVentaCabCE.CodCobranza = Convert.ToInt32(Request.QueryString["Codigo"]);
                    dtTabla = objDocumentoVentaCabCN.F_Voucher_Pagos_VistaPreliminar(objDocumentoVentaCabCE);
                    dtTabla.TableName = NombreTabla;
