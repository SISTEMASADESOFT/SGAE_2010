<%@ Page Title="Ventas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Estadistico_Ventas_General_CasaH100.aspx.cs" Inherits="SistemaInventario.Reportes.Estadistico_Ventas_General_CasaH100" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" src="Estadistico_Ventas_General_CasaH100.js" charset="UTF-8"></script>
        ...
        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
            ...
            <div id="divConsultaArticulo" style="padding:20px; display:grid; grid-template-columns: 1fr 1fr; gap:20px;">
                ...
                <div style="background:#fff; border:1px solid #ddd; border-radius:6px; padding:15px; display:none">
                    <h3 style="font-size:13px; margin:0 0 10px;">Distribucion de Ventas</h3>
                    <canvas id="canvasVentasPie" style="max-height:300px;"></canvas>
                </div>

               
                 <div style="background:#fff; border:1px solid #ddd; border-radius:6px; padding:15px; display:none ">
                    <h3 style="font-size:13px; margin:0 0 10px;">Ventas Por Sucursal</h3>
                    <canvas id="canvasVentasSucursal" style="max-height:300px;"></canvas>
                </div>
