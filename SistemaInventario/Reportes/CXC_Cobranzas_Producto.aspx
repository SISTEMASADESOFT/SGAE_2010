<%@ Page Title="Reporte Cobranzas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CXC_Cobranzas_Producto.aspx.cs" Inherits="SistemaInventario.Reportes.CXC_Cobranzas_Producto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CXC_Cobranzas_Producto.js" charset="UTF-8"></script>
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="font-weight: bold">
                                   ...
                                   <td style="font-weight: bold">
                                    <asp:CheckBox ID="chkProducto" runat="server" Text="PRODUCTO" Font-Bold="True" />
                                </td>
                                <td style="display:none;">
