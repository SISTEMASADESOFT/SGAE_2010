<%@ Page Title="Movimiento de Productos" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="Inventario_MovimientoProductoTEK.aspx.cs" Inherits="SistemaInventario.Reportes.Inventario_MovimientoProductoTEK" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Inventario_MovimientoProductoTEK.js"
        charset="UTF-8"></script>
