<%@ Page Title="Registro Ventas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="Contabilidad_RegistroVentas_Proforma.aspx.cs" Inherits="SistemaInventario.Reportes.Contabilidad_RegistroVentas_Proforma" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Contabilidad_RegistroVentas_Proforma.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 300px">
        Reporte de Registro de Ventas Proforma</div>
