var AppSession = "../Reportes/Reporte_ComisionXVendedor.aspx";
...
$(document).ready(function () {
    ...
    $('#MainContent_btnResumido').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;
        try {
            F_ReporteResumido();
    ...
    $('#MainContent_btnDetallado').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;
        try {
            F_ReporteDetallado();
...
function F_Reporte() {
    ...
    if ($('#MainContent_chkDetallado').is(':checked')) {
        CodMenu = 408;
        Titulo = "REPORTE VENTAS POR VENDEDOR DETALLADO";
    }
...
function F_ReporteResumido() {
    var Cuerpo = '#MainContent_';
    var rptURL = '';
    var Params = 'width=' + (screen.width * 0.48) + ', height=' + (screen.height * 0.40) + ', top=0, left=0, directories=no, menubar=no, toolbar=no, location=no, resizable=yes, scrollbars=yes, titlebar=yes';
    var TipoArchivo = 'application/pdf';
    var CodMenu = 602;
    var NombreArchivo = 'Xls_RegistroVentas_ComisionxVendedor_Resumido.xlsx';
    ...
    rptURL = rptURL + 'Desde=' + $('#MainContent_txtDesde').val() + '&';
    rptURL = rptURL + 'Hasta=' + $('#MainContent_txtHasta').val() + '&';
    rptURL = rptURL + 'Vendedor=' + $('#MainContent_ddlVendedor').val() + '&';
    rptURL = rptURL + 'NombreArchivo=' + NombreArchivo + '&';
...
function F_ReporteDetallado() {
    var Cuerpo = '#MainContent_';
    var rptURL = '';
    var Params = 'width=' + (screen.width * 0.48) + ', height=' + (screen.height * 0.40) + ', top=0, left=0, directories=no, menubar=no, toolbar=no, location=no, resizable=yes, scrollbars=yes, titlebar=yes';
    var TipoArchivo = 'application/pdf';
    var CodMenu = 603;
    var NombreArchivo = 'Xls_RegistroVentas_ComisionxVendedor_Detallado.xlsx';
    var NombreHoja = 'VENTAS';
