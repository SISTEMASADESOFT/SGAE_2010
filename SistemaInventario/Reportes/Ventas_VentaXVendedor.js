...
$(document).ready(function () {
    ...
    $('.MesAnioPicker').datepicker({
        ...
        onClose: function (dateText, inst) {
            ...
            $(this).val($.datepicker.formatDate('yymmdd', new Date(year, month, 1)));
        }
    });
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_FormaPago', result.split('~')[5]);
...
function F_Reporte() {
    ...
    rptURL = rptURL + 'Desde=' + F_Fecha_Formato($("#MainContent_txtDesde").val(),'ISO') + '&';
    rptURL = rptURL + 'Hasta=' + F_Fecha_Formato($('#MainContent_txtHasta').val(),'ISO') + '&';
    rptURL = rptURL + 'CodEmpleado=' + $('#MainContent_ddlVendedor').val() + '&';
    rptURL = rptURL + 'CodMoneda=' + $('#MainContent_ddlMoneda').val() + '&';
    rptURL = rptURL + 'CodFormaPago=' + $('#MainContent_ddlFormaPago').val() + '&';
