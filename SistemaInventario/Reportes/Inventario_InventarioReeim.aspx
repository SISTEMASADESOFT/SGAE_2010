<%@ Page Title="Inventario Stock Actual" Language="C#" MasterPageFile="~/Site.Master"    AutoEventWireup="true" CodeBehind="Inventario_InventarioReeim.aspx.cs" Inherits="SistemaInventario.Reportes.Inventario_InventarioReeim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Inventario_InventarioReeim.js" charset="UTF-8"></script>
                        ...
                        <tr>
                          ...
                          <tr>
                                        ...
                                        <td colspan='5' style="padding-left: 1px;">
                                            <asp:TextBox ID="txtMarca" runat="server" Width="310px" Font-Names="Arial" ForeColor="Blue"
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                <div id="div_tipo">
                                    <asp:DropDownList ID="ddlTipo" runat="server" Font-Names="Arial" Font-Bold="True"
                                        ForeColor="Blue">
