<%@ Page Title="Retenciones Concar" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ContabilidadConcar_Retenciones.aspx.cs" Inherits="SistemaInventario.Reportes.ContabilidadConcar_Retenciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ContabilidadConcar_Retenciones.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 300px">
        Reporte de Retenciones - Concar</div>
