...
{
    public partial class Web_Pagina_ConstruirExcel_antiguo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            switch (Convert.ToInt32(Request["CodMenu"]))
            {
                ...
                case 12:
                    ...
                    break;
                case 13:
                    P_ReporteVentasPorPeriodoCompletoReeim();
                    break;
                case 202:
                ...
                case 714:
                    ...
                    break;
                case 715:
                    P_Reporte_Ventas_Mes_Reeim();
                    break;
                case 716:
                    P_RegistroAjusteInventarioRomanExcel();
                    break;
                case 717:
                    P_DocumentoVentaCab_VENTA_EMPLEADO_Resumido();
                    break;
                case 718:
                    P_DocumentoVentaCab_VENTA_EMPLEADO_DETALLADO();
                    break;
                case 719:
                    P_Contabilidad_RegistroVentas_Roman_Proformas();
                    break;
                case 720:
                    P_NOTAINGRESOSALIDACab_COMPRA_EMPLEADO_DETALLADO();
                    break;
                case 721:
                    P_DocumentoVentaCab_VENTA_EMPLEADO_Resumido();
                    break;
                case 722:
                    P_Inventario_StockActual_Roman();
                    break;

                case 723:
                    P_Reporte_Ultima_Compra_Producto_Reeim();
                    break;
                case 1000:
                    P_Reporte_Cobranzas();
                    break;
        ...
        public void p_ReporteVentasPorUnidades()
        {
            ...
            objEntidad.CodProcedencia = Convert.ToInt32(Request["Filtro_Procedencia"]);
            objEntidad.CodMoneda = Convert.ToInt32(Request["Filtro_CodMoneda"]);
            ...
            jArr2 = Newtonsoft.Json.JsonConvert.DeserializeObject(Request["Familia"].ToString());
            ...
            jArr2 = Newtonsoft.Json.JsonConvert.DeserializeObject(Request["Linea"].ToString());
            foreach (dynamic item in jArr2)
            {
            ...
            dynamic jArr3 = Newtonsoft.Json.JsonConvert.DeserializeObject(Request["Marca"].ToString());
            ...
            jArr2 = Newtonsoft.Json.JsonConvert.DeserializeObject(Request["Almacen"].ToString());
            foreach (dynamic item in jArr2)
            {
            ...
            dtTabla = objOperacion.F_Inventario_Unidades_Fisicas(objEntidad);

            ws.Cells["A1"].LoadFromDataTable(dtTabla, true);

            ws.Column(1).Width = 10.71;
            ws.Column(2).Width = 15.71;
            ws.Column(3).Width = 39.71;
            ws.Column(4).Width = 87.71;
            ws.Column(5).Width = 16.43;
            ws.Column(6).Width = 20.57;
            ws.Column(7).Width = 8.29;
            ws.Column(8).Width = 6.57;
            ws.Column(9).Width = 10.29;
            ws.Column(10).Width = 10.71;
            ws.Column(11).Width = 10.71;
            ws.Column(12).Width = 10.71;
            ws.Column(13).Width = 10.71;
            ws.Cells["j:j"].Style.Numberformat.Format = null;
            ws.Cells["j:j"].Style.Numberformat.Format = "#,##0.00";
        ...
        public void P_Inventario_Valorizado()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
        ...
        public void P_ReporteVentasPorPeriodoCompletoReeim()
        {
            DocumentoVentaCabCE objEntidad = new DocumentoVentaCabCE();
            DocumentoVentaCabCN objOperacion = new DocumentoVentaCabCN();
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                ws.Cells["A1"].Value = "REPORTE DE UNIDADES VENDIDAS POR PERIODO"; ws.Row(1).Style.Font.Size = 18; ws.Row(1).Style.Font.Bold = true;
                ws.Cells["A2"].Value = "PERIODO: DEL " + PeriodoDesde + " AL " + PeriodoHasta; ws.Row(2).Style.Font.Bold = true;
                ws.Cells["A3"].Value = "LINEA: " + Familias; ws.Row(3).Style.Font.Bold = true;
                ws.Cells["A4"].Value = "MARCAS: " + Marcas; ws.Row(4).Style.Font.Bold = true;
                ws.Cells["A5"].Value = "ALMACEN: " + Almacen; ws.Row(5).Style.Font.Bold = true;
    ...
    dtTabla.Columns.RemoveAt(15); dtTabla.Columns.RemoveAt(14);
        ...
        public void P_Inventario_StockActual()
        {
            ...
            objLGProductosCE.CodMarca = Convert.ToInt32(Request.QueryString["CodMarca"]);
            objLGProductosCE.chkMarca = Convert.ToInt32(Request.QueryString["Marca"]);
            objLGProductosCE.Tipo = Convert.ToInt32(Request.QueryString["Tipo"]);
            ...
            ws.Column(1).Width = 12.71;
            ws.Column(2).Width = 13.71;
            ws.Column(3).Width = 49.71;
            ws.Column(4).Width = 62.71;
            ws.Column(5).Width = 8.71;
            ws.Column(6).Width = 11.71;
            ws.Column(7).Width = 11.71;
            ws.Column(8).Width = 11.71;
            ws.Column(9).Width = 11.71;
            ws.Column(10).Width = 11.71;
            ws.Column(11).Width = 11.71;
            ws.Cells["A1"].LoadFromDataTable(dtTabla, true);
            ...
            ws.Cells["B1:B100000"].Style.Numberformat.Format = "@";
        ...
        public void P_Inventario_StockActual_Roman()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
            ...
            objLGProductosCE.Marca = Convert.ToString(Request.QueryString["Marca"]);
            objLGProductosCE.CodAlmacen = Convert.ToInt32(Session["CodSede"]);
            objLGProductosCE.CodFamilia = Convert.ToString(Request.QueryString["CodFamilia"]);
            objLGProductosCE.CodProcedencia = Convert.ToInt32(Request.QueryString["Procedencia"]);


            DataTable dtTabla = null;

            dtTabla = objLGProductosCN.F_LGProductos_Inventario_StockActual_Roman(objLGProductosCE);
            ...
            ws.Column(5).Width = 8.71;
            ws.Column(6).Width = 10.71;
            ws.Column(7).Width = 9.71;
            ws.Column(8).Width = 9.71;
            ws.Column(9).Width = 9.71;
            ws.Column(10).Width = 9.71;
            ws.Column(11).Width = 13.71;
            ws.Column(12).Width = 9.71;
            ws.Column(13).Width = 13.71;
            ws.Column(14).Width = 33.71;
            ws.Cells["A1"].LoadFromDataTable(dtTabla, true);
            ws.Cells["A1:k1"].Style.Font.Size = 10;
            ws.Cells["A1:k1"].Style.Font.Name = "arial";
            ws.Cells["A1:k1"].Style.Font.Bold = true;
            ...
            ws.Cells["A1:A100000"].Style.Numberformat.Format = "@";
            ws.Cells["B1:B100000"].Style.Numberformat.Format = "@";
            ws.Cells["C1:C100000"].Style.Numberformat.Format = "@";
            ws.Cells["D1:D100000"].Style.Numberformat.Format = "@";
            ws.Row(1).Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
            ws.Row(1).Style.VerticalAlignment = ExcelVerticalAlignment.Center;
        ...
        public void P_Reporte_Ventas_Mes_Reeim()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
            ...
            dtTabla = objLGProductosCN.F_DOCUMENTOVENTACAB_VENTAS_MENSUALES_VENDEDOR_Reeim(objLGProductosCE);

            ws.Cells["A1"].LoadFromDataTable(dtTabla, true);
            ws.Column(1).Width = 56.57;
            ws.Column(2).Width = 21.71;
            //ws.DeleteColumn(1);
        ...
        public void P_Reporte_Ingreso_Mes()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
            ...
            objLGProductosCE.chkMarca = Convert.ToInt32(Request.QueryString["Marca"]);
            objLGProductosCE.codMarca = Convert.ToInt32(Request.QueryString["CodMarca"]);
            objLGProductosCE.ChkFamilia = Convert.ToInt32(Request.QueryString["Familia"]);
            objLGProductosCE.IdFamilia = Convert.ToInt32(Request.QueryString["CodFamilia"]);
            objLGProductosCE.chkCliente = Convert.ToInt32(Request.QueryString["Cliente"]);
            objLGProductosCE.CodCliente = Convert.ToInt32(Request.QueryString["CodCtacte"]);



            DataTable dtTabla = null;

            dtTabla = objLGProductosCN.F_INGRESO_SALIDA_POVIS(objLGProductosCE);
        ...
        public void P_Reporte_Cobranza()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
            ...
            objLGProductosCE.CodAlmacen = Convert.ToInt32(Request["CodAlmacen"]);
            objLGProductosCE.CodEmpresa = Convert.ToInt32(Session["CodEmpresa"]);
            objLGProductosCE.CodMedioPago = Convert.ToInt32(Request["CodMedioPago"]);
            objLGProductosCE.CodTipoDoc = Convert.ToInt32(Request["CodTipoDoc"]);
            objLGProductosCE.FlagAcuenta = Convert.ToInt32(Request["FlagAcuenta"]);
            objLGProductosCE.NumeroDoc = Convert.ToString(Request["Numero"]);
            objLGProductosCE.Desde = Convert.ToDateTime(Request["Desde"]);
            objLGProductosCE.Hasta = Convert.ToDateTime(Request["Hasta"]);
            objLGProductosCE.CodCliente = Convert.ToInt32(Request["CodCtaCte"]);
            objLGProductosCE.Retraso = Convert.ToInt32(Request["Retraso"]);
            objLGProductosCE.Ruta = Convert.ToInt32(Request["Ruta"]);
            objLGProductosCE.CodVendedor = Convert.ToInt32(Request["CodVendedor"]);

            

            DataTable dtTabla = null;

            dtTabla = objLGProductosCN.F_DOCUMENTOVENTACAB_LISTAR_COBRANZAS_Excel(objLGProductosCE);

            

            ws.Column(1).Width = 0;
            ws.Column(2).Width = 0;
            ws.Column(3).Width = 3.71;
            ws.Column(4).Width = 10.71;
            ws.Column(5).Width = 25.71;
            ws.Column(6).Width = 5.71;
            ws.Column(7).Width = 10.71;
            ws.Column(8).Width = 12.71;
            ws.Column(9).Width = 10.71;
            ws.Column(10).Width = 10.71;
            ws.Column(11).Width = 10.71;
            ws.Column(12).Width = 6.71;
            ws.Column(13).Width = 6.71;
            ws.Column(14).Width = 6.71;
            ws.Column(15).Width = 6.71;
            ws.Row(1).Height = 29.71;
            ws.Column(1).Style.Font.Size = 10;
            ws.Column(2).Style.Font.Size = 10;
            ws.Column(3).Style.Font.Size = 10;
            ws.Column(4).Style.Font.Size = 10;
            ws.Column(5).Style.Font.Size = 10;
            ws.Column(6).Style.Font.Size = 10;
            ws.Column(7).Style.Font.Size = 10;
            ws.Column(8).Style.Font.Size = 10;
            ws.Column(9).Style.Font.Size = 10;
            ws.Column(10).Style.Font.Size = 10;
            ws.Column(11).Style.Font.Size = 10;
            ws.Column(12).Style.Font.Size = 10;
            ws.Column(13).Style.Font.Size = 10;
            ws.Column(14).Style.Font.Size = 10;
            ws.Column(15).Style.Font.Size = 10;
            ws.Cells["A1"].LoadFromDataTable(dtTabla, true);
            ws.Cells["A1:P1"].Style.Font.Size = 10;
            ws.Cells["A1:P1"].Style.Font.Name = "arial";
            ws.Cells["A1:P1"].Style.Font.Bold = true;
            ws.Cells["A1:P1"].Style.Font.Color.SetColor(Color.Black);
            ws.Column(5).Style.HorizontalAlignment = ExcelHorizontalAlignment.Left;
            ws.Row(1).Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
            ws.Row(1).Style.VerticalAlignment = ExcelVerticalAlignment.Center;
            ws.Cells["I2:I1000"].Style.Numberformat.Format = "0";
            ws.Cells["J2:J1000"].Style.Numberformat.Format = "0";
            ws.Cells["K2:K1000"].Style.Numberformat.Format = "0";
        ...
        public void P_Reporte_Productos()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
            ...
            objLGProductosCE.CodAlmacen = Convert.ToInt32(Session["CodSede"]);
            objLGProductosCE.DscProducto = Convert.ToString(Request["Descripcion"]);
            objLGProductosCE.IdFamilia = Convert.ToInt32(Request["IdFamilia"]);
            objLGProductosCE.CodEstado = Convert.ToInt32(Request["CodEstado"]);
            objLGProductosCE.Marca = Convert.ToString(Request["Marca"]);

            objLGProductosCE.FlagProductosConStock = Convert.ToInt32(Request["FlagProductosConStock"]);

            DataTable dtTabla = null;

            dtTabla = objLGProductosCN.F_LGProductos_Listar(objLGProductosCE);

            ws.Column(1).Width = 21;
            ws.Column(2).Width = 21;
            ws.Column(3).Width = 79;
            ws.Column(4).Width = 10.71;
            ...
            ws.Row(1).Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
            ws.Row(1).Style.VerticalAlignment = ExcelVerticalAlignment.Center;
            ws.Cells["D2:D1000"].Style.Numberformat.Format = "0.00";
            ws.Cells["E2:E1000"].Style.Numberformat.Format = "0.00";
            ws.Cells["F2:F1000"].Style.Numberformat.Format = "0.00";
        ...
        public void P_RegistroAjusteInventarioRomanExcel()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
            ...
            dtTabla = objOperacion.F_REGISTRO_AJUSTE(objEntidad);
        ...
        public void P_DocumentoVentaCab_VENTA_EMPLEADO_Resumido()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
            ...
            dtTabla = objLGProductosCN.F_DocumentoVentaCab_VENTA_EMPLEADO_Resumido(objLGProductosCE);
            ...
            ws.Cells["G2"].Value = DateTime.Now.ToString("hh:mm:ss");

            ws.Cells["A1"].Value = dtTabla.Rows[0]["Empresa"].ToString();
            ws.Cells["A2"].Value = "SUCURSAL " + dtTabla.Rows[0]["SUCURSAL"].ToString();
            ws.Cells["E3"].Value = Request["Titulo"].ToString();
            ws.Cells["E4"].Value = Request["SubTitulo"].ToString();
            ws.Cells["A6"].Value = "TD";
            ws.Cells["B6"].Value = "NUMERO";
            ws.Cells["C6"].Value = "FECHA";
            ws.Cells["D6"].Value = "RUC";
            ws.Cells["E6"].Value = "CLIENTE";
            ws.Cells["F6"].Value = "SOLES";
            ws.Cells["G6"].Value = "DOLARES";
            ...
            ws.Column(5).Width = 86.48;
            ws.Column(6).Width = 11.91;
            ws.Column(7).Width = 13.06;
            ...
            ws.Cells["E3"].Style.Font.Size = 16;
            ws.Cells["E4"].Style.Font.Size = 12;
            ...
            ws.Cells["A6:G6"].Style.Font.Size = 12;
            ...
            ws.Cells["A8:A1000"].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
            ws.Row(3).Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
            ws.Row(4).Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
            ws.Cells["F8:F1000"].Style.Numberformat.Format = "#,##0.00";
            ws.Cells["G8:G1000"].Style.Numberformat.Format = "#,##0.00";
            ///////////////////////////////////////////////////
            for (int I = 0; I < dtTabla.Rows.Count; I++)
            {
                ...
                if (dtTabla.Rows[I]["VENDEDOR"].ToString() == VENDEDOR)
                {
                    ...
                    ws.Cells["E" + (I + C).ToString()].Value = dtTabla.Rows[I]["CLIENTE"].ToString();
                    ws.Cells["F" + (I + C).ToString()].Value = dtTabla.Rows[I]["SOLES"];
                    ws.Cells["G" + (I + C).ToString()].Value = dtTabla.Rows[I]["DOLARES"];

                        if (dtTabla.Rows.Count == I + 1)
                        {
                            ws.Cells["E" + (I + C + 1).ToString()].Value =  dtTabla.Rows[I]["VENDEDOR"].ToString();
                            ws.Cells["E" + (I + C + 1).ToString()].Style.Font.Bold = true;
                            ws.Cells["F" + (I + C + 1).ToString()].Formula = "SUM(F" + LIO.ToString() + ":F" + (I + C).ToString() + ")";
                            ...
                            ws.Cells["E" + (I + C + 1).ToString()].Value = "TOTAL  " ;
                            ws.Cells["E" + (I + C + 1).ToString()].Style.Font.Bold = true;
                            ws.Cells["F" + (I + C + 1).ToString()].Formula = "=F" + LMI.ToString() + "+ F" + (I + C).ToString();
                            ws.Cells["F" + (I + C + 1).ToString()].Style.Font.Bold = true;
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////
                else
                {
                    ...
                    ws.Cells["E" + (I + C).ToString()].Value = dtTabla.Rows[I - 1]["VENDEDOR"].ToString() ;
                    ws.Cells["E" + (I + C).ToString()].Style.Font.Bold = true;
                    ws.Cells["F" + (I + C).ToString()].Formula = "SUM(F" + LIO.ToString() + ":F" + (I + C - 1).ToString() + ")";
                    ...
                    ws.Cells["E" + (I + C + 1).ToString()].Value = dtTabla.Rows[I]["CLIENTE"].ToString();
                    ws.Cells["F" + (I + C + 1).ToString()].Value = dtTabla.Rows[I]["SOLES"];
                    ws.Cells["G" + (I + C + 1).ToString()].Value = dtTabla.Rows[I]["DOLARES"];
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public void P_Contabilidad_RegistroVentas_Roman_Proformas()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
            ...
            dtTabla = objOperacion.F_DOCUMENTOVENTACAB_REPORTE_CONTABILIDAD_REGISTROVENTA_Proforma(objEntidad);
        ...
        public void P_Reporte_Cobranzas()
        {
            ...
            ws.Column(2).Width = 103.71;
            ws.Column(3).Width = 22.71;
            ws.Column(4).Width = 15.48;
            ws.Column(5).Width = 13.91;
            ws.Column(6).Width = 13.91;
            ws.Column(7).Width = 11.06;
            ws.Column(8).Width = 11.06;
            ws.Column(9).Width = 25.91;
            ws.Column(10).Width = 25.06;
        ...
        public void P_NOTAINGRESOSALIDACab_COMPRA_EMPLEADO_DETALLADO()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
            ...
            dtTabla = objLGProductosCN.F_NOTAINGRESOSALIDACab_COMPRA_EMPLEADO_DETALLADO(objLGProductosCE);
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public void P_NOTAINGRESOSALIDACab_COMPRA_EMPLEADO_Resumido()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
            ...
            dtTabla = objLGProductosCN.F_NOTAINGRESOSALIDACab_COMPRA_EMPLEADO_Resumido(objLGProductosCE);
        ...
        public void P_Ventas_VentasDiarias()
        {
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                ws.Cells["C" + (dtTabla.Rows.Count + 11).ToString()].Value = (decimal)dtTabla.Compute("SUM([FT])", null);
                ws.Cells["D" + (dtTabla.Rows.Count + 11).ToString()].Value = (decimal)dtTabla.Compute("SUM([BO])", null);
                ws.Cells["E" + (dtTabla.Rows.Count + 11).ToString()].Value = (decimal)dtTabla.Compute("SUM([TF])", null);
        ...
        public void P_Reporte_Ultima_Compra_Producto_Reeim()
        {
            FileInfo newFile = new FileInfo(Server.MapPath(Request["NombreArchivo"]).ToString());
            ...
            objLGProductosCE.chkCliente = Convert.ToInt32(Request.QueryString["chkCliente"]);
            objLGProductosCE.CodCliente = Convert.ToInt32(Request.QueryString["CodCliente"]);
            objLGProductosCE.chkFecha = Convert.ToInt32(Request.QueryString["Fecha"]);

            String Subtitulo = Request.QueryString["Cliente"].ToString() + "Reporte Compra Periodo Desde " + Request.QueryString["Desde"].ToString() + " Hasta " + Request.QueryString["Hasta"].ToString();


            DataTable dtTabla = null;

            dtTabla = objLGProductosCN.P_Reporte_Ultima_Compra_Producto_Reeim(objLGProductosCE);

            ws.Cells["A1"].Value = Subtitulo;
            ws.Cells["A2"].LoadFromDataTable(dtTabla, true);
            ws.Column(1).Width = 5.57;
            ws.Column(2).Width = 50.71;
            ws.Column(3).Width = 102.71;
            ws.Column(4).Width = 17.71;
            ws.Column(5).Width = 7.71;
            ws.Column(6).Width = 8.71;
            ws.Column(7).Width = 11.71;
            ws.Cells["A2"].LoadFromDataTable(dtTabla, true);
            ws.Cells["A2:G2"].Style.Font.Size = 10;
            ws.Cells["A2:G2"].Style.Font.Name = "arial";
            ws.Cells["A2:G2"].Style.Font.Bold = true;
            ws.Cells["A2:G2"].Style.Font.Color.SetColor(Color.Black);

            ws.Cells["A1"].Style.Font.Size = 16;
            ws.Cells["A1"].Style.Font.Name = "arial";
            ws.Cells["A1"].Style.Font.Bold = true;
            ws.Cells["A1"].Style.Font.Color.SetColor(Color.Black);
            //ws.DeleteColumn(1);
