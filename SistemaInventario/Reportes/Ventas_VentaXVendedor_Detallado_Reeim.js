var AppSession = "../Reportes/Ventas_VentaXVendedor_Detallado_Reeim.aspx";
...
function F_Reporte() {
    ...
    rptURL = '../Reportes/Web_Pagina_Crystal_Nuevo_Antiguo.aspx';
    rptURL = rptURL + '?';
...
function F_ReporteIndividual_excel() {
    var Detallado = 0;
    var CodMenu = 717;
    var Titulo = "REPORTE VENTAS POR VENDEDOR";
    var NombreArchivo = "Xls_VentasxVendedor.xlsx";
    var NombreHoja = "VentasVendedor";

    if ($('#MainContent_chkDetallado').is(':checked')) {
        CodMenu = 1503;
        Titulo = "REPORTE VENTAS POR VENDEDOR DETALLADO";
        var NombreArchivo = "Xls_VentasxVendedor_Detallado.xlsx";
        var NombreHoja = "VentasVendedorDetallado";
    }
