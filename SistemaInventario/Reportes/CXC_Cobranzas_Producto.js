var AppSession = "../Reportes/CXC_Cobranzas_Producto.aspx";
var ddlCliente;
...
$(document).ready(function () {
    ...
    $('#MainContent_chkTodas').change(function () {
        ...
        $('#MainContent_chkProducto').change(function () {
        if ($(this).is(":checked")) {          
            $('#MainContent_chkClienteSumarizado').prop("checked", false);         
        }      
    });

          $('#MainContent_chkClienteSumarizado').change(function () {
        if ($(this).is(":checked")) {          
            $('#MainContent_chkProducto').prop("checked", false);         
        }      
    });
...
function F_Buscar(){
    ...
    if ($('#MainContent_chkClienteSumarizado').is(':checked')) {
        ...
        if ($('#MainContent_chkProducto').is(':checked')) {
        Titulo = "REPORTE DE COBRANZAS";
        NombreArchivo = "Web_Reporte_Cobranzas_rptCobranzasGrupal_Producto.rpt";
        CodMenu = 449;
    }
