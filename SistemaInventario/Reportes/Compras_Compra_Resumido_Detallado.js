var AppSession = "../Reportes/Compras_Compra_Resumido_Detallado.aspx";
...
function F_Reporte(Tipo) {
    ...
    if (!$('#MainContent_chkClasificacion').is(':checked')) 
        CodClasificacion = 0;
    ...
    if (Tipo === 'E') {
        ...
        if (Resumido == 1) {
            CodMenu = 6;
            NombreArchivo = 'Xls_ComprasResumido.xlsx';
        }
        else { 
            CodMenu = 7;
            NombreArchivo = 'Xls_ComprasDetallado.xlsx';
        }            
    }
    ...
    rptURL = rptURL + 'CodClasificacion=' + CodClasificacion + '&';
