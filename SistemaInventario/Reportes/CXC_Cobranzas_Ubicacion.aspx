<%@ Page Title="Reporte Cobranzas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CXC_Cobranzas_Ubicacion.aspx.cs" Inherits="SistemaInventario.Reportes.CXC_Cobranzas_Ubicacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CXC_Cobranzas_Ubicacion.js" charset="UTF-8"></script>
                 ...
                 <tr>
                    <td style="font-weight: bold;">
                       ...
                       <td colspan='4' style="padding-left: 3px;">
                              ...
                              <asp:DropDownList ID="ddlSucursales" runat="server" Font-Names="Arial" ForeColor="Blue"
               ...
               <tr>
                    ...
                    <td colspan='4' style="padding-left: 4px;">
                        <div id="div_Departamento">
                            <asp:DropDownList ID="ddlDepartamento" runat="server" Font-Names="Arial" ForeColor="Blue"
