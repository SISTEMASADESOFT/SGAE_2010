...
function F_Controles_Inicializar() {
        ...
        url: 'Inventario_MovimientoProducto_Alvarado.aspx/F_Familias_Listar_NET',
        data: "{'pTodos':'0'}",
        dataType: "json",
        async: false,
        success: function (json) {
            ...
            ddlTipoReporte = new SlimSelect({
              select: '#ddlTipoReporte'
                        ...
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: 'Inventario_MovimientoProducto_Alvarado.aspx/F_Almacenes_Listar_NET',
                        data: "{'pTodos':'0'}",
                        dataType: "json",
                        async: false,
                        success: function (json) {
                          ...
                          ddlAlmacen = new SlimSelect({
                                     select: '#ddlAlmacen',
                                     placeholder: 'TODAS LAS ALMACENES POR DEFECTO',
                                     searchingText: 'Buscando...', // Optional - Will show during ajax request
...
function F_Reporte(TipoReporte) {
    ...
    rptURL = rptURL + 'IdAlmacen=' + Sys.Serialization.JavaScriptSerializer.serialize(arrAlmacen)  + '&';
