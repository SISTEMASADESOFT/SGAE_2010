<%@ Page Title="Reporte de Ventas x Mes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ventas_VentaXVendedor_Reeim.aspx.cs" Inherits="SistemaInventario.Reportes.Ventas_VentaXVendedor_Reeim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="Ventas_VentaXVendedor_Reeim.js" charset="UTF-8"></script>
                            ...
                            <td>
                                <asp:TextBox ID="txtCliente" runat="server" Width="150px" Font-Names="Arial" ForeColor="Blue"
                                    Font-Bold="True"></asp:TextBox>
                                        ...
                                        LAS VENTAS ESTAN EXPRESADAS EN DOLARES
                                        </td>
                                        </tr>
