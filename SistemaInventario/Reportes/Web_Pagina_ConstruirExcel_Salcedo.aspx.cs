...
{
    public partial class Web_Pagina_ConstruirExcel_Salcedo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            switch (Convert.ToInt32(Request["CodMenu"]))
            {
                ...
                case 13:
                    ...
                    break;
                case 15:
                    P_ReporteVentasPerdidasPorPeriodoPorFamilia();
                    break;
                case 202:
    ...
    dtTabla.Columns.RemoveAt(15); dtTabla.Columns.RemoveAt(14);
        ...
        public void P_Inventario_StockActual_Salcedo()
        {
            ...
            ws.Column(3).Width = 10.77;
            ws.Column(4).Width = 10.77;
            ws.Column(5).Width = 10.77;
            ws.Column(6).Width = 10.77;
            ws.Column(7).Width = 10.77;
            ws.Column(8).Width = 10.77;
            ws.Column(9).Width = 10.77;
            ws.Column(10).Width = 10.77;
            ws.Column(11).Width = 10.77;
            ws.Column(12).Width = 10.77;
            ws.Column(13).Width = 10.77;
        ...
        public void P_Reporte_Caja_Chica()
        {
            ...
            if (dtTabla.Rows.Count != 0)
            {
                ...
                ws.Cells["F12:F1000"].Style.Numberformat.Format = "0";
                ws.Cells["F12:F1000"].Style.HorizontalAlignment = ExcelHorizontalAlignment.Right;
                ///////////////////////////////////////////////////
     ...
     ///////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public void P_ReporteVentasPerdidasPorPeriodoPorFamilia()
        {
            ...
            DataTable dtTabla = objOperacion.F_DocumentoVentaCab_VentasPerdidasArticulos_Periodo(objEntidad);
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                ws.Cells["A1"].Value = "REPORTE DE UNIDADES CON VENTA PERDIDA"; ws.Row(1).Style.Font.Size = 18; ws.Row(1).Style.Font.Bold = true;
                ws.Cells["A2"].Value = "PERIODO: DEL " + PeriodoDesde + " AL " + PeriodoHasta; ws.Row(2).Style.Font.Bold = true;
                ws.Cells["A3"].Value = "ALMACEN: " + Almacen; ws.Row(5).Style.Font.Bold = true;

                int co = 5;
                ws.Cells["A" + co].LoadFromDataTable(dtTabla, true);
