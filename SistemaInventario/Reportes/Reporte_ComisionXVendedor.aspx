<%@ Page Title="Reporte de Comision X Vendedor" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Reporte_ComisionXVendedor.aspx.cs" Inherits="SistemaInventario.Reportes.Reporte_ComisionXVendedor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="Reporte_ComisionXVendedor.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 390px">REPORTE DE COMISION X VENDEDOR</div> 
...
<%--                                                        <td colspan='3'>
    ...
    <div id="div_Moneda">
                                    ...
                                    <div  class="linea-button">
                                      <asp:Button ID="btnResumido" runat="server" Text="Resumido" Font-Names="Arial"
                                                                class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" Width="120px" 
                                                                 />
                                      <asp:Button ID="btnDetallado" runat="server" Text="Detallado" Font-Names="Arial"
                                                                class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" Width="120px" 
                                                                 />
                                    </div>
                                </div>
