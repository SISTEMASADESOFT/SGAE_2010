<%@ Page Title="Compras Por Vendedor" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Compras_CompraXVendedor_Detallado_Reeim.aspx.cs" Inherits="SistemaInventario.Reportes.Compras_CompraXVendedor_Detallado_Reeim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="Compras_CompraXVendedor_Detallado_Reeim.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 390px">REPORTE DE COMPRAS POR VENDEDOR</div> 
