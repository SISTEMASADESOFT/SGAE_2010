var AppSession = "../Ventas/RegistroNotaCreditoMonica.aspx";
...
//        }
        ...
        var objParams = {
                    ...
                    Filtro_Exonerada: $('#MainContent_txtExonerada').val()*-1,
    ...
    try {
        ...
        F_FacturacionNotaCredito_NET(arg, function (result) {
            ...
            if (str_mensaje_operacion == "") {
                ...
                $('#MainContent_txtExonerada').val(result.split('~')[14]);
        ...
        F_EliminarTemporal_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                ...
                if (result.split('~')[5] == '0') {
                    ...
                    $('#MainContent_txtExonerada').val(result.split('~')[9]);
                }
                if ($('#MainContent_ddlFormaPago').val() == 1)
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfCategoriaIgv = '#' + imgID.replace('imgEditarRegistro', 'hfCategoriaIgv');
        $('#hfCategoriaIgv').val($(hfCategoriaIgv).val());
...
//function F_EditarTemporal(Fila) {
//    try {

//        var imgEditarRegistro = '#' + Fila;
//        var hfCategoriaIgv = imgEditarRegistro.replace('imgEditarRegistro', 'hfCategoriaIgv');
...
//        var precioDisplay = parseFloat($(Contenedor + 'txtPrecio')).val();
//        var precioBase = precioDisplay;
//        var tasaigv_producto = 1;
//        var flagigv_producto = 0;

//        var TasaIgv_NC = parseFloat($("#MainContent_ddlIgv option:selected").text()) + 1;
...
//            TasaIgv_NC = parseFloat($("#MainContent_ddlIgv option:selected").text()) + 1;
//            precioBase = precioDisplay / TasaIgv_NC;
//            flagigv_producto = 1;
//        }
...
//                    $('#MainContent_txtIgv').val(parseFloat(result.split('~')[6]).toFixed(2));
//                    $('#MainContent_txtTotal').val(parseFloat(result.split('~')[5]).toFixed(2))
//                    $('#MainContent_txtExonerada').val(parseFloat(result.split('~')[9]).toFixed(2))
//                }
//                if ($('#MainContent_ddlFormaPago').val() == 1)
//                    $('#MainContent_txtAcuenta').val(parseFloat(parseFloat($('#MainContent_txtTotal').val()) - parseFloat($('#MainContent_txtAcuentaNV').val())).toFixed(2));
...
//        var Contenedor = '#MainContent_';
//        var CategoriaIgv = $(hfCategoriaIgv).val();
//        var precioDisplay = parseFloat($(Contenedor + 'txtPrecio').val()) || 0;
//        var cantidad = parseFloat($(Contenedor + 'txtCantidad').val()) || 0;
...
//                if (result.split('~')[5] == '0') {
//                    $('#MainContent_txtTotal, #MainContent_txtIgv, #MainContent_txtSubTotal, #MainContent_txtAcuenta, #MainContent_txtAcuentaNV').val('0.00');
//                } else {
//                    $('#MainContent_txtAcuentaNV').val(parseFloat(result.split('~')[8]).toFixed(2));
//                    $('#MainContent_txtSubTotal').val(parseFloat(result.split('~')[7]).toFixed(2));
//                    $('#MainContent_txtIgv').val(parseFloat(result.split('~')[6]).toFixed(2));
...
//              
//                if ($('#MainContent_ddlFormaPago').val() == 1) {
//                    var acuenta = parseFloat($('#MainContent_txtTotal').val()) - parseFloat($('#MainContent_txtAcuentaNV').val());
//                    $('#MainContent_txtAcuenta').val(parseFloat(acuenta).toFixed(2));
//                }
...
function F_EditarTemporal() {
    try {
        var Contenedor = '#MainContent_';
        var CategoriaIgv = $('#hfCategoriaIgv').val() || "0"; 
...
function F_AnularRegistro(Fila) {
    ...
    try {
        ...
        var objParams = {
                ...
                Filtro_Serie: $("#MainContent_ddlSerie option:selected").text(),
                Filtro_SerieDoc: $("lblfactanu").text(),
                Filtro_Numero: $('#MainContent_txtNumeroConsulta').val(),
                Filtro_Desde: $('#MainContent_txtDesde').val(),
                Filtro_Hasta: $('#MainContent_txtHasta').val(),
                Filtro_CodCtaCte: $('#hfCodCtaCteConsulta').val(),
...
function F_VistaPreliminar(Fila, CodMenu) {
    var imgID = Fila.id;
    var Codigo = $('#' + imgID.replace('imgPdfFactura', 'lblCodigo')).val();
    var lblNumero = $('#' + imgID.replace('imgPdfFactura', 'lblNumero')).text().substring(0, 1);
