<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleARASACSTANDARD.aspx.cs" 
Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleARASACSTANDARD" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleARASACSTANDARD.js" charset="UTF-8"></script>       
                                    ...
                                    <asp:TemplateField HeaderText="FT">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgImprimirFactura" ImageUrl="~/Asset/images/imprimir.gif"
                                                ToolTip="IMPRIMIR FACTURA" OnClientClick="F_ImprimirFacturaGrilla(this,213); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
