...
namespace SistemaInventario.Ventas
{
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    ...
                    ref MarcaVehiculo, ref DireccionTrans, ref NroBultos, ref KM, ref OC);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        ref String MarcaVehiculo, ref String DireccionTrans, ref String NroBultos, ref String KM, ref String OC)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
        ...
        public static jqProformasResult F_Consulta_Cotizaciones_Pendientes_NET(int CodAlmacen)
        {
            ...
            ProformaCabCE par = new ProformaCabCE() { CodEmpresa = Convert.ToInt32(HttpContext.Current.Session["CodEmpresa"]), CodAlmacen = Convert.ToInt32(HttpContext.Current.Session["CodSede"]), CodEstado = 6 };
        ...
        [WebMethod]
        public static ProformaCabCE F_ObtenerCotizacion_PorNumero_Proforma_Net(int NumeroCotizacion)
        {
            ProformaCabCE objEntidad = new ProformaCabCE();
            ProformaCabCN objOperacion = new ProformaCabCN();
            objEntidad.Numero = NumeroCotizacion.ToString();
            objEntidad.CodAlmacen = Convert.ToInt32(HttpContext.Current.Session["CodSede"]);
            return objOperacion.F_ProformaCab_ObtenerXNumero_Proforma_Alvarado(objEntidad);
        }
