<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleWong.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleWong" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleWong.js" charset="UTF-8"></script>       
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                    ...
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Cod. Prov." HeaderStyle-HorizontalAlign="Center">
                                                <ItemStyle HorizontalAlign="Left" />
                                                <ItemTemplate>
                                                      <asp:Label runat="server" ID="lblCodigoProveedor" Text='<%# Bind("CodigoProveedor") %>' Font-Size="Medium"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    ui-corner-top ui-helper-clearfix">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <td>
                                                                <asp:TextBox ID="txtObservacionFacturaEdicion" runat="server" Width="500" Font-Names="Arial" ForeColor="Blue"
                                                                    Font-Bold="True" ></asp:TextBox>
                                                            </td>
                                                                <td>
