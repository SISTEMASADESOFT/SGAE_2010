var AppSession = "../Ventas/RegistroFacturaMultipleSalazar.aspx";
var Codtipodoc=1
var CodigoMenu = 4000;
var CodigoInterno = 2;
var CodCategoria = 1;
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_TipoMantenimiento', result.split('~')[34]);
                        F_Update_Division_HTML('div_TipoMantenimientoEdicion', result.split('~')[35]);
                        ...
                        $('#MainContent_ddlTipoMantenimiento').css('background', '#FFFFE0'); 
                        $("#MainContent_ddlTipoMantenimientoEdicion").css('background', '#FFFFE0');
                        $("#MainContent_txtNroRucTransportista").css('background', '#FFFFE0');
    ...
    try 
        {        
            ...
            var SerieGuia = $('#MainContent_ddlSerieGuia option:selected').text().substring(0, 1);
             ...
             if ($(Cuerpo + 'txtNroOperacion').val().trim()==''  & ($(Cuerpo + 'ddlFormaPago').val()== 6 | $(Cuerpo + 'ddlFormaPago').val()==10 | $(Cuerpo + 'ddlFormaPago').val()== 13 | $(Cuerpo + 'ddlFormaPago').val()==14))
                        Cadena=Cadena + '<p></p>' + 'NUMERO OPERACION';
         
             if ($(Cuerpo + 'txtTotal').val()=='0.00')
                    Cadena=Cadena + '<p></p>' + 'No ha ingresado ningun producto';
                    
             if (!F_ValidarCorreo($.trim($(Cuerpo + 'txtCorreo').val())))
                   Cadena = Cadena + '<p></p>' + 'Correo';

             if ($('#MainContent_ddldireccionNueva').val() == null )
                            Cadena=Cadena + '<p></p>' + 'DIRECCION';

             if ($(Cuerpo + 'ddlTipoMantenimiento').val()!=1 & $.trim($("#MainContent_txtPlaca1").val()).length <5)
                    Cadena=Cadena + '<p></p>' + 'PLACA MINIMO 6 CARACTERES';    
            ...
            switch($("#MainContent_ddlTipoDoc").val()) {
                ...
                if ($(Cuerpo + 'chkGuia').is(':checked')) {         
                 ...
                 if ($('#MainContent_txtNroRuc').val() == '11111111')
                       Cadena = Cadena  + '<p></p>' + 'CLIENTE VARIOS NO PUEDE TENER GUIA REMISION';
...
function F_GrabarDocumento(){
  try 
        ...
        var objParams = {
            ...
            Filtro_CodTipoMantenimiento: $('#MainContent_ddlTipoMantenimiento').val(), 
...
function F_Nuevo(){
       ...
       $('#MainContent_txtCelular1').val(''); 
       $('#MainContent_txtCelular2').val(''); 
       ...
       $('#MainContent_ddlVendedor').val(CodEmpleado);
       $('#MainContent_ddlTipoMantenimiento').val(1);
       $('#MainContent_txtKM').val('');      
       $("#MainContent_txtUsuarioPrecio").val('');
       $("#MainContent_txtContraseñaPrecio").val('');
       $("#MainContent_txtObservacionPrecio").val('');
...
function F_EditarRegistro(Fila) {
 ...
 try 
    ...
    F_DatosFactura_NET(arg, function (result) {
                    ...
                    $('#MainContent_txtClaveAgencia').val(result.split('~')[38]);
                    $('#MainContent_ddlTipoMantenimientoEdicion').val(result.split('~')[46]);    
...
var arrDetalle = new Array();
    ...
    var objParams = {
                      ...
                      Filtro_XmlDetalle: Sys.Serialization.JavaScriptSerializer.serialize(arrDetalle),
                      Filtro_CodTipoMantenimiento: $('#MainContent_ddlTipoMantenimientoEdicion').val(), 
                      Filtro_Celular1:$('#MainContent_txtCelular1Edicion').val(),
                      Filtro_Celular2:$('#MainContent_txtCelular2Edicion').val(),
        ...
        try {
            ...
            F_ReemplazarFactura_NET(arg, function (result) {
                ...
                if (str_resultado_operacion == "1") {
                    ...
                    $('#MainContent_ddlTipoMantenimiento').text(result.split('~')[36]);  
...
function F_InicializarCajaTexto()
{
    ...
    $("#MainContent_txtCelular1Edicion").css('background', '#FFFFE0');

    $("#MainContent_txtCelular2Edicion").css('background', '#FFFFE0');
