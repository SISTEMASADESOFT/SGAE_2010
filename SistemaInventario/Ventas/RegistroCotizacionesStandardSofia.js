var AppSession = "../Ventas/RegistroCotizacionesStandardSofia.aspx";
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_Gratuito', result.split('~')[17]);
                         F_Update_Division_HTML('div_CanalVentas', result.split('~')[22]);
                        $('#MainContent_ddlMoneda').val(1);
...
function F_ValidarGrabarDocumento(){
    try 
        {        
            ...
            Cadena = Cadena + '<p></p>' + 'Selecione Un Canal De Ventas';
...
//                Cliente=Cliente.substr(Cliente.length - (Cliente.length -(Index+2)));
        ...
        var objParams = {
          ...
          //  Filtro_Delivery:$(Contenedor + 'txtDelivery').val().trim(),
            ...
            try {
                ...
                F_AgregarTemporal_NET(arg, function (result) {
                    ...
                    if (result.split('~')[2] == "Los Producto(s) se han agregado con exito") {
                        ...
                        $('#MainContent_txtDelivery').val(data.Gratuito);
                        $('#MainContent_ddlCanalVenta').val(data.FlagKM);
