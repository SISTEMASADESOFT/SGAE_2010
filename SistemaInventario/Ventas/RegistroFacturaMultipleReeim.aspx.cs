...
namespace SistemaInventario.Ventas
{
    public partial class RegistroFacturaMultipleReeim : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_EliminarDireccionTemporal_NET);
        ...
        protected void grvConsultaArticulo_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    DocumentoVentaDetCN objOperacion = new DocumentoVentaDetCN();
                    DocumentoVentaDetCE objEntidad = new DocumentoVentaDetCE();
                    GridView grvDetalleProducto = null;
                    HiddenField lblCodigo = null;
                    ...
                    grvDetalleProducto = (GridView)(e.Row.FindControl("grvDetalleProducto"));
                    ...
                    if (lblCodigo.Value != "")
                    {
                        DataTable dta_consultaDetallearticulo = null;
                        DataRow dtr_consultafilaarticulo = null;
                        dta_consultaDetallearticulo = new DataTable();

                        dta_consultaDetallearticulo.Columns.Add("CodigoFabrica", typeof(string));
                        dta_consultaDetallearticulo.Columns.Add("Codigo", typeof(string));
                        dta_consultaDetallearticulo.Columns.Add("DscProducto", typeof(string));
                        dta_consultaDetallearticulo.Columns.Add("FechaIngreso", typeof(string));

                        dtr_consultafilaarticulo = dta_consultaDetallearticulo.NewRow();

                        dtr_consultafilaarticulo[0] = "";
                        dta_consultaDetallearticulo.Rows.Add(dtr_consultafilaarticulo);

                        grvDetalleProducto.DataSource = dta_consultaDetallearticulo;
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_ddlVendedorEdicion_html = "";
            Hashtable obj_parametros = null;
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ref ddlTipoDoc, ref ddlTipoDoc2, ref CantidadPlacas, ref ddlSerieNV, ref ddlSerieCT, ref ddlEstado, ref ddlFormaPagoEdicion, ref ddlSerieGuiaEdicion, ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlTipoTransportista, ref ddlTipoTransportistaEdicion, ref ddlcodunidadpeso, ref ddlcodunidadpesoedicion, ref ddlEstadoConsultaNP, ref ddlVendedorEdicion);
                ...
                str_ddl_ddlVendedorEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlVendedorEdicion);
            ...
            str_resultado =
                ...
                str_ddlEmpleadoConsulta_html + "~" +    //24
                 str_ddl_TipoTransportista_html + "~" +  //25
                str_ddl_TipoTransportistaedicion_html + "~" +//26
                str_ddl_CodUnidadpeso_html + "~" +   //27
                str_ddl_CodUnidadpesoEdicion_html + "~" + //28
                str_ddl_EstadoConsultaNP_html + "~" + //29
                str_ddl_ddlVendedorEdicion_html;//30
        ...
        public String F_GrabarDocumento_NET(String arg)
        {
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_GrabarDocumento(obj_parametros, ref str_mensaje_operacion, ref Codigo,ref Codtraslado);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            Int32 Serie = 0;
            Int32 Codireccion = 0;
            Int32 CodireccionTransportista = 0;
            String DNIConductor = "";
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref CodDistritoTrans, ref Placa, ref Marca, ref Licencia, ref NroBultos, ref Peso, ref NroConductor, ref Conductor, ref                                                              CodConductor, ref Serie, ref RucTransportista, ref Codireccion, ref CodireccionTransportista, ref DNIConductor
                                               , ref NombreConductor
                                               , ref NombreAgencia, ref GuiaAgencia, ref ClaveAgencia, ref Celular, ref ObservacionGuia, ref Observacion,
                                               ref Codempleado);
        ...
        public String F_ProductoDetalle_NET(String arg)
        {
            ...
            String str_mensaje_operacion = "";
            String grvNombre = "";
            String str_grv_grvDetalleProducto_html = "";
            int Col = 0;
            int Codigo = 0;
            Hashtable obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
            ...
            try
            {
                ...
                grvDetalleProducto.DataSource = objOperacion.F_PreImportacionDetalle(objEntidad);
                grvDetalleProducto.DataBind();

                str_grv_grvDetalleProducto_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleProducto);
            }
            catch (Exception exxx)
            {
                str_resultado = "ERROR AL BUSCAR DETALLE: " + exxx;
            ...
            str_resultado =
                Convert.ToString(int_resultado_operacion) + "~" +
                str_mensaje_operacion + "~" +
                str_grv_grvDetalleProducto_html + "~" +
                grvNombre;
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_TipoTransportista, ref DropDownList ddl_TipoTransportistaEdicion,
            ref DropDownList ddl_CodunidadPeso, ref DropDownList ddl_CodunidadPesoedicion, ref DropDownList ddl_EstadoConsultaNP, ref DropDownList ddl_empleadoEdicion)
        {
            ...
            ddl_empleadoEdicion.Items.Clear();

            ddl_empleadoEdicion.DataSource = dta_consulta;
            ddl_empleadoEdicion.DataTextField = "NombreCompleto";
            ddl_empleadoEdicion.DataValueField = "CodEmpleado";
            ddl_empleadoEdicion.DataBind();
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("CodigoFabrica", typeof(string));
            dta_consultadetalle.Columns.Add("Codigo", typeof(string));
            dta_consultadetalle.Columns.Add("DscProducto", typeof(string));
            dta_consultadetalle.Columns.Add("FechaIngreso", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_DetalleNV()
        {
            ...
            dta_consultadetallenv.Columns.Add("CodCliente", typeof(string));
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            {
                objOperacion.F_TemporalFacturacionDet_Insert_Reeim(objEntidad);
                Codigo = objEntidad.CodDocumentoVenta;
            }
            else
            {
                objEntidad.CodDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]);
                objOperacion.F_TemporalFacturacionDetalle_Insert_Reeim(objEntidad);
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref Int32 Codtraslado)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            {                
                case 16: //Nota de Venta
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Reeim(objEntidad); 
                    MsgError = objEntidad.MsgError; Codigo = objEntidad.CodDocumentoVenta;Codtraslado = objEntidad.CodTraslado;
                    break;
                default: //Facturas y Boletas                  
                    if (objEntidad.NotaPedido == 0)
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Reeim(objEntidad); //Insert Normal                           
                    else //Insert con NOTAPEDIDO NOTA VENTA, COTIZACION
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Reeim(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objEntidad.CodAlmacenGeneralBusqueda = Convert.ToInt32(Session["CodSede"]);
            objEntidad.CodEstado = Convert.ToInt32(objTablaFiltro["Filtro_CodEstado"]);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,
                            ...
                            ref String Conductor, ref Int32 CodConductor, ref Int32 Serie, ref String RucTransportista, ref Int32 CodDireccion,
                            ref Int32 CodireccionTransportista, ref String DNIConductor , ref String NombreConductor
                            , ref String NombreAgencia, ref String GuiaAgencia, ref String ClaveAgencia, ref String Celular, ref String ObservacionGuia
            , ref String Observacion, ref Int32 CodEmpleado)
        {
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    try { RucTransportista = Convert.ToString(dta_consulta.Rows[0]["RucTransportista"]); }
                    catch (Exception) { }
                    try { Placa = Convert.ToString(dta_consulta.Rows[0]["Placatraslado"]); }
                    catch (Exception) { }
                    try { Marca = Convert.ToString(dta_consulta.Rows[0]["Marca"]); }
                    catch (Exception) { }
                    try { Peso = Convert.ToInt32(dta_consulta.Rows[0]["Peso"]); }
                    catch (Exception) { }
                    try { Bulto = Convert.ToString(dta_consulta.Rows[0]["NroBultos"]); }
                    catch (Exception) { }
                    ...
                    try { DNIConductor = Convert.ToString(dta_consulta.Rows[0]["DNIConductor"]); }
                    catch (Exception) { }
                    try { NombreConductor = Convert.ToString(dta_consulta.Rows[0]["NombreConductor"]); }
                    catch (Exception) { }   
                }
                catch (Exception exxx)
                { }
        ...
        public void P_EdicionFactura(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodTraslado)
        {
            ...
            objEntidad.Observacion = Convert.ToString(objTablaFiltro["Filtro_Observacion"]);
            objEntidad.CodAlmacen = Convert.ToInt32(Session["CodSede"]);
            objEntidad.CodEmpresa = Convert.ToInt32(Session["CodEmpresa"]); //direcciontemporal
