<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaMultipleTek_BDantigua.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleTek_BDantigua" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script src="../Scripts/UtilitariosAPI.js" type="text/javascript"></script>
    <script src="../Scripts/inputatajos/kibo.js" type="text/javascript"></script>
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleTek_BDantigua.js" charset="UTF-8"></script>       
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td id="div_Cliente">
                                                        <asp:TextBox ID="txtCliente" runat="server" Width="295px" Font-Names="Arial" ForeColor="Blue"
                                                    ...
                                                    <td  style="padding-left:8px;">
                                                        <div id="div_moneda">
                                                            <asp:DropDownList ID="ddlMoneda" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="84" BackColor="#FFFF99">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                                                    <td id="tdftNormal">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td id="div_Placa1" style="padding-left:5px;">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtCelular" CssClass="Derecha" runat="server" Width="74px"
                                                            Font-Names="Arial" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                         ...
                                         <td >
                                                        <asp:TextBox ID="txtObservacion" runat="server" Width="450px" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:CheckBox ID="CheckBox1" runat="server" Text="ANTIGUO SUNAT"
                                                            Font-Bold="True" style = "display:none;" />
                                                    </td>
                                                    <td>
                                                        <asp:CheckBox ID="CheckBox2" runat="server" Text="ANTIGUO NO ENVIA SUNAT"
                                                            Font-Bold="True" style="display:none;" />
                                                    </td>
    ...
    ui-widget ui-state-default ui-corner-all ui-button-text-only" Font-Names="Arial" Font-Bold="True" style= "display:none;" />
                            </div>
                            <div>
                                ...
                                <table style="float: right; width: auto">
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            <asp:Button ID="BtnAntiguaBD" runat="server" Text="Pasar Nuevo Sistema" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                                Font-Names="Arial" Font-Bold="True" Width="180" />
                                        </td>
                                        <td>
                                ...
                                <asp:Panel ID="pnlOrdersAuditoria" runat="server" Style="display: none">
                                    ...
                                    <asp:TemplateField HeaderText="Numero" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%--<asp:HiddenField ID="hfCodArchivoSunatXMLDOCUMENTOVENTA" runat="server" Value='<%# Bind("CodArchivoSunatXMLDOCUMENTOVENTA") %>' />
                                            <asp:HiddenField ID="hfCodArchivoSunatXMLTRALADO" runat="server" Value='<%# Bind("CodArchivoSunatXMLTRALADO") %>' />--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
            ...
            <table >        
                        ...
                        <table>
                            <tr>
                                ...
                                <td style = "padding-left:18px;">
                                    <asp:TextBox ID="txtClienteEditar" runat="server" Width="426px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                                </td>
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtcelularEdicion" runat="server" Width="80px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="font-weight: bold; display: none;">
                                    OC
                ...
                <tr>
                 ...
                 <td style="font-weight: bold">
                                         ...
                                         <td  style="padding-left: 5PX; ">
                                                        <asp:TextBox ID="txtobservacionEditar" runat="server" Width="595px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" ReadOnly="False"></asp:TextBox>
                                                    </td>
                </tr>
                </table>
    ...
    <input id="hfDireccionTransportistaEdicion" type="hidden" value="0" />
    ...
    <input id="hfCodDireccionDestinoDefecto" type="hidden" value="0" />
    <input id="hfCodDepartamentoDestino" type="hidden" value="0" />
    <input id="hfCodProvinciaDestino" type="hidden" value="0" />
    <input id="hfCodDistritoDestino" type="hidden" value="0" />
    <input id="hfCodigoTemporalEdicion" type="hidden" value="0" />
    <input id="hfDirecciontransportistaEditar" type="hidden" value="0" />
    ...
    <input id="hfCodArchivoSunatXMLDOCUMENTOVENTA" type="hidden" value="" />
    <input id="hfCodArchivoSunatXMLTRALADO" type="hidden" value="" />
</asp:Content>
