...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table>
        <tr valign="top">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td  style="padding-left: 5PX; ">
                                                        <asp:TextBox ID="txtObservacion" runat="server" Width="600px" Font-Names="Arial" ForeColor="Blue"
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtClienteConsulta" runat="server" Width="260" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                            </td>
                                            <td style="font-weight: bold">
                                                VEND
                                            ...
                                            <td>
                                              ...
                                              <td>
                                                <asp:TextBox ID="txtCelularConsulta" runat="server" Width="60" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </tbody>
            ...
            <td valign="top" style="width: 120px; display:none;padding-top: 68px">
