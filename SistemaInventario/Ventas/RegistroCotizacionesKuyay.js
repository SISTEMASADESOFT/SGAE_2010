var AppSession = "../Ventas/RegistroCotizacioneskuyay.aspx";
...
////   hEcho por Adrian
    $('#MainContent_txtNroRuc').autocomplete(   
    {
        ...
        select: function (e, i) {
            $('#MainContent_txtNroRuc').val(i.item.NroRuc);
             $('#MainContent_hfCodCtaCteServidor').val(i.item.val);
    ...
    $("#MainContent_chkProductoNuevo").click(function(){
        if($(this).is(":checked")){
            ...
            $('#hfCodProducto').val(0);
            $('#MainContent_chkBloqueoExclusivo').prop("checked",false);
            $('#MainContent_chkBloqueoExclusivo').prop("checked",false);
...
//                    Cliente=Cliente.substr(Cliente.length - (Cliente.length -(Index+2)));
    ...
    $("#MainContent_chkImpresion").change(function () {
     ...
     $("#MainContent_btnImport").click(function () {
       if (F_PermisoOpcion(CodigoMenu, 4000107, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
        $('#MainContent_hfEmision').val($('#MainContent_txtEmision').val());
        $('#MainContent_hfVencimiento').val($('#MainContent_txtVencimiento').val());
        $('#MainContent_hfDireccion').val($('#MainContent_ddlDireccion').val());
        $('#MainContent_hfFormaPago').val($('#MainContent_ddlFormaPago').val());
        $('#MainContent_hfIgv').val($('#MainContent_ddlIgv').val());
        $('#MainContent_hfVendedor').val($('#MainContent_ddlVendedor').val());
        $('#MainContent_hfTC').val($('#MainContent_lblTC').text());
        $('#MainContent_hfSerie').val($('#MainContent_ddlSerie option:selected').text());
           ...
           var Cuerpo='#MainContent_';
            ...
            var C=0;
             ...
             if ($(Cuerpo + 'ddlMoneda').val()!=2)
                    Cadena=Cadena + '<p></p>' + 'MONEDA DEBE SER DOLARES';
...
return true;
 ...
 try 
        ...
        if ($("#MainContent_txtFechaVencimiento").val()=='')
           cadena = cadena + "Ingrese la Fecha de Vencimiento"
        ...
        var precioDisplayValue = parseFloat($("#MainContent_txtPrecioDisplay").val()) || 0;

        if (precioDisplayValue <= 0) {
            cadena = cadena + "CAMPO PRECIO ARTICULO DEBE SER MAYOR A CERO <p></p> ";
        }
        ...
        if (isNaN($("#MainContent_txtPrecioDisplay").val()))
        {
         ...
         var fechaCaducidad = $("#MainContent_txtFechaVencimiento").val();
...
function F_AgregarTemporal() {
    ...
    try {
        ...
        var objDetalle = {
            ...
            Vencimiento : $('#MainContent_txtFechaVencimiento').val(),
            CodDetalle: 0,
            Acuenta: 0,        
            CodTipoDoc: 0,
            Filtro_FlagIgv: FlagIgv,
        ...
        var objParams = {
            ...
            Filtro_FechaVencimiento: $(Contenedor + 'txtFechaVencimiento').val(),
        ...
        AgregandoProducto = false;
            ...
            var str_mensaje_operacion = result.split('~')[2];
             ...
             if (str_mensaje_operacion == "Los Producto(s) se han agregado con exito") {
                ...
                $('#MainContent_ddlPrecio').empty();
                $('#MainContent_txtArticuloAgregar').val('');
                 $('#MainContent_txtFechaVencimiento').val('');
                $('#MainContent_txtCantidad').val('');                
                $('#MainContent_txtExclusivo').val('');         
                $('#MainContent_txtCantidadMayorista').val('0');
                $('#MainContent_txtPrecioMayorista').val('0.00');
                $("#hfMenorPrecioAgregar").val(0);
                $('#lblCantidadRegistro').text(F_Numerar_Grilla("grvDetalleArticulo", "lblCodigo"));
                F_MostrarTotales();
                F_TablaDown(); 
...
function convertirAFormatoSeguro(fechaStr) {
    if (!fechaStr) return '';
...
function F_NuevoCliente(){              
            ...
            F_Update_Division_HTML('div_grvDetalleArticulo', GridDetalleFTInicializado);
            F_Update_Division_HTML('div_grvArticulosPedido', GridDetalleFTInicializado);
            $('#lblCantidadRegistro').text(F_Numerar_Grilla("0"));
            $('.ccsestilo').css('background', '#FFFFE0'); 
}
...
if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Editar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    ...
    var lblEstado = '#' + imgID.replace('imgReemplazar', 'lblEstado');
    var lblTipoDoc = '#' + imgID.replace('imgReemplazar', 'hfCodTipoDoc');
    var hfIDCargaMasivaExcelCab = '#' + imgID.replace('imgReemplazar', 'hfIDCargaMasivaExcelCab');
    ...
    if ($(hfIDCargaMasivaExcelCab).val() != 0)
    {
    alertify.log('EL DOCUMENTO FUE SUBIDO DE UN EXCEL NO SE PUEDE MODIFICAR');
    return false;
    }
...
function F_InicializarCajaTexto()
{
    ...
    $('#MainContent_txtFechaVencimiento').css('background', '#FFFFE0');
    ...
    $("#MainContent_grvConsulta_txtFechaCaducidad").css('background', '#FFFFE0');
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfExclusivoEdicion = '#' + imgID.replace('imgEditarRegistro', 'hfExclusivoEdicion');
        var hfFlagBloqueoMayorista = '#' + imgID.replace('imgEditarRegistro', 'hfFlagBloqueoMayorista');
        var hfFlagBloqueoExclusivo = '#' + imgID.replace('imgEditarRegistro', 'hfFlagBloqueoExclusivo');
        ...
        $(Cuerpo + 'txtExclusivoEdicion').val(parseFloat($(hfExclusivoEdicion).val()).toFixed(2));
        ...
        if ($(hfFlagBloqueoMayorista).val()==0)
            $(Cuerpo + 'chkBloqueoMayorista').prop("checked",false);
        else
            $(Cuerpo + 'chkBloqueoMayorista').prop("checked",true);

        if ($(hfFlagBloqueoExclusivo).val()==0)
            $(Cuerpo + 'chkBloqueoExclusivo').prop("checked",false);
        else
            $(Cuerpo + 'chkBloqueoExclusivo').prop("checked",true);
...
function F_EdicionRegistroProducto() {
    ...
    if ($('#MainContent_chkServicios').is(':checked'))
        ...
        var FlagBloqueoMayorista = 0;
        var FlagBloqueoExclusivo = 0;

        if ($(Contenedor + 'chkBloqueoMayorista').is(':checked'))
            FlagBloqueoMayorista = 1;

        if ($(Contenedor + 'chkBloqueoExclusivo').is(':checked'))
            FlagBloqueoExclusivo = 1;
