<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultiplexml.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultiplexml" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultiplexml.js" charset="UTF-8"></script>       
...
<%--
                ...
                <div class="ui-jqdialog-content" id="div_CuerpoGuia" style="display: none">
                  <table cellpadding="0" cellspacing="0" class="form-inputs">
                    ...
                    <div id="tabConsulta">
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    <tbody>
                                        <tr>
                                          <td>
                                                <div id="div3">
                                                    <asp:DropDownList ID="ddlConexion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                        Font-Bold="True" Width="85px">
                                                    <asp:ListItem Text="ARA VMT" Value="BDCONEXION"></asp:ListItem>
                                                    <asp:ListItem Text="CENTRAL" Value="BDLosOlivos"></asp:ListItem>
                                                    <asp:ListItem Text="PRENSAS" Value="BDIndependencia"></asp:ListItem>
                                                    <asp:ListItem Text="ABC" Value="BDABC"></asp:ListItem>
                                                    <asp:ListItem Text="ARA VES" Value="BDLurin"></asp:ListItem>
                                                    <asp:ListItem Text="ARA 250" Value="BD250"></asp:ListItem>
                                                    <asp:ListItem Text="CHICLAYO" Value="BDCHICLAYO"></asp:ListItem>
                                                    <asp:ListItem Text="PGP 270" Value="BD270"></asp:ListItem>
                                                    <asp:ListItem Text="HUANCAYO" Value="BDHUANCAYO"></asp:ListItem>
                                                    <asp:ListItem Text="ARA SJL" Value="BDSJL"></asp:ListItem>
                                                    <asp:ListItem Text="ARA ATE" Value="BDATE"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                                            <td style="font-weight: bold">
                        ...
                        <asp:Button ID="btnDescargarXML" runat="server" Text="XML" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                    Font-Names="Arial" Font-Bold="True" Width="120" />
                        ...
                        <div id="div_consulta">
                            <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                                ...
                                <Columns>     
                                 <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:CheckBox runat="server" ID="chkxml" CssClass="chkDelete" Text=""  />
                                    </ItemTemplate>
                                </asp:TemplateField>                   
                                   <%-- <asp:TemplateField>
                                        <ItemTemplate>
 ...
 <div id="div1" style="padding-top: 5px;Width: 870px;">
