                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Panel ID="pnlProductos" runat="server" Style="display: none">
                                                        <asp:GridView ID="grvDetalleProducto" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                                            AutoGenerateColumns="False" GridLines="None" class="GridView">
                                                            <Columns>
                                                                <asp:BoundField DataField="M1" HeaderText="MARGEN1">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="M2" HeaderText="MARGEN2">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                            </Columns>
                                ...
                                <div class="ui-jqdialog-content">
                                    <div class="ui-jqdialog-content">
                                        ...
                                        <div id="div_grvConsultaUltimosPrecios" style="padding-top: 5px;">
                                            ...
                                            <asp:TemplateField>
                                        <ItemTemplate>
                                            <img id="imgMas" alt="" style="cursor: pointer" src="../Asset/images/plus.gif" onclick="imgMas_ClickDetalle(this);"
                                                title="Ver Detalle" />
                                            <asp:Panel ID="pnlOrdersDetalle" runat="server" Style="display: none">
                                                <asp:GridView ID="grvDetalleproductos" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                                    AutoGenerateColumns="False" GridLines="None" class="GridView">
                                                    <Columns>
                                                        <asp:BoundField DataField="Codigo" HeaderText="Codigo">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                            ...
                                            <asp:TemplateField HeaderText="Fecha">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="hfcoddoc" runat="server" Value='<%# Bind("CodDocumentoventa") %>' />
                                                    <asp:HiddenField ID="hfcodtipodoc" runat="server" Value='<%# Bind("Codtipodoc") %>' />
                                                    <asp:HiddenField ID="hfDetalleCargado" runat="server" Value='0' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
