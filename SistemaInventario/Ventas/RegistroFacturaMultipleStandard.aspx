<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleStandard.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleStandard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleStandard.js" charset="UTF-8"></script>       
                                ...
                                <asp:ImageButton runat="server" ID="imgDireccion" ImageUrl="../Asset/images/add_small.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <%--     <td> el de arriba es con igv
                                                        <asp:CheckBox runat="server" ID="CheckBox1" Text="C/Igv" onclick="F_ValidarCheckConIgvMaestro(this.id);"
                                                            Checked="True" Font-Bold="True" /> le cambie de nombre al reves 
                                                    </td>--%>
    ...
    ui-corner-top ui-helper-clearfix">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                        ...
                        <td style="padding-left: 4PX;">
                                                        <asp:TextBox ID="txtObservacionFacturaEdicion" runat="server" Width="920px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" ReadOnly="False"></asp:TextBox>
                                                    </td>
                  </tr>
            </table>
