var AppSession = "../Ventas/RegistroFacturaMultipleYordanNuevo.aspx";
var Codtipodoc=1
var CodigoMenu = 4000;
var CodigoInterno = 2;
var CodCategoria = 1;
...
//    });
    ...
    });MainContent_ddldireccionNuevaDestinoEdicion

    $("#MainContent_chkGuiaEdicion").click(function () {
        if ($(this).is(':checked')) {
                  $(Cuerpo + 'ddldireccionNuevaDestinoEdicion').prop('disabled', false);
...
//                $('#MainContent_chkImpresionGuiaEdicion').prop('checked',true);  
          ...
          $(Cuerpo + 'ddldireccionNuevaDestinoEdicion').prop('disabled', true);
...
function F_AgregarArticulo(ControlID, DirectoBoton) {
    ...
    hfStock = imgAgregar_grilla.replace('imgAgregar', 'hfStock');
...
//    $('#MainContent_txtStockAgregar').val($(hfStock).text());
       $('#MainContent_txtStockAgregar').val($(hfStock).val());
