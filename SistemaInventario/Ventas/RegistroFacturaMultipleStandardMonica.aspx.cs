...
{
    public partial class RegistroFacturaMultipleStandardMonica : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_AgregarTemporal_NV_NET);
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlVendedorEdicion, ref ddlTipoTransportista, ref ddlTipoTransportistaEdicion, ref ddlcodunidadpeso, ref ddlcodunidadpesoedicion, ref ddlAlmacen);
        ...
        //public String F_AgregarTemporal_NET_NV(String arg)
        //{
        //    String str_resultado = "";
        //    String str_mensaje_operacion = "";
        //    String str_grvDetalleArticulo_html = "";
        ...
        //        obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
        //        P_AgregarTemporal(obj_parametros, ref Codigo, ref MsgError);
        //        P_CargarGrillaTemporal2(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref Acuenta, ref Exonerada, ref NotaPedido);
        //        str_grvDetalleArticulo_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleArticulo);
        ...
        //        Convert.ToInt32(NotaPedido)
        //          + "~" +
        //        Math.Round(Exonerada, 2).ToString();
        ...
        private void P_CargarGrillaTemporal2(Hashtable obj_parametros, int Codigo, ref GridView grvDetalleArticulo, ref decimal SubTotal, ref decimal Igv, ref decimal Total, ref decimal Acuenta, ref decimal Exonerada, ref int NotaPedido)
        {
            ...
            if (Codigo != 0)
            {
                objEntidad.Igv = Convert.ToDecimal(obj_parametros["Filtro_TasaIgv"]);
                objEntidad.CodMoneda = Convert.ToInt32(obj_parametros["Filtro_CodMoneda"]);
                objEntidad.Tasa = Convert.ToDecimal(obj_parametros["Filtro_Tasa"]);
                objEntidad.CodAlmacen = Convert.ToInt32(Session["CodSede"]);
                objEntidad.CodDocumentoVenta = Codigo;
                objEntidad.CodCliente = Convert.ToInt32(obj_parametros["Filtro_CodCliente"]);
                ...
                objEntidad.ConexionGeneral = (objEntidad.CodTipoDoc == 16)
                    ? Convert.ToString(Session["ConexionGeneral"])
                    : string.Empty;
            ...
            {
                foreach (DataRow fila in dta_consulta.Rows)
                {
                    decimal importe = Convert.ToDecimal(fila["Importe"]);
                    decimal acuentaItem = Convert.ToDecimal(fila["Acuenta"]);
                    int codCategoriaIgv = Convert.ToInt32(fila["CodCategoriaIgv"]);


                    if (codCategoriaIgv == 3)
                        Exonerada += importe;
                    else
                        Total += importe;
                ...
                if (Convert.ToInt32(obj_parametros["Filtro_FlagIgv"]) == 1)
                {
                    SubTotal = Total / Convert.ToDecimal(obj_parametros["Filtro_TasaIgvDscto"]);
                    Igv = SubTotal * (Convert.ToDecimal(obj_parametros["Filtro_TasaIgvDscto"]) - 1);
                }
                else
                {
                    SubTotal = Total;
                    Igv = Total * (Convert.ToDecimal(obj_parametros["Filtro_TasaIgvDscto"]) - 1);
                    Total = SubTotal + Igv;
                }
                ...
                if (objEntidad.CodTipoDoc == 7 || objEntidad.CodTipoDoc == 16)
                {
                    SubTotal *= -1;
                    Igv *= -1;
                    Total *= -1;
                ...
                try
                {
                    NotaPedido = Convert.ToInt32(dta_consulta.Rows[0]["NotaPedido"]);
                }
                catch
                {
                    NotaPedido = 0;
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_VendedorEdicion, ref DropDownList ddl_TipoTransportista, ref DropDownList ddl_TipoTransportistaEdicion, ref DropDownList ddl_CodunidadPeso, ref DropDownList ddl_CodunidadPesoedicion
            , ref DropDownList ddl_Almacen)
        {
        ...
        public void P_Inicializar_GrillaVacia_Articulo()
        {
            ...
            dta_consultaarticulo.Columns.Add("CodCategoriaIgv", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("CodCategoriaIgv", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_DetalleNV()
        {
            ...
            //nv
            dta_consultadetallenv.Columns.Add("CodCategoriaIgv", typeof(string));
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " CodCategoriaIgv = '" + item.CodCategoriaIgv + "'";
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodDocumentoVenta, ref Int32 CodTraslado)
        {
            ...
            objEntidad.Exonerada = Convert.ToDecimal(objTablaFiltro["Filtro_Exonerada"]);
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 16: //Nota de Venta
                    // objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Standard(objEntidad);
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Monica(objEntidad);
                    MsgError = objEntidad.MsgError;
                ...
                default: //Facturas y Boletas
                    if (Convert.ToInt32(objTablaFiltro["Filtro_NotaPedido"]) == 0)
                        //objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Standard(objEntidad);
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Monica(objEntidad);//Insert Normal
                    else
                        //objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Standard(objEntidad);
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Monica(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura, ref Decimal Acuenta, ref Decimal TasaIgv)
        ...
        public String F_AgregarTemporal_NV_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
