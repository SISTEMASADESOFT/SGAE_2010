  ...
  try {
    ...
    F_Controles_Inicializar_NET(arg, function (result) {
      ...
      if (str_resultado_operacion == "1") {
        ...
        F_Update_Division_HTML('div_EmpleadoConsulta', result.split('~')[8]);
        F_Update_Division_HTML('div_TipoDocConsulta', result.split('~')[9]);
...
function F_Buscar() {
  ...
  try {
    ...
    if ($("#MainContent_chkNumero").is(":checked")) chkNumero = 1;
    ...
    var objParams = {
      ...
      Filtro_NumeroDoc: $.trim($("#MainContent_txtNumeroConsulta").val()),
      Filtro_Placa: $.trim($("#MainContent_txtPlacaConsulta").val()),
