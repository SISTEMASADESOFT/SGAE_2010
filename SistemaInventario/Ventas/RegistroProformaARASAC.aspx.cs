...
{
    public partial class RegistroProformaARASAC : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlGratuito, ref ddlVendedorEdicion, ref ddlTipoTransportista, ref ddlTipoTransportistaEdicion, ref ddlcodunidadpeso, ref ddlcodunidadpesoedicion, ref ddlAlmacen);
            ...
            , ref DropDownList ddl_Almacen)
        {
            ...
            dta_consulta = objOperacion.F_TCCorrelativo_Serie_Select_Proforma_Alvarado(objEntidad);
            ...
            dta_consulta = objOperacionTCDocumentos.F_TCDocumentos_ListarFacturacion_Solo_Proforma();
            ...
            dta_consulta = objOperacionTCEmpresa.F_TCEmpresa_Listar(new TCEmpresaCE() { CodEmpresa = Convert.ToInt32(Session["CodEmpresa"]) });
        ...
        public void P_Obtener_NumeroCorrelativo(Hashtable objTablaFiltro, ref String Numero)
        {
            ...
            dta_consulta = objOperacion.F_TCCorrelativo_Numero_Select_Proforma_Alvarado(objEntidad);
        ...
        public void P_Cargar_Grilla(Hashtable objTablaFiltro, ref GridView grvConsulta)
        {
            ...
            grvConsulta.DataSource = objOperacion.F_LGProductos_Select_Ventas_Proforma_Alvarado(objEntidad);
            grvConsulta.DataBind();
        }
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " CodigoInterno = '" + item.CodigoInterno + "'";
            ...
            {
                objOperacion.F_TemporalFacturacionDet_Insert_Proforma_Alvarado(objEntidad);
                Codigo = objEntidad.CodDocumentoVenta;
            }
            else
            {
                objEntidad.CodDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]);
                objOperacion.F_TemporalFacturacionDetalle_Insert_Proforma_Alvarado(objEntidad);
        ...
        public void P_EliminarTemporal(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_TemporalFacturacionDet_Eliminar_Proforma_Alvarado(objEntidad);
            ...
            ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura, ref Decimal Acuenta, ref Int32 NotaPedido)
        {
            ...
            if (Codigo != 0)
            {
                ...
                dta_consulta = objOperacion.F_TemporalFacturacionDet_Listar_Proforma_Alvarado(objEntidad);
            }
            if (dta_consulta.Rows.Count > 0)
            {
                if (Convert.ToInt32(objTablaFiltro["Filtro_NotaPedido"]) == 1)
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodDocumentoVenta, ref Int32 CodTraslado)
        {
            ...
            objEntidad.CodEmpresa = Convert.ToInt32(Session["CodEmpresaGeneral"]);
            objEntidad.CodAlmacen = Convert.ToInt32(Session["CodAlmacenGeneral"]);
            objEntidad.CodUsuario = Convert.ToInt32((Session["CodUsuario"]));
            objEntidad.CodTipoDoc = Convert.ToInt32(objTablaFiltro["Filtro_CodTipoDoc"]);
            objEntidad.SerieDoc = Convert.ToString(objTablaFiltro["Filtro_SerieDoc"]);
            objEntidad.NumeroDoc = Convert.ToString(objTablaFiltro["Filtro_NumeroDoc"]);
            ...
            objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Alvarado_Proforma(objEntidad);
            MsgError = objEntidad.MsgError;
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_Listar_Proforma_Alvarado(objEntidad);
        ...
        public void P_AnularRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objOperacion.F_DocumentoVentaCab_Anulacion_Proforma_Alvarado(objEntidad);
        ...
        public void P_ActualizarPrecios(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_TemporalFacturacionDet_Update_Proforma_Alvarado(objEntidad);
                             ...
                             ref int FlagConCodigo, ref String RucTransportista, ref String ObservacionGuia, ref String Observacion, ref Int32 CodEmpleado, ref Int32 CodDireccionDestino, ref int CodDireccionTransportista, ref int FlagUnitario)
        {
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_Datos_Proforma_Alvarado(objEntidad);
        ...
        public void P_EdicionFactura(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_EdicionFactura_Proforma_Alvarado(objEntidad);
        ...
        public void P_ACTUALIZAR_MONTO_MONEDA(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_ACTUALIZAR_MONTO_MONEDA_PROFORMA(objEntidad);
