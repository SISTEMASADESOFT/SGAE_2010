<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="RegistroCotizacionesStandard.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacionesStandard" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionesStandard.js"   charset="UTF-8"></script>     
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <tr>
                                        <td>
                                          <asp:TextBox ID="txtObservacion" runat="server" Width="527px" Font-Names="Arial" ForeColor="Blue"
                                            ...
                                            <td  >
                                                ...
                                                <asp:HiddenField ID="hfCodMonedaCotizacion" runat="server" Value="1" />
