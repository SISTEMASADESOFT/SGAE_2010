<%@ Page Title="Orden de Pedido Celular" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistroOrdenPedidoPOVISCelular.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroOrdenPedidoPOVISCelular" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroOrdenPedidoPOVISCelular.js"    charset="UTF-8"></script>    
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table>
        <tr valign="top">
            <td style="width: 645px" valign="top">
                <div class="titulo" style="width: 645px">
                ...
                <div id="divTabs" style="width: 700px">
                    <ul>
                         ...
                         <table cellpadding="0" cellspacing="0" class="form-inputs" width="550">
                                    ...
                                    <tr>
                                      <td style="font-weight: bold">
                                                    ...
                                                    <tr>
                                                     <td>
                                                        <asp:TextBox ID="txtDistrito" runat="server" Width="278px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                                   <td style="font-weight: bold">
                                                                    Serie
  ...
  <td>
                                                                    <div id="div_serie">
                                                                        <asp:DropDownList ID="ddlSerie" Width="50" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                            Font-Bold="True">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </td>
                                                     ...
                                                     <td>
                                                        <div id="div_moneda">
                                                            <asp:DropDownList ID="ddlMoneda" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="60" BackColor="#FFFF99">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td style="padding-left:9px;">
                                                        <div id="div_Vendedor">
                                                            <asp:DropDownList ID="ddlVendedor" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="145"  Enabled="False">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                                                        <td style="font-weight: bold">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDescuentoTotal" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                     ...
                                     <tr>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                      <asp:TextBox ID="txtObservacion" runat="server" Width="528px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                            ...
                            <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Descripcion" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtDescripcion" Font-Bold="true" CssClass="ccsestilo"
                                                Width="280px" Font-Names="Arial" ForeColor="Blue" Text='<%# Bind("Producto") %>'
                                    ...
                                    <asp:TemplateField HeaderText="Cantidad" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtCantidad" Width="45px" Font-Bold="true" Style="text-align: center;"
    ...
    <div id="div_consulta" style = "padding-top:5px;">
        <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
            CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None" Width="673px"
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/Eliminar.jpg"
                            ToolTip="ANULAR ORDEN PEDIDO" OnClientClick="F_AnularPopUP(this); return false;" />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton runat="server" ID="imgReemplazar" ImageUrl="~/Asset/images/Reemplazo.png"
                            ToolTip="EDITAR ORDEN PEDIDO" OnClientClick="F_ReemplazarDocumento2(this); return false;" />
                    </ItemTemplate>
                </asp:TemplateField>  
                ...
                <asp:TemplateField HeaderText="Total">
                    ...
                    <ItemTemplate>
                     ...
                     <asp:BoundField DataField="Descuento" HeaderText="Dscto" HeaderStyle-HorizontalAlign="Center" >
                            ...
                            <div style="overflow-y: scroll; height: 280px;">
                                <div id="div_grvConsultaArticulo" style="padding-top: 5px">
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        ...
                                        GridLines="None" Width="580px" OnRowDataBound="grvConsultaArticulo_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField>
                                    ...
                                    <%--        <asp:TemplateField>
                                     ...
                                     <%--       <asp:BoundField DataField="CostoConIgv" HeaderText="Costo">
                                        ...
                                        <%--         <asp:BoundField DataField="CALLE" HeaderText="P.C">
                                              ...
                                              <asp:BoundField DataField="MINORISTA" HeaderText="P.F">
                                                <ItemStyle />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:BoundField>
                ...
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tbody>
                       ...
                       <td>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlUM" Style="width: 150px" runat="server" Font-Size="16">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="font-weight: bold">
                                            Dscto.
                                        ...
                                        <td>
                                            <asp:TextBox Style="width: 70px; color: blue; font-family: Arial; text-align: right;
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtArticuloAgregar" runat="server" Width="490px" Font-Names="Arial"
