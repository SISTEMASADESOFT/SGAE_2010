<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleSalazar.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleSalazar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleSalazar.js" charset="UTF-8"></script>       
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    plan
                                                      ...
                                                      <td>
                                                        <div id="div_TipoMantenimiento">
                                                            <asp:DropDownList ID="ddlTipoMantenimiento" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtCelular1" CssClass="Derecha" runat="server" Width="60px"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtCelular2" CssClass="Derecha" runat="server" Width="60px"
                                                            Font-Names="Arial" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
               ...
               <table cellpadding="0" cellspacing="0" align="center">
                                    <tr>
                                        ...
                                        <td style="font-weight: bold">
                                            ...
                                            <td style="font-weight: bold;padding-left: 50px;font-size: medium;display:none;">
                                        T. Soles:
                                    </td>
                                    <td style="font-weight: bold;display:none;">
                 ...
                 <td>
                    ...
                    <td  style="font-weight: bold;">
                                                    plan
                                                      ...
                                                      <td>
                                                        <div id="div_TipoMantenimientoEdicion">
                                                            <asp:DropDownList ID="ddlTipoMantenimientoEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="100">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
