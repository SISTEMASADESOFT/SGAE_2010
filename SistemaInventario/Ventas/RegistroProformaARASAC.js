var AppSession = "../Ventas/RegistroProformaARASAC.aspx";
var Codtipodoc=1
var CodigoMenu = 4000;
var CodigoInterno = 2;
var CodCategoria = 1;
...
$(document).ready(function () {
    ...
    F_AUTOCOMPLETENRORUC_PROFORMA();
    F_AUTOCOMPLETECLIENTECONSULTA_PROFORMA();
...
function F_EditarRegistro(Fila) {
 ...
 F_GuardarDireccion_Proforma($('#hfNroRucCliente').val(),'#hfCodigoTemporalEdicion',$('#hfCodCtaCteEdicion').val(),'#MainContent_txtClienteEditar',
                    ...
                    {
                        F_GuardarDireccion_Proforma($('#MainContent_txtNroRucTransportistaEdicion').val(),'#hfCodigoTemporalEdicion',$('#hfCodTransportistaEdicion').val(),
...
function F_GuardarCambiosFactura() {
 try 
    ...
    var FlagUnitario = 0; if ($('#MainContent_chkUnitario').is(':checked')) {FlagUnitario = 1; };
        var Contenedor = '#MainContent_';
...
function F_AgregarTemporalCTxNumero() {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'RegistroFacturaMultiple.aspx/F_ObtenerCotizacion_PorNumero_Proforma_Net',
        dataType: "json",
...
//                      Codtipodoc = 16;
//                        $('#MainContent_txtCodCotizacion').val('');
//                         F_GuardarDireccion_Proforma($('#MainContent_txtNroRuc').val(),'#hfCodigoTemporal',$('#hfCodCtaCte').val(),'#MainContent_txtCliente',0,
//                        Ubigeo,Direccion,'#MainContent_ddldireccionNueva','#MainContent_ddldireccionNuevaDestino',Codtipodoc);
//                        
              ...
              success: function (dbObject) {
                ...
                $('#td_loadingTransportista').css('display', 'none');
                    ...
                    $('#hfNroRucTransportista').val(dbObject.ruc);
                             ...
                             F_GuardarDireccion_Proforma($('#MainContent_txtNroRucTransportista').val(),'#hfCodigoTemporal',$('#hfCodTransportista').val()
...
function F_BUSCARDNIONBLURENTER(RUC)
{
         ...
         var CADENA=F_BuscarDatosPorRucDniENTERONBLUR_PROFORMA(VALORRUC,1); //FUNCION Q BUSCA DATOS EN LA BASE DE DATOS DE CLIENTE  DEBE ESTARR EN UTLITARIOS DEBE 2 CODCTACTE RAZONSOCIAL
         var CODCTACTE = 0;
         var RAZONSOCIAL = '';
         if (CADENA.length > 0)
         {
             ...
             if (CODCTACTE>0)
             { F_GuardarDireccion_Proforma($('#MainContent_txtNroRuc').val(),'#hfCodigoTemporal',$('#hfCodCtaCte').val()
        ...
        success: function (dbObject) {
            ...
            try {
                if (data.MsgError === "") {
                    ...
                    {
                    $('#MainContent_ChkUnitarioGeneral').prop('checked',true);
