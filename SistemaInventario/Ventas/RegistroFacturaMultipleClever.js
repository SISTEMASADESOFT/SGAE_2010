...
//    $('#MainContent_txtNroRuc').enterKey(function () {
...
//                success: function (dbObject) {
 ...
 //#MainContent_txtCliente',0,$('#MainContent_ddlMoneda').val(),'#MainContent_ddlIgv option:selected','#MainContent_chkConIgvMaestro',Ubigeo);
 //                
 //                  }else{
 //                   API = "Usuario No Encontrado";
 //                      console.log(API);
        ...
        $.ajax({
            ...
            success: function (dbObject) {
                ...
                $('#td_loading').css('display', 'none');
                    ...
                    F_GuardarDireccion($('#MainContent_txtNroRuc').val(),'#hfCodigoTemporal',$('#hfCodCtaCte').val(),
 '#MainContent_txtCliente',0,ubigeo,direccion.replace(distrito, ""),'#MainContent_ddldireccionNueva','#MainContent_ddldireccionNuevaDestino',1);
...
function F_ValidarGrabarDocumento(){
    try 
        {      
           ...
           if ($('#MainContent_chkPlaca').is(':checked') && $.trim($(Cuerpo + 'txtPlaca').val())=='')
               Cadena=Cadena + '<p></p>' + 'Placa';

           if ($('#MainContent_chkKM').is(':checked') && $.trim($(Cuerpo + 'txtKM').val())=='')
    ...
    $.ajax({
        ...
        var Contenedor = '#MainContent_';
                    ...
                    var objParams = {
                        ...
                        Filtro_CodGuia: "0",
                        Filtro_Descuento: "0",
                        Filtro_TasaIgv:tasaigv,// parseFloat($("#MainContent_ddlIgv option:selected").text()) + parseFloat(1),
                        Filtro_TasaIgvDscto: tasaigv,
                        Filtro_CodigoTemporal: $('#hfCodigoTemporal').val(),
                        Filtro_XmlDetalle: Sys.Serialization.JavaScriptSerializer.serialize(arrDetalle),
                ...
                F_AgregarTemporal_NET(arg, function (result) {
                    ...
                    if (result.split('~')[2] == "Los Producto(s) se han agregado con exito") {                       
                        ...
                        if ($.trim($('#MainContent_txtPlaca').val())=='')
                            $('#MainContent_chkPlaca').prop('checked', false);
                        else
                            $('#MainContent_chkPlaca').prop('checked', true);

                        if ($.trim($('#MainContent_txtKM').val())=='')
                            $('#MainContent_chkKM').prop('checked', false);
                        else
...
function F_ValidarGrabarDireccion() {
    ...
    try {
        ...
        if($('#hfDistrito').val()=="0")
            ...
            if ($.trim($(Cuerpo + 'txtDireccionMultiple').val()).length <3)
