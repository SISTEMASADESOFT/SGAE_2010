...
{
    public partial class RegistroCotizacionesStandardSofia : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv,
                    ...
                    ref ddlCompraEdicion, ref ddlFamiliaEdicion, ref ddlCanalVenta);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_serie, ref DropDownList ddl_serieconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_combomonedaedicion, ref DropDownList ddl_combocompraedicion, ref DropDownList ddl_combofamiliaedicion, ref DropDownList ddl_CanalVenta)
        {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            objEntidadProforma.Delivery = Convert.ToDecimal(objTablaFiltro["Filtro_Delivery"]);
            objEntidadProforma.CodCanalVenta = Convert.ToInt32(objTablaFiltro["Filtro_CanalVenta"]);
            ...
            if (Convert.ToInt64(hfIDExcel.Value) == 0)
            {
                if (objEntidadProforma.CodProformaAnterior > 0)
                {
                    ...
                    objOperacionProforma.F_Proformas_Insert_Edicion_Sofia(objEntidadProforma);
                }
                else
                {
                   // objOperacionProforma.F_Proformas_Insert_Alvarado(objEntidadProforma);
                    objOperacionProforma.F_Proformas_Insert_Sofia(objEntidadProforma);
                }
            }
            else
            {
