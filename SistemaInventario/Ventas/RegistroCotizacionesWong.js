var AppSession = "../Ventas/RegistroCotizacionesWong.aspx";
var CodigoMenu = 4000;
var CodigoInterno = 1;
var CodCategoria = 1;
...
////   hEcho por Adrian
    ...
    $('#MainContent_btnBuscarArticulo').click(function () {
        ...
        try {
            ...
            if ($.trim($('#MainContent_txtArticulo').val()) == "")
                return false;
            if ($.trim($('#MainContent_txtArticulo').val()) == "" | $.trim($('#MainContent_txtArticulo').val()).length < 3)
