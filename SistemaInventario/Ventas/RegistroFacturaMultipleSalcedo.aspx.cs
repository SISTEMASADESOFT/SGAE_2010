...
namespace SistemaInventario.Ventas
{
    public partial class RegistroFacturaMultipleSalcedo : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_VentaPerdida_NET);
        }
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlGratuito, ref ddlTipoTransportista, ref ddlTipoTransportistaEdicion, ref ddlcodunidadpeso, ref ddlcodunidadpesoedicion, ref ddlVendedorEdicion);
            ...
            str_resultado =
                ...
                str_ddl_TipoTransportista_html + "~" + //27
                str_ddl_TipoTransportistaedicion_html + "~" +//28
                str_ddl_CodUnidadpeso_html + "~" +//29
                str_ddl_CodUnidadpesoEdicion_html + "~" +//30
                str_ddlEmpleadoEdicion_html;//31
        ...
        //                                       ref  NroRucCliente, ref  NroRucTransportista, ref Codtipotransportista);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_Gratuito, ref DropDownList ddl_TipoTransportista, ref DropDownList ddl_TipoTransportistaEdicion, ref DropDownList ddl_CodunidadPeso, ref DropDownList ddl_CodunidadPesoedicion, ref DropDownList ddl_empleadoEdicion)
        {
        ...
        public void P_Inicializar_GrillaVacia_Articulo()
        {
            ...
            dta_consultaarticulo.Columns.Add("VentaPerdida", typeof(string));
        ...
        //    {
        //        case 16:
        //            objOperacion.F_DocumentoVentaCab_Insert_NV_OC_SALCEDO(objEntidad);
        //            MsgError = objEntidad.MsgError;
        //            Codigo = objEntidad.CodDocumentoVenta; CodTraslado = 0;
        //            break;
        //        default:
        //            if (objEntidad.NotaPedido == 0)
        //                objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_SALCEDO(objEntidad);
        //            else
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        //    objOperacion.F_EdicionFactura_Salcedo(objEntidad);
        ...
        public String F_VentaPerdida_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_VentaPerdida(obj_parametros, ref  MsgError);
        ...
        public void P_VentaPerdida(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodCliente = Convert.ToInt32(objTablaFiltro["Filtro_CodCLiente"]);
            objEntidad.CodProducto = Convert.ToInt32(objTablaFiltro["Filtro_CodProducto"]);
            objEntidad.DescripcionVentaPerdida = Convert.ToString(objTablaFiltro["Filtro_DescripcionVentaPerdida"]);

            objOperacion = new TCDocumentosCN();

            objOperacion.F_VentaPerdida(objEntidad);
