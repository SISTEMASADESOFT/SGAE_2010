<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleYordanNuevo.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleYordanNuevo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleYordanNuevo.js" charset="UTF-8"></script>       
    ...
    <table>
        <tr valign="top">
            ...
            <td style="width: 1100px" valign="top">
                ...
                <div id="divTabs" style="width: 1055px">
                    <ul>
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="display:none">
                                                        <asp:TextBox ID="txtDistrito" runat="server" Width="342px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                             ...
                                             <td style="padding-left: 8px">
                                                 <div id="div_moneda">
                                                     <asp:DropDownList ID="ddlMoneda" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                         Font-Bold="True" Width="80px" BackColor="#FFFF99">
                                                     </asp:DropDownList>
                                                 </div>
                                             </td>
                                             <td id="tdftNormal">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                     ...
                                                     <td style="font-weight: bold; padding-left: 21PX;">
                                                        SubTotal
                                                    </td>
                                                    <td>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtVencimiento" runat="server" Width="51px" CssClass="Jq-ui-dtp" Font-Names="Arial" ForeColor="Blue"
                                                    ...
                                                    <td>
                                                      ...
                                                      <td style="font-weight: bold; padding-left: 59px">
                                                        Nro Operacion
                                                    </td>
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="font-weight: bold; padding-left: 55px;">
                                                                Traslado
                                                            </td>
                                                            <td>
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="font-weight: bold;padding-left: 177px">
                                                                Peso 
                                                            </td>
                                                            <td>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgReemplazar" ImageUrl="~/Asset/images/Reemplazo.png"
                                                ToolTip="EDITAR VENTA" OnClientClick="F_ReemplazarDocumento(this); return false;"  Visible="false"/>
                                        </ItemTemplate>
                                    </asp:TemplateField>
...
--%>
                            ...
                            <div style="overflow-y: scroll; height: 330px;">
                                <div id="div_grvConsultaArticulo" style="padding-top: 5px">
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        border="0" CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None"
                                        Width="1200" OnRowDataBound="grvConsultaArticulo_RowDataBound">
                                        <Columns>
                                        ...
                                        ToolTip="VISUALIZAR FOTOS DEL PRODUCTO" OnClientClick="F_VisualizarImagenVenta(this); return false;" Visible="false" />
                                                </ItemTemplate>
                                            </asp:TemplateField>  
                            ...
                            <td>
                               ...
                               <%--         <td style="font-weight: bold">
                                ...
                                <%--        
                                         ...
                                         <td style="padding-left: 5px;">
                                            <asp:TextBox ID="txtLote" runat="server" Width="118px" Height="25" CssClass="Jq-ui-dtp"  
                                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" Font-Size="16" ></asp:TextBox>
                                        </td>    
                                        --%>
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td id="div_Placa1Editar" style="display:none">
 ...
 <div id="div_grvDetalleEdicion" style="padding-top: 5px;Width: 870px; display:none ">
