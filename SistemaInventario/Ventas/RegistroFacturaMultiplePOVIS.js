    ...
    $("#MainContent_chkGuiaEdicion").click(function () {
        if ($(this).is(':checked')) {
             ...
             BloqueoTipoTransportista($(Cuerpo + 'ddlSerieGuiaEdicion option:selected').text(),(Cuerpo + 'txtNumeroGuiaEdicion'),(Cuerpo + 'txtFechaTrasladoEdicion')
                 ...
                 ,'#MainContent_ImageButton3','#MainContent_ImageButton4','#MainContent_chkGuiaEdicion'),$('#hfCodTransportista').val();
...
function F_CambioSerie_TipoDoc_Notapedido() {
if (!F_SesionRedireccionar(AppSession)) return false;
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_FormatoImpresion', result.split('~')[30]);
                        ...
                        F_Update_Division_HTML('div_TipoTransportista', result.split('~')[31]);
                        F_Update_Division_HTML('div_codunidadpeso', result.split('~')[33]);
                        F_Update_Division_HTML('div_TipoTransportistaEdicion', result.split('~')[32]);
                        F_Update_Division_HTML('div_codunidadpesoedicion', result.split('~')[34]);
...
//        $('#hfNotaPedido').val(0);
        $('#MainContent_grvDetalleArticulo .chkDelete :checkbox').each(function () {
               chkSi = '#' + this.id;
               if ($(chkSi.replace('chkEliminar', 'hfCodTipoDoc')).val()==10 || $(chkSi.replace('chkEliminar', 'hfCodTipoDoc')).val()==16|| $(chkSi.replace('chkEliminar', 'hfCodTipoDoc')).val()==23)
               {
               $('#hfNotaPedido').val(1);
               }         
        });
...
function F_GuardarCambiosFactura() {
 try 
    ...
    var NroBultos = 0; if ($('#MainContent_txtNuBultosEdicion').val()!='') {NroBultos = $('#MainContent_txtNuBultosEdicion').val(); };
    var Peso = 0; if ($('#MainContent_txtPesoEdicion').val()!='') {Peso = $('#MainContent_txtPesoEdicion').val(); };
var arrDetalle = new Array();
     var F=0;
     var FlagUnitario=1;
    ...
    var objParams = {
                      ...
                      Filtro_CodEmpleado:$('#MainContent_dllvendedorEditor').val(), //SOLO PARA SALCEDO
...
function F_ImprimirElectronica(Fila) {
    ...
    var imgID = Fila.id;
    var lblCodigo = '#' + imgID.replace('imgPdf', 'lblCodigo');
    var CodTipoFormato =  $('#MainContent_ddlFormatoImpresion2').val(); 
            ...
            MostrarEspera(false);
                ...
                F_AgregarTemporal_NET(arg, function (result) {
                    ...
                    if (result.split('~')[2] == "Los Producto(s) se han agregado con exito") {
                        ...
                        F_CambioSerie_TipoDoc_Notapedido();
                    }
                    else {
                        MostrarEspera(false);
                        alertify.log(result.split('~')[1]);
...
function F_BUSCARDNIONBLURENTER(RUC)
{
         ...
         if ($(RUC).val()=='' || $(RUC).val()=='55555555555')
         return false;
...
function F_Inicializar_CajaText()
{
    $("#MainContent_txtNumeroConsulta").ForceNumericOnly();
