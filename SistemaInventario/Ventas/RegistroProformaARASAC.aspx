<%@ Page Title="PROFORMA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroProformaARASAC.aspx.cs" 
Inherits="SistemaInventario.Ventas.RegistroProformaARASAC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroProformaARASAC.js" charset="UTF-8"></script>       
        ...
        <tr valign="top">
            <td style="width: 1100px" valign="top">
                <div class="titulo" style="width: 1045px">
                    ...
                    <asp:Label ID="Label3" runat="server" Text="REGISTRO DE PROFORMA" Font-Bold="False"
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtCodCotizacion" CssClass="Derecha" runat="server" Width="72px"
                                                    ...
                                                    <td id="div_Placa1">
                                                        <asp:TextBox ID="txtPlaca1" runat="server" Width="72px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold;">
                                                        KM
                                                    ...
                                                    <td id="Td1" >
                                                        <asp:TextBox ID="txtKM" runat="server" Width="72px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td >
                                                        <asp:TextBox ID="txtObservacion" runat="server" Width="922px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" ReadOnly="False"></asp:TextBox>
                                                    </td>
                                               <td style="display: none">
                                    ...
                                    <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgImprimirFactura" ImageUrl="~/Asset/images/imprimir.gif"
                                                ToolTip="IMPRIMIR PROFORMA" OnClientClick="F_ImprimirFacturaGrilla(this,213); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
