var AppSession = "../Ventas/RegistroFacturaMultipleUnitarioChiquito.aspx";
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        if (F_Numerar_Grilla("grvConsultaArticulo",'lblProducto')==1)
                        F_AgregarArticulo('MainContent_grvConsultaArticulo_imgAgregar_0',1);
                    }
                    else {
...
function F_GrabarDocumento(){
  try 
        ...
        var objParams = {
            ...
            Filtro_CodDireccionDestino: $('#hfCodDireccion').val(),
...
function F_GuardarCambiosFactura() {
 try 
    ...
    var objParams = {
                      ...
                      Filtro_CodDireccionDestino: 0, // POR EL MOMENTO ESTA EN DURO
...
function F_ImprimirFacturaGrilla(Fila,CodMenu) {
        ...
        if (CodMenu == 200)
        {
            Codigo = $('#' + imgID.replace('imgImprimirGuia', 'lblCodigo')).val() ; 
