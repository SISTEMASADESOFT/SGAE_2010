...
{
    public partial class RegistroFacturaMultipleStandard : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            str_resultado =
                ...
                str_dllUsuarionNP_html + "~" + //34
                str_dllSucursal_html; //35
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            , ref DropDownList ddl_Almacen, ref DropDownList ddl_Usuario, ref DropDownList ddl_sucursal)
        {
            ...
            dta_consulta = null;
            objEntidadConceptosDet.CodEmpresaGeneral = Convert.ToInt32(Session["CodEmpresa"]);
        ...
        public void P_Obtener_NumeroCorrelativo(Hashtable objTablaFiltro, ref String Numero)
        {
            ...
            objEntidad.CodEmpresaGeneral = Convert.ToInt32(Session["CodEmpresa"]);
            objEntidad.CodAlmacenGeneral = Convert.ToInt32(Session["CodSede"]);
            if (objEntidad.CodTipoDoc == 16)
            {
                objEntidad.ConexionGeneral = Convert.ToString(Session["ConexionGeneral"]);
            }
