var AppSession = "../Ventas/RegistroCotizacionesStandard.aspx";
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_UsuarioNP', result.split('~')[22]);
                        F_Update_Division_HTML('div_SucursalNP', result.split('~')[23]);
                        $('#MainContent_ddlMoneda').val(1);
...
//                Cliente=Cliente.substr(Cliente.length - (Cliente.length -(Index+2)));
        ...
        var objParams = {
            ...
            Filtro_Celular: $('#MainContent_txtCelular').val().trim(),
...
function F_ACTUALIZAR_MONTO_MONEDA() {
        ...
        var codMoneda = $('#MainContent_ddlMoneda').val()
         $('#MainContent_hfCodMonedaCotizacion').val(codMoneda);
