var AppSession = "../Ventas/RegistroFacturaMultipleStandard.aspx";
var Codtipodoc=1
var CodigoMenu = 4000;
var CodigoInterno = 2;
var CodCategoria = 1;
...
$(document).ready(function () {
   ...
   // F_AUTOCOMPLETECONDUCTORDNIEDICION();
    ...
    $("#MainContent_txtCliente").bind("propertychange change keyup paste input", function(){
     ...
     $('#MainContent_btnBuscarNP').click(function () {
    if (!F_SesionRedireccionar(AppSession)) return false;
     try 
        {
          F_BuscarNP();
    ...
    if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Editar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        try {
            ...
            if (confirm("ESTA SEGURO DE GRABAR LA DIRECCION"))
                ...
                '#MainContent_txtNroRucTransportistaEdicion','#MainContent_MainContent_btnGrabarDireccion');
...
function F_CambioTipo() {
    ...
    default:
        ...
        $('#hfCodCtaCte').val('');
        $('#MainContent_ddldireccionNueva').val('');
        $('#hfCodCtaCte').val(0);
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_UsuarioNP', result.split('~')[34]);
                        F_Update_Division_HTML('div_SucursalNP', result.split('~')[35]);
...
//                            {
                                 ...
                                 var TienePermisoDuplicado = F_PermisoOpcion_SinAviso(4000, 4000299, '');
                ...
                if (str_resultado_operacion == "1") 
                {
                    if (str_mensaje_operacion=='Se Grabo Correctamente')
                    {
                        ...
                        $('#MainContent_txtNumero').val(result.split('~')[3]);
                         ...
                         //  var CodMenu = 203 esto es para ve
