...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                          <td>
                                                        <asp:TextBox ID="txtFamiliaConsulta" runat="server" Width="175px" Font-Names="Arial"
                                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                         <td style="font-weight: bold">
                                        Descripcion
                                    ...
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                     ...
                                     <%--       <asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Stock">
                                              ...
                                              <asp:TemplateField HeaderText="V-P">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblVentaPerdida" Text='<%# Bind("VentaPerdida") %>' Font-Size="Medium"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="UM">
                                                <ItemStyle HorizontalAlign="Center" />
            ...
            <div class="ui-jqdialog-content">
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tbody>
                        ...
                        <tr>
                         <td style="font-weight: bold;">
                                 <asp:CheckBox ID="chkVentasPerdidas" runat="server" Text="Otro" Font-Bold="True" />
                            </td>
                           <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtArticuloVentaPerdida" runat="server" Width="700px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True" Font-Size="16"></asp:TextBox>
                                        </td>
                                         <td style="font-weight: bold">
                                            Venta Perdida
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtVentaPerdida" runat="server" Width="40px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" CssClass="Derecha" Font-Size="16"></asp:TextBox>
                                        </td>
                                         <td>
                                            <asp:Button ID="btnVentaPerdida" runat="server" Text="Venta Perdida" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                                Font-Names="Arial" Font-Bold="True" Width="120" />
                                        </td>
                                    </tr>
                                    </table>
 ...
 <%--   <div id="div_Editar" style="display: none;">
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                             ...
                                             <td style="font-weight: bold;padding-left: 4px;">
                                                ...
                                                <tr>
                                                 <td style="padding-left:0px;">
                                    <asp:TextBox ID="txtGuiaAgenciaEdicion" runat="server" Width="80px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                                 <td style="font-weight: bold;padding-left:75px;">
                                 C.AGENCIA
                                                 ...
                                                 <td style="font-weight: bold;padding-left:0px;">
                                    <asp:TextBox ID="txtClaveAgenciaEdicion" runat="server" Width="105px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                                 <td style="font-weight: bold;">
                                   Placa
   ...
   <input id="hfCodCtaCte" type="hidden" value="0" />
    ...
    <input id="hfIDFamiliaConsulta" type="hidden" value="" />
</asp:Content>
