...
namespace SistemaInventario.Ventas
{
    public partial class RegistroCotizacionesReeim : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_LlenarGridDetalleProducto_NET);
        }
        ...
        protected void grvConsultaUltimoPrecio_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {

                GridView grvConsultaUltimosPrecios = null;
                GridView grvDetalleproductos = null;

                grvConsultaUltimosPrecios = (GridView)(e.Row.FindControl("grvConsultaUltimosPrecios"));
                grvDetalleproductos = (GridView)(e.Row.FindControl("grvDetalleproductos"));
                    ...
                    grvConsultaUltimosPrecios.DataSource = dta_consultaarticulo;
                    ...
                    grvDetalleproductos.DataSource = dta_consultaarticulo;
                    grvDetalleproductos.DataBind();
        ...
        public String F_ProductoDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_productoMargen(objEntidad);
                grvDetalle.DataBind();
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv,
                                        ref ddlEstado, ref ddlVendedor, ref ddlEmpleadoConsulta, ref dllUsuarionNP, ref dllSucursal);
            ...
            str_resultado =
                ...
                str_dllUsuarionNP_html + "~" + //17
                str_dllSucursal_html; //18
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_serie, ref DropDownList ddl_serieconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_Usuario,ref DropDownList ddl_sucursal)
        {
            ...
            dta_consulta = null;
            dta_consulta = objoperacionusuario.F_UsuarioNP_Listar();
        ...
        public void P_Inicializar_GrillaVacia_UltimoPrecio()
        {
            ...
            dta_consultadetallenv.Columns.Add("CodDocumentoventa", typeof(string));
            dta_consultadetallenv.Columns.Add("Codtipodoc", typeof(string));
            dta_consultadetallenv.Columns.Add("Codigo", typeof(string));
            dta_consultadetallenv.Columns.Add("Descripcion", typeof(string));
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DetalleNP(Hashtable objTablaFiltro, ref GridView grvDetalleNP)
        {
            ...
            dta_consulta = objOperacion.F_ItemNP_Listar(objEntidad);
        ...
        public String F_LlenarGridDetalleProducto_NET(String arg)
        {
            int int_resultado_operacion = 0;
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String grvNombre = "";
            String str_grv_grvDetalle_html = "";
            int Col = 0;
            int Codigo = 0;
            int CodTipoDoc = 0;
            int CodTipoDocNota = 0;
            string ID = "";
            string Descripcion = "";
            string Marca = "";
            string Cantidad = "";
            ...
            try
            {
                ...
                Codigo = Convert.ToInt32(obj_parametros["Filtro_Codigo"]);
                CodTipoDoc = Convert.ToInt32(obj_parametros["Filtro_CodTipoDoc"]);
                CodTipoDocNota = Convert.ToInt32(obj_parametros["Filtro_CodTipoDocNota"]);


                //Obtengo el Grid para llenarlo y dibujarlo
               
                GridView grvDetalleproductos = (GridView)grvConsultaUltimosPrecios.Rows[0].FindControl("grvDetalleproductos");
                    ...
                    objEntidad.CodTipoDocNota = CodTipoDocNota;

                    grvDetalleproductos.DataSource = objOperacion.F_DocumentoVentaDet_Listar_Reeim(objEntidad);
                    grvDetalleproductos.DataBind();
              

                //se crea el html a partir del grid llenado
                str_grv_grvDetalle_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleproductos);
