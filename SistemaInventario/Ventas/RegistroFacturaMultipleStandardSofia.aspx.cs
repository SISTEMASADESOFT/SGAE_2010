...
{
    public partial class RegistroFacturaMultipleStandardSofia : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_CambioGeneral_NET);
            CallbackManager.Register(F_FacturacionGuia_NET);
            CallbackManager.Register(F_ActualizarSoloDetalle_NET);
        }
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.ConexionGeneral = Convert.ToString(Session["ConexionGeneral"]);
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlCanalVenta_html = "";
            String str_ddlCanalVentaEdicion_html = "";
            String str_ddlCanalVentaConsulta_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlVendedorEdicion, ref ddlTipoTransportista, ref ddlTipoTransportistaEdicion,
                                        ref ddlcodunidadpeso, ref ddlcodunidadpesoedicion, ref ddlAlmacen, ref ddlCanalVenta, ref ddlCanalVentaEdicion, ref ddlCanalVentaConsulta);
                ...
                str_ddlCanalVenta_html = Mod_Utilitario.F_GetHtmlForControl(ddlCanalVenta);
                str_ddlCanalVentaEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlCanalVentaEdicion);
                str_ddlCanalVentaConsulta_html = Mod_Utilitario.F_GetHtmlForControl(ddlCanalVentaConsulta);
            ...
            str_resultado =
                ...
                str_ddl_TipoTransportista_html + "~" + //29
                str_ddl_TipoTransportistaedicion_html + "~" +//30
                str_ddl_CodUnidadpeso_html + "~" +//31
                str_ddl_CodUnidadpesoEdicion_html + "~" +//32
                str_ddlAlmacen_html+ "~" +//33
                str_ddlCanalVenta_html+ "~" +//34
                str_ddlCanalVentaEdicion_html + "~" +//35
                str_ddlCanalVentaConsulta_html;//36
        ...
        public String F_GrabarDocumento_NET(String arg)
        {
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_GrabarDocumento(obj_parametros, ref str_mensaje_operacion, ref CodDocumentoVenta, ref CodTraslado);
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    ...
                    ref MarcaVehiculo, ref DireccionTrans, ref FlagConCodigo, ref KM, ref OC);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ref CodTraslado, ref SerieGuia, ref NumeroGuia, ref Fecha,ref CodTransportista, ref Transportista,
                                               ref KM, ref OrdenCompra, ref Recepcion, ref FlagComisionable, ref CodCtaCte, ref Motorizado,
                                               ref Placa, ref Marca, ref Licencia, ref Bulto, ref Peso,ref NroConductor, ref Conductor,
                                               ref CodConductor, ref Serie, ref NombreAgencia,ref GuiaAgencia, ref ClaveAgencia,ref CodComprobanteEgreso,
                                               ref FlagConCodigo, ref RucTransportista, ref ObservacionGuia, ref Observacion, ref Codempleado, ref CodDireccionDestino,
                                               ref CodDireccionTransportista);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
            }
            catch (Exception ex)
            ...
            str_resultado =
                ...
                CodDireccionDestino.ToString() + "~" + //41
                RucTransportista + "~" + //42
                ObservacionGuia + "~" + //43
                Observacion + "~" +//44
                Codempleado;////45
        ...
        public String F_ActualizarSoloDetalle_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_VendedorEdicion, ref DropDownList ddl_TipoTransportista, 
            ref DropDownList ddl_TipoTransportistaEdicion, ref DropDownList ddl_CodunidadPeso, ref DropDownList ddl_CodunidadPesoedicion,ref DropDownList ddl_Almacen,
            ref DropDownList ddl_CanalVenta, ref DropDownList ddl_CanalVentaEdicion, ref DropDownList ddl_CanalVentaConsulta)
        {
            ...
            dta_consulta = null;
            objEntidadConceptosDet.CodEmpresaGeneral = Convert.ToInt32(Session["CodEmpresaGeneral"]);
            dta_consulta = objOperacionConceptosDet.F_TCConceptos_Almacen(objEntidadConceptosDet);

            ddl_Almacen.Items.Clear();

            ddl_Almacen.DataSource = dta_consulta;
            ddl_Almacen.DataTextField = "Descripcion";
            ddl_Almacen.DataValueField = "CodAlmacen";
            ddl_Almacen.DataBind();
            ddl_Almacen.Items.Insert(0, new ListItem("TODOS", "0"));

  

            objEntidadConceptosDet.CodConcepto = 99;
            dta_consulta = null;
            dta_consulta = objOperacionConceptosDet.F_TCConceptos_Select(objEntidadConceptosDet);
            ddl_CanalVenta.Items.Clear();
            ddl_CanalVenta.DataSource = dta_consulta;
            ddl_CanalVenta.DataTextField = "DscAbvConcepto";
            ddl_CanalVenta.DataValueField = "CodConcepto";
            ddl_CanalVenta.DataBind();


            ddl_CanalVentaEdicion.Items.Clear();
            ddl_CanalVentaEdicion.DataSource = dta_consulta;
            ddl_CanalVentaEdicion.DataTextField = "DscAbvConcepto";
            ddl_CanalVentaEdicion.DataValueField = "CodConcepto";
            ddl_CanalVentaEdicion.DataBind();

            ddl_CanalVentaConsulta.Items.Clear();
            ddl_CanalVentaConsulta.DataSource = dta_consulta;
            ddl_CanalVentaConsulta.DataTextField = "DscAbvConcepto";
            ddl_CanalVentaConsulta.DataValueField = "CodConcepto";
            ddl_CanalVentaConsulta.DataBind();
            ddl_CanalVentaConsulta.Items.Insert(0, new ListItem("TODOS", "0"));
        }
                                        ...
                                        ref DropDownList ddl_serieguia, ref DropDownList ddl_comboserienv)
        {
            ...
            objEntidad.CodAlmacenGeneral = Convert.ToInt32(Session["CodAlmacenGeneral"]);
            objEntidad.CodEmpresaGeneral = Convert.ToInt32(Session["CodEmpresaGeneral"]);
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("Delivery", typeof(string));
            dta_consulta.Columns.Add("CodCanalVenta", typeof(string));
            dta_consulta.Columns.Add("CodEmpleado", typeof(string));
            dta_consulta.Columns.Add("DELIVERY", typeof(string));
            dta_consulta.Columns.Add("CANALVENTAS", typeof(string));
            dta_consulta.Columns.Add("ObservacionFactura", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_DetalleNV()
        {
            ...
            dta_consultadetallenv.Columns.Add("NroRucTransportista", typeof(string));
            ...
            dta_consultadetallenv.Columns.Add("CodCanalVenta", typeof(string));
            dta_consultadetallenv.Columns.Add("Delivery", typeof(string));
            dta_consultadetallenv.Columns.Add("CodEmpleado", typeof(string));
            dta_consultadetallenv.Columns.Add("ObservacionFactura", typeof(string));
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " CodProformaDet = '" + item.CodProformaDet + "'";
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodDocumentoVenta, ref Int32 CodTraslado)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            objEntidad.Placa1 = Convert.ToString(objTablaFiltro["Filtro_Placa1"]);
            ...
            objEntidad.OrdenCompra = Convert.ToString(objTablaFiltro["Filtro_OrdenCompra"]);
            ...
            objEntidad.Delivery = Convert.ToDecimal(objTablaFiltro["Filtro_Delivery"]);
            objEntidad.CodCanalVenta = Convert.ToInt32(objTablaFiltro["Filtro_CanalVenta"]);
            objEntidad.ObservacionFactura = Convert.ToString(objTablaFiltro["Filtro_ObservacionFactura"]);
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 16: //Nota de Venta
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Sofia(objEntidad);
                    MsgError = objEntidad.MsgError;
                    CodDocumentoVenta = objEntidad.CodDocumentoVenta;
                    break;
                default: //Facturas y Boletas
                        if (Convert.ToInt32(objTablaFiltro["Filtro_NotaPedido"]) == 0)
                            objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Sofia(objEntidad); //Insert Normal
                        else
                            objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Sofia(objEntidad);
                  
                    MsgError = objEntidad.MsgError; CodDocumentoVenta = objEntidad.CodDocumentoVenta; CodTraslado = objEntidad.CodTraslado;
                    break;
            }
        }
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objEntidad.CodCanalVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodCanalVenta"]);
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_Listar_Sofia(objEntidad);
        ...
        public void P_FacturacionNV(Hashtable objTablaFiltro, ref GridView GrillaOC)
        {
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_NVXFacturar_Alvarado(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento, ref Int32 FormaPago, ref String Placa1,
                             ...
                             ref String Fecha, ref Int32 CodTransportista, ref String Transportista,ref String KM,
                             ref String OrdenCompra, ref String Recepcion,ref Int32 FlagComisionable, ref Int32 CodCtaCte, ref Int32 Motorizado,
                             ref String Placa, ref String Marca, ref String Licencia, ref Int32 Bulto, ref Decimal Peso, ref String NroConductor, ref String Conductor,
                             ref Int32 CodConductor,ref Int32 Serie,ref String NombreAgencia,ref String GuiaAgencia,ref String ClaveAgencia ,ref int CodComprobanteEgreso,
                             ref int FlagConCodigo, ref String RucTransportista, ref String ObservacionGuia, ref String Observacion, ref Int32 CodEmpleado, ref Int32 CodDireccionDestino, ref int CodDireccionTransportista)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                    ...
                    CodEmpleado = Convert.ToInt32(dta_consulta.Rows[0]["CodEmpleado"]);
                    ...
                    CodTransportista = Convert.ToInt32(dta_consulta.Rows[0]["CodTransportista"]);             
                    RucTransportista = Convert.ToString(dta_consulta.Rows[0]["RucTransportista"]); 
                    Transportista = Convert.ToString(dta_consulta.Rows[0]["Transportista"]);
                    Placa = Convert.ToString(dta_consulta.Rows[0]["PlacaTransportista"]); 
                    Marca = Convert.ToString(dta_consulta.Rows[0]["Marca"]); 
                    CodConductor = Convert.ToInt32(dta_consulta.Rows[0]["CodConductor"]);
                    Conductor = Convert.ToString(dta_consulta.Rows[0]["Conductor"]);
                    NroConductor = Convert.ToString(dta_consulta.Rows[0]["NroConductor"]);
                    Peso = Convert.ToDecimal(dta_consulta.Rows[0]["Peso"]); 
                    Bulto = Convert.ToInt32(dta_consulta.Rows[0]["Bulto"]);
                    Licencia = Convert.ToString(dta_consulta.Rows[0]["Licencia"]);
                    ObservacionGuia = Convert.ToString(dta_consulta.Rows[0]["ObservacionGuia"]);
                    CodDireccionDestino = Convert.ToInt32(dta_consulta.Rows[0]["CodDireccionDestino"]);
                    CodDireccionTransportista = Convert.ToInt32(dta_consulta.Rows[0]["CodDireccionTransportista"]);       
             }
        }
        ...
        public void P_EdicionFactura(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            // INICIO DE LOS DATOS DE LA FACTURA
            ...
            if (Convert.ToInt32(objTablaFiltro["Filtro_Codtipodoc"]) == 16)
            {
                objEntidad.ConexionGeneral = Convert.ToString(Session["ConexionGeneral"]);
            }
            else
            ...
            objOperacion.F_EdicionFactura_Sofia(objEntidad);
        ...
        ref String MarcaVehiculo, ref String DireccionTrans, ref String FlagConCodigo, ref String KM, ref String OC)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                FlagConCodigo = Convert.ToString(dtTabla.Rows[0]["FlagConCodigo"]);
                KM = Convert.ToString(dtTabla.Rows[0]["KM"]);
                OC = Convert.ToString(dtTabla.Rows[0]["OrdenCompra"]);
            }
        }
        ...
        public String F_CambioGeneral_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_CAMBIOGENERAL(obj_parametros, ref Codigo, ref MsgError);
                P_CargarGrillaTemporal(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref Acuenta, ref NotaPedido);
                str_grvDetalleArticulo_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleArticulo);
        ...
        public void P_CAMBIOGENERAL(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            objOperacion.F_TemporalFacturacionDetalle_Cambiogeneral(objEntidad);
            Codigo = objEntidad.CodDocumentoVenta;
            MsgError = objEntidad.MsgError;
        }
        ...
        public String F_FacturacionGuia_NET(String arg)
        {
            ...
            try
            {
                ...
                P_FacturacionGuia(obj_parametros, ref str_mensaje_operacion, ref  CodTraslado, ref  Serie,
             ref  Numero, ref  CodTipoTransportista, ref  CodTransportista, ref  NroRucTransportista, ref  Transportista
            , ref  UbigeoTransportista, ref  NroBultos, ref  Peso, ref  CodConductor, ref  NroConductor
            , ref  Conductor, ref  Observacion, ref  Placa, ref  Marca, ref  Licencia,
            ref  Codtipodoc, ref  CodCtaCte, ref  NroRuc, ref  RazonSocial, ref  CodDireccion
        , ref  Direccion, ref  Ubigeo, ref  Codigo);

                if (str_mensaje_operacion == "")
                    P_CargarGrillaTemporal_Guia(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref Acuenta, ref TasaIgv);
            ...
            str_resultado =
                    Convert.ToString(int_resultado_operacion)//1
                    + "~" +
                    str_mensaje_operacion//2
                     + "~" +
                    CodTraslado.ToString()//3
                     + "~" +
                    Serie.ToString()//4
                     + "~" +
                    Numero.ToString()//5
                      + "~" +
                   CodTipoTransportista.ToString()//6
                     + "~" +
                    CodTransportista.ToString()//7
                     + "~" +
                    NroRucTransportista.ToString()//8
                     + "~" +
                      Transportista.ToString()//9
                      + "~" +
                    UbigeoTransportista.ToString()//10
                      + "~" +
                    NroBultos.ToString()//11
                    + "~" +
                    Peso.ToString()//12
                    + "~" +
                    CodConductor.ToString()//13
                     + "~" +
                    NroConductor.ToString()//14
                     + "~" +
                    Conductor.ToString()//15
                     + "~" +
                    Observacion.ToString()//16
                     + "~" +
                    Placa.ToString()//17
                     + "~" +
                    Marca.ToString()//18
                     + "~" +
                    Licencia.ToString()//19
                     + "~" +
                    Codtipodoc.ToString()//20
                     + "~" +
                    CodCtaCte.ToString()//21
                     + "~" +
                    NroRuc.ToString()//22
                     + "~" +
                    RazonSocial.ToString()//23
                     + "~" +
                    CodDireccion.ToString()//24
                     + "~" +
                    Direccion.ToString()//25
                     + "~" +
                    Ubigeo.ToString()//26
                     + "~" +
                    Codigo.ToString()//27
                     + "~" +
                    str_grvDetalleArticulo_html;//28

            return str_resultado;
        }

        public void P_FacturacionGuia(Hashtable objTablaFiltro, ref String Mensaje, ref Int32 CodTraslado, ref String Serie,
            ref String Numero, ref Int32 CodTipoTransportista, ref Int32 CodTransportista, ref String NroRucTransportista, ref String Transportista
           , ref Int32 UbigeoTransportista, ref Int32 NroBultos, ref Decimal Peso, ref Int32 CodConductor, ref String NroConductor
           , ref String Conductor, ref String Observacion, ref String Placa, ref String Marca, ref String Licencia,
           ref Int32 Codtipodoc, ref Int32 CodCtaCte, ref String NroRuc, ref String RazonSocial, ref Int32 CodDireccion
       , ref String Direccion, ref Int32 Ubigeo, ref Int32 Codigo)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_ListarXCodigo_Guia(objEntidad);

            if (dta_consulta.Rows.Count > 0)
            {
                CodTraslado = Convert.ToInt32(dta_consulta.Rows[0]["CodTraslado"]);
                Serie = Convert.ToString(dta_consulta.Rows[0]["Serie"]);
                Numero = Convert.ToString(dta_consulta.Rows[0]["Numero"]);
                CodTipoTransportista = Convert.ToInt32(dta_consulta.Rows[0]["CodTipoTransportista"]);
                CodTransportista = Convert.ToInt32(dta_consulta.Rows[0]["CodTransportista"]);
                NroRucTransportista = Convert.ToString(dta_consulta.Rows[0]["NroRucTransportista"]);
                Transportista = Convert.ToString(dta_consulta.Rows[0]["Transportista"]);
                UbigeoTransportista = Convert.ToInt32(dta_consulta.Rows[0]["UbigeoTransportista"]);
                NroBultos = Convert.ToInt32(dta_consulta.Rows[0]["NroBultos"]);
                Peso = Convert.ToDecimal(dta_consulta.Rows[0]["Peso"]);
                CodConductor = Convert.ToInt32(dta_consulta.Rows[0]["CodConductor"]);
                NroConductor = Convert.ToString(dta_consulta.Rows[0]["NroConductor"]);
                Conductor = Convert.ToString(dta_consulta.Rows[0]["Conductor"]);
                Observacion = Convert.ToString(dta_consulta.Rows[0]["Observacion"]);
                Placa = Convert.ToString(dta_consulta.Rows[0]["Placa"]);
                Marca = Convert.ToString(dta_consulta.Rows[0]["Marca"]);
                Licencia = Convert.ToString(dta_consulta.Rows[0]["Licencia"]);
                Codtipodoc = Convert.ToInt32(dta_consulta.Rows[0]["Codtipodoc"]);
                CodCtaCte = Convert.ToInt32(dta_consulta.Rows[0]["CodCtaCte"]);
                NroRuc = Convert.ToString(dta_consulta.Rows[0]["NroRuc"]);
                RazonSocial = Convert.ToString(dta_consulta.Rows[0]["RazonSocial"]);
                CodDireccion = Convert.ToInt32(dta_consulta.Rows[0]["CodDireccion"]);
                Direccion = Convert.ToString(dta_consulta.Rows[0]["Direccion"]);
                Ubigeo = Convert.ToInt32(dta_consulta.Rows[0]["Ubigeo"]);
                objEntidad.CodTraslado = CodTraslado;

                objOperacion.F_DocumentoVentaDet_InsertTemporalGuia(objEntidad);
        ...
        public void P_CargarGrillaTemporal_Guia(Hashtable objTablaFiltro, Int32 Codigo, ref GridView grvDetalle,
