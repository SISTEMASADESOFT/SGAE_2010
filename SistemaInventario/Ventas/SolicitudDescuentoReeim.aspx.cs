...
{
    public partial class SolicitudDescuentoReeim : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlIgv, ref ddlEmpleadoConsulta);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_comboigv, ref DropDownList ddl_empleadoconsulta)
        {
            DataTable dta_consulta = null;
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("COdigoReem", typeof(string));
            dta_consultadetalle.Columns.Add("Linea", typeof(string));
            dta_consultadetalle.Columns.Add("Marca", typeof(string));
            dta_consultadetalle.Columns.Add("Stock", typeof(string));
            dta_consultadetalle.Columns.Add("Stockcieneguilla", typeof(string));
            dta_consultadetalle.Columns.Add("StockVitrina", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            objEntidad.NroBultos = Convert.ToInt32(objTablaFiltro["Filtro_NuBultos"]);
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 16: //Nota de Venta
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Reeim(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_Factura_NV(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_NP_OC(objEntidad);
                    ...
                    if (objEntidad.FlagFacturaANTIGUA == 0)
                    {
                        if (objEntidad.NotaPedido == 0)
                        {
                            if (objEntidad.FlagNotaVentaANTIGUA == 0)
                                ...
                                objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_NVANTIGUA_Reeim(objEntidad); //Insert NV ANTIGUA
                        }
                        else //Insert con NOTAPEDIDO NOTA VENTA, COTIZACION
                            objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Reeim(objEntidad);
                    }
                    else
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_NVANTIGUA_Reeim(objEntidad); //FACTURA ANTIGUA
