...
//            toastr.warning("Error Detectado: " + e);
    ...
    $("#MainContent_txtCelularConsulta").css('background', '#FFFFE0');
       ...
       try 
        {
              ...
              var objParams = {
                                ...
                                Filtro_Celular: $.trim($('#MainContent_txtCelularConsulta').val())
                               };
        ...
        try {
            ...
            F_ReemplazarFactura_NET(arg, function (result) {
                ...
                if (str_resultado_operacion == "1") {
                    ...
                    $('#hfNumeroAnterior').val(result.split('~')[19]);      
                    $('#hfCodigoTemporal').val(result.split('~')[2]);
                    ...
                    $('#MainContent_txtNumero').val(result.split('~')[19]);          
                    $('#MainContent_txtEmision').val(result.split('~')[21]);
                    $('#MainContent_txtVencimiento').val(result.split('~')[22]);
                    $('#MainContent_ddlVendedor').val(result.split('~')[20]);           
                    $('#MainContent_txtObservacion').val(result.split('~')[24]);
                    $('#MainContent_txtPlaca').val(result.split('~')[25]);   
                    $('#MainContent_txtCelular').val(result.split('~')[26]);
                    $('.ccsestilo').css('background', '#FFFFE0');
