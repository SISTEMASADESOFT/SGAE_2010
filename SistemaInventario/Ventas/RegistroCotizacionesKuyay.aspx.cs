...
{
    public partial class RegistroCotizacioneskuyay : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value != "")
                {
                    ...
                    dta_consultaarticulo.Columns.Add("FechaCaducidad", typeof(string));
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv,
                                        ref ddlEstado, ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlMonedaEdicion,
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_serie, ref DropDownList ddl_serieconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_combomonedaedicion, ref DropDownList ddl_combocompraedicion, ref DropDownList ddl_combofamiliaedicion)
        {
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("BloqueoMayorista", typeof(string));
            dta_consultadetalle.Columns.Add("BloqueoExclusivo", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_Articulo()
        {
            ...
            dta_consultaarticulo.Columns.Add("FlagBloqueoExclusivo", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("IDCargaMasivaExcelCab", typeof(string));
            dta_consulta.Columns.Add("FechaCaducidad", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            objEntidadProforma.IDPruebasExcelCab = Convert.ToInt64(hfIDExcel.Value);

            if (Convert.ToInt64(hfIDExcel.Value) == 0)
            {
                ...
                {
                    objOperacionProforma.F_Proformas_Insert_Alvarado(objEntidadProforma);// no cambiar name
                }
            }
            else
            {
                objOperacionProforma.F_Proformas_Insert_Alvarado_Excel(objEntidadProforma);
                hfIDExcel.Value = "0";
            }
        ...
        public void P_ActualizarPrecios(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_TemporalFacturacionDet_Update_Kuyay(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        {
            string Mensaje = "SE GRABO CORRECTAMENTE";
            Label5.Text = "";
            hfIDExcel.Value = DateTime.Now.ToString("yyyyMMddHHmmss");
            long IdExcel = long.Parse(hfIDExcel.Value.ToString());
            MSG = "";
            ...
            P_GrabarDocumento_Excel_Plus();

            Label5.Text = Mensaje;
            hfIDExcel.Value = "0";
            hfCodCtaCteServidor.Value = "0";
            hfDireccion.Value = "0";
            hfVencimiento.Value = "0";
            hfFormaPago.Value = "0";
            hfVendedor.Value = "0";
            hfIgv.Value = "0";
            hfTC.Value = "0";
        ...
        public void P_GrabarDocumento_Excel_Plus()
        {
            ...
            objEntidadProforma.CodCtaCte = Convert.ToInt32(hfCodCtaCteServidor.Value);
            objEntidadProforma.Serie = Convert.ToString(hfSerie.Value);
            objEntidadProforma.Numero = "";
            objEntidadProforma.FechaEmision = Convert.ToDateTime(hfEmision.Value);

            objEntidadProforma.NroRuc = Convert.ToString(txtNroRuc.Text);
            objEntidadProforma.NroDni = "";
            objEntidadProforma.CodDepartamento = 0;
            objEntidadProforma.CodProvincia = 0;
            objEntidadProforma.CodDistrito = 0;
            objEntidadProforma.CodTipoCliente = 2;
            objEntidadProforma.RazonSocial = Convert.ToString(txtCliente.Text);
            objEntidadProforma.ApePaterno = "";
            objEntidadProforma.ApeMaterno = "";
            objEntidadProforma.Nombres = "";
            objEntidadProforma.Direccion = "";
            objEntidadProforma.CodDireccion = Convert.ToInt32(hfDireccion.Value);
            objEntidadProforma.flagCodigo = 1;
            objEntidadProforma.CodMoneda = 2;
            objEntidadProforma.CodEstado = 6;
            objEntidadProforma.Vencimiento = Convert.ToDateTime(hfVencimiento.Value);
            objEntidadProforma.CodFormaPago = Convert.ToInt32(hfFormaPago.Value);
            objEntidadProforma.Gratuito = 0;
            objEntidadProforma.SubTotal = 0;
            objEntidadProforma.Igv = 0;
            objEntidadProforma.FlagIgv = 1;
            objEntidadProforma.Total = 0;
            objEntidadProforma.TipoCambio = Convert.ToDecimal(hfTC.Value);
            objEntidadProforma.CodUsuario = Convert.ToInt32((Session["CodUsuario"]));
            objEntidadProforma.CodDetalle = 0;
            objEntidadProforma.CodEstado = 6;
            objEntidadProforma.CodTipoDoc = 15;
            objEntidadProforma.Referencia = "";
            objEntidadProforma.Atencion = "";
            objEntidadProforma.Observacion = "";
            objEntidadProforma.CodTasa = Convert.ToInt32(hfIgv.Value);
            objEntidadProforma.Placa = "";
            objEntidadProforma.Placa2 = "";
            objEntidadProforma.Placa3 = "";
            objEntidadProforma.Placa4 = "";
            objEntidadProforma.KM = "";
            objEntidadProforma.Correo = "";
            objEntidadProforma.CodProformaAnterior = 0;
            objEntidadProforma.Celular = "";
            objEntidadProforma.NroOperacion = "";
            objEntidadProforma.CodEmpleado = Convert.ToInt32(hfVendedor.Value);
            objEntidadProforma.FlagComisionable = 0;
            objEntidadProforma.UsuarioPermiso = "";
            objEntidadProforma.ClavePermiso = "";
            objEntidadProforma.ObservacionPermiso = "";
            objEntidadProforma.IDPruebasExcelCab = Convert.ToInt64(hfIDExcel.Value);
                    ...
                    using (var package = new ExcelPackage(fileInfo))
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(sqlConnectionString))
                        {
                            ...
                            for (int row = worksheet.Dimension.Start.Row + 1; row <= worksheet.Dimension.End.Row; row++)
                            {
                                ...
                                string P1 = worksheet.Cells[row, 3].Text;

                                // Realizar la inserción en la base de datos
                                string insertQuery = "INSERT CargaMasivaPreciosExcel(CODIGO,Cantidad,p1,IDCargaMasivaExcelCab,NombreArchivo) " +
                                                     "VALUES (@CODIGO,@CANTIDAD,@P1,@IDPruebasExcelCab,@NombreArchivo)";
                                ...
                                using (SqlCommand cmd = new SqlCommand(insertQuery, connection))
                                {
                                    ...
                                    cmd.Parameters.AddWithValue("@IDPruebasExcelCab", hfIDExcel.Value);
        ...
        public void P_ActualizarFechaVencimientoTemporal(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaDetCE objEntidad = new DocumentoVentaDetCE();
            DocumentoVentaDetCN objOperacion = new DocumentoVentaDetCN();
            ...
            if (objTablaFiltro["Filtro_FechaVencimiento"] != null && !string.IsNullOrEmpty(objTablaFiltro["Filtro_FechaVencimiento"].ToString()))
            {
                objEntidad.FechaVencimiento = Convert.ToDateTime(objTablaFiltro["Filtro_FechaVencimiento"]);
            }
            else
