<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleUnitarioChiquito.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleUnitarioChiquito" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleUnitarioChiquito.js" charset="UTF-8"></script>       
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="font-weight: bold;padding-left: 72px;">
                                                        Placa
                                                    </td>
                                                    <td id="div_Placa1" style="padding-left: 19px;">
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtNumeroGuia" runat="server" Width="45" Font-Names="Arial" ForeColor="Blue"
                                                                    Font-Bold="True"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtFechaTraslado" runat="server" Width="50px" CssClass="Jq-ui-dtp"
                                                                    Font-Names="Arial" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                            </td>
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="font-weight: bold;padding-left: 156px">
                                                                Peso 
                                                            </td>
                                                            <td>
                            ...
                            <ItemTemplate>
                                <asp:CheckBox runat="server" ID="chkEliminar" CssClass="chkDelete" Text="" />
                                    ...
                                    <asp:TemplateField HeaderText="Codigo" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:HyperLink runat="server" ID="lblCodigo" Font-Underline="true" ForeColor="Blue"  CssClass="detallesart"
                                   ...
                                   <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                     ...
                                     <Columns>
                                            ...
                                            <ItemStyle Font-Bold="true"/>
                                               ...
                                               <asp:BoundField DataField="ModeloAbreviado" HeaderText="Mod Abreviado">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            ...
                                            <asp:TemplateField HeaderText="Descripcion" HeaderStyle-HorizontalAlign="Center">
                                                <ItemStyle HorizontalAlign="Left" />
                                                <ItemTemplate>
                                                    <asp:HyperLink runat="server" ID="lblProducto" Font-Underline="true" ForeColor="Blue" Font-Size="Medium" CssClass="detallesart"
                                               ...
                                               <asp:BoundField DataField="Compatibilidad" HeaderText="Compatibilidad">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                ...
                                <td style="padding-left:2px;">
                                    <asp:TextBox ID="txtNroOCEdicion" runat="server" Width="80px" Font-Names="Arial"
                                       ...
                                       <td style = "display:none;">
                                                       ...
                                                       <td>
                                                        <asp:CheckBox ID="chkUnitario" runat="server" Text="UNITARIO XML" Font-Bold="True" />
                                                    </td>                      
                                <td style = "display:none;">
