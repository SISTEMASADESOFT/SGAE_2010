<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleStandardSofia.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleStandardSofia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleStandardSofia.js" charset="UTF-8"></script>       
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                            ...
                            <div>
                                ...
                                <asp:ImageButton runat="server" ID="imgDireccion" ImageUrl="../Asset/images/add_small.png"
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td id="div_Placa1" style="display:none">
                                                    ...
                                                    <td style="padding-left: 24px; display:none">
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      <td id="div_CanalVentas">
                                                   <asp:DropDownList ID="ddlCanalVenta" runat="server" Font-Names="Arial" ForeColor="Blue"
                                    ...
                                    <asp:TextBox ID="txtDelivery" runat="server" Width="80px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                     </td>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                           ...
                                                           <td>
                                                                <asp:TextBox ID="txtObservacionFactura" runat="server" Width="920" Font-Names="Arial"
                                                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                            </td>
                ...
                <div class="ui-jqdialog-content" id="div_CuerpoGuia" style="display: none">
                  <table cellpadding="0" cellspacing="0" class="form-inputs">
                            ...
                            <div class="linea-button">
                              <asp:Button ID="btnTraerGuiaRemision" runat="server" Text="CONSIGNACION" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                ...
                                <asp:Button ID="btnAgregarProducto" runat="server" Text="Agregar (F2)" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                    Font-Names="Arial" Font-Bold="True" Width="120" />
                                <asp:Button ID="btnNotaVenta" runat="server" Text="NOTA DE VENTA (F3)" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                    Font-Names="Arial" Font-Bold="True" Width="120" />
                                            ...
                                            <tr>
                                             <td>
                                                ...
                                                CANAL VENTA
                                                 ...
                                                 <td>
                                                <div id="div_CanalVentaConsulta">
                                                    <asp:DropDownList ID="ddlCanalVentaConsulta" runat="server" Font-Names="Arial" ForeColor="Blue"
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-weight: bold">
                                            <label id="lblGrillaConsulta"></label>
                                                ...
                                                <td style="font-weight: bold;padding-left: 50px; color: red;font-size: medium">
                                        FALTA APROBAR:
                                    </td>
  ...
  <asp:TemplateField HeaderText="GR">
                                   ...
                                   <asp:TemplateField HeaderText="WS">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgMandarWhatsApp" ImageUrl="~/Asset/images/whatsapp.png"
                                                ToolTip="MANDAR WHATSAPP"  Height="20px" Width="20px" OnClientClick="F_EnviarWhatsApp(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="A">
                            <ItemTemplate>
                                ...
                                <asp:Panel ID="pnlOrdersAuditoria" runat="server" Style="display: none">
                                    ...
                                    <asp:TemplateField HeaderText="Numero" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hfDelivery" runat="server" Value='<%# Bind("Delivery") %>' />
                                            <asp:HiddenField ID="hfCodCanalVenta" runat="server" Value='<%# Bind("CodCanalVenta") %>' />
                                            <asp:HiddenField ID="hfObservacion" runat="server" Value='<%# Bind("ObservacionFactura") %>' />
                                 ...
                                 <asp:TemplateField HeaderText="Total">
                                    ...
                                    <asp:BoundField DataField="Saldo" HeaderText="Saldo" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemStyle HorizontalAlign="Right" />
                                          ...
                                          <asp:BoundField DataField="DELIVERY" HeaderText="DELIVERY" HeaderStyle-HorizontalAlign="Center"  DataFormatString="{0:N2}">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="Placa" HeaderText="Placa" HeaderStyle-HorizontalAlign="Center" Visible="false">
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:BoundField>
                                  
                                    <asp:BoundField DataField="CANALVENTAS" HeaderText="CANAL" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                              <%--      <asp:BoundField DataField="Comision" HeaderText="Comision" HeaderStyle-HorizontalAlign="Center">
                                    ...
                                    <asp:TemplateField HeaderText="Correo Sunat" Visible="false">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                     ...
                                     <%--            <asp:ImageButton runat="server" ID="imgVisualizarRegistro" ImageUrl="../Asset/images/Viewx16.png"
                                        ToolTip="VISUALIZAR FOTOS DEL PRODUCTO" OnClientClick="F_VisualizarImagenVenta(this); return false;" />--%>
                                            ...
                                            <asp:TemplateField HeaderText="Stock">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblstock" Text='<%# Bind("Stock") %>' Font-Size="Medium" CssClass="detallesart"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="UM">
                                                <ItemStyle HorizontalAlign="Center" />
            ...
            <div class="ui-jqdialog-content">
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tbody>
                        ...
                        <tr>
                            <td style="font-weight: bold">
                                <asp:CheckBox ID="chkServicios" runat="server" Text="ADICIONALES" Font-Bold="True" />
                            </td>
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Numero">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hfCodCanalVenta" runat="server" Value='<%# Bind("CodCanalVenta") %>' />
                                        <asp:HiddenField ID="hfDelivery" runat="server" Value='<%# Bind("Delivery") %>' />
                                        <asp:HiddenField ID="hfCodEmpleado" runat="server" Value='<%# Bind("CodEmpleado") %>' />
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                 ...
                 <td style="font-weight: bold;display:none;">
                                ...
                                <td>
                                    <asp:TextBox ID="txtDeliveryEdicion" runat="server" Width="80px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                        ...
                        <td id="div_CanalVentasEdicion">
                          <asp:DropDownList ID="ddlCanalVentaEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                     ...
                     <tr>
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                             <td>
                                               <asp:TextBox ID="txtObservacionFacturaEdicion" runat="server" Width="400px" Font-Names="Arial"
