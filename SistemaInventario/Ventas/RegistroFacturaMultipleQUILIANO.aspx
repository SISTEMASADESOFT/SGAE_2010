<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaMultipleQUILIANO.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleQUILIANO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleQUILIANO.js"  charset="UTF-8"></script>      
                                    ...
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CostoConIgv" HeaderText="Costo">
                                              ...
                                              <asp:TemplateField HeaderText="P.M">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
