...
$(document).ready(function () {
  ...
  F_GuardarDireccion($('#MainContent_txtNroRucTransportista').val(),'#hfCodigoTemporal',$('#hfCodCtaCteTransportista').val()
            ,'#MainContent_txtTransportista',1,Ubigeo,Direccion,'#MainContent_ddldireccionNuevaTransportista','',Codtipodoc);
        ...
        $.ajax({
            ...
            success: function (dbObject) {
                ...
                $('#td_loading').css('display', 'none');
                    ...
                    F_GuardarDireccion($('#MainContent_txtNroRuc').val(),'#hfCodigoTemporal',$('#hfCodCtaCte').val(),
 '#MainContent_txtCliente',0,ubigeo,direccion.replace(distrito, ""),'#MainContent_ddldireccionNueva','#MainContent_ddldireccionNuevaDestino',Codtipodoc);
...
function F_GuardarCambiosFactura() {
 try 
    ...
    var Peso = 0;if ($.trim($('#MainContent_txtPesoEdicion').val())!='') {Peso=$.trim($('#MainContent_txtPesoEdicion').val());};
    var NroBultos=0;if ($.trim($('#MainContent_txtNuBultosEdicion').val())!='') {NroBultos=$.trim($('#MainContent_txtNuBultosEdicion').val());};
