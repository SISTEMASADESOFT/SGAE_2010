...
{
    public partial class RegistroOrdenPedidoPOVISCelular : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value != "")
                {
                    ...
                    DataTable dta_consultaobservacion = null;
                    DataRow dtr_consultaobservacionfila = null;
                    dta_consultaobservacion = new DataTable();

                    dta_consultaobservacion.Columns.Add("Observacion", typeof(string)); 

                    dtr_consultaobservacionfila = dta_consultaobservacion.NewRow();
                    dtr_consultaobservacionfila[0] = "";
                    dta_consultaobservacion.Rows.Add(dtr_consultaobservacionfila);

                    grvDetalleObservacion.DataSource = dta_consultaobservacion;
                    grvDetalleObservacion.DataBind();
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("Descuento", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            objEntidadOrdenPedido.CodEstado = Convert.ToInt32(objTablaFiltro["Filtro_CodEstado"]);
            objEntidadOrdenPedido.Vencimiento = Convert.ToDateTime(objTablaFiltro["Filtro_Vencimiento"]);
            objEntidadOrdenPedido.Observacion = Convert.ToString(objTablaFiltro["Filtro_Observacion"]);
            ...
            objEntidadOrdenPedido.CodOrdenPedidoAnterior = Convert.ToInt32(objTablaFiltro["Filtro_CodOrdenPedidoAnterior"]);
            objEntidadOrdenPedido.CodEmpleado = Convert.ToInt32(objTablaFiltro["Filtro_CodEmpleado"]);
            objEntidadOrdenPedido.Descuento = Convert.ToDecimal(objTablaFiltro["Filtro_Descuento"]);
            objEntidadOrdenPedido.Observacion = Convert.ToString(objTablaFiltro["Filtro_Observacion"]);
