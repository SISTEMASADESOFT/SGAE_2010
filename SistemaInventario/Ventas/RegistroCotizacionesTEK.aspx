...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionesTEK.js" charset="UTF-8"></script>
                                       ...
                                       <asp:TemplateField HeaderText="Marca">
                                            ...
                                            <asp:TemplateField HeaderText="UM">
                                               ...
                                               <asp:TemplateField HeaderText="Precio">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblPrecioConsulta" Text='<%# Bind("Precio1") %>'  Font-Size="Medium"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
