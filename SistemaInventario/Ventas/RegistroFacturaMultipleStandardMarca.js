var AppSession = "../Ventas/RegistroFacturaMultipleStandardMarca.aspx";
var Codtipodoc=1
var CodigoMenu = 4000;
var CodigoInterno = 2;
var CodCategoria = 1;
...
function F_ACTUALIZAR_MONTO_MONEDA() {
        var tasaigv = 1;
        var FlagIgv = 0;
        var codigoTemporal = $('#hfCodigoTemporal').val();

       if (!codigoTemporal || codigoTemporal === "0") {
       // $('#MainContent_txtTotal').val('0.00');
//      
//          alertify.log('PRIMERO INGRESE UN PRODUCTO');
       return; 
       }
