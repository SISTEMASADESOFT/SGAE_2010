                            ...
                            <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                             ...
                             <%--       <asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="FT">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgPdf2" ImageUrl="~/Asset/images/pdf.png" ToolTip="VISTA PRELIMINAR FT PDF"
                                    ...
                                    <asp:TemplateField HeaderText="GR">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgImprimirGuiaPDF" ImageUrl="~/Asset/images/pdf.png"
                                                ToolTip="VISTA PRELIMINAR GR PDF" OnClientClick="F_ImprimirGuiaPDF(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="FT">
                                        <ItemTemplate>
                                    ...
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        ...
                                        ToolTip="VISUALIZAR FOTOS DEL PRODUCTO" OnClientClick="F_VisualizarImagenVenta(this); return false;" />
                                            ...
                                            <asp:TemplateField HeaderText="Costo">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblCosto" Text='<%# Bind("CostoConIgv") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                ...
                <tr>
                 ...
                 <tr>
                            <td style="font-weight: bold">
                                ...
                                <table>
                                  <td>
                                    <asp:TextBox ID="txtObservacionEdicion" runat="server" Width="885px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="font-weight: bold;display:none">
                                 VENDEDOR
