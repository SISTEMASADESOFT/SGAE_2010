...
if (!F_SesionRedireccionar(AppSession)) return false;
        ...
        if ($('#MainContent_txtNroRuc').val().split('-')[0].trim() == '55555555555')
        {
            $('#MainContent_txtCliente').val($('#MainContent_txtNroRuc').val().split('-')[1].trim());
            $('#MainContent_txtNroRuc').val($('#MainContent_txtNroRuc').val().split('-')[0].trim());
            return false;
        }
    ...
    $('#MainContent_txtNroRuc').val(Cliente.split('-')[0].trim());
        ...
        else
        {
            ...
            else
            {
                ...
                {
                  if ($('#MainContent_txtNroRuc').val() == '55555555555')
                  return false;
//                    if ( Index ==-1 ) {} else {
