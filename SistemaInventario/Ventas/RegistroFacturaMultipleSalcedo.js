...
//            $('#MainContent_txtCodfamiliaEdicion').val(i.item.Codigo);
    ...
    if (F_PermisoOpcion(CodigoMenu, 4000203, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
        try 
        {
                ...
                $('#MainContent_txtFamiliaConsulta').val('');
...
//            $('#div_ImpresorasNotaPedido').dialog('close');
    ...
    $('#MainContent_btnBuscarArticulo').click(function () {
        ...
        try {
            ...
            if ($('#MainContent_txtArticulo').val() == "" & $('#hfIDFamiliaConsulta').val()==0)
                return false
            if (($('#MainContent_txtArticulo').val == "" | $('#MainContent_txtArticulo').val().length < 3)& $('#hfIDFamiliaConsulta').val()==0)
    ...
    $('#MainContent_btnAnular').click(function () {
      ...
      $('#MainContent_btnVentaPerdida').click(function () {
    if (!F_SesionRedireccionar(AppSession)) return false;
    ...
    if (F_PermisoOpcion(CodigoMenu, 4000203, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
        ...
        if (confirm("ESTA SEGURO DE GRABAR LA VENTA PERDIDA "))
                F_VentaPerdida();   
...
//           $('.Jq-ui-dtp').datepicker('setDate', new Date());
    ...
    $("#MainContent_chkVentasPerdidas").change(function () {
        if (this.checked) {
            $('#MainContent_txtArticuloVentaPerdida').prop('disabled', false);
            $('#MainContent_txtArticuloVentaPerdida').val('');
        }else{
        
            $('#MainContent_txtArticuloVentaPerdida').prop('disabled', true);
            $('#MainContent_txtArticuloVentaPerdida').val($('#MainContent_txtArticuloAgregar').val());
    ...
    $('#MainContent_txtFamiliaConsulta').blur(function () {
    if ($('#MainContent_txtFamiliaConsulta').val() == '')
        $('#hfIDFamiliaConsulta').val(0);
    return false;
...
$(document).on("change", "select[id $= 'MainContent_ddlTipoTransportista']",function () {
     BloqueoTipoTransportista(true,$(Cuerpo + 'ddlSerieGuia option:selected').text(),(Cuerpo + 'txtNumeroGuia'),(Cuerpo + 'txtFechaTraslado')
                 ,(Cuerpo + 'txtDestino'),
                 (Cuerpo + 'txtTransportista'),(Cuerpo + 'txtNroRucTransportista')
                 ,(Cuerpo + 'txtPlacaTraslado'),(Cuerpo + 'txtLicenciaGuia'),(Cuerpo + 'txtNuBultos'),(Cuerpo + 'txtPeso')
                 ,(Cuerpo + 'txtConductorRazonSocial'),(Cuerpo + 'txtConductorDNI'),$(Cuerpo + 'ddlTipoTransportista').val()
                 ,(Cuerpo + 'txtDistritoTransportista'),(Cuerpo + 'txtDireccionTransportista')
                 ,$('#hfCodDistritoTransportista').val(),$('#hfCodDireccionTransportista').val(),$('#hfCodConductor').val(),(Cuerpo + 'txtMarcaGuia'));
});
...
$(document).on("change", "select[id $= 'MainContent_ddlTipoTransportistaEdicion']",function () {
     BloqueoTipoTransportista(true,$(Cuerpo + 'ddlSerieGuiaEdicion option:selected').text(),(Cuerpo + 'txtNumeroGuiaEdicion'),(Cuerpo + 'txtFechaTrasladoEdicion')
                 ,(Cuerpo + 'txtDestinoEdicion'),
                 (Cuerpo + 'txtTransportistaEdicion'),(Cuerpo + 'txtNroRucTransportistaEdicion')
                 ,(Cuerpo + 'txtPlacaTrasladoEdicion'),(Cuerpo + 'txtLicenciaGuiaEdicion'),(Cuerpo + 'txtNuBultosEdicion'),(Cuerpo + 'txtPesoEdicion')
                 ,(Cuerpo + 'txtConductorRazonSocialEdicion'),(Cuerpo + 'txtConductorDNIEdicion'),$(Cuerpo + 'ddlTipoTransportistaEdicion').val()
                 ,(Cuerpo + 'txtDistritoTransportistaEdicion'),(Cuerpo + 'txtDireccionTransportistaEdicion')
                 ,$('#hfCodDistritoTransportistaEdicion').val(),$('#hfCodDireccionDefectoTransportista').val(),$('#hfCodConductor').val(),(Cuerpo + 'txtMarcaGuiaEdicion'));
});
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_TipoTransportista', result.split('~')[27]);
                        F_Update_Division_HTML('div_codunidadpeso', result.split('~')[29]);
                        F_Update_Division_HTML('div_TipoTransportistaEdicion', result.split('~')[28]);
                        F_Update_Division_HTML('div_codunidadpesoedicion', result.split('~')[30]);
                        F_Update_Division_HTML('div_VendedorEdicion', result.split('~')[31]);
//                        F_Update_Division_HTML('Div_EstadoNP', result.split('~')[29]);
    ...
    $('#MainContent_txtConductorDNI').css('background', '#FFFFE0');
                        ...
                        $('#MainContent_txtGuiaAgenciaEdicion').css('background', '#FFFFE0');
                        $('#MainContent_txtClaveAgenciaEdicion').css('background', '#FFFFE0');
                        $('#MainContent_txtVentaPerdida').css('background', '#FFFFE0');
                        $('#MainContent_txtAtencion').val('');
                        $('#MainContent_txtReferencia').val('');
...
function F_AgregarArticulo(ControlID, DirectoBoton) {
    ...
    $('#MainContent_txtArticuloVentaPerdida').val($(hfArticulo_grilla).text());
    $('#MainContent_txtCantidad').val(1);
...
//        }
    ...
    $('#MainContent_chkServicios').prop('checked', false);
    $('#MainContent_chkVentasPerdidas').prop('checked', false);
...
//        }
        ...
        var objParams = {
            ...
            Filtro_NroRuc: NroRuc,                
            Filtro_FlagCSIgv: FlagCSIgv,
            Filtro_Placa1:$(Contenedor + 'txtPlaca').val(),
            Filtro_Placa2:$(Contenedor + 'txtPlaca2').val(),
            Filtro_Placa3:$(Contenedor + 'txtPlaca3').val(),
            Filtro_Placa4:$(Contenedor + 'txtPlaca4').val(),
            Filtro_KM:$(Contenedor + 'txtKM').val(),
 ...
 try 
  ...
  F_GuardarDireccion($('#hfNroRucCliente').val(),'#hfCodigoTemporalEdicion',$('#hfCodCtaCteEdicion').val(),'#MainContent_txtClienteEditar',
                    ...
                    F_GuardarDireccion($('#MainContent_txtNroRucTransportistaEdicion').val(),'#hfCodigoTemporalEdicion',$('#hfCodTransportistaEdicion').val(),
                      ...
                      BloqueoTipoTransportista($("#MainContent_ddlSerieGuiaEdicion option:selected").text(),(Cuerpo + 'txtNumeroGuiaEdicion'),(Cuerpo + 'txtFechaTrasladoEdicion'),
                        (Cuerpo + 'ddldireccionNuevaDestinoEdicion'),(Cuerpo + 'txtTransportistaEdicion'),(Cuerpo + 'txtNroRucTransportistaEdicion'),(Cuerpo + 'txtPlacaTrasladoEdicion'),
                        (Cuerpo + 'txtLicenciaGuiaEdicion'),(Cuerpo + 'txtNuBultosEdicion'),(Cuerpo + 'txtPesoEdicion'),(Cuerpo + 'txtConductorRazonSocialEdicion'),
                        (Cuerpo + 'txtConductorDNIEdicion'),$(Cuerpo + 'ddlTipoTransportistaEdicion').val(),(Cuerpo + 'ddldireccionNuevaTransportistaEdicion'),'#hfCodConductor',
                        (Cuerpo + 'txtMarcaGuiaEdicion'),'#MainContent_ImageButton3','#MainContent_ImageButton4','#MainContent_chkGuiaEdicion',$('#hfCodTransportista').val()); 

                   }
                    else if ($('#hfCodTransportista').val()>0)
                    {  
                          F_GuardarDireccion($('#MainContent_txtNroRucTransportistaEdicion').val(),'#hfCodigoTemporalEdicion',$('#hfCodTransportistaEdicion').val(),
                                          '#MainContent_txtTransportistaEdicion',1,Ubigeo,Direccion,'#MainContent_ddldireccionNuevaTransportistaEdicion','',Codtipodoc);
...
var arrDetalle = new Array();
    ...
    var objParams = {
                      ...
                      Filtro_CodFormaPago:  $('#MainContent_ddlFormaPagoEdicion').val(),
                      Filtro_CodCliente: $('#hfCodCtaCteEdicion').val(),
                      Filtro_CodEmpleado: 0,  //$('#MainContent_ddlVendedorEdicion').val(), SOLO PARA SALCEDO
                      Filtro_Placa1:  $('#MainContent_txtPlaca1Editar').val(),
                      Filtro_Placa2:  $('#MainContent_txtPlaca2Edicion').val(),
                      Filtro_Placa3:  $('#MainContent_txtPlaca3Edicion').val(),
                      Filtro_Placa4:  $('#MainContent_txtPlaca4Edicion').val(),
...
//                }
        ...
        F_AgregarTemporal_NET(arg, function (result) {
            ...
            ,0,Ubigeo,Direccion,'#MainContent_ddldireccionNueva','#MainContent_ddldireccionNuevaDestino',Codtipodoc);
...
function F_InicializarCajaTexto()
{
    ...
    $('#MainContent_txtArticuloVentaPerdida').css('background', '#FFFFE0');
    
    $('#MainContent_txtArticuloVentaPerdida').prop('disabled', true);

     $("#MainContent_txtVentaPerdida").ForceNumericOnly();
...
function F_VentaPerdida() {
if (!F_SesionRedireccionar(AppSession)) return false;
var Codproducto=0

if($('#MainContent_txtVentaPerdida').val()==0 |$('#MainContent_txtVentaPerdida').val()=='')
{
alertify.log("INGRESE CANTIDAD DE VENTA PERDIDA ");
return false
}

if($('#MainContent_txtArticuloVentaPerdida').val()=='')
{
alertify.log("INGRESE DESCRIPCION DE VENTA PERDIDA ");
return false
}

    var arg;
      if ($("#MainContent_chkVentasPerdidas").is(':checked')) 
      Codproducto=0;
      else
    ...
    try {
        var objParams =
            {               
                Filtro_Cantidad: $('#MainContent_txtVentaPerdida').val(),
                Filtro_CodCLiente: $('#hfCodCtaCte').val(),
                Filtro_CodProducto: Codproducto,
                Filtro_DescripcionVentaPerdida: $('#MainContent_txtArticuloVentaPerdida').val()
            };
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                         alertify.log(result.split('~')[2]);
                         $('#MainContent_txtArticuloVentaPerdida').val('');  
                         $('#MainContent_txtVentaPerdida').val('');    
                         $('#MainContent_chkVentasPerdidas').prop('checked',false); 
                         F_Buscar_Productos();   
