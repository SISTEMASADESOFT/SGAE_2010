var AppSession = "../Ventas/RegistroFacturaMultipleStandardSofia.aspx";
var Codtipodoc=1
var CodigoMenu = 4000;
var CodigoInterno = 2;
var CodCategoria = 1;
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_CanalVentas', result.split('~')[34]);
                        F_Update_Division_HTML('div_CanalVentasEdicion', result.split('~')[35]);
                        F_Update_Division_HTML('div_CanalVentaConsulta', result.split('~')[36]);
                        ...
                        $('#MainContent_ddlCanalVenta').css('background', '#FFFFE0');
                        $('#MainContent_txtDeliveryEdicion').css('background', '#FFFFE0');
                        $('#MainContent_txtObservacionFactura').css('background', '#FFFFE0');
                        $('#MainContent_txtObservacionFacturaEdicion').css('background', '#FFFFE0');
                        $('#MainContent_ddlCanalVentaEdicion').css('background', '#FFFFE0');
                        ...
                        $('#MainContent_txtDelivery').css('background', '#FFFFE0');
                       ...
                       $('#MainContent_ddlCanalVentaConsulta').css('background', '#FFFFE0');
                        //Placas
    ...
    try 
        {      
           ...
           if (F_ValidarCelular($(Cuerpo + 'txtCelular').val())!='')
            ...
            if ($(Cuerpo + 'ddlCanalVenta').val() == '0')
            Cadena = Cadena + '<p></p>' + 'Selecione Canal Un De Ventas';
...
function F_GrabarDocumento(){
  try 
        ...
        var objParams = {
            ...
            Filtro_CanalVenta:$(Contenedor + 'ddlCanalVenta').val(), 
            Filtro_Delivery: $(Contenedor + 'txtDelivery').val().trim()? parseFloat($(Contenedor + 'txtDelivery').val().trim()): 0,
            Filtro_ObservacionFactura: $('#MainContent_txtObservacionFactura').val(),  
...
function F_Nuevo(){
       ...
       $('#MainContent_ddlMoneda').val('1');
       $('#MainContent_ddlFormaPago').val('1'); 
       $('#MainContent_ddlCanalVenta').val(0); 
        $('#MainContent_txtDelivery').val('');       
       $('#MainContent_txtCliente').val('');       
       ...
       $('#MainContent_txtNroOC').val('');  
        $('#MainContent_txtObservacionFactura').val('');      
       ...
       try 
        {
              ...
              var objParams = {
                                ...
                                Filtro_CodCanalVenta: $('#MainContent_ddlCanalVentaConsulta').val()
                               };
...
function F_EditarRegistro(Fila) {
 ...
 try 
        ...
        var hfDelivery = '#' + imgID.replace('imgEditarDocumento', 'hfDelivery');
        var hfCodCanalVenta = '#' + imgID.replace('imgEditarDocumento', 'hfCodCanalVenta');
        var hfObservacion = '#' + imgID.replace('imgEditarDocumento', 'hfObservacion');

        var Cuerpo = '#MainContent_';

       // $(Cuerpo + 'txtDeliveryEdicion').val($(hfDelivery).val());
          $(Cuerpo + 'txtDeliveryEdicion').val(Number($(hfDelivery).val()).toFixed(2));
          $(Cuerpo + 'ddlCanalVentaEdicion').val($(hfCodCanalVenta).val());
           $(Cuerpo + 'txtObservacionFacturaEdicion').val($(hfObservacion).val());
...
var arrDetalle = new Array();
    ...
    var objParams = {
                     ...
                     // Filtro_Delivery:$('#MainContent_txtDeliveryEdicion').val().trim(),
                      Filtro_Delivery: $('#MainContent_txtDeliveryEdicion').val().trim() ? parseFloat($('#MainContent_txtDeliveryEdicion').val().trim()) : 0,
                      Filtro_CanalVenta: $('#MainContent_ddlCanalVentaEdicion').val(),
                      Filtro_ObservacionFactura: $('#MainContent_txtObservacionFacturaEdicion').val(),
                      Filtro_XmlDetalle: Sys.Serialization.JavaScriptSerializer.serialize(arrDetalle),
                    ...
                    //  Filtro_NroBultos: $('#MainContent_txtNuBultosEdicion').val(),
                      Filtro_NroBultos: $('#MainContent_txtNuBultosEdicion').val().trim() ? parseFloat($('#MainContent_txtNuBultosEdicion').val().trim()) : 0,
                     // Filtro_Peso: $('#MainContent_txtPesoEdicion').val(),
                      Filtro_Peso: $('#MainContent_txtPesoEdicion').val().trim() ? parseFloat($('#MainContent_txtPesoEdicion').val().trim()) : 0,
...
function F_AgregarTemporalNV() {
    try {
        ...
        $('#MainContent_grvDetalleNV .chkDelete :checkbox').each(function () {
            ...
            hfCodCanalVenta = chkSi.replace('chkEliminar', 'hfCodCanalVenta');
            hfDelivery = chkSi.replace('chkEliminar', 'hfDelivery');
            hfCodEmpleado = chkSi.replace('chkEliminar', 'hfCodEmpleado');
            ...
            if ($(chkSi).is(':checked')) {           
               // var acuenta = $(lblAcuenta).text(); if ($(lblAcuenta).text() == '') acuenta = '0';
                ...
                arrDetalle.push(objDetalle);
                $('#MainContent_ddlCanalVenta').val($(hfCodCanalVenta).val());
                $('#MainContent_ddlVendedor').val($(hfCodEmpleado).val());
                 $('#MainContent_txtDelivery').val($(hfDelivery).val());
        ...
        var tasaigv = parseFloat($("#MainContent_ddlIgv option:selected").text()) + parseFloat(1);
                ...
                F_AgregarTemporal_NET(arg, function (result) {
                    ...
                    if (result.split('~')[2] == "Los Producto(s) se han agregado con exito") {                        
                        ...
                        $('#MainContent_txtDelivery').val(data.CodCategoria);
                        $('#MainContent_ddlCanalVenta').val(data.FlagComisionable);
                        $('.ccsestilo').css('background', '#FFFFE0');
                        $('#hfNotaPedido').val(result.split('~')[9]);
                            if ($('#hfNotaPedido').val() == '5')
                                $('#hfCodCtaCteNP').val($('#hfCodCtaCte').val());
...
//            Cadena=Cadena + '<p></p>' + 'NUMERO OPERACION';
          ...
          if($(Cuerpo + 'ddlCanalVentaEdicion').val() =='0')
            Cadena = Cadena + '<p></p>' + 'Selecione Canal Un De Ventas';                    
...
function F_Inicializar_TextBox()
{
    ...
    //$("#MainContent_txtDelivery").ForceNumericOnly();
