...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                            ...
                            <div>
                                ...
                                <asp:ImageButton runat="server" ID="imgDireccion" ImageUrl="../Asset/images/add_small.png"
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-weight: bold;">
                                                        <asp:Label ID="lblID" runat="server" Text="" Font-Bold="True"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                ...
                <div class="ui-jqdialog-content" id="div_CuerpoGuia" style="display: none">
                  <table cellpadding="0" cellspacing="0" class="form-inputs">
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                         ...
                                                         <td style="font-weight: bold;padding-left:17px; color: #FF0000; font-size: small;">
                                                                Destino
                                                            </td>
                            ...
                            <div class="linea-button">
                                <asp:Button ID="btnDescuento" runat="server" Text="Autorizar Descuento" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            ...
                            <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Cantidad" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtCantidad" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                CssClass="ccsestilo2" Font-Names="Arial" ForeColor="Blue" Text='<%# Bind("Cantidad") %>'
                                    ...
                                    <asp:TemplateField HeaderText="Valor Venta" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtPrecio" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                CssClass="ccsestilo2" Font-Names="Arial" ForeColor="Blue" Text='<%# Bind("PrecioDscto") %>'
                                    ...
                                    <asp:TemplateField HeaderText="Importe">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label runat="server" CssClass="detallesart" ID="lblImporte" Text='<%# Bind("ImporteReeim") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <div class="ui-jqdialog-content">
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                            <div id="Div_EstadoNP" style="margin-left:0px">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="I">
                                                ...
                                                <ItemTemplate>
                                                    <img id="imgMasProducto" alt="" style="cursor: pointer" src="../Asset/images/plus.gif"
                                                        onclick="imgMasProducto_Click(this);" title="VER PRE IMPORTACION PRODUCTO" />
                                                    <asp:Panel ID="pnlProductos" runat="server" Style="display: none">
                                                        <asp:GridView ID="grvDetalleProducto" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="DscProducto" HeaderText="DscProducto">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:BoundField>
                                            ...
                                            <asp:TemplateField HeaderText="Pri">
                                             ...
                                             <asp:TemplateField HeaderText="Cie">
                                                <ItemStyle HorizontalAlign="Center" Width="50px" Font-Size="Medium" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblStockcieneguilla" Font-Size="Medium"  Text='<%# Bind("Stockcieneguilla") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                              <asp:TemplateField HeaderText="Vit">
                                                <ItemStyle HorizontalAlign="Center" Width="50px" Font-Size="Medium" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblStockVitrina" Font-Size="Medium"  Text='<%# Bind("StockVitrina") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                           <%-- <asp:TemplateField HeaderText="UM">
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" >
                                    <ItemTemplate>
                                        <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                            ToolTip="Eliminar Direccion" OnClientClick="F_EliminarDireccion(hfCodigoTemporal,this,MainContent_ddldireccionNueva,MainContent_txtDistritoMultiple); return false;" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" >
                                    <ItemTemplate>
    ...
    <input id="hfStockTransportista" type="hidden" value="0" />
    <input id="hfMargenStockTransportista" type="hidden" value="0" />
    <input id="hfstock" type="hidden" value="0" />
    <input id="hfstockcieneguilla" type="hidden" value="0" />
