...
namespace SistemaInventario.Ventas
{
    public partial class RegistroFacturaMultipleRoman : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value != "")
                {
                    ...
                    dta_consultaarticulo.Columns.Add("PrecioNeto", typeof(string));
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlVendedorEdicion, ref ddlTipoTransportista, ref ddlTipoTransportistaEdicion, ref ddlcodunidadpeso, ref ddlcodunidadpesoedicion);
            ...
            str_resultado =
                ...
                str_ddlEmpleadoEdicion_html + "~" +    //25
                 str_ddl_TipoTransportista_html + "~" +  //26
                str_ddl_TipoTransportistaedicion_html + "~" +//27
                str_ddl_CodUnidadpeso_html + "~" +   //28
                str_ddl_CodUnidadpesoEdicion_html ;//29
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    ...
                    ref NroBultos, ref Peso, ref PlacaVehiculo, ref Observacion, ref FlagComisionable, ref CodDireccion);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_empleadoedicion, ref DropDownList ddl_TipoTransportista, ref DropDownList ddl_TipoTransportistaEdicion,
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 5: //Orden de Compra
                    ...
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Roman(objEntidad); 
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        ref String DireccionTrans, ref String NroBultos, ref String Peso, ref String PlacaVehiculo, ref String Observacion, ref int FlagComisionable, ref int CodDireccion)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
        ...
        public String F_LlenarGridDetalleEdicion_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalleEdicion.DataSource = objOperacion.F_DocumentoVentaDet_Listar(objEntidad);
