                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtUMAgregar" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <td  >
                                            <asp:TextBox ID="txtMargen" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" Font-Size="16" onblur="F_Actualizarpreciodisplay(this.id, 'txtMargen'); return false;"  Visible="false"></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold; display:none">
                                            %
                                        </td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtMargenMinimo" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" Visible="false" ReadOnly="true" Font-Size="16"></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold">
                                            %
                                        </td>
