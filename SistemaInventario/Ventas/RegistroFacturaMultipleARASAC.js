var AppSession = "../Ventas/RegistroFacturaMultipleARASAC.aspx";
var Codtipodoc=1
var CodigoMenu = 4000;
var CodigoInterno = 2;
var CodCategoria = 1;
...
function F_LlenarGridDetalle(Fila){
  try 
        {             
                ...
                var NumeroDoc = $('#' + Fila.replace('pnlOrders', 'lblnumero')).text();
...
function F_Observacion(Fila) {
    try {
        ...
        var NumeroDoc = $('#' + Fila.replace('pnlOrdersObservacion', 'lblNumero')).text();
...
function F_Auditoria(Fila) {
    try {
        ...
        var grvNombre = 'MainContent_grvConsulta_grvDetalleAuditoria_' + Col;
                ...
                var NumeroDoc = $('#' + Fila.replace('pnlOrdersAuditoria', 'lblNumero')).text();
...
function F_LlenarGridDetalleEdicion(Fila,ComprobanteEgreso){
  try 
        {       
                ...
                var NumeroDoc = $('#' + Fila.replace('imgEditarDocumento', 'lblnumero')).text();
...
function F_VistaPreliminar(Fila,CodMenu) {
    ...
    if (CodMenu == 100){
       ...
       alertify.log("No tiene guia adjunta");
        ...
        CodTipoDocGeneral = $('#' + imgID.replace('imgPdfFactura', 'hfCodTipoDoc')).val();
    }   
...
function F_ImprimirFactura(Codigo,CodMenu) {    
        ...
        rptURL = rptURL + 'NombreArchivo=' + NombreArchivo + '&';
        rptURL = rptURL + 'NombreTabla=' + NombreTabla + '&';
        rptURL = rptURL + 'CodTipoDoc=' + CodTipoDocGeneral + '&';
