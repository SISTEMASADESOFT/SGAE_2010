...
{
    public partial class RegistroFacturaMultipleSalazar : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlTipoMantenimiento_html = "";
            String str_ddlTipoMantenimientoEdicion_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlcodunidadpeso, ref ddlcodunidadpesoedicion, ref ddlAlmacen, ref ddlTipoMantenimiento, ref ddlTipoMantenimientoEdicion);
                ...
                str_ddlTipoMantenimiento_html = Mod_Utilitario.F_GetHtmlForControl(ddlTipoMantenimiento);
                str_ddlTipoMantenimientoEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlTipoMantenimientoEdicion);
            ...
            str_resultado =
                ...
                str_ddlTipoMantenimiento_html + "~" +//34
                str_ddlTipoMantenimientoEdicion_html;//35
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    ...
                    ref MarcaVehiculo, ref DireccionTrans, ref NroBultos, ref Peso, ref PlacaVehiculo, ref CodTipoMantenimiento);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref CodDireccionTransportista, ref CodTipoMantenimiento);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
            }
            catch (Exception ex)
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_comboestado, ref DropDownList ddl_comboformapagoedicion, ref DropDownList ddl_comboguiaedicion,ref DropDownList ddl_empleado,
            ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_VendedorEdicion, ref DropDownList ddl_TipoTransportista,ref DropDownList ddl_TipoTransportistaEdicion,
            ref DropDownList ddl_CodunidadPeso, ref DropDownList ddl_CodunidadPesoedicion, ref DropDownList ddl_Almacen, ref DropDownList ddl_TipoMantenimiento, 
            ref DropDownList ddl_TipoMantenimientoEdicion)
        {
            ...
            dta_consulta = null;
            objEntidadConceptosDet.CodConcepto = 19;
            dta_consulta = objOperacionConceptosDet.F_TCConceptos_Select(objEntidadConceptosDet);

            ddl_TipoMantenimiento.Items.Clear();
            
            ddl_TipoMantenimiento.DataSource = dta_consulta;
            ddl_TipoMantenimiento.DataTextField = "DscAbvConcepto";
            ddl_TipoMantenimiento.DataValueField = "CodConcepto";
            ddl_TipoMantenimiento.DataBind();

            ddl_TipoMantenimientoEdicion.Items.Clear();
                                 
            ddl_TipoMantenimientoEdicion.DataSource = dta_consulta;
            ddl_TipoMantenimientoEdicion.DataTextField = "DscAbvConcepto";
            ddl_TipoMantenimientoEdicion.DataValueField = "CodConcepto";
            ddl_TipoMantenimientoEdicion.DataBind();
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodDocumentoVenta, ref Int32 CodTraslado)
        {
            ...
            objEntidad.CodTipoMantenimiento = Convert.ToInt32(objTablaFiltro["Filtro_CodTipoMantenimiento"]);
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 16: //Nota de Venta
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Salazar(objEntidad);
                    MsgError = objEntidad.MsgError;
                ...
                default: //Facturas y Boletas
                    if (Convert.ToInt32(objTablaFiltro["Filtro_NotaPedido"]) == 0)
                            objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Salazar(objEntidad); //Insert Normal
                        else
                            objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Salazar(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento, ref Int32 FormaPago, ref String Placa1,
                             ...
                             ref int FlagConCodigo, ref String RucTransportista, ref String ObservacionGuia, ref String Observacion, ref Int32 CodEmpleado, 
                             ref Int32 CodDireccionDestino, ref int CodDireccionTransportista, ref int CodTipoMantenimiento)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_Datos_Salazar(objEntidad);
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                    ...
                    CodTipoMantenimiento = Convert.ToInt32(dta_consulta.Rows[0]["CodTipoMantenimiento"]);  
             }
        }
        ...
        public void P_EdicionFactura(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_EdicionFactura_Salazar(objEntidad);
        ...
        ref Int32 CodTipoMantenimiento)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                CodTipoMantenimiento = Convert.ToInt32(dtTabla.Rows[0]["CodTipoMantenimiento"]);               
            }
        }
