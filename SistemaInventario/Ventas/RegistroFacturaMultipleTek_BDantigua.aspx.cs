...
{
    public partial class RegistroFacturaMultipleTek_BDantigua : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_PasaraNuevoSistema_NET);
        }
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_DocumentoVentaDet_Listar_Antiguo(objEntidad);
                grvDetalle.DataBind();
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ref ddlTipoDoc, ref ddlTipoDoc2, ref ddlSerieNV, ref ddlEstado, ref ddlFormaPagoEdicion, ref ddlSerieGuiaEdicion,
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlSerieCotizacion, ref ddlVendedorEdicion, ref ddlTipoTransportista, ref ddlTipoTransportistaEdicion, ref ddlcodunidadpeso, ref ddlcodunidadpesoedicion);
            ...
            str_resultado =
                ...
                str_ddl_EstadoConsultaNP_html;//33
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    ...
                    ref MarcaVehiculo, ref DireccionTrans, ref NroBultos, ref Peso, ref PlacaVehiculo, ref Observacion,ref CodDireccion);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref NroOperacion, ref Observacion, ref CodCtaCte, ref RucTransportista, ref Placa, ref Marca, ref Licencia,
                                               ref NroBultos, ref Peso, ref CodConductor, ref DNIConductor, ref NombreConductor,ref NombreAgencia,
                                               ref GuiaAgencia, ref ClaveAgencia, ref Celular, ref ObservacionGuia, ref Codireccion, ref CodireccionTransportista);
            ...
            str_resultado =
                ...
                OrdenCompra + "~" + //16
                Recepcion + "~" + //17
                FlagComisionable.ToString() + "~" + //18
                str_ddlSerieGuiaEdicion_html + "~" + //19
                CodEmpresa + "~" +//20
                Motorizado + "~" +//21
                NroOperacion + "~" +//22
                Observacion + "~" +//23
                CodCtaCte.ToString() + "~" +  //24
                RucTransportista + "~" + //25
                Placa + "~" + //26
                Marca + "~" + //27
                Licencia + "~" + //28
                ...
                Celular + "~" +//37
                ObservacionGuia + "~" + //38
                Codireccion.ToString() + "~" + //39
                CodireccionTransportista.ToString();//40
            return str_resultado;
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_seriecotizacion, ref DropDownList ddl_VendedorEdicion, ref DropDownList ddl_TipoTransportista, ref DropDownList ddl_TipoTransportistaEdicion, ref DropDownList ddl_CodunidadPeso, ref DropDownList ddl_CodunidadPesoedicion)
        {
            ...
            dta_consulta = objOperacionTCDocumentos.F_TCDocumentos_ListarFacturacion_Antiguo();
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("CodArchivoSunatXMLDOCUMENTOVENTA", typeof(string));
            dta_consulta.Columns.Add("CodArchivoSunatXMLTRALADO", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref Int32 CodTraslado)
        {
            ...
            {
                case 5:
                    objEntidad.CodTipoCliente = 1;
                    objEntidad.CodClaseCliente = 1;
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_TEK(objEntidad);
                    MsgError = objEntidad.MsgError; Codigo = objEntidad.CodDocumentoVenta; CodTraslado = 0;
                    break;
                case 16:
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_TEK(objEntidad);
                    MsgError = objEntidad.MsgError;
                ...
                default:
                    if (objEntidad.NotaPedido == 0)
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_TEK(objEntidad);
                    else
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_TEK(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objEntidad.CodAlmacen = Convert.ToInt32(Session["CodSede"]);
            objEntidad.CodAlmacenGeneral = Convert.ToInt32(Session["CodSede"]);
            objEntidad.CodEmpresa = Convert.ToInt32(Session["CodSede"]);
            objEntidad.CodEmpresaGeneral = Convert.ToInt32(Session["CodSede"]);
            objEntidad.CodEstado = Convert.ToInt32(objTablaFiltro["Filtro_CodEstado"]);
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_Listar_BDantigua(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,ref Int32 FormaPago,ref String Placa1,
                            ...
                            ref String Fecha,ref Int32 CodTransportista, ref String Transportista,ref String KM, ref String OrdenCompra, ref String Recepcion,  
                            ref Int32 FlagComisionable,ref Int32 CodEmpresa,ref Int32 Motorizado, ref string NroOperacion, ref String Observacion,ref Int32 CodCtaCte,
                            ref String RucTransportista, ref String Placa, ref String Marca, ref String Licencia, ref String NroBultos, ref String Peso, 
                            ref Int32 CodConductor,ref String DNIConductor, ref String NombreConductor, ref String NombreAgencia, ref String GuiaAgencia,
                            ref String ClaveAgencia, ref String celular, ref String ObservacionGuia, ref Int32 CodDireccion, ref Int32 CodDireccionTransportista)   
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                celular = Convert.ToString(dta_consulta.Rows[0]["celular"]);
                ...
                try
                {
                    ...
                    CodDireccionTransportista = Convert.ToInt32(dta_consulta.Rows[0]["CodDireccionTrans"]);
                    ...
                    try { CodConductor = Convert.ToInt32(dta_consulta.Rows[0]["Codconducto"]); }
                    catch (Exception) { }
        ...
        ref String MarcaVehiculo, ref String DireccionTrans, ref String NroBultos, ref String Peso, ref String PlacaVehiculo, ref String Observacion, ref Int32 CodDireccion)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
        ...
        public String F_PasaraNuevoSistema_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            Hashtable obj_parametros = null;
            ...
            F_PasaraNuevoSistema(obj_parametros);
        ...
        public void F_PasaraNuevoSistema(Hashtable objTablaFiltro)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            {
                XmlDetalle = XmlDetalle + "<D ";
                XmlDetalle = XmlDetalle + " CodDocumentoventa = '" + item.Codigo + "'";
                XmlDetalle = XmlDetalle + " />";
            }
            ...
            objOperacion.F_PasaraNuevoSistema(objEntidad);
        }
    }
}
