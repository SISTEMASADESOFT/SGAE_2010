var AppSession = "../Ventas/RegistroFacturaMultiplexml.aspx";
var Codtipodoc=1
var CodigoMenu = 4000;
var CodigoInterno = 2;
var CodCategoria = 1;
...
//            $('#MainContent_chkSinIgvMaestro').prop('disabled',true);
    ...
    $('#MainContent_btnDescargarXML').click(function () {
    if (!F_SesionRedireccionar(AppSession)) return false;
     try 
        {
          F_DescargarArchivosXMLGRUPAL();
          return false;
        }
...
function F_GrabarDocumento(){
  try 
        ...
        var objParams = {
            ...
            Filtro_ComisionTarjeta: ComisionTarjetaFinal,            
            Filtro_CodDocumentoVentaDireccion: $('#MainContent_ddldireccionNueva').val(), 
            Filtro_NotaPedido: $('#hfCodigoTemporal').val(),
       ...
       try 
        {
              ...
              var objParams = {
                                ...
                                Filtro_Conexion: $('#MainContent_ddlConexion').val()
                               };
...
function F_DescargarArchivosXMLGRUPAL () {

 var DocumentoventaCab = {};
                 DocumentoventaCab["Codigos"] ;
                       
  
    DocumentoventaCab["Conexion"]   =  $('#MainContent_ddlConexion').val();    
      $('#MainContent_grvConsulta .chkDelete :checkbox').each(function () {
                chkDel = '#' + this.id;
                lblCodigo = chkDel.replace('chkxml', 'lblCodigo');
                if ($(chkDel).is(':checked') ) {
                 DocumentoventaCab["Codigo"] = $(lblCodigo).val(); 
                   DocumentoventaCab["TipoDocumento"]   =  'ENVIO';  
                 ...
                 //descargo el XML ENVIO
                     $.ajax({
                         ...
                         type: 'POST',
                         contentType: "application/json; charset=utf-8",
                         url: '../Servicios/Stocks.asmx/DescargarDocumentosSunatGrupal',
                         dataType: "json",
                  ...
                  DocumentoventaCab["TipoDocumento"]   =  'RPTA';  
                    //descargo el CDR RPTA
                   $.ajax({
                  async: true,
                  type: 'POST',
