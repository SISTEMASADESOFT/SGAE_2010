...
{
    public partial class RegistroCotizacionesStandard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Label5.Text = "SE GRABO CORRECTAMENTE";
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv,
                    ...
                    ref ddlCompraEdicion, ref ddlFamiliaEdicion, ref dllUsuarionNP, ref dllSucursal);
            ...
            str_dllUsuarionNP_html + "~" + //22
            str_dllSucursal_html; //23
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
         ...
         //   DocumentoVentaCabCN objOperacion = new DocumentoVentaCabCN();
          ...
          //  P_GrabarDocumento_Excel_Plus();
            ProformaCabCE resultado = P_GrabarDocumento_Excel_Plus();
           ...
           // Label5.Text = Mensaje;
            ...
            if (resultado == null || resultado.MsgError != "Se Grabo Correctamente")
            {
                if (resultado != null && !string.IsNullOrEmpty(resultado.MsgError))
                    Label5.Text = "ERROR AL GRABAR DOCUMENTO";
        ...
        public ProformaCabCE P_GrabarDocumento_Excel_Plus()
        {
            ...
            objEntidadProforma.CodMoneda = Convert.ToInt32(hfCodMonedaCotizacion.Value);
        ...
        public void P_DetalleNP(Hashtable objTablaFiltro, ref GridView grvDetalleNP)
        {
            ...
            dta_consulta = objOperacion.F_ItemNP_Listar_Cotizacion(objEntidad);
