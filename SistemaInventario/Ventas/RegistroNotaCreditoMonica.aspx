<%@ Page Title="Nota de Credito-Venta" Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="RegistroNotaCreditoMonica.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroNotaCreditoMonica" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroNotaCreditoMonica.js"        charset="UTF-8"></script> 
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                     <tr style = "display:none;">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td >
                                            <asp:TextBox ID="txtVencimiento" runat="server" Width="55px" CssClass="Jq-ui-dtp"  Enabled="False"
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-left: 11px; font-weight: bold">
                                        ...
                                        <td style="display: none;">
                                            <asp:TextBox ID="txtAcuentaNV" runat="server" Width="70px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" CssClass="Derecha" ReadOnly="True" Text="0.00"></asp:TextBox>
                                        </td>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 4px">
                                <asp:TextBox ID="txtObservacion" runat="server" Width="905px" Font-Names="Arial"
            ...
            <div id="div_consulta">
             ...
             <%--           <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                        ...
                        <asp:TemplateField HeaderText="FE">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgPdfFactura" ImageUrl="~/Asset/images/pdf.png" ToolTip="VISUALIZAR NOTA DE CREDITO"
                        ...
                        <asp:TemplateField HeaderText="NC">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgImprimirFactura" ImageUrl="~/Asset/images/imprimir.gif"
                                    ToolTip="IMPRIMIR NOTA DE CREDITO" OnClientClick="F_ImprimirFacturaGrilla(this,213); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <input id="hfCodDocumentoVentaAnulacion" type="hidden" value="0" />
        ...
        <input id="hfCategoriaIgv" type="hidden" value="0" />
