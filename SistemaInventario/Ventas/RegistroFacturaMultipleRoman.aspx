...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0"  >
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtObservacion" runat="server" Width="465px" Font-Names="Arial"
                                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                     <td>
                        ...
                        <div id="div_grvDetalleArticulo">
                            <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Precio" Visible=false ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtPrecio" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                CssClass="ccsestilo" Font-Names="Arial"  ReadOnly="True" ForeColor="Blue" Text='<%# Bind("Precio") %>'
                                                ></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Desc." Visible=false ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtDescuento" Width="40px" Font-Bold="true" Style="text-align: center;"
                                                CssClass="ccsestilo" Font-Names="Arial"   ReadOnly="True" ForeColor="Blue" Text='<%# Bind("Descuento") %>'
                                                ></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Precio" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtPrecioNeto" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                CssClass="ccsestilo" Font-Names="Arial"  ForeColor="Blue" Text='<%# Bind("PrecioDesc") %>'  
                                                onblur="F_ActualizarPrecio(this.id, 'txtPrecioNeto'); return false;"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <Columns>
                                  ...
                                  <%--  <asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="GR">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgImprimir2" ImageUrl="~/Asset/images/pdf.png" ToolTip="Generar Guia PDF"
                                                OnClientClick="F_VerGuia(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="GR">
                                        <ItemTemplate>
                                            ...
                                            <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                                <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Precio" Visible=false  HeaderText="Precio">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Descuento" Visible=false  HeaderText="Desc.">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>
                                                         <asp:BoundField DataField="PrecioNeto" HeaderText="Precio">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="Numero" HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <%--<asp:Label runat="server" ID="" Text='<%# Bind("Numero") %>' CssClass="detallesart"></asp:Label>--%>
                                            <asp:HyperLink runat="server" ID="lblnumero" Font-Underline="true" ForeColor="Black"
                                                Style="cursor: hand" Text='<%# Bind("Numero") %>' onclick="F_ImprimirDocumento(undefined,this,'lblnumero','ALM'); return false;" 
                                                ToolTip="Ver Archivo "  CssClass="detallesart" >
                                        </asp:HyperLink>
                                        ...
                                        ToolTip="VISUALIZAR FOTOS DEL PRODUCTO" OnClientClick="F_VisualizarRegistro(this); return false;" />
                                            ...
                                            <asp:TemplateField HeaderText="Código">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="hfcosto" runat="server" Value='<%# Bind("CostoConIgv") %>' />
                                            ...
                                            <asp:TemplateField HeaderText="Codigo 2">
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtCodigoProductoAgregar" runat="server" Width="400px" Font-Names="Arial"
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCosto" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ReadOnly="true" Font-Size="16"></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold">
                                            MARGEN
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtMargen" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" Font-Size="16" onblur="F_Actualizarpreciodisplay(this.id, 'txtMargen'); return false;" ></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold">
                                            %
                                        </td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtMargenMinimo" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ReadOnly="true" Font-Size="16"></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold">
                                            %
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox Style="width: 80px; position: absolute; color: blue; font-family: Arial;
                                                ...
                                                Font-Size="16" onblur="F_Actualizarpreciodisplay(this.id, 'txtPrecioDisplay'); return false;"></asp:TextBox>
    ...
    <div id="divClaveMargen" style="display: none">
        <table>
            <tr>
                <td style="font-weight: bold">
                    Usuario Auxiliar
                ...
                <td>
                    <asp:TextBox ID="txtUsuarioMargen" runat="server" Width="98px" Font-Names="Arial"
                        ForeColor="Blue" Font-Bold="True" ToolTip="Ingresar Usuario"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtClaveMargen" runat="server" Width="98px" Font-Names="Arial"
                        ForeColor="Blue" Font-Bold="True" TextMode="Password" ToolTip="Ingresar Contraseña"></asp:TextBox>
                </td>
            </tr>
        </table>
        <div class="linea-button">
            <table>
                <tr>
                    <td>
                        <asp:Button ID="btnCancelarMargen" runat="server" Text="Cancelar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="100" />
                    </td>
                    <td>
                        <asp:Button ID="btnVerificarMargen" runat="server" Text="Aceptar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="100" />
                    </td>
                </tr>
            </table>
 ...
 <div id="div_grvDetalleEdicion" style="padding-top: 5px;Width: 870px;">
    ...
    <input id="hfPrecio2" type="hidden" value="0" />
    <input id="hfMargen" type="hidden" value="0" />
    <input id="hfCodctaWsp" type="hidden" value="0" />
    <input id="hfSerieWsp" type="hidden" value="0" />
    <input id="hfNumeroWsp" type="hidden" value="0" />
    ...
    <input id="hfnombretransportista" type="hidden" value="" />
