var AppSession = "../Ventas/RegistroFacturaMultipleStandardMC.aspx";
var Codtipodoc=1
var CodigoMenu = 4000;
var CodigoInterno = 2;
var CodCategoria = 1;
...
//        }
        ...
        if (F_PermisoOpcion_SinAviso(CodigoMenu, 4000103, '') == 0 & parseFloat($(txtPrecio).val()) == parseFloat($(hfPrecio).val()) & parseFloat($(txtCantidad).val()) == parseFloat($(hfCantidad).val())) {
...
function F_ActualizarCantidad(Fila) {
    try {
        ...
        if (parseFloat($(hfAcuenta).val()) != 0 & parseFloat($(txtCantidad).val()) > parseFloat($(hfCantidadOC).val()) & parseFloat($(hfCantidadOC).val())>0) {
            $(txtCantidad).val(parseFloat($(hfCantidad).val()).toFixed(2));
            return false;
        }
