var AppSession = "../Ventas/RegistroCotizacionesSanli.aspx";
    ...
    try {
        ...
        if (parseFloat($(hfExclusivo).val())>0)
            ...
            FlagPrecio=1;
              ...
              if (F_PermisoOpcion_SinAviso(CodigoMenu, 4000208, '') == 0 & parseFloat($(hfCosto).val())>=parseFloat($(txtPrecio).val()) & parseFloat($(hfCosto).val())>0 )
            {
