<%@ Page Title="Solicitudes de descuentos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SolicitudDescuentoReeim.aspx.cs" Inherits="SistemaInventario.Ventas.SolicitudDescuentoReeim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="SolicitudDescuentoReeim.js"
        charset="UTF-8"></script>
                        ...
                        <div id="div_grvDetalleArticulo" style="padding-top: 5px;">
                            <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                   ...
                                   <%-- <asp:BoundField DataField="Almacen" HeaderText="Alm."  Visible="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:BoundField>--%>
                                 <%--   <asp:BoundField DataField="Solicitante" HeaderText="Vend."  Visible="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:BoundField>--%>
                                    <asp:BoundField DataField="CodigoProducto" HeaderText="Codigo">
                                      ...
                                      <asp:BoundField DataField="COdigoReem" HeaderText="Codigo Reem">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="Marca" HeaderText="Marca">
                                     ...
                                     <asp:BoundField DataField="P1" HeaderText="Pre.Min">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="P2" HeaderText="Pre.Sug">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="ValorVenta" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
