                                ...
                                <asp:ImageButton runat="server" ID="imgDireccion" ImageUrl="../Asset/images/add_small.png"
                                        ...
                                        <td id="Td1">
                                            <asp:TextBox ID="txtKM" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                                    ...
                                                    <td style="font-weight: bold;">
                                                                <asp:CheckBox ID="chkOC" runat="server" Text="Orden Compra" Font-Bold="True" />
                                                    </td>
                                                    <td>
                                 ...
                                 Observacion
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                                                           <asp:TextBox ID="txtObservacion" runat="server" Width="921px" Font-Names="Arial"
                                                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                    </tr>
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtNumeroConsulta" runat="server" Width="80" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                            </td>
                                            <td>
                ...
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 250px;
                    ...
                    <div id="div2" class="ui-jqdialog-content">
                        ...
                        <div id="div_table_almacenes">
                            <div>
                                <table id="table_almacenes_deudas" cellpadding="0" cellspacing="0" style = "display:none;">
                                    <tr>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                           ...
                                           <td style="font-weight: bold;display:none;">
                                <asp:CheckBox ID="CheckBox1" runat="server" Text="Servicios" Font-Bold="True" />
                            </td>
                                    </tr>
                                </table>
                            </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtFechaTrasladoEdicion" runat="server" Width="55px" CssClass="Jq-ui-dtp"
                                                      ReadOnly="True"  Font-Names="Arial" ForeColor="Blue" Font-Bold="True" Enabled="False"></asp:TextBox>
                                                </td>
