...
{
    public partial class RegistroFacturaMultipleKuyay : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value != "")
                {
                    ...
                    dta_consultaarticulo.Columns.Add("Procedencia", typeof(string));

                    dta_consultaarticulo.Columns.Add("FechaCaducidad", typeof(DateTime));
                    dta_consultaarticulo.Columns.Add("Marca", typeof(string));
                    dta_consultaarticulo.Columns.Add("RegistroSanitario", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("Vencimiento", typeof(DateTime));
            dta_consultadetalle.Columns.Add("Lote", typeof(string));
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " Lote = '" + item.Lote + "'";
                DateTime vencimientoParsed = DateTime.MinValue;
                string vencimientoXml = "";

                if (item.Vencimiento != null && DateTime.TryParse(item.Vencimiento.ToString(), out vencimientoParsed))
                {
                    vencimientoXml = vencimientoParsed.ToString("yyyy-MM-dd");
                }
                
                XmlDetalle += " Vencimiento = '" + vencimientoXml + "'";
                XmlDetalle += " />";
            ...
            switch (objEntidad.CodTipoDoc)
            {
                ...
                default: //Facturas y Boletas
                        if (Convert.ToInt32(objTablaFiltro["Filtro_NotaPedido"]) == 0)
                            objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Standard(objEntidad); //Insert Normal
                        else
        ...
        public void P_ActualizarPrecios(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.Lote = Convert.ToString(objTablaFiltro["Filtro_Lote"]);

            objOperacion = new DocumentoVentaDetCN();

            objOperacion.F_TemporalFacturacionDet_Update_Factura_Kuyay(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        , ref  Direccion, ref  Ubigeo, ref  Codigo, ref DireccionTransportista, ref CodDireccionTransportista);
        ...
        public void P_FacturacionGuia(Hashtable objTablaFiltro, ref String Mensaje, ref Int32 CodTraslado, ref String Serie,
           ...
           , ref String UbigeoTransportista, ref Int32 NroBultos, ref Decimal Peso, ref Int32 CodConductor, ref String NroConductor
       ...
       , ref String Direccion, ref String Ubigeo, ref Int32 Codigo, ref String DireccionTransportista, ref Int32 CodDireccionTransportista)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                Transportista = Convert.ToString(dta_consulta.Rows[0]["Transportista"]);
                UbigeoTransportista = Convert.ToString(dta_consulta.Rows[0]["UbigeoTransportista"]);
                ...
                Ubigeo = Convert.ToString(dta_consulta.Rows[0]["Ubigeo"]);
                DireccionTransportista = Convert.ToString(dta_consulta.Rows[0]["DireccionTransportista"]);
                CodDireccionTransportista = Convert.ToInt32(dta_consulta.Rows[0]["CodDireccionTransportista"]); // Dirección específica
