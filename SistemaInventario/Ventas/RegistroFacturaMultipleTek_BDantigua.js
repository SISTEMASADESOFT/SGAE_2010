var AppSession = "../Ventas/RegistroFacturaMultipleTek_BDantigua.aspx";
...
$(document).ready(function () {
      ...
      $('#MainContent_txtNroRuc').autocomplete(   
    {
        ...
        select: function (e, i) {    
            ...
            $('#MainContent_txtCliente').val(i.item.RazonSocialSola);
            ...
            ,'#MainContent_txtCliente',0,Ubigeo,Direccion,'#MainContent_ddldireccionNueva','#MainContent_ddldireccionNuevaDestino','');
      },
            close: function () {
  ...
  F_GuardarDireccion($('#MainContent_txtNroRucTransportista').val(),'#hfCodigoTemporal',$('#hfCodCtaCteTransportista').val()
            ,'#MainContent_txtTransportista',1,Ubigeo,Direccion,'#MainContent_ddldireccionNuevaTransportista','');
     ...
     $('#MainContent_txtNroRucTransportistaEdicion').autocomplete(   
    {
        ...
        select: function (e, i) {
            ...
            $('#hfTransportistaEdicion').val(i.item.RazonSocialSolo);
            $('#MainContent_txtTransportistaEdicion').val(i.item.RazonSocialSolo);
    ...
    $('#MainContent_txtConductorDNI').blur(function () {
        var Datos='';
        if($('#MainContent_txtConductorDNI').val().indexOf('-') > -1)
           Datos = $('#MainContent_txtConductorDNI').val().split('-');
        ...
        var Datos='';
        if($('#MainContent_txtConductorDNIEdicion').val().indexOf('-') > -1)
           Datos = $('#MainContent_txtConductorDNIEdicion').val().split('-');
    ...
    $("#MainContent_txtNroRucTransportistaEdicion").bind("propertychange change keyup paste input", function(){
        if ($("#MainContent_txtNroRucTransportistaEdicion").val() != $("#hfNroRucTransportistaEdicion").val() & $("#hfCodCtaCteTransportistaEdicion").val() != '0')
        {
    ...
    $('#MainContent_btnDescargarCDR').click(function () {
        try {
        if ($('#hfCodArchivoSunatXMLDOCUMENTOVENTA').val()!=0){
            F_DownloadArchivoXML($('#hfCodArchivoSunatXMLDOCUMENTOVENTA').val());
            }

             if ($('#hfCodArchivoSunatXMLTRALADO').val()!=0){
            F_DownloadArchivoXML($('#hfCodArchivoSunatXMLTRALADO').val());
            }
...
//           $('.Jq-ui-dtp').datepicker('setDate', new Date());
   ...
   // if (F_PermisoOpcion(CodigoMenu, 4000203, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
    ...
    $('#MainContent_BtnAntiguaBD').click(function () {
     if (!F_SesionRedireccionar(AppSession)) return false;
        try {            
              F_PasaraNuevoSistema();
              return false;
        }
        catch (e) {
            alertify.log("Error Detectado: " + e);
...
$(document).on("change", "select[id $= 'MainContent_ddlMonedaLC']",function () {
 ...
 $(document).on("change", "select[id $= 'MainContent_ddlTipoTransportistaEdicion']",function () {
         BloqueoTipoTransportista($(Cuerpo + 'ddlSerieGuiaEdicion option:selected').text(),(Cuerpo + 'txtNumeroGuiaEdicion'),(Cuerpo + 'txtFechaTrasladoEdicion')
                 ...
                 ,$('hfCodConductor').val(),'#MainContent_ImageButton3','#MainContent_ImageButton4','#MainContent_chkGuiaEdicion');
});
        ...
        $.ajax({
            ...
            success: function (dbObject) {
                ...
                $('#td_loading').css('display', 'none');
                    ...
                    F_GuardarDireccion($('#MainContent_txtNroRuc').val(),'#hfCodigoTemporal',$('#hfCodCtaCte').val(),
 '#MainContent_txtCliente',0,ubigeo,direccion.replace(distrito, ""),'#MainContent_ddldireccionNueva','#MainContent_ddldireccionNuevaDestino');
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('Div_EstadoNP', result.split('~')[33]);
            ...
            var Cadena = 'Ingresar los sgtes. Datos:'; 
             ...
             if ($(Cuerpo + 'ddlVendedor').text()==null)
                    ...
                    Cadena=Cadena + '<p></p>' + 'Vendedor';
                     ...
                     if ($(Cuerpo + 'ddldireccionNueva').val()==null)
...
function F_GrabarDocumento(){
  try 
        ...
        $('#MainContent_grvDetalleArticulo .chkDelete :checkbox').each(function () {
               chkSi = '#' + this.id;
               if ($(chkSi.replace('chkEliminar', 'hfCodTipoDoc')).val()==5 || $(chkSi.replace('chkEliminar', 'hfCodTipoDoc')).val()==16)
               {
               $('#hfNotaPedido').val(1);
               }         
        });
       ...
       try 
        {
              ...
              var objParams = {
                                ...
                                Filtro_CodestadoNP: $('#MainContent_ddlEstadoConsultaNP').val(),
                                Filtro_CodEstadSunat: $('#MainContent_ddlEstadoConsulta').val()
                               };
...
function F_EditarRegistro(Fila) {
 ...
 try 
    ...
    F_DatosFactura_NET(arg, function (result) {
                    ...
                    $('#hfCodtipodoc').val($(hfcodtipodoc_grilla).val());  
                    if ($(hfcodtipodoc_grilla).val()!=16){
                    ...
                    $('#hfCodTransportista').val(result.split('~')[13]);
                    $('#MainContent_txtTransportistaEdicion').val(result.split('~')[14]);                               
                    $('#MainContent_txtKMEdicion').val(result.split('~')[15]);
                    $('#MainContent_txtNroOCEdicion').val(result.split('~')[16]);
                    $('#MainContent_txtRecepcion').val(result.split('~')[2]);                       
                    $('#MainContent_ddlSerieGuiaEdicion').css('background', '#FFFFE0');  
                    $('#MainContent_ddlEmpresaEdicion').val(result.split('~')[20]);
                    $('#MainContent_txtNroRucTransportistaEdicion').val(result.split('~')[25]);          
                    ...
                    $('#hfCodConductor').val(result.split('~')[31]);
                    $('#MainContent_txtConductorDNIEdicion').val(result.split('~')[32]);
                    $('#MainContent_txtConductorRazonSocialEdicion').val(result.split('~')[33]);              
                    $('#MainContent_txtNombreAgencia').val(result.split('~')[34]);
                    $('#MainContent_txtGuiaAgencia').val(result.split('~')[35]);
                    $('#MainContent_txtClaveAgencia').val(result.split('~')[36]);
                    $('#MainContent_txtcelularEdicion').val(result.split('~')[37]);
                    $('#MainContent_txtObservacionGuiaEdicion').val(result.split('~')[38]);
                    ...
                    $('#MainContent_txtNroOperacionEdicion').val(result.split('~')[26]);
                    $('#MainContent_txtobservacionEditar').val(result.split('~')[27]);
                    $('#hfCodCtaCteEdicion').val(result.split('~')[24]);     
                  ...
                  if ($('#hfCodTransportista').val()>0)
                  {
                      ...
                      BuscarDireccionCotizacion('#hfCodigoTemporalEdicion',result.split('~')[39],'#MainContent_ddldireccionNuevaDestinoEdicion','');                                                      
                  }
                  else
                  {
                      F_GuardarDireccion($('#hfNroRucCliente').val(),'#hfCodigoTemporalEdicion',$('#hfCodCtaCteEdicion').val(),'#MainContent_txtClienteEditar',
...
//function F_ImprimirFactura(Codigo,CodMenu,TipoImp) {
        ...
        var tasaigv = parseFloat($("#MainContent_ddlIgv option:selected").text()) + parseFloat(1);
                ...
                F_AgregarTemporal_NET(arg, function (result) {
                    ...
                    if (result.split('~')[2] == "Los Producto(s) se han agregado con exito") {
                        ...
                        $('#MainContent_txtCelular').val(data.Celular);
                        ...
                        Ubigeo,Direccion,'#MainContent_ddldireccionNueva','#MainContent_ddldireccionNuevaDestino','');
...
//                    $('#hfCodigoTemporal').val(result.split('~')[2]);
  ...
  F_GuardarDireccion($('#MainContent_txtNroRuc').val(),'#hfCodigoTemporal',$('#hfCodCtaCte').val()
            ,'#MainContent_txtCliente',0,Ubigeo,Direccion,'#MainContent_ddldireccionNueva','#MainContent_ddldireccionNuevaDestino','');
                    ...
                    BuscarDireccionCotizacion('#hfCodigoTemporal',result.split('~')[37],'#MainContent_ddldireccionNueva','#MainContent_ddldireccionNuevaDestino');
...
function F_VerArchivoCDR (Control) {
    ...
    CodArchivoSunatXMLDOCUMENTOVENTA =  Control.replace('lblnumero', 'hfCodArchivoSunatXMLDOCUMENTOVENTA');
    CodArchivoSunatXMLTRALADO =  Control.replace('lblnumero', 'hfCodArchivoSunatXMLTRALADO');
    ...
    $('#hfCodArchivoSunatXMLDOCUMENTOVENTA').val($(CodArchivoSunatXMLDOCUMENTOVENTA).val());
    $('#hfCodArchivoSunatXMLTRALADO').val($(CodArchivoSunatXMLTRALADO).val());
...
function F_ImprimirFacturaHTML(Fila) {
    ...
    if (Guia == 0)
    {
        ...
        F_ImprimirDocumento($(Codigo).val(),Fila,'imgPdf2','PDF',$(hfCodTipoDoc).val());
        return false
    }
    else
    {    
...
function F_BuscarPadronSunatTransportista() {
    ...
    if (APITransportista == "Usuario No Encontrado") {
          $.ajax({
            ...
            ,'#MainContent_txtTransportista',1,ubigeoTransportista,direccion.replace(distrito, ""),'#MainContent_ddldireccionNuevaTransportista','');
                }
                catch (x) { }
                MostrarEspera(false);
            },
            ...
            success: function (dbObject) {
                ...
                try {
                    ...
                    if (ubigeoTransportistaEdicion==null){
                     ...
                     F_GuardarDireccion($('#MainContent_txtNroRucTransportistaEdicion').val(),'#hfCodigoTemporalEdicion',$('#hfCodTransportistaEdicion').val(),
                                         '#MainContent_txtTransportistaEdicion',1,ubigeoTransportistaEdicion,direccion.replace(distrito, ""),'#MainContent_ddldireccionNuevaTransportistaEdicion','');
                }
                catch (x) { }
                MostrarEspera(false);
            },
...
function F_DownloadArchivoXML(CodArchivoSunatXML) {

        var datos = API_NET("GET", "api/Ventas/ConsultasVentas/DownloadXML?CodArchivoSunatXML="+CodArchivoSunatXML, undefined);
        console.log(datos.Data)

        var archivos = datos.Data[0]
...
function F_DescargarArchivoXML(CodArchivoSunatXML) {

//var datos = API_NET("POST", "api/Ventas/ConsultasVentas/DownloadXML?CodArchivoSunatXML="+CodArchivoSunatXML, undefined);
...
try{
        ...
        var arg = Sys.Serialization.JavaScriptSerializer.serialize(objParams);
          ...
          MostrarEspera(true);
           F_PasaraNuevoSistema_NET(arg, function (result) {
            MostrarEspera(false);
            ...
            if (str_resultado_operacion == result.split('~')[0]) {
            alertify.log('Los Documento(s) se han agregado con exito');
            }
            else
            {
            alertify.log(result.split('~')[1]);
