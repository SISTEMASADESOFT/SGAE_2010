...
<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="RegistroCotizacioneskuyay.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacioneskuyay" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacioneskuyay.js"   charset="UTF-8"></script>     
        ...
        <tr valign="top">
            <td style="width: 1100px" valign="top">
                    ...
                    <div id="tabRegistro">
                        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="div_Cliente">
                                                        <asp:TextBox ID="txtCliente" runat="server" Width="450px" Font-Names="Arial" ForeColor="Blue"
                                                            ...
                                                            <asp:HiddenField ID="hfCodCtaCteServidor" runat="server" Value="0" />
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Distrito
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtDistrito" runat="server" Width="330px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                             <asp:HiddenField ID="hfCodDepartamento2" runat="server" Value="0" />
                                                             <asp:HiddenField ID="hfCodProvincia2" runat="server" Value="0" />
                                                             <asp:HiddenField ID="hfCodDistrito2" runat="server" Value="0" />
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtEmision" runat="server" Width="56px" CssClass="Jq-ui-dtp" Font-Names="Arial"
                                                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                                                             ...
                                                             <asp:HiddenField ID="hfFormaPago" runat="server" />
                                    ...
                                    <tr>
                                                    ...
                                                    <td style="padding-left: 30px; display:none ">
                                                        <asp:TextBox ID="txtVencimiento" runat="server" Width="56px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" ReadOnly="True"></asp:TextBox>
                                                             <asp:HiddenField ID="hfVencimiento" runat="server" />
                                                    </td>
                                                    <td style="display: none">
                                                        Dscto %
                                                    </td>
                                     ...
                                     <tr>
                                        ...
                                        <tr>
                                        <td>
                                                        <asp:TextBox ID="txtObservacion" runat="server" Width="910px" Font-Names="Arial" ForeColor="Blue"
                                            ...
                                            <td  style = "display:none;">
                                                ...
                                                <asp:HiddenField ID="hfIDExcel" runat="server"  Value="0" />
                                            </td>
                                        </tr>
                            ...
                            <div class="linea-button">
                             <asp:Button ID="btnImport" runat="server" Text="EXCEL" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="120" OnClick="btnImport_Click"  style = "display:none;" />
               ...
               <%--  <asp:TemplateField HeaderText="VCTO" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:TextBox runat="server" ID="txtFechaVencimiento" Width="55px"
                                     Text='<%# Bind("Vencimiento", "{0:dd/MM/yyyy}") %>'
                                      ForeColor="Blue" Font-Bold="True" Font-Names="Arial"
                                     CssClass="Jq-ui-dtp ccsestilo"
               ...
               <table cellpadding="0" cellspacing="0" align="center">
                                ...
                                <asp:Panel ID="pnlOrdersAuditoria" runat="server" Style="display: none">
                                                ...
                                                <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Importe" HeaderText="Importe">
                                                         ...
                                                         <asp:BoundField DataField="FechaCaducidad" HeaderText="VCTO">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="Numero" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hfIDCargaMasivaExcelCab" runat="server" Value='<%# Bind("IDCargaMasivaExcelCab") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                      ...
                      <%--                <asp:TemplateField HeaderText="VCTO" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtFechaCaducidad" Width="55px"
                                                Text='<%# Bind("FechaCaducidad", "{0:dd/MM/yyyy}") %>'
                                                
                                                ReadOnly="True"
                                                 ForeColor="Blue" Font-Bold="True" Font-Names="Arial"
                                                CssClass="Jq-ui-dt ccsestilo"
                                                ></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
--%>
                                ...
                                Codigo
                                        ...
                                        <td style="font-weight: bold">
                                         ...
                                         <td style="padding-left: 5px;">
                                            <asp:TextBox ID="txtFechaVencimiento" runat="server" Width="118px" Height="25" CssClass="Jq-ui-dtp"  
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 698px;height: 450 px">                      
                            ...
                            <tr>
                                ...
                                <td colspan='5'>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtCodigoVisualizacion" runat="server" Width="200px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                            ...
                                            <td style="padding-left: 5px;">
                                                <asp:TextBox ID="txtDescripcionVisualizacion" runat="server" Width="600px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
