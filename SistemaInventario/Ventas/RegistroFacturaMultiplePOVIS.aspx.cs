...
namespace SistemaInventario.Ventas
{
    public partial class RegistroFacturaMultiplePOVIS : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlFormatoImpresion2_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlEmpresa, ref ddlEmpresaConsulta, ref ddlEmpresaEdicion, ref dllvendedorEditor, ref ddlFormatoImpresion2, ref ddlTipoTransportista, ref ddlTipoTransportistaEdicion, ref ddlcodunidadpeso, ref ddlcodunidadpesoedicion, ref ddlVendedorEdicion);
                ...
                str_ddlFormatoImpresion2_html = Mod_Utilitario.F_GetHtmlForControl(ddlFormatoImpresion2);
            ...
            str_resultado =
                ...
                str_ddlFormatoImpresion2_html + "~" + //30
                str_ddl_TipoTransportista_html + "~" + //31
                str_ddl_TipoTransportistaedicion_html + "~" + //32
                str_ddl_CodUnidadpeso_html + "~" + //33
                str_ddl_CodUnidadpesoEdicion_html + "~" + //34
                str_ddlEmpleadoEdicion_html; //35
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_comboempresaedicion, ref DropDownList ddl_empleadoEditar,ref DropDownList ddl_FormatoImpresion2, ref DropDownList ddl_TipoTransportista, ref DropDownList ddl_TipoTransportistaEdicion, ref DropDownList ddl_CodunidadPeso, ref DropDownList ddl_CodunidadPesoedicion, ref DropDownList ddl_empleadoEdicion)
        {
            ...
            dta_consulta = null;
            objEntidadConceptosDet.CodConcepto = 13;
            objEntidadConceptosDet.CodAlmacen= Convert.ToInt32(Session["CodSede"]);
            dta_consulta = objOperacionConceptosDet.F_TCConceptos_Select_Formato_Povis(objEntidadConceptosDet);

            ddl_FormatoImpresion2.Items.Clear();

            ddl_FormatoImpresion2.DataSource = dta_consulta;
            ddl_FormatoImpresion2.DataTextField = "DscAbvConcepto";
            ddl_FormatoImpresion2.DataValueField = "CodConcepto";
            ddl_FormatoImpresion2.DataBind();
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodDocumentoVenta, ref Int32 CodTraslado)
        {
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 16: //Nota de Venta
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Povis(objEntidad);
                    MsgError = objEntidad.MsgError;
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_Listar_Povis(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public static OrdenPedidoCabCE F_ObtenerOrdenPedido_PorNumero_Net(int NumeroOrdenPedido)
        {
            ...
            objEntidad.CodAlmacen = Convert.ToInt32(HttpContext.Current.Session["CodSede"]);
            return objOperacion.F_OrdenPedidoCab_ObtenerXNumero_Povis(objEntidad);
        }
