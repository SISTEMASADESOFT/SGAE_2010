...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tbody>
                        ...
                        DESCRIPCION 2
                                ...
                                <td style = "padding-left:4px">
                                            <asp:TextBox ID="txtDescripcion2Consulta" runat="server" Width="700px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True" Font-Size="16" Enabled="False"></asp:TextBox>
                                        </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 710px;height: 450 px">                      
                       
                        <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix"
                            style="width: 710px">
                            DATOS PRODUCTO
                        </div>
                        <div class="ui-jqdialog-content" style="width: 710px">
                            <table cellpadding="0" cellspacing="0" class="form-inputs">
                            ...
                            <asp:CheckBox ID="chkProductoNuevo" runat="server" Text="Producto Nuevo" Font-Bold="True" Font-Size="Medium" />
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <asp:TextBox ID="txtDescripcionEdicion" runat="server" Width="498px" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                        <td style="font-weight: bold">
                                                    UM 
   ...
   <td style = "padding-left:4px;">
                                                    <asp:TextBox ID="txtMarcaEdicion" runat="server" Width="581px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                </tr>
