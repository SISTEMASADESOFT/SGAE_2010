...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtTotal" runat="server" Width="65px" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td >
                                                        <asp:TextBox ID="txtDescuentoTotal" CssClass="Derecha" runat="server" Width="70px"
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton runat="server" ID="imgAprobarOrdenPedido" ImageUrl="~/Asset/images/ok.gif"
                            ToolTip="PASAR A PENDIENTE" OnClientClick="F_AprobarOrdenPedido_Ventana(this); return false;" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
