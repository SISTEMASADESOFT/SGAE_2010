        ...
        var objParams =
            {
                ...
                Filtro_FlagProductosConStock: 0
            };
...
function F_ValidarGrabarDocumento(){
    try 
        ...
        if ($('#MainContent_ddlTipoDocumento').val() != 23 && $(Cuerpo + 'txtSerie').val() == '')
            Cadena=Cadena + '<p></p>' + 'Serie';

        if ($('#MainContent_ddlTipoDocumento').val() != 23 && ($(Cuerpo + 'txtNumero').val() == '' | $(Cuerpo + 'txtNumero').val() == '00000000'))
...
//            }
            ...
            if ($(hfCodProforma).val() != '') {
                toastr.warning("No se puede Editar las notas de ingreso ");
                return false;
            }    
