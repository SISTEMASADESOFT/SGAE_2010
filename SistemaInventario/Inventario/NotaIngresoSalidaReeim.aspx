<%@ Page Title="Nota de Ingreso" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NotaIngresoSalidaReeim.aspx.cs" Inherits="SistemaInventario.Inventario.NotaIngresoSalidaReeim" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="NotaIngresoSalidaReeim.js" charset="UTF-8"></script>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="font-weight: bold">Impresion</td>
                                        <td>
                ...
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/Eliminar.jpg"
                                    ToolTip="ANULAR NOTA DE INGRESO" OnClientClick="F_AnularPopUP(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                          ...
                          <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgDesConfirmar" ImageUrl="~/Asset/images/refresh-icon.png"
                                    ToolTip="DESCONFIRMAR NOTA INGRESO" OnClientClick="F_DesconfirmarRegistro(this); return false;"  Width="16px" Height="16px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                       ...
                       <asp:BoundField DataField="Proforma" HeaderText="Proforma">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                            ...
                            <div style="overflow-y: scroll; height: 375px;">
                                <div id="div_grvConsultaArticulo" style="padding-top: 5px">
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        ...
                                        GridLines="None" Width="1160px" OnRowDataBound="grvConsultaArticulo_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Pri">
                                              ...
                                              <asp:TemplateField HeaderText="CIE">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblStockcieneguilla" Text='<%# Bind("Stockcieneguilla") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                              <asp:TemplateField HeaderText="VIT">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblStockVitrina" Text='<%# Bind("StockVitrina") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
