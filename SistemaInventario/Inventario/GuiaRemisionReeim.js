var AppSession = "../Inventario/GuiaRemisionReeim.aspx";
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_Destino', result.split('~')[16]);
        ...
        if ($.trim($(Contenedor + 'txtNuBultos').val()) != '')
           ...
           if ($(Contenedor + 'ddlMotivoTrabajo').val()== '9'){
            ...
            CodAlmacenLlegada = $(Contenedor + 'ddlDireccion').val();
             ...
             if ($(Contenedor + 'ddlMotivoTrabajo').val()== '14'){
            CodCtaCte = 5257;
...
function F_ImprimirFacturaPDF(Fila) {
        ...
        var SerieGUIA = ($("#" + Fila.id.replace("imgPdf", "lblNumero")).text()).substring(0,1);
        var NombreTabla = "";
        var NombreArchivo = "";
        ...
        rptURL = rptURL + 'NombreArchivo=' + NombreArchivo + '&';
        rptURL = rptURL + 'CodTipoFormato=' + CodTipoFormato + '&';
        rptURL = rptURL + 'SerieGUIA=' + SerieGUIA + '&';
        window.open(rptURL, "PopUpRpt", Params);
...
function F_Efecto_MotivoTrabajo() {
     ...
     {
        case "7":
            $('#tdConsignacion').css('display', '');
                   $('#tcEntreMismaEmpresa').css('display', 'none');
             
        break;
        case "9":
            $('#tcEntreMismaEmpresa').css('display', '');
              $('#tdConsignacion').css('display', 'none');
...
function F_AgregarTemporalCTxNumero() {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'GuiaRemisionReeim.aspx/F_Obtenernotaingreso_PorNumero_Net',
        dataType: "json",
