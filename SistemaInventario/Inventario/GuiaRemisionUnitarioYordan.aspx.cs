...
{
    public partial class GuiaRemisionUnitarioYordan : System.Web.UI.Page
    {
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_ValidarEstado(obj_parametros, ref str_mensaje_operacion);
        ...
        private void P_ValidarEstado(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            Mensaje = objOperacion.F_DocumentoVentaCab_Validar_Estado(objEntidad).MsgError;
        }
