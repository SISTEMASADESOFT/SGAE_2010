...
//        if ($(Cuerpo + 'txtPartida').val() == $("#MainContent_ddlDestino option:selected").text() & $(Cuerpo + 'txtPartida').val() == )
...
if (!F_SesionRedireccionar(AppSession)) return false;
        ...
        if ($(lblEstado).text() == 'FACTURADO' || $(lblEstado).text() == 'ANULADO' || $(lblEstado).text() == 'RECIBIDO')
