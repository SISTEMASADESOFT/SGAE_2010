...
{
    public partial class GuiaRemisionUnitarioReeim : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(
                        ...
                        ref Referencia, ref CodAlmacenLlegada, ref CodDireccion, ref CodEmpresa, ref CodDireccionDestino, ref NroRuc);
              ...
              ref DropDownList ddl_TipoDocumentoConsulta, ref DropDownList ddl_comboempresa, ref DropDownList ddl_comboempresaconsulta, ref DropDownList ddl_TipoTransportista, ref DropDownList ddl_CodunidadPeso)
        {
            ...
            dta_consulta = objOperacionOperaciones.F_Motivo_Traslado_Listar_Reeim();
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodTraslado, ref Int32 CodProforma)
        {
            ...
            objEntidad.CodDireccionDestino = Convert.ToInt32(objTablaFiltro["Filtro_CodDireccionDestino"]);
            ...
            objEntidad.Placa = Convert.ToString(objTablaFiltro["Filtro_PlacaTraslado"]);
            ...
            objEntidad.CodNotaIngreso = Convert.ToInt32(objTablaFiltro["Filtro_CodNotaingreso"]);

            objOperacion = new TrasladosCabCN();

            objOperacion.F_TrasladosCab_Insert_Reeim(objEntidad);
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref int CodEmpresa, ref int CodDireccionDestino, ref string NroRuc)
        {
            TrasladosCabCE objEntidad = new TrasladosCabCE();
            TrasladosCabCN objOperacion = new TrasladosCabCN();
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                NroRuc = Convert.ToString(dtTabla.Rows[0]["NroRuc"]);
            }
        }
        ...
        public static jqNotaIngresoSalidaCab F_Consulta_Notaingreso_Pendientes_NET(int CodAlmacen)
        {
            ...
            NotaIngresoSalidaCabCE par = new NotaIngresoSalidaCabCE() { CodEmpresa = 3, CodAlmacen = CodAlmacen, CodEstado = 13 };
            data.rows = (new NotaIngresoSalidaCabCN()).F_Notaingreso_ListarXEstado_Reeim(par);
            return data;
        }
        ...
        [WebMethod]
        public static NotaIngresoSalidaCabCE F_Obtenernotaingreso_PorNumero_Net(int NumeroNotaingreso)
        {
            ...
            objEntidad.NumeroDoc = NumeroNotaingreso.ToString();
            return objOperacion.F_NotaingresosalidaCab_ObtenerXNumero_Reeim(objEntidad);
        }
