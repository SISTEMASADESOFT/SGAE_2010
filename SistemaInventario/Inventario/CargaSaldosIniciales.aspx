<%@ Page Title="Registro de Saldo Inicial Excel" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="CargaSaldosIniciales.aspx.cs" Inherits="SistemaInventario.Inventario.CargaSaldosIniciales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CargaSaldosIniciales.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class='overlay'>
        <div class="titulo">
            REGISTRO SALDO INICAL MASIVO POR EXCEL</div>
        <div id="divTabs">
            <ul>
