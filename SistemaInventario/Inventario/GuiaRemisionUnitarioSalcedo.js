var AppSession = "../Inventario/GuiaRemisionUnitarioSalcedo.aspx";
    ...
    try 
        ...
        if ($(Cuerpo + 'txtPartida').val() == '')
            Cadena = Cadena + '<p></p>' + 'Partida';
              ...
              if ($(Cuerpo + 'txtObservacionGuiaEdicion').val().trim() == '')
...
if (!F_SesionRedireccionar(AppSession)) return false;
        ...
        var lblCliente = '#' + imgID.replace('imgAnularDocumento', 'lblCliente');
                         ...
                         if ($(lblNumero).text().substring(0, 4)=='0250' | $(lblNumero).text().substring(0, 4)=='0211' | $(lblNumero).text().substring(0, 4)=='0173' | $(lblNumero).text().substring(0, 4)=='0270')
    {
       toastr.warning('SERIE NO VALIDA, NO SE PUEDE CONFIRMAR');
       return false;
    }   
