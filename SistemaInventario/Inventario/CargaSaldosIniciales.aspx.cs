...
{
    public partial class CargaSaldosIniciales : System.Web.UI.Page
    {
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
            ...
            dtValidacionesProductos = objOperacion.F_SaldoInicialAjustes_VALIDACIONES_EXCEL(Convert.ToInt64(HiddenField1.Value));
        ...
        protected void btnFormato_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtTabla = null;
              ...
              dtTabla = objOperacion.F_ObtenerFormatoSaldoInicial();
              ...
              using (ExcelPackage pck = new ExcelPackage())
              {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    Response.AddHeader("Content-Disposition", "attachment; filename=SaldoInicialFormato.xlsx");
                    ...
                    using (var package = new ExcelPackage(fileInfo))
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(sqlConnectionString))
                        {
                            ...
                            for (int row = worksheet.Dimension.Start.Row + 1; row <= worksheet.Dimension.End.Row; row++)
                            {
                                ...
                                string insertQuery = "INSERT INTO RegistroSaldoInicialExcel (CodAlmacen,CodProducto,Cantidad,Codigo,Observacion,IDPruebasExcelCab,NombreArchivo) " +
        ...
        private bool f_Validacion()
        {
            ...
            DataTable dta_existe = (new DocumentoVentaCabCN()).F_SaldoInicial_VerificaExcel(FileUpload1.FileName.ToString());
        ...
        private void ProcedimientoTrasladar(ref string Mensaje, ref int CodMovimiento)
        {
            ...
            objOperacion.F_RegistroSaldoInicial_Excel_GRABAR(objEntidad);
