<%@ Page Title="Guia Remision" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GuiaRemisionUnitarioRoman.aspx.cs" Inherits="SistemaInventario.Inventario.GuiaRemisionUnitarioRoman" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="GuiaRemisionUnitarioRoman.js" charset="UTF-8"></script>
   ...
   <div id="divTabs" style="width: 1045px">
        ...
        <div id="tabRegistro">
            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                                    ...
                                    <tr>
                                        <td style="font-weight: bold;display:none;">
                                         ...
                                         <asp:DropDownList ID="dllDireccionTransportista" Style="width: 405px" runat="server">
                                            ...
                                            <td style="font-weight: bold;padding-left: 250px;">
                                            Peso
                                        </td>
                                            <td>
                            ...
                            <tr>
                                    <td style="font-weight: bold">
                                         ...
                                         <td>
                                          ...
                                          <tr>
                                                  <td>
                                                                <asp:TextBox ID="txtObservacionGuiaEdicion" runat="server" Width="400" Font-Names="Arial" ForeColor="Blue"
                                                                    Font-Bold="True" ></asp:TextBox>
                                                            </td>
                                          <td style="font-weight: bold;">
                                            Placa
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtLicenciaGuia" runat="server" Width="111" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                    ...
                                    <td style="font-weight: bold">
                                         ...
                                         <td>
                                          ...
                                          <tr>
                                          <td>
                                            <asp:TextBox ID="txtNotaPedido" runat="server" Width="80" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                        </td>
                                   ...
                                   <td style="font-weight: bold; padding-left:20px">
                                        Partida 
                                         ...
                                         <td >
                                            <div id="div_NotaPedido">
                                                <asp:DropDownList ID="ddlNotaPedido" runat="server" Font-Names="Arial" ForeColor="Blue"
                ...
                <asp:Button ID="btnListarPedidos" runat="server" Text="Listar Pedidos." class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemStyle HorizontalAlign="Left" />
                                            ...
                                            <asp:BoundField DataField="UM" HeaderText="UM">
                                             ...
                                             <asp:BoundField DataField="NOTAPEDIDO" HeaderText="NOTAPEDIDO">
