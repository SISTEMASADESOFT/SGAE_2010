<%@ Page Title="Kardex" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KardexKarinaCosto.aspx.cs" Inherits="SistemaInventario.Inventario.KardexKarinaCosto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="KardexKarinaCosto.js" charset="UTF-8"></script>
            ...
            <Columns>
               ...
               <asp:TemplateField HeaderText="Numero">
                ...
                <asp:TemplateField HeaderText="Costo">
                    ...
                    <ItemStyle HorizontalAlign="Right" />
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblCosto" Text='<%# Bind("Costo") %>' CssClass="detallesart1"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="CP Soles">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Right" />
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblCPSoles" Text='<%# Bind("CPSOLES") %>' CssClass="detallesart"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
