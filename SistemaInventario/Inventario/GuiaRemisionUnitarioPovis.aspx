<%@ Page Title="Guia Remision" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GuiaRemisionUnitarioPovis.aspx.cs" Inherits="SistemaInventario.Inventario.GuiaRemisionUnitarioPovis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="GuiaRemisionUnitarioPovis.js" charset="UTF-8"></script>
                                    ...
                                    <tr>
                                        <td style="padding-left: 5px; font-weight: bold">
                                         ...
                                         <asp:TextBox ID="txtFamiliaConsulta" runat="server" Width="175px" Font-Names="Arial"
                                                            ForeColor="Blue" Font-Bold="True" Style="display: none;"></asp:TextBox>
                                         </td>
                                         
                                        <td>
                                            <asp:TextBox ID="txtArticulo" runat="server" Width="640px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                        <td style = "">
