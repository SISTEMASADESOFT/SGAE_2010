<%@ Page Title="Actualizacion Masiva Producto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ActualizacionProductoMasivo_Wong.aspx.cs" Inherits="SistemaInventario.Inventario.ActualizacionProductoMasivo_Wong" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ActualizacionProductoMasivo_Wong.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class='overlay'>
        <div class="titulo">
            ACTUALIZACION MASIVA PRODUCTOS POR EXCEL</div>
        <div id="divTabs">
            <ul>
            ...
            <div id="tabRegistro">
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                    ...
                    <div>
                        ...
                        <table style="width: 100%; border-collapse: collapse; font-family: Arial; font-size: 16px; margin-top: 10px; color: #003366;">
                            <tr style="background-color: #e6f2ff;">
                                <td colspan="2" style="padding: 10px 0; font-weight: bold; border: 1px solid #cce0ff; text-align: center; font-size: 18px;">
                                    🧾 Formato requerido para el archivo Excel:
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="padding: 10px 15px; border: 1px solid #cce0ff; font-size: 18px;">
                                   A = CODIGO UNICO,B = DESCRIPCION, 
                                   C = OBSERVACION, D = MEDIDA,E =CODIGO OEM, 
                                   F = CODIGO FABRICA, G=CODIGO PROVEEDOR,H=OBSERVACION 2 
                                </td>
                            </tr>
                            <tr style="background-color: #f0f8ff;">
                                <td style="padding: 12px 15px; border: 1px solid #cce0ff; width: 50%; font-size: 16px;">
                                    📌  (CODIGOUNICO) debe ser de tipo <strong>texto</strong>.
                                </td>
                                <td style="padding: 12px 15px; border: 1px solid #cce0ff; width: 50%; font-size: 16px;">
                                    📁 Nombre de la hoja: PRODUCTO
                                </td>
                            </tr>
                            <tr style="background-color: #f0f8ff;">
                                <td style="padding: 12px 15px; border: 1px solid #cce0ff; width: 50%; font-size: 16px;">
                                    ⚠️ No deben duplicarse los códigos de producto.
                                </td>
                                <td style="padding: 12px 15px; border: 1px solid #cce0ff; width: 50%; font-size: 16px;">
                                   ❌ Respetar los siguientes indices con sus respectivos espacios , deben estar escritos correctamente
                                 ...
                                 <tr style="background-color: #f0f8ff;">
                                <td style="padding: 12px 15px; border: 1px solid #cce0ff; width: 50%; font-size: 16px;">
                                    ⚠️ Los Espacios en Blancos se omiten 
                                </td>
                                <td style="padding: 12px 15px; border: 1px solid #cce0ff; width: 50%; font-size: 15px;">     
                                         A = CODIGO UNICO    , B = DESCRIPCION   ,   C = OBSERVACION  ,   D = MEDIDA
                                       , E =CODIGO OEM  ,   F= CODIGO FABRICA , G=CODIGO PROVEEDOR , H=OBSERVACION 2 
