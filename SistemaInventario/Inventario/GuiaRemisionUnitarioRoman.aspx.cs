...
{
    public partial class GuiaRemisionUnitarioRoman : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_NotaDePedido_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlMotivoTrabajo, ref str_direccion, ref ddlSerieConsulta,
                    ...
                    ref ddlcodunidadpeso, ref ddlNotaPedido);
                ...
                str_ddl_NotaDePedido_html = Mod_Utilitario.F_GetHtmlForControl(ddlNotaPedido);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combomotivotrabajo,
              ...
              ref DropDownList ddl_TipoDocumentoConsulta, ref DropDownList ddl_comboempresa, ref DropDownList ddl_comboempresaconsulta, ref DropDownList ddl_TipoTransportista, ref DropDownList ddl_CodunidadPeso, ref DropDownList ddlSerieNotaPedido)
        {
            DataTable dta_consulta = null;
            ...
            dta_consulta = null;
            objEntidad.CodTipoDoc = 23;
            objEntidad.CodAlmacen = Convert.ToInt32(Session["CodSede"]);
            objEntidad.CodEmpresa = 3;
            dta_consulta = objOperacion.F_TCCorrelativo_Serie_Select_NotaPedido(objEntidad);

            ddlSerieNotaPedido.Items.Clear();

            ddlSerieNotaPedido.DataSource = dta_consulta;
            ddlSerieNotaPedido.DataTextField = "SerieDoc";
            ddlSerieNotaPedido.DataValueField = "CodSerie";
            ddlSerieNotaPedido.DataBind();
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " CodTrasladoDet = '" + item.CodTrasladoDet + "'";
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodTraslado, ref Int32 CodProforma)
        {
            ...
            objOperacion.F_TrasladosCab_Insert_Roman(objEntidad);
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
        ...
        [WebMethod]
        public static NotaIngresoSalidaCabCE F_Obtener_Pedido_PorNumero_Net(int CodSerie, string NumeroPedido)
        {
            ...
            objEntidad.CodSerie = CodSerie;
            objEntidad.NumeroPedido = NumeroPedido.ToString();
            objEntidad.CodAlmacen = Convert.ToInt32(HttpContext.Current.Session["CodSede"]);
            return objOperacion.F_Obtener_Pedido_PorNumero(objEntidad);
        }


        [WebMethod]
        //busca el stock del almacen especificado
        public static jqProformasResult F_Consulta_Pedido_Pendientes_NET(int CodAlmacen)
        {
            jqProformasResult data = new jqProformasResult();
            NotaIngresoSalidaCabCE par = new NotaIngresoSalidaCabCE() { CodEmpresa = Convert.ToInt32(HttpContext.Current.Session["CodEmpresa"]), CodAlmacen = Convert.ToInt32(HttpContext.Current.Session["CodSede"]), CodEstado = 7 };
            data.rows = (new NotaIngresoSalidaCabCN()).F_Consulta_Pedido_Pendientes_NET(par);
            return data;
        }
