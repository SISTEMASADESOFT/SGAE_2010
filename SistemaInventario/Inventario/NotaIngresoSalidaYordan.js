var AppSession = "../Inventario/NotaIngresoSalidaYordan.aspx";
 ...
 MostrarEspera(true);
    $.ajax({
        ...
        success: function (dbObject) {
            ...
            var data = dbObject.d;
            try {
            if (data.ltrasladosDet && data.ltrasladosDet.length > 0)

            {
                ...
                return true;
                    ...
                    var mensaje = data.Observacion2 ;
                    $('#MainContent_txtMensaje').val(mensaje);
                    toastr.warning(mensaje);
                }
...
//   $("#MainContent_txtSerie").prop('disabled', Valor);
   ...
   $("#MainContent_txtCantidad").prop('disabled', Valor); 
