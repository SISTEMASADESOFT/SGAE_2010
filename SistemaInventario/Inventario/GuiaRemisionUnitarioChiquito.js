    ...
    try 
        ...
        if ($('#MainContent_ddlDestino').val() == null)
            Cadena = Cadena + '<p></p>' + 'Destino';
              ...
              if ($('#MainContent_ddlDireccion').val() == $('#MainContent_ddlDestino').val())
            Cadena = Cadena + '<p></p>' + 'Direccion y destino no pueden ser lo mismo';
...
function F_GrabarDocumento(){
    ...
    try 
        ...
        var objParams = {
                ...
                Filtro_CodDireccionDestino: $(Contenedor + 'ddlDestino').val(),
                Filtro_CodEstado: 6,
                Filtro_TipoCambio: $(Contenedor + 'lblTC').text(),
                Filtro_CodMoneda: 1,
                Filtro_CodTasa: 1,
