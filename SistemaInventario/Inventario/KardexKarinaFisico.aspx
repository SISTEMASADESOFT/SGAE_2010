<%@ Page Title="Kardex" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KardexKarinaFisico.aspx.cs" Inherits="SistemaInventario.Inventario.KardexKarinaFisico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="KardexKarinaFisico.js" charset="UTF-8"></script>
        ...
        <asp:GridView ID="grvKardex" runat="server" AutoGenerateColumns="False" border="0"
            ...
            <Columns>
               ...
               <asp:TemplateField HeaderText="Numero">
                ...
                <asp:BoundField DataField="FechaAnexo" HeaderText="Fecha Anexo" Visible="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
