<%@ Page Title="Nota de Ingreso" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NotaIngresoSalidaKarinaNuevo.aspx.cs" Inherits="SistemaInventario.Inventario.NotaIngresoSalidaKarinaNuevo" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="NotaIngresoSalidaKarinaNuevo.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-left: 2px;">
                                            <asp:TextBox ID="txtObservacion" runat="server" Width="755px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True" ReadOnly="False"></asp:TextBox>
                                        </td>
                                           <td >
                                            <asp:CheckBox ID="chkImpresion" runat="server" Font-Bold="True" checked="true" Text="IMPRIMIR" />
                ...
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <%--            ToolTip="CONFIRMAR NOTA INGRESO" OnClientClick="F_ConfirmarRegistroPopUP(this); return false;" />--%>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgImprimir" ImageUrl="~/Asset/images/imprimir.gif"
                                    ToolTip="IMPRIMIR NOTA INGRESO" OnClientClick="F_VistaPreliminar(this,117); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgPdf" ImageUrl="~/Asset/images/pdf.png" ToolTip="VISUALIZAR PDF"
                                    OnClientClick="F_VistaPreliminar(this,101); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Numero" ItemStyle-Width="75">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfCodAlmacenPartida" runat="server" Value='<%# Bind("CodAlmacenPartida") %>' />
                                <asp:HiddenField ID="hfCodAlmacenLlegada" runat="server" Value='<%# Bind("CodAlmacenLlegada") %>' />  
                                <asp:HiddenField ID="hfCodManual" runat="server" Value='<%# Bind("CodManual") %>' />
                        ...
                        <asp:BoundField DataField="Usuario" HeaderText="Codigos">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField> 
 ...
 <td style="font-weight: bold;display:none;">
    ...
    ui-state-default ui-corner-all ui-button-text-only" Font-Names="Arial" Font-Bold="True" Width="120" />
        ...
        <div id="div_Confirmacion" style="display: none;">
        <div class="ui-jqdialog-content">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td style="font-weight: bold">
                        Observacion de la Nota de Ingreso
                    </td>
                  
                </tr>
                <tr>
                  <td>
                           <asp:TextBox ID="txtObservacionConfirmacion" runat="server" Width="450px" Font-Names="Arial"
                        ForeColor="Blue" Font-Bold="True" TextMode="MultiLine" Height="80"></asp:TextBox>
                    </td>
                ...
                <tr>
                   <td style="font-weight: bold;padding-top:5px;"  align="right">
                        <asp:Button ID="btnConfirmacion" runat="server" Text="CONFIRMAR" class="ui-button ui-widget
            ui-state-default ui-corner-all ui-button-text-only" Font-Names="Arial" Font-Bold="True" Width="120" />
                    </td>
                </tr>
            </table>
    ...
    <input id="hfDireccion" type="hidden" value="" />
        <input id="hfConfirmacion" type="hidden" value="0" />
</asp:Content>
