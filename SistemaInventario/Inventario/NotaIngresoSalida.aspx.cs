...
namespace SistemaInventario.Inventario
{
    public partial class NotaIngresoSalida : System.Web.UI.Page
    {
            ...
            try
            {
               ...
               // P_ValidarFactura(obj_parametros, ref str_mensaje_operacion);
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(
                        obj_parametros,
                        ref Codigo, ref CodFacturaAnterior,ref FechaEmision, ref SerieDoc,
                        ref NumeroDoc, ref CodTipoDoc,ref CodCtaCte, ref RazonSocial, ref CodDireccion,
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            //dta_consulta = objOperacion.F_NotaIngresoSalidaCab_Select_Compras_Nuevo(objEntidad);
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ref int Codigo, ref int CodFacturaAnterior,ref string FechaEmision, 
            ref string SerieDoc, ref string NumeroDoc, ref int CodTipoDoc,ref int CodCtaCte,
            ref string RazonSocial, ref int CodDireccion,ref int CodAlmacen,ref string Observacion,
            ref int CodTipoOperacion, ref int CodMotivoTraslado
           )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
