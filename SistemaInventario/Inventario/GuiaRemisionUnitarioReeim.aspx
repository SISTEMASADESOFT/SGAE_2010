<%@ Page Title="Guia Remision" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GuiaRemisionUnitarioReeim.aspx.cs" Inherits="SistemaInventario.Inventario.GuiaRemisionUnitarioReeim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="GuiaRemisionUnitarioReeim.js" charset="UTF-8"></script>
...
<table>
 <tr  valign="top">
    ...
    <div id="divTabs" style="width: 1020px">
        <ul>
                        ...
                        <tr>
                                    <td style="font-weight: bold">
                                        ...
                                        <td style="padding-left: 24px;">
                                            <asp:TextBox ID="txtPlacaTraslado" runat="server" Width="50" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtLicenciaGuia" runat="server" Width="63" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                         <td style="font-weight: bold">
                                            N.I.
                                         ...
                                         <td>
                                            <asp:TextBox ID="txtNotaingreso" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                         <td style = "display:none;">
 ...
 <td style="font-weight: bold;display:none;">
        ...
        <div class="ui-jqdialog-content">
            <table>
                <tr>
                    ...
                    <td style="padding-left: 5px;">
                        <asp:Button ID="btnTraerNotaIngreso" runat="server" Text="Facturar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
    ...
    <input id="hfcodnotaingreso" type="hidden" value="0" />
    <input id="hfCoddireccionDestino" type="hidden" value="0" />
</asp:Content>
