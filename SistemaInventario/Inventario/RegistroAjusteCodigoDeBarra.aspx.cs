...
{
    public partial class RegistroAjusteCodigoDeBarra : System.Web.UI.Page
    {
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
            ...
            dtValidacionesProductos = objOperacion.F_RegistroAjustes_VALIDACIONES_CODIGOBARRAS(Convert.ToInt64(HiddenField1.Value));
        ...
        protected void btnFormato_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtTabla = null;
              ...
              dtTabla = objOperacion.F_ObtenerFormatoAjusteInventario_Barras();
                    ...
                    using (var package = new ExcelPackage(fileInfo))
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(sqlConnectionString))
                        {
                            ...
                            for (int row = worksheet.Dimension.Start.Row + 1; row <= worksheet.Dimension.End.Row; row++)
                            {
                                ...
                                string insertQuery = "INSERT INTO RegistroAjusteExcel (CodAlmacen,CodProducto,Codigo,IDPruebasExcelCab,NombreArchivo) " +
                                                     "VALUES (@CodAlmacen,@CodProducto,@Codigo,@IDPruebasExcelCab,@NombreArchivo)";

                                using (SqlCommand cmd = new SqlCommand(insertQuery, connection))
                                {
                                    cmd.Parameters.AddWithValue("@CodAlmacen", Convert.ToInt32(Session["CodSede"].ToString()));
                                    cmd.Parameters.AddWithValue("@CodProducto", 0); // El valor 0 como se especifica en el codigo original
                                  //cmd.Parameters.AddWithValue("@Inventario", Inventario); stock
        ...
        private void ProcedimientoTrasladar(ref string Mensaje, ref int CodMovimiento)
        {
            ...
            objOperacion.F_RegistroAjustes_Excel_GRABAR_CODIGOBARRAS(objEntidad);
