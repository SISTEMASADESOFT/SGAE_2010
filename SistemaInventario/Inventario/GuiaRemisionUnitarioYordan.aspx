<%@ Page Title="Guia Remision" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GuiaRemisionUnitarioYordan.aspx.cs" Inherits="SistemaInventario.Inventario.GuiaRemisionUnitarioYordan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="GuiaRemisionUnitarioYordan.js" charset="UTF-8"></script>
