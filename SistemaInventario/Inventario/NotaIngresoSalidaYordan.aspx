<%@ Page Title="Nota de Ingreso" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NotaIngresoSalidaYordan.aspx.cs" Inherits="SistemaInventario.Inventario.NotaIngresoSalidaYordan" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="NotaIngresoSalidaYordan.js" charset="UTF-8"></script>
 ...
 <td style="font-weight: bold;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 2px;">
                                           ...
                                           <td style="display:none" >
                                            <asp:CheckBox ID="chkImpresion" runat="server" Font-Bold="True" checked="false" Text="IMPRIMIR" />
   ...
   <td>
                ...
                <div class="linea-button">
                  ...
                  <%--       <asp:Button ID="btnBuscarGuiaAlmacenExterno" runat="server" Text="Buscar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
...
--%>
                              <asp:TemplateField HeaderText="Cantidad" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox runat="server" Enabled="false" ID="txtCantidad" Width="75px" Font-Bold="true" Style="text-align: center;"
                                    CssClass="ccsestilo" Font-Names="Arial" ForeColor="Blue" Text='<%# Bind("Cantidad") %>'
                                     ></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <div id="div_consulta" style="padding-top: 5px;">
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Motorizado" HeaderText="Motorizado" Visible="false">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>   
                    </Columns>
                            ...
                            <div style="overflow-y: scroll; height: 375px;">
                                <div id="div_grvConsultaArticulo" style="padding-top: 5px">
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        ...
                                        GridLines="None" Width="1120px" OnRowDataBound="grvConsultaArticulo_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
