...
{
    public partial class NotaIngresoSalidaKarinaNuevo : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            {              
                ...
                if (lblCodigo.Value.ToString() != "")
                {
                    ...
                    dta_consulta.Columns.Add("Producto", typeof(string));
                    dta_consulta.Columns.Add("Cantidad", typeof(string));
                    dta_consulta.Columns.Add("UM", typeof(string));
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlIgv, ref ddlSerie, ref ddlMotivoTrabajo, ref str_direccion,
                                         ...
                                         ref ddlTipoDocumento,ref ddlEmpleado, ref ddlEstado);
        ...
        public String F_GrabarDocumento_NET(String arg)
        {
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_GrabarDocumento(obj_parametros, ref MsgError, ref CodMovimiento);
 ...
 objEntidad.CodMovimiento = Codigo;
               grvDetalle.DataSource = objOperacion.F_NotaIngresoInventarioCab_Observacion_Alvarado(objEntidad);
        ...
        public String F_Auditoria_NET(String arg)
        {
            ...
            try
            {
                ...
                NotaIngresoSalidaCabCE objEntidad = new NotaIngresoSalidaCabCE();
  objEntidad.CodMovimiento = Codigo;
              grvAuditoria.DataSource = objOperacion.F_NotaIngresoInventarioCab_AUDITORIA_Alvarado(objEntidad);
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodMovimiento = Codigo;
             grvDetalle.DataSource = objOperacion.F_NotaIngresoInventarioDet_LISTAR_ALVARADO(objEntidad);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda, ref DropDownList ddl_comboigv,
             ...
             ref DropDownList ddl_TipoDocumento, ref DropDownList ddl_Empleado, ref DropDownList ddl_comboestado)
        {
            DataTable dta_consulta = null;
        ...
        public void P_Inicializar_GrillaVacia_ConsultaFactura()
        {
            ...
            dta_consulta.Columns.Add("CodAlmacenPartida", typeof(string));
            dta_consulta.Columns.Add("CodAlmacenLlegada", typeof(string));
            dta_consulta.Columns.Add("Responsable", typeof(string));
            dta_consulta.Columns.Add("CodManual", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodMovimiento)
        {
         ...
         //  objOperacion.F_Transferencias_Insert_Alvarado(objEntidad);
             ...
             objOperacion.F_NotaIngresoInventarioCab_Insert_Karina(objEntidad);

            MsgError = objEntidad.MsgError;
            CodMovimiento = objEntidad.CodMovimiento;
        }
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_NotaIngresoInventarioCab_Listar_Alvarado(objEntidad);
        ...
        public void P_AnularRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
         ...
         //   objOperacion.F_Anulacion_NotaIngreso_Inventario(objEntidad);
            ...
            objOperacion.F_Anulacion_NotaIngresoInventarioCab(objEntidad);
        ...
        public void P_ConfirmarRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objOperacion.F_Confirmacion_NotaIngreso_Traslados_Karina(objEntidad);
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
           ...
           )
        {
            ...
            dtTabla = objOperacion.F_NotaIngresoInventarioCab_Reemplazar_ALVARADO(objEntidad);
        ...
        [WebMethod]
        public static TrasladosCabCE F_ObtenerTraslados_PorID_Net(int CodDireccion, int CodTipoDoc, string SerieDoc, string NumeroDoc)
        {
            ...
            objEntidad.CodDireccion = CodDireccion;
            objEntidad.CodTipoDoc = CodTipoDoc;
            objEntidad.SerieDoc = SerieDoc;
            objEntidad.NumeroDoc = NumeroDoc;
