var AppSession = "../Inventario/NotaIngresoSalidaUnitarioChiquito.aspx";
...
function F_ValidarGrabarDocumento(){
    try 
        ...
        if ($(Cuerpo + 'txtEmision').val()=='')
            ...
            if ($(Cuerpo + 'txtSerie').val()=='' & $(Cuerpo + 'ddlMotivoTrabajo').val() != 14)
            Cadena=Cadena + '<p></p>' + 'Serie';

            if (($(Cuerpo + 'txtNumero').val()=='' | $(Cuerpo + 'txtNumero').val()=='00000000') & $(Cuerpo + 'ddlMotivoTrabajo').val() != 14)
    ...
    if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Editar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        try {
            ...
            var hfCodTipoDoc = '#' + imgID.replace('imgReemplazar', 'hfCodTipoDoc');
             ...
             var hfCodTraslado = "#"+imgID.replace("imgReemplazar","hfCodTraslado");
            ...
            if($(hfCodTraslado).val()!=''){
                toastr.warning("ESTA NOTA DE INGRESO NO PUEDE SER MODIFICADO, SOLO SE PUEDE MODIFICAR LA GUIA EN EL PUNTO DE PARTIDA");
                return false;
            }    
...
if (!F_SesionRedireccionar(AppSession)) return false;
        ...
        var hfCodTraslado = "#"+imgID.replace("imgAnularDocumento","hfCodTraslado");
        ...
        if ($(lblEstado).text()=='CONFIRMADO')
        {
            ...
            return false;
                    ...
                    if($(hfCodTraslado).val()!=''){
                toastr.warning("ESTA NOTA DE INGRESO NO PUEDE SER ANULADA, SOLO SE PUEDE ANULAR LA GUIA EN EL PUNTO DE PARTIDA");
                return false;
            }    
...
function F_EliminarRegistro(Fila) {
 ...
 try 
    ...
    var hfCodTraslado = "#"+imgID.replace("imgEliminarDocumento","hfCodTraslado");
        ...
        if ($(lblEstado).text()=='CONFIRMADO')
        {
            ...
            return false;
                            ...
                            if($(hfCodTraslado).val()!=''){
                toastr.warning("ESTA NOTA DE INGRESO NO PUEDE SER ELIMININADA, SOLO SE PUEDE ELIMINAR LA GUIA EN EL PUNTO DE PARTIDA");
                return false;
            }    
