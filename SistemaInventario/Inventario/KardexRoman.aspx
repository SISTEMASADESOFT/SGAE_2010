<%@ Page Title="Kardex" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KardexRoman.aspx.cs" Inherits="SistemaInventario.Inventario.KardexRoman" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="KardexRoman.js" charset="UTF-8"></script>
                ...
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <asp:TextBox ID="txtArticulo" runat="server" Width="415px" Font-Names="Arial" ForeColor="Blue"
                            ...
                            <td>
                                    <div id="ddlorden">
                                        <asp:DropDownList ID="ddlOrdenamiento" runat="server" Font-Names="Arial" ForeColor="Blue"
                                            ...
                                            <asp:ListItem Value="2" Selected="True">Descendente</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </td>
                                <td style="font-weight: bold">
                                ...
                                <td>
                                    <asp:TextBox ID="txtRazonSocial" runat="server" Width="160px" Font-Names="Arial"
