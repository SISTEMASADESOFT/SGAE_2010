...
{
    public partial class NotaIngresoSalidaReeim : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_DesConfirmarRegistro_Net);
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlIgv, ref ddlSerie, ref ddlMotivoTrabajo, ref str_direccion,
                                         ...
                                         ref ddlTipoDocumento,ref ddlAlmacen);
                ...
                str_ddlPartida_html = Mod_Utilitario.F_GetHtmlForControl(ddlAlmacen);
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(
                        ...
                        ref CodAlmacen, ref Observacion, ref CodTipoOperacion
                        );
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda, ref DropDownList ddl_comboigv,
             ...
             ref DropDownList ddl_TipoDocumento, ref DropDownList ddl_partida)
        {
            DataTable dta_consulta = null;
            ...
            ddl_partida.DataTextField = "DscAlmacen";
            ddl_partida.DataValueField = "CodAlmacen";
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodTraslado, ref Int32 CodigoMov)
        {
            ...
            objEntidad.CodAlmacenPartida = Convert.ToInt32(objTablaFiltro["Filtro_CodAlmacenOrigen"]);
            objEntidad.CodAlmacenLlegada = Convert.ToInt32(objTablaFiltro["Filtro_CodAlmacen"]);
            objEntidad.CodDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]);
            objEntidad.FechaEmision = Convert.ToDateTime(objTablaFiltro["Filtro_FechaEmision"]);
            objEntidad.SerieDoc = Convert.ToString(objTablaFiltro["Filtro_SerieDoc"]);
            objEntidad.NumeroDoc = Convert.ToString(objTablaFiltro["Filtro_NumeroDoc"]);
            ...
            objOperacion.F_Transferencias_Insert_Reeim(objEntidad);

            MsgError = objEntidad.MsgError;
            CodigoMov = objEntidad.CodDocumentoVenta;
            try
            {
                if (Convert.ToString(objTablaFiltro["Filtro_ConexionNombre"]) != "" & MsgError == "Se Grabo Correctamente")
                {
                    string conexionNombre = Convert.ToString(objTablaFiltro["Filtro_ConexionNombre"]);
                    int CodAlmacenRemoto = Convert.ToInt32(objTablaFiltro["Filtro_CodAlmacenRemoto"]);
                    string msg = "";
                    int codigo = 0;
                    P_ActualizarGuiaExterna(objTablaFiltro, ref codigo, ref msg);
                }
            }
            catch (Exception)
            {
        ...
        public String F_Mostrar_Serie_NET(String arg)
        {
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_Mostrar_Serie(obj_parametros, ref Serie);
                int_resultado_operacion = 1;
                str_mensaje_operacion = "";
            }
            catch (Exception ex)
        ...
        public void P_Mostrar_Serie(Hashtable objTablaFiltro, ref String comboserie)
        {
            TCCorrelativoCE objEntidad = null;
            TCCorrelativoCN objOperacion = null;
            DataTable dta_consulta = null;
            ...
            if (dta_consulta.Rows.Count > 0)
                comboserie = Convert.ToString(dta_consulta.Rows[0]["SerieDoc"]);
        }
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref int CodAlmacen, ref string Observacion, ref int CodTipoOperacion
           )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
        ...
        public String F_DesConfirmarRegistro_Net(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvConsulta_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_DesConfirmarRegistro(obj_parametros, ref str_mensaje_operacion);
                if (str_mensaje_operacion == "SE DESCONFIRMO CORRECTAMENTE")
                    P_Buscar(obj_parametros, ref grvConsulta);
                str_grvConsulta_html = Mod_Utilitario.F_GetHtmlForControl(grvConsulta);
                int_resultado_operacion = 1;
            }
        ...
        public void P_DesConfirmarRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
            ...
            //objOperacion.F_Eliminacion_NotaIngreso(objEntidad);
            objOperacion.F_DesConfirmacion_NotaIngreso_Inventario_Reeim(objEntidad);
