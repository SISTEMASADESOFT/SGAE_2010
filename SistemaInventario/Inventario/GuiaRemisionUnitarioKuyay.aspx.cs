...
{
    public partial class GuiaRemisionUnitarioKuyay : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_ActualizarGuia_Net);
        ...
        public String F_ActualizarGuia_Net(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_ActualizarGuia(obj_parametros, ref MsgError);
                Codigo = Convert.ToInt32(obj_parametros["Filtro_CodigoTemporal"]);
                P_CargarGrillaTemporal_Guia(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total);
                if (grvDetalleArticulo.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_DetalleArticulo();
                str_grvDetalleArticulo_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleArticulo);
        ...
        public void P_Inicializar_GrillaVacia_DetalleArticulo()
        {
            ...
            dta_consultadetalle.Columns.Add("Vencimiento", typeof(string));
        ...
        public void P_ActualizarGuia(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaDetCE objEntidad = null;
            DocumentoVentaDetCN objOperacion = null;
           ...
           // objOperacion.F_TemporalFacturacionDet_Update(objEntidad);
          objOperacion.F_TemporalFacturacionDet_Update_Guia(objEntidad);
            // objOperacion.F_TemporalFacturacionDet_Update_Factura_Kuyay(objEntidad);
