...
{
    public partial class CargaProductoMasivo_TRADING : System.Web.UI.Page
    {
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
            ...
            objOperacion.F_LGPRODUCTOS_CARGAMASIVA_NARVAEZ(objEntidad);
                    ...
                    using (var package = new ExcelPackage(fileInfo))
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(sqlConnectionString))
                        {
                            ...
                            for (int row = worksheet.Dimension.Start.Row + 1; row <= worksheet.Dimension.End.Row; row++)
                            {
                                ...
                                string insertQuery = "INSERT INTO CargaMasivaProducto (CODIGOUNICO,DESCRIPCION,MARCA,OBSERVACION,UBICACION,FAMILIA,PRECIO,PRECIO2,PRECIO3,CODMONEDAPRECIO,COSTO,CODMONEDACOSTO,STOCK,IDCargaMasivaExcelCab)" +
                                           "VALUES (@CODIGOUNICO,@DESCRIPCION,@MARCA,@OBSERVACION,@UBICACION,@FAMILIA,@PRECIO,@PRECIO2,@PRECIO3,@MONEDAPRECIO,@COSTO,@MONEDACOSTO,@STOCK,@CodCargaMasivaCab)";

                                using (SqlCommand cmd = new SqlCommand(insertQuery, connection))
                                {
                                    cmd.Parameters.AddWithValue("@CODIGOUNICO", CODIGOINTERNO);
