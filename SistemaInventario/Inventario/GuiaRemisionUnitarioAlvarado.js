var AppSession = "../Inventario/GuiaRemisionUnitarioAlvarado.aspx";
...
//        $('#' + Control + ' option:selected').val($("#" + Control + " option:selected").next().val());
//    }
//    else {
//        $('#' + Control + ' option:selected').val($("#" + Control + " option:selected").prev().val());
//    }
//}

function F_ddlDisplayDown(Control) {
    if ($('#' + Control + ' option:selected').next().length > 0) {
         $('#' + Control).next().prop('selected', 'selected');
    }
    else {
        $('#' + Control).prev().prop('selected', 'selected');
    }
}
...
//    {
//       toastr.warning('SERIE NO VALIDA, NO SE PUEDE MODIFICAR');
//       return false;
//    }   
