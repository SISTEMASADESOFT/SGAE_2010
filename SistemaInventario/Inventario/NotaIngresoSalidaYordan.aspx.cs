...
{
    public partial class NotaIngresoSalidaYordan : System.Web.UI.Page
    {
  ...
  objEntidad.CodMovimiento = Codigo;
        ...
        public void P_AgregarTemporal_GuiaExterna(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError, ref string NroRucProeedor)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (dt.Rows[0]["Estado"].ToString() != "PENDIENTE")
                    {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodMovimiento)
        {
         ...
         //  objOperacion.F_Transferencias_Insert_Alvarado(objEntidad);
             ...
             objOperacion.F_NotaIngresoInventarioCab_Insert_Alvarado(objEntidad);
