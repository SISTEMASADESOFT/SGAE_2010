...
{
    public partial class GuiaRemisionReeim : System.Web.UI.Page
    {
              ...
              ref DropDownList ddl_TipoDocumentoConsulta, ref DropDownList ddl_comboempresa, ref DropDownList ddl_comboempresaconsulta, ref DropDownList ddl_combodestino)
        {
            ...
            objEntidadAlmacen.CodTipoDoc = 4;
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
        ...
        public static NotaIngresoSalidaCabCE F_Obtenernotaingreso_PorNumero_Net(int NumeroNotaingreso)
        {
            ...
            return objOperacion.F_NotaingresosalidaCab_ObtenerXNumero(objEntidad);
        }
