var AppSession = "../Inventario/KardexRoman.aspx";
...
$(document).on("change", "select[id $= 'MainContent_ddlOrdenamiento']", function () {
    F_Buscar();
    $('#MainContent_txtArticulo').focus();
    return false;
});
        ...
        F_Controles_Inicializar_NET
            (
                ...
                function (result) {
                    ...
                    $('#MainContent_ddlOrdenamiento').val(1);
                }
            );
...
//        }
    ...
    var CodMenu = '2001';
    var Pagina = '../Reportes/Web_Pagina_Crystal.aspx';
    var NombreTabla = "Electronica";
    
    if (codtipodocnota == 7) {
        CodMenu = '301'
        Pagina = '../Reportes/Web_Pagina_Crystal_Nuevo.aspx';
