var AppSession = "../Inventario/GuiaRemisionUnitarioWong.aspx";
...
function F_Reporte() {
    ...
    var CodMenu = 3004;
    var Titulo = "REPORTE GUIA DE REMISION";
    var SubTitulo = "DESDE " + $("#MainContent_txtDesde").val() + " HASTA " + $('#MainContent_txtHasta').val();
    var Desde = '19900101';
    var Hasta = '19900101';
    var NombreTabla = "NotaIngreso";
    var NombreArchivo = "Web_Reporte_GuiaRemision.rpt";
    ...
    rptURL = rptURL + 'CodEstado=' + $('#MainContent_ddlEstado').val() + '&';
    rptURL = rptURL + 'CodTipoDoc=' + $('#MainContent_ddlTipoDocConsulta').val() + '&'; 
        ...
        var objParams =
            {
                ...
                Filtro_CodCargo: 0,
                Filtro_CodEstado: 1,
                Filtro_FlagResponsableInventario: 1
            };
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_Empleado', result.split('~')[21]);
                        F_Update_Division_HTML('div_Estado', result.split('~')[22]);
                        ...
                        CodEmpleado = result.split('~')[23];
                        $('#MainContent_ddlEmpleado').val(CodEmpleado);
                 ...
                 ,$('hfCodConductor').val(),(Cuerpo + 'txtMarcaGuia'),'#MainContent_ImageButton1','#MainContent_ImageButton2','#MainContent_chkGuia');
                       $('.ccsestilo').css('background', '#FFFFE0');
                       $('.detallesart2').css('background', '#FFFFE0');  
                       F_InicializarProveedorPorRUC('20536854127');
                     }
                    else {
                        toastr.warning(str_mensaje_operacion);
                    }
...
function F_ValidarGrabarDocumento(){
    try 
        ...
        if ($(Cuerpo + 'ddlEmpleado').val() == 0)
            Cadena = Cadena + '<p></p>' + 'Seleccione Responsable';
...
function F_GrabarDocumento(){
    ...
    try 
        ...
        var objParams = {
                ...
                Filtro_Empleado: $(Contenedor + 'ddlEmpleado').val(),
...
function F_InicializarProveedorPorRUC(ruc) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#hfCodCtaCte').val(row[0]);
            $('#hfNroRuc').val(row[8]);
            $('#hfProveedor').val(row[11]);

            $('#MainContent_txtNroRuc').val(row[8]);
            $('#MainContent_txtProveedor').val(row[11]);
...
function F_AnularRegistro() {
    ...
    try 
        ...
        var objParams = {
                              Filtro_CodTraslado: $('#hfCodDocumentoVentaAnulacion').val(),
                              Filtro_SerieDoc: $("#MainContent_ddlSerieConsulta option:selected").text(),     
                              Filtro_Numero: $('#MainContent_txtNumeroConsulta').val(),
                              Filtro_Desde: $('#MainContent_txtDesde').val(),
                              Filtro_Hasta: $('#MainContent_txtHasta').val(),
    ...
    F_AnularRegistro_Net(arg, function (result) {
        ...
        if (str_mensaje_operacion == "Se anulo correctamente.") {
             ...
             toastr.warning('NO SE PUEDE ANULAR LA GUIA');           
             F_Buscar();     
             $('#div_Anulacion').dialog('close');          
             return false;
        }
