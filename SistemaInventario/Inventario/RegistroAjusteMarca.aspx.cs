...
{
    public partial class RegistroAjusteMarca : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblFecha.Text != "")
                {
                    ...
                    dta_consultaarticulo.Columns.Add("Entrada", typeof(string));
                    dta_consultaarticulo.Columns.Add("Salida", typeof(string));
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                CodigoTransaccion = Convert.ToInt64(obj_parametros["Filtro_Codigo"]);
                ...
                objEntidad.CodigoTransaccion = CodigoTransaccion;

                grvDetalle.DataSource = objOperacion.F_MOVIMIENTOS_LISTAR_AJUSTE_MASIVO_PRODUCTO(objEntidad);
                grvDetalle.DataBind();
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("CodigoTransaccion", typeof(string));
        ...
        public void P_Cargar_Grilla(Hashtable objTablaFiltro, ref GridView grvConsulta)
        {
            ...
            if (Convert.ToInt32(objTablaFiltro["Filtro_Operacion"])==0)
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            switch (Convert.ToInt32(objTablaFiltro["Filtro_Operacion"]))
            {
                case 0:
                    objOperacion.F_LGProductos_Ajuste(objEntidad);
                    break;
                case 1:
                    objOperacion.F_MOVIMIENTOS_AJUSTE_NEGATIVO_CERO(objEntidad);
                    break;
                default:
                    objOperacion.F_MOVIMIENTOS_AJUSTE_TODOS_CERO(objEntidad);
                    break;
            }           
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_MOVIMIENTOS_LISTAR_AJUSTE_MASIVO(objEntidad);
        ...
        public void P_EliminarRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objEntidad.CodigoTransaccion = Convert.ToInt64(objTablaFiltro["Filtro_Codigo"]);
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);

            objOperacion = new NotaIngresoSalidaCabCN();

            objOperacion.F_MOVIMIENTOS_LISTAR_AJUSTE_MASIVO_ELIMINAR(objEntidad);
