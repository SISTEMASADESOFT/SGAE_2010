...
{
    public partial class GuiaRemisionUnitarioWong : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlMotivoTrabajo, ref str_direccion, ref ddlSerieConsulta,
                    ref ddlAlmacen, ref ddlTipoDocumento, ref ddlTipoDocConsulta, ref ddlEmpresa, ref ddlEmpresaConsulta, ref ddlTipoTransportista,
                    ref ddlcodunidadpeso, ref ddlEmpleado, ref ddlEstado);
                ...
                str_ddl_Empleado_html = Mod_Utilitario.F_GetHtmlForControl(ddlEmpleado);
            ...
            str_resultado =
                ...
                Session["NroRuc"].ToString() + "~" + //20;
                str_ddl_Empleado_html + "~" +
                str_ddl_Estado_html + "~" +
                Session["CodEmpleado"].ToString();
        ...
        public String F_AnularRegistro_Net(String arg)
        {
            ...
            try
            {
                ...
                P_ValidarGuia(obj_parametros, ref str_mensaje_operacion);
        ...
        public String F_DireccionTransportista_NET(String arg)
        {
            ...
            try
            {
                ...
                str_ddlDireccionTransportista_html = Mod_Utilitario.F_GetHtmlForControl(dllDireccionTransportista);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(
                        ...
                        ref Referencia, ref CodAlmacenLlegada, ref CodDireccion, ref CodEmpresa, ref CodDireccionDestino);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combomotivotrabajo,
              ...
              ref DropDownList ddl_TipoDocumentoConsulta, ref DropDownList ddl_comboempresa, ref DropDownList ddl_comboempresaconsulta, ref DropDownList ddl_TipoTransportista, ref DropDownList ddl_CodunidadPeso, ref DropDownList ddl_Empleado,
            ref DropDownList ddl_comboestado)
        {
            DataTable dta_consulta = null;
            ...
            dta_consulta = objOperacionTCDocumentos.F_GuiaRemision_Documentos_Listar(objEntidadTCDocumentos);
            ...
            dta_consulta = null;
            dta_consulta = objOperacionTCDocumentos.F_GuiaRemision_GI_NI_Documentos_Listar(objEntidadTCDocumentos);
            ...
            objEmpleado.FlagResponsableInventario = Convert.ToInt32(objTablaFiltro["Filtro_FlagResponsableInventario"]);
            dta_consulta = (new EmpleadoCN()).F_Empleado_Listar_Responsable_Inventario(objEmpleado);
            ...
            ddl_Empleado.Items.Insert(0, new ListItem("----Seleccione----", "0"));

            dta_consulta = null;
            objEntidadConceptosDet.Flag = 5;
        ...
        public void P_Cargar_Grilla(Hashtable objTablaFiltro, ref GridView grvConsulta)
        {
            ...
            objEntidad.DscProducto = Convert.ToString(objTablaFiltro["Filtro_DscProducto"]).Trim();
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodTraslado, ref Int32 CodProforma)
        {
            ...
            objEntidad.CodEmpleado = Convert.ToInt32(objTablaFiltro["Filtro_Empleado"]);
                    
            objOperacion = new TrasladosCabCN();

            //objOperacion.F_TrasladosCab_Insert_Alvarado(objEntidad);
            objOperacion.F_TrasladosCab_Insert_Karina(objEntidad);
        ...
        public void P_LlenarGrillaVacia_ConsultaArticulo()
        {
            ...
            dta_consultaarticulo.Columns.Add("Modelo", typeof(string));
            dta_consultaarticulo.Columns.Add("ModeloAbreviado", typeof(string));
            dta_consultaarticulo.Columns.Add("Abreviatura", typeof(string));
            dta_consultaarticulo.Columns.Add("Compatibilidad", typeof(string));
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref int CodEmpresa, ref int CodDireccionDestino)
        {
            TrasladosCabCE objEntidad = new TrasladosCabCE();
            TrasladosCabCN objOperacion = new TrasladosCabCN();
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                CodDireccionDestino = Convert.ToInt32(dtTabla.Rows[0]["CodDireccionDestino"]);
            }
        }
        ...
        public void P_ValidarGuia(Hashtable objTablaFiltro, ref String Mensaje)
        {
            TrasladosCabCE objEntidad = null;
            TrasladosCabCN objOperacion = null;
            ...
            Mensaje = objOperacion.F_TrasladosCab_Validar_Guia(objEntidad).MsgError;
        }
        ...
        public void P_GrabarDireccionTemporal(Hashtable objTablaFiltro, ref int CodDocumentoVentaDireccion, ref int FlagTraslado, ref String MsgError)
        {
            ...
            FlagTraslado = objEntidad.FlagTraslado;
        ...
        [WebMethod]
        public static NotaIngresoSalidaCabCE F_ObtenerNotaIngreso_PorID_Net(int CodDocumentoVentaDireccion, int CodTipoDocSust, string SerieDocSust, string NumeroDocSust)
        {
            ...
            objEntidad.CodDocumentoVentaDireccion = CodDocumentoVentaDireccion;
            objEntidad.CodTipoDocSust = CodTipoDocSust;
            objEntidad.SerieDocSust = SerieDocSust;
            objEntidad.NumeroDocSust = NumeroDocSust;
        ...
        public void P_AgregarTemporal_Servidor(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            {
                objEntidad.CodDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]);
                objOperacion.F_TemporalFacturacionDet_Insert_Alvarado_Servidor_Detalle(objEntidad);
                Codigo = Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]);
            }
            MsgError = objEntidad.MsgError;
        }
