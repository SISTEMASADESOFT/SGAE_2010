<%@ Page Title="Registro de Ajuste Excel" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="CargaProductoMasivo_Karina.aspx.cs" Inherits="SistemaInventario.Inventario.CargaProductoMasivo_Karina" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CargaProductoMasivo_Karina.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class='overlay'>
        <div class="titulo">
            CARGA MASIVA PRODUCTOS POR EXCEL</div>
        <div id="divTabs">
            <ul>
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <div >
                        <table style="width: 100%; border-collapse: collapse; font-family: Arial; font-size: 16px; color: #003366;">
                            ...
                            <tr>
                                <td colspan="2" style="padding: 10px 15px; border: 1px solid #cce0ff; font-size: 18px;">
                                    ⚠️ Los precios no pueden tener <strong>comas</strong>, ejemplo: '1,000'
                                </td>
                            </tr>
                            <tr style="background-color: #f0f8ff;">
                                <td colspan="2" style="padding: 12px 15px; border: 1px solid #cce0ff; font-size: 16px;">
                                    ⚠️ <strong>Campos obligatorios</strong>: PRECIO, PRECIO2, PRECIO3, COSTO, STOCK, CODMONEDACOSTO, CODMONEDAPRECIO no pueden estar vacíos.
                                </td>
                            </tr>
                            <tr style="background-color: #f0f8ff;">
                                <td colspan="2" style="padding: 12px 15px; border: 1px solid #cce0ff; font-size: 16px;">
                                    ⚠️ Al escribir el <strong>CODIGOUNICO</strong> en el Excel,debe rellenar los campos obligatorios.
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div id="div_grvDetalleArticulo" style="padding-top: 5px;">
                        <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="CodigoUnico">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
