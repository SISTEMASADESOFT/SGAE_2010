...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                             ...
                                             <td>
                                            <asp:CheckBox runat="server" ID="chkCosteable" Text="NO COSTEABLE" 
                         ...
                         <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgEditarRegistro" ImageUrl="~/Asset/images/btnEdit.gif"
                                    ToolTip="EDITAR DISTRIBUCION" OnClientClick="F_distribucion(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>        
    ...
    <div id="divFacturarVentas" style="display: none;">
     ...
     <div id="div_Distribucion" style="display: none;">
        <div class="ui-jqdialog-content">
            <table cellpadding="0" cellspacing="0" class="form-inputs">
                <tr>
                    <td colspan="2">
                        <asp:Button ID="btnGrabarDistribucion" runat="server" Text="Grabar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="120" />
                ...
                <tr>
                   <td style="padding-top: 5px;">
                    <div id="div_DetalleDostribucion">
                        <asp:GridView ID="grvDetalleDistribucion" runat="server" AutoGenerateColumns="False" border="0"
                            CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None" Width="460px">
                            <Columns>
                                <asp:TemplateField HeaderText="Sucursal">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hfCodarticulo" runat="server" Value='<%# Bind("Codarticulo") %>' />
                                        <asp:HiddenField ID="hfCodDetalleDocumento" runat="server" Value='<%# Bind("CodDetalleDocumento") %>' />
                                        <asp:HiddenField ID="hfCodDetDistribucion" runat="server" Value='<%# Bind("CodDetDistribucion") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Cantidad" ItemStyle-HorizontalAlign="Center" >
                                   <ItemTemplate>
                                   <asp:TextBox runat="server" ID="txtCantidadDistribuida" Width="55px" Font-Bold="true" Style="text-align: center;"
                                    CssClass="ccsestilo" Font-Names="Arial" ForeColor="Blue" Text='<%# Bind("CantidadDistribuida") %>'></asp:TextBox>
                                 </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
    ...
    <input id="hfCodDistribucion" type="hidden" value="0" />
</asp:Content>
