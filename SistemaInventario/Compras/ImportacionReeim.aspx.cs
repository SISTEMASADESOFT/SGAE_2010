...
namespace SistemaInventario.Compras
{
    public partial class ImportacionReeim : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value.ToString() != "")
                {
                    ...
                    dta_consultaarticulo.Columns.Add("CODIGOREEMS", typeof(string));
        ...
        public void P_ImportarDocumento(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objEntidad.NumeroDua = Convert.ToString(objTablaFiltro["Filtro_NumeroDua"]);

            objOperacion = new DocumentoVentaCabCN();
            objOperacion.F_NotaIngresoSalidaCab_IngresarImportacion_Reeim(objEntidad);
            Mensaje = objEntidad.MsgError;
            ...
            if (FileUpload1.HasFile)
            {
                if (FileUpload1.PostedFile.ContentType == ExcelContentType || FileUpload1.PostedFile.ContentType == Excel2010ContentType)
                {
                    ...
                    try
                    {
                        ...
                        Cadena = string.Format("Select [CODIGOFABRICA],[CANTIDAD],[FOB]," + HiddenField1.Value + " AS IDPruebasExcelCab,'" + FileUpload1.FileName + "' AS NombreArchivo FROM [{0}] ", "IMPORTACION$");
                        ...
                        using (OleDbConnection connection = new OleDbConnection(excelConnectionString))
                        {
                            ...
                            using (DbDataReader dr = command.ExecuteReader())
                            {
                                ...
                                using (SqlBulkCopy bulkCopy = new SqlBulkCopy(sqlConnectionString))
                                {
                                    ...
                                    bulkCopy.ColumnMappings.Add("[FOB]", "Costo");
                    ...
                    catch (Exception ex)
                    {
                        try
                        {
                            MensajeError = "Error en la lectura del excel. <p></p> " +
                                            ...
                                            " Columnas: <p></p>" +
                                            " <b>[A]=CODIGOFABRICA, [B]=CANTIDAD, [C]=FOB </b>";
