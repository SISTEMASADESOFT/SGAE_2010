<%@ Page Title="Importacion" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ImportacionMarca.aspx.cs" Inherits="SistemaInventario.Compras.ImportacionMarca" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ImportacionMarca.js" charset="UTF-8"></script>
                ...
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                    ...
                    <div>
                        <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                          ...
                          LAS COLUMNAS SON A=CODIGOUNICO,B=DESCRIPCION,C=MARCA,D=CANTIDAD,E=COSTO,F=P1,G=P2,H=P3,I=IDFAMILIA
                                </td>                               
                            </tr>
                             <tr>
                                <td style="font-weight: bold; font-size: medium;" colspan='2'>                        
