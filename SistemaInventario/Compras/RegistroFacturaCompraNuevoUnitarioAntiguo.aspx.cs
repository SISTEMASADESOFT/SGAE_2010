...
{
    public partial class RegistroFacturaCompraNuevoUnitarioAntiguo : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value.ToString() != "")
                {
                    ...
                    grvDetalle.DataSource = objOperacion.F_NotaIngresoSalidaDet_Select_ANTIGUO(objEntidad);
                    grvDetalle.DataBind();
        ...
        public String F_PasaraNuevoSistema_NET(String arg)
        {
            ...
            try
            {
                ...
                P_PasaraNuevoSistema(obj_parametros);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_NotaIngresoSalidaCab_Select_Compras_FACTURA_ANTIGUO(objEntidad);
        ...
        public void P_PasaraNuevoSistema(Hashtable objTablaFiltro)
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
            ...
            {
                XmlDetalle = XmlDetalle + "<D ";
                XmlDetalle = XmlDetalle + " CodMovimiento = '" + item.Codigo + "'";
                XmlDetalle = XmlDetalle + " />";
            }
