<%@ Page Title="Orden Compra" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="OrdenCompraUnitarioKarina.aspx.cs" Inherits="SistemaInventario.Compras.OrdenCompraUnitarioKarina" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="OrdenCompraUnitarioKarina.js" charset="UTF-8"></script>
                        ...
                        <asp:TemplateField HeaderText="Cantidad" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox runat="server" ID="txtCantidad" Width="75px" Font-Bold="true" Style="text-align: center;"
                                    ...
                                    Font-Names="Arial" ForeColor="Blue" Text='<%# Bind("Cantidad") %>'
