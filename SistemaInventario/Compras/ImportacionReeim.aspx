                ...
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                    ...
                    <div>
                        <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                          ...
                          LAS COLUMNAS DEBE SER A=CODIGOFABRICA,B=CANTIDAD,C=FOB
                                </td>                               
                            </tr>
                      <tr>
                                <td style="font-weight: bold; font-size: medium;" colspan='2'>                        
                          LAS COLUMNA A DEBE SER DE TIPO TEXTO.LA HOJA EXCEL DEBE LLAMARSE:IMPORTACION
                                </td>                               
                            </tr> 
                      <tr>
                                <td style="font-weight: bold; font-size: medium;" colspan='2'>                        
                          LOS CODIGOFABRICA DE LOS PRODUCTOS NO DEBEN DUPLICARSE.EL EXCEL NO DEBE TENER FUENTES ASIATICAS
                                </td>                               
                            </tr>
                        </table>
                    </div>
                         ...
                         <asp:TemplateField HeaderText="A">
                                        ...
                                        <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Codigo" HeaderText="Codigo">
                                                  ...
                                                  <asp:BoundField DataField="CodigoReemS" HeaderText="CodigoReem">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="Costo" HeaderText="FOB">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                 <asp:BoundField DataField="CostoGO" HeaderText="Costo C/IGV">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="P1" HeaderText="Margen1">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="P2" HeaderText="Margen2">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="P3" HeaderText="Linea">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                            </Columns>
                            ...
                            <asp:TemplateField HeaderText="Numero">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="hfNroDua" runat="server" Value='<%# Bind("NroDua") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:BoundField DataField="NroDua" HeaderText="NroDua">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
     ...
     <div id="divIngresar" style="display: none;">
        <table>
            <tr>               
                ...
                <td>
                    <asp:TextBox ID="txtNumDua" runat="server" Width="300px" Font-Names="Arial"
                        ForeColor="Blue" Font-Bold="True" ></asp:TextBox>
                </td>
            </tr>                                                     
            <tr>               
