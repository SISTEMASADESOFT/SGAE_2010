<%@ Page Title="Importacion" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ImportacionKarina.aspx.cs" Inherits="SistemaInventario.Compras.ImportacionKarina" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ImportacionKarina.js" charset="UTF-8"></script>
             ...
             <div>
                        ...
                        <table style="width: 100%; border-collapse: collapse; font-family: Arial; font-size: 16px; margin-top: 10px; color: #003366;">
                            ...
                            <tr style="background-color: #f0f8ff;">
                                ...
                                <td style="padding: 12px 15px; border: 1px solid #cce0ff; width: 50%; font-size: 16px;">
                                    ❌ Evitar fuentes asiáticas en el Excel.
                                </td>
                            </tr>
                        </table>
                        ...
                        <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Codigo Interno">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblCodigoInterno" Text='<%# Bind("CODIGOUNICO") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                ...
                <div id="div_consulta" style="padding-top: 5px;">
                    <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" ID="imgIngresarImportacion"  ImageUrl="~/Asset/images/ok.gif"
                         ...
                         <asp:TemplateField HeaderText="A">
                            ...
                            <asp:TemplateField HeaderText="Numero">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="NroDua" HeaderText="DUA">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="Proveedor" HeaderStyle-HorizontalAlign="Center">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="FechaDua" HeaderText="Fecha DUA">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                   ...
                   <%--         <asp:BoundField DataField="FechaCancelacion" HeaderText="Cancelac" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <asp:TemplateField HeaderText="G.O." HeaderStyle-HorizontalAlign="Center">
                              ...
                              <asp:BoundField DataField="PreImportacion" HeaderText="PRE IMPORTACION">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
