...
{
    public partial class ImportacionMarca : System.Web.UI.Page
    {
                    ...
                    using (var package = new ExcelPackage(fileInfo))
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(sqlConnectionString))
                        {
                            ...
                            for (int row = worksheet.Dimension.Start.Row + 1; row <= worksheet.Dimension.End.Row; row++)
                            {
                                ...
                                string P1 = worksheet.Cells[row, 6].Text;                              
                                string IDFamilia = worksheet.Cells[row, 7].Text;
                                                
                                // Realizar la inserción en la base de datos
                                string insertQuery = "INSERT ImportacionExcel(CodigoInterno,Descripcion,Marca,Cantidad,Costo,P1,IDFamilia,IDPruebasExcelCab,NombreArchivo) " +
                                                     "VALUES (@CodigoInterno,@Descripcion,@Marca,@Cantidad,@Costo,@P1,@IDFamilia,@IDPruebasExcelCab,@NombreArchivo)";
