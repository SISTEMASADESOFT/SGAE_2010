...
namespace SistemaInventario.Compras
{
    public partial class RegistroFacturaCompraNuevoTEK : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_Distribucion_NET);
            CallbackManager.Register(F_GrabarDocumentoDistribucion_NET);
        }
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(obj_parametros,
                                        ...
                                        ref Distrito, ref Guia, ref CodCajaFisica, ref CodFacturaAsociada, ref FlagCSIgv, ref CodEmpresa, ref FlagCosteable);
        ...
        public void P_Inicializar_GrillaVacia_Distribucion()
        {
            DataTable dta_consultadetalleoc = null;
            DataRow dtr_filadetalle = null;
            ...
            dta_consultadetalleoc.Columns.Add("CodAlmacen", typeof(string));
            dta_consultadetalleoc.Columns.Add("CodAlterno", typeof(string));
            dta_consultadetalleoc.Columns.Add("CantidadTotal", typeof(string));
            dta_consultadetalleoc.Columns.Add("CantidadDistribuida", typeof(string));
            dta_consultadetalleoc.Columns.Add("Codarticulo", typeof(string));
            dta_consultadetalleoc.Columns.Add("CodDetalleDocumento", typeof(string));
            dta_consultadetalleoc.Columns.Add("CodDetDistribucion", typeof(string));
            ...
            grvDetalleDistribucion.DataSource = dta_consultadetalleoc;
            grvDetalleDistribucion.DataBind();
        }
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " CodOrdenCompraDet = '" + item.CodOrdenCompraDet + "'";
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref Int32 FlagCSIgv, ref Int32 CodEmpresa, ref Int32 FlagCosteable
        )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
        ...
        public String F_Distribucion_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            int Codigo = 0;
            String str_grvDetalleDistribucion_html = "";
            Hashtable obj_parametros = null;
            ...
            try
            {
                ...
                P_CargarGrillaDistribucion(obj_parametros, ref grvDetalleDistribucion, ref Codigo);

                if (grvDetalleDistribucion.Rows.Count == 0)
                {
                    P_Inicializar_GrillaVacia_Distribucion();
                    str_mensaje_operacion = "No se encontraron registros.";
                }
                else
                    str_mensaje_operacion = "";

                str_grvDetalleDistribucion_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleDistribucion);
            ...
            str_resultado =
                ...
                str_mensaje_operacion
                + "~" +
                str_grvDetalleDistribucion_html
                + "~" +
                Codigo.ToString();
        ...
        public void P_CargarGrillaDistribucion(Hashtable objTablaFiltro, ref GridView grvDetalleDistribucion, ref Int32 Codigo)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            objEntidad = new DocumentoVentaCabCE();
            ...
            objEntidad.CodAlmacen = Convert.ToInt32(Session["CodSede"]);
            objEntidad.CodDetDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_coddetdetalle"]);
            objEntidad.CodArticulo = Convert.ToInt32(objTablaFiltro["Filtro_CodArticulo"]);
            objEntidad.Cantidad = Convert.ToDecimal(objTablaFiltro["Filtro_Cantidad"]);


            dta_consulta = objOperacion.F_TemporalDistribucionDet_Listar(objEntidad);
            Codigo = objEntidad.CodDocumentoVenta;

                grvDetalleDistribucion.DataSource = dta_consulta;
                grvDetalleDistribucion.DataBind();
        }

        public String F_GrabarDocumentoDistribucion_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_numerofactura = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_GrabarDocumentoDistribucion(obj_parametros, ref MsgError, ref Codigo);
        ...
        public void P_GrabarDocumentoDistribucion(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            objEntidad = new DocumentoVentaCabCE();
            int iCodEmpresa = Convert.ToInt32(Session["CodEmpresa"]);
            objEntidad.CodEmpresa = iCodEmpresa;
            objEntidad.Coddistribucion = Convert.ToInt32(objTablaFiltro["Filtro_Coddistribucion"]);
            String XmlDetalle = "";
            ...
            {
                XmlDetalle = XmlDetalle + "<D ";
                XmlDetalle = XmlDetalle + " Codalmacen = '" + item.Codalmacen + "'";
                XmlDetalle = XmlDetalle + " CantidadTotal = '" + item.CantidadTotal + "'";
                XmlDetalle = XmlDetalle + " CodArticulo = '" + item.CodArticulo + "'";
                XmlDetalle = XmlDetalle + " CoddetalleDocumento = '" + item.CoddetalleDocumento + "'";
                XmlDetalle = XmlDetalle + " CantidadDistruida = '" + item.CantidadDistruida + "'";
                XmlDetalle = XmlDetalle + " CodDetDistribucion = '" + item.CodDetDistribucion + "'";
                XmlDetalle = XmlDetalle + " />";
            }
            ...
            objOperacion.F_TemporalDistribucionDet_Insert(objEntidad);
                Codigo = objEntidad.CodDocumentoVenta;
