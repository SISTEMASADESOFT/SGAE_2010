...
namespace SistemaInventario.Compras
{
    public partial class RegistroFacturaCompraNuevo : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value.ToString() != "")
                {
                    ...
                    if (Convert.ToInt32(hfCodTipoDoc.Value.ToString())==17)
                        grvDetalle.DataSource = objOperacion.F_NotaCompraDet_Select(objEntidad);
                    else
        ...
        public String F_AgregarTemporal_Servidor_NET(String arg)
        {
            ...
            try
            {
                ...
                if (MsgError == "Los Producto(s) se han agregado con exito")
                    P_CargarGrillaTemporal(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref TotalDscto, ref FlagCSIgv);
        ...
        [WebMethod]
        public static DocumentoVentaCabCE F_BuscarComprasExternas_Net(string SerieDoc, string NumeroDoc)
        {
            ...
            return objOperacion.F_DOCUMENTOVENTACAB_COMPRA_EXTERNA(objEntidad);
        }
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            if (objEntidad.CodTipoDocSust==17)
                objOperacion.F_NotaPedido_Insert_Alvarado(objEntidad);
            else
        ...
        public void P_EliminarRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            if (Convert.ToInt32(objTablaFiltro["Filtro_CodTipoDoc"])==17)
                objOperacion.F_Eliminacion_NotaCompra(objEntidad);
            else
        ...
        public void P_ValidarFactura(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            Mensaje = objOperacion.F_NotaIngresoSalidaCab_Validar_Factura_Alvarado(objEntidad).MsgError;
        }
        ...
        )
        {
            ...
            dtTabla = objOperacion.F_NotaIngresoSalidaCab_Reemplazar_Alvarado(objEntidad);
        ...
        public String F_Auditoria_NET(String arg)
        {
            ...
            try
            {
                ...
                if (CodTipoDoc == 17)
                    grvAuditoria.DataSource = objOperacion.F_AUDITORIA_NOTACOMPRA(objEntidad);
                else
