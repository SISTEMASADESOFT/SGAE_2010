<%@ Page Title="Nota Credito-Compra" Language="C#" MasterPageFile="~/Site.Master"   AutoEventWireup="true" CodeBehind="NotaCredito_antiguo.aspx.cs" Inherits="SistemaInventario.Compras.NotaCredito_antiguo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="NotaCredito_antiguo.js" charset="UTF-8"></script>
