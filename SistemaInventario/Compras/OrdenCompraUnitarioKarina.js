var AppSession = "../Compras/OrdenCompraUnitarioKarina.aspx";
...
//    }
    ...
    if (F_PermisoOpcion(CodigoMenu, 3000102, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
        try 
        {
                    ...
                    $(Cuerpo + 'txtCodigoProductoAgregar').val('')
                    $(Cuerpo + 'txtCodigoProductoAgregar').val('');
                    $(Cuerpo + 'txtStockAgregar').val('');
                    $(Cuerpo + 'txtUMAgregar').val('');
                    $(Cuerpo + 'txtArticuloAgregar').val('');
                    $(Cuerpo + 'txtCantidad').val('');
                    $('#MainContent_txtClienteDropTop').val($('#MainContent_txtProveedor').val());
...
function F_ValidarAgregar(){
 try 
        ...
        if ($("#MainContent_txtPrecioDisplay").val() == 0)
            cadena = cadena + "EL COSTO NO PUEDE SER 0 <p></p> ";

        
        if ($("#MainContent_txtCantidad").val() == 0)
            cadena = cadena + "LA CANTIDAD NO PUEDE SER 0 <p></p> ";
        ...
        if ($("#MainContent_txtPrecioDisplay").val() == '')
            cadena = cadena + "CAMPO COSTO ARTICULO <p></p> ";
 ...
 try 
        {
            ...
            return false;
               ...
               if (isNaN(txtPrecio) || txtPrecio <= 0) {
                $(txtPrecio).val('1.00');
                alertify.log("Costo Minimo 1");
                return false;
            }
...
function F_ImprimirFacturaPDF(Fila) {
        ...
        var CodMenu = '3000';
        var NombreArchivo = 'Web_Reporte_Compras_rptOrdendeCompra.rpt';
