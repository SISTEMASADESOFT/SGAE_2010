...
{
    public partial class ImportacionKarina : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia_ConsultaFactura()
        {
            ...
            dta_consulta.Columns.Add("PreImportacion", typeof(string));
                        ...
                        using (SqlConnection connection = new SqlConnection(sqlConnectionString))
                        {
                           ...
                           VALUES (@CODIGOUNICO,@CANTIDAD,@COSTO,@P1,@P2,@P3,@IDPruebasExcelCab,@NombreArchivo)";
                                ...
                                using (SqlCommand cmd = new SqlCommand(insertQuery, connection))
                                {
                                    ...
                                    cmd.Parameters.AddWithValue("@P2", PRECIO2);
                                    cmd.Parameters.AddWithValue("@P3", PRECIO3);
