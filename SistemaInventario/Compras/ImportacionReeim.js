...
$(document).ready(function () {
    ...
    $('#MainContent_txtNumDua').css('font-size', '12px');
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        $('#MainContent_txtNumDua').css('background', '#FFFFE0');
...
function F_ImportarDocumento() {
    try {
        ...
        var objParams = {
            ...
            Filtro_Numero: $("#MainContent_txtNumIng").val(),
            Filtro_NumeroDua: $("#MainContent_txtNumDua").val()
        };
...
function F_IngresarRegistro(Fila) {
    ...
    try {
        ...
        hfNroDua_grilla = '#' + imgID.replace('imgIngresarImportacion', 'hfNroDua');
        ...
        $('#MainContent_txtNumDua').val($(hfNroDua_grilla).val());
        lblCodImportacion = $(lblCodImportacion).val();
