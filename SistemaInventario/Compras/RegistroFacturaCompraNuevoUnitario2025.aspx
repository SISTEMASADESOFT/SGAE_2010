<%@ Page Title="Compras Factura" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaCompraNuevoUnitario2025.aspx.cs" Inherits="SistemaInventario.Compras.RegistroFacturaCompraNuevoUnitario2025" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaCompraNuevoUnitario2025.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id="tabRegistro">
            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtOrdenCompra" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"  CssClass="Derecha"></asp:TextBox>
                                        </td>
                                  
                                         <td >
                                            <div id="div_OrdenCompra">
                                                <asp:DropDownList ID="ddlSerieOrdenComra" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" Width="115">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                ...
                <div class="linea-button">
                    <asp:Button ID="btnListarOrdenes" runat="server" Text="Listar Ordenes." class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                ...
                <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="Importe">
                         ...
                         <asp:TemplateField HeaderText="PrecioFinal" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox runat="server" ID="txtPrecioFinal" Width="75px" Font-Bold="true" Style="text-align: center;"
                                    Font-Names="Arial" CssClass="ccsestilo" ForeColor="Blue" Text='<%# Bind("PrecioFinal") %>'
                                    onblur="F_ActualizarPrecioFinal(this.id); return false;"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>


                          <asp:TemplateField HeaderText="PrecioMecanico" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox runat="server" ID="txtPrecioMecanico" Width="75px" Font-Bold="true" Style="text-align: center;"
                                    Font-Names="Arial" CssClass="ccsestilo" ForeColor="Blue" Text='<%# Bind("PrecioMecanico") %>'
                                    onblur="F_ActualizarPrecioMecanico(this.id); return false;"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
      ...
      <td valign="top" style="width: 120px">
                ...
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 250px;
                    ...
                    <div id="divListaCotizaciones" class="ui-jqdialog-content">
                        <ul id="lu_Ordenes" class="ul-float" style="padding-left: 5px; width: 220px">
                        </ul>
                    </div>
                </div>
            </td>
    ...
    Font-Bold="True" Font-Size="Small"></asp:TextBox>--%>
                    ...
                    <td style="padding-left: 5px;">
                        <asp:Button ID="btnFacturarOrdenCompra" runat="server" Text="Facturar" class="ui-button
