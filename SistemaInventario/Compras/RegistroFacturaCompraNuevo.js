...
function F_BuscarComprasExternas() {
...
// {
 MostrarEspera(true);
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'RegistroFacturaCompraNuevo.aspx/F_BuscarComprasExternas_Net',
        dataType: "json",
        data: "{'SerieDoc':'" + $('#MainContent_txtSerie').val()  + "','NumeroDoc':'" + $('#MainContent_txtNumero').val()  + "'}",
        success: function (dbObject) {
            MostrarEspera(true);
            
            var data = dbObject.d;
            try {
            if(data.ListaDocumentoVentaDet.length>0)
            {
                    var arrDetalle = new Array();
                    var Contenedor = '#MainContent_';
                    var tasaigv;
             ...
             tasaigv=1;
                    ...
                    //Array de Items
                    $.each(data.ListaDocumentoVentaDet, function (index, item) {
                            var objDetalle = {
...
//                       $("#MainContent_txtEmision").prop('disabled', true);
        ...
        error: function (xhr, ajaxOptions, thrownError) {
        alertify.log("ERROR DETECTADO: " + xhr.responseJSON.Message)
