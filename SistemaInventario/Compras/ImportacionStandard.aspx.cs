...
{
    public partial class ImportacionStandard : System.Web.UI.Page
    {
                    ...
                    using (var package = new ExcelPackage(fileInfo))
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(sqlConnectionString))
                        {
                            ...
                            for (int row = worksheet.Dimension.Start.Row + 1; row <= worksheet.Dimension.End.Row; row++)
                            {
                                ...
                                string insertQuery = "INSERT ImportacionExcel(CodigoInterno,Descripcion,Cantidad,Costo,P1,P2,P3,IDFamilia,IDPruebasExcelCab,NombreArchivo) " +
                                                     "VALUES (@CodigoInterno,@Descripcion,@Cantidad,@Costo,@P1,@P2,@P3,@IDFamilia,@IDPruebasExcelCab,@NombreArchivo)";
