<%@ Page Title="Importacion" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ImportacionStandard.aspx.cs" Inherits="SistemaInventario.Compras.ImportacionStandard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ImportacionStandard.js" charset="UTF-8"></script>
                ...
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                    ...
                    <div>
                        <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                          ...
                          LAS COLUMNAS SON A=CODIGOINTERNO,B=DESCRIPCION,C=CANTIDAD,D=COSTO,E=P1,F=P2,G=P3,H=IDFAMILIA
                                </td>                               
                            </tr>
                             <tr>
                                <td style="font-weight: bold; font-size: medium;" colspan='2'>                        
