...
{
    public partial class RegistroFacturaCompraNuevoUnitarioWong : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlSerieOrdenComra_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref ddlTipoDocumento, ref ddlClasificacion, ref ddlCategoria,
                    ref ddlClasificacionConsulta, ref ddlCajaFisica, ref  ddlSerieDocVentas, ref ddlEmpleadoConsulta, ref ddlEstado, ref ddlTipoDocConsulta, ref ddlSerieOrdenComra);
                ...
                str_ddlSerieOrdenComra_html = Mod_Utilitario.F_GetHtmlForControl(ddlSerieOrdenComra);
            ...
            str_resultado =
                ...
                str_ddlSerieOrdenComra_html;  //20
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_comboformapago,
             ...
             ref DropDownList ddl_comboestado, ref DropDownList ddl_combodocumentoconsulta, ref DropDownList ddlSerieOrdenComra)
        {
            ...
            ddlSerieOrdenComra.Items.Clear();

            ddlSerieOrdenComra.DataSource = dta_consulta;
            ddlSerieOrdenComra.DataTextField = "SerieDoc";
            ddlSerieOrdenComra.DataValueField = "CodSerie";
            ddlSerieOrdenComra.DataBind();
        }
        ...
        public void P_Inicializar_GrillaVacia_DetalleArticulo()
        {
            ...
            dta_consultadetalle.Columns.Add("PrecioFinal", typeof(string));
            dta_consultadetalle.Columns.Add("PrecioMecanico", typeof(string));
        ...
        public void P_ActualizarPrecios(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.PrecioMecanico = Convert.ToDecimal(objTablaFiltro["Filtro_PrecioMecanico"]);
            objEntidad.PrecioFinal = Convert.ToDecimal(objTablaFiltro["Filtro_PrecioFinal"]);
            objOperacion = new DocumentoVentaDetCN();
        ...
        [WebMethod]
        public static NotaIngresoSalidaCabCE F_Obtener_Orden_PorNumero_Net(int NumeroCotizacion, string Seriedoc)
        {
            ...
            objEntidad.NumeroOrdenCompra = NumeroCotizacion.ToString();
            objEntidad.SerieDoc = Seriedoc.ToString();
            objEntidad.CodAlmacen = Convert.ToInt32(HttpContext.Current.Session["CodSede"]);
            return objOperacion.F_Obtener_Orden_PorNumero(objEntidad);
        }


        [WebMethod]
        //busca el stock del almacen especificado
        public static jqProformasResult F_Consulta_Ordenes_Pendientes_NET(int CodAlmacen)
        {
            jqProformasResult data = new jqProformasResult();
            NotaIngresoSalidaCabCE par = new NotaIngresoSalidaCabCE() { CodEmpresa = Convert.ToInt32(HttpContext.Current.Session["CodEmpresa"]), CodAlmacen = Convert.ToInt32(HttpContext.Current.Session["CodSede"]), CodEstado = 6 };
            data.rows = (new NotaIngresoSalidaCabCN()).F_OrdenCompraCab_ListarXEstado(par);
            return data;
        }
