    ...
    public partial class NotaCredito : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {                    
                    ...
                    dta_consulta.Columns.Add("codigointerno", typeof(string));
                    dta_consulta.Columns.Add("Producto", typeof(string));
                    dta_consulta.Columns.Add("Cantidad", typeof(string));
                    dta_consulta.Columns.Add("CantidadEntregada", typeof(string));
                    dta_consulta.Columns.Add("UM", typeof(string));
                    dta_consulta.Columns.Add("Precio", typeof(string));
                    dta_consulta.Columns.Add("marca", typeof(string));

                    dta_consulta.Columns.Add("Importe", typeof(string));
                    dta_consulta.Columns.Add("Anexo", typeof(string));
                    dta_consulta.Columns.Add("OC", typeof(string));
                    dta_consulta.Columns.Add("Anexo2", typeof(string));
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_NotaIngresoSalidaDet_Select_Alvarado(objEntidad);
                grvDetalle.DataBind();
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
           ...
           //if (objEntidad.NumeroDoc.Substring(0, 1).Equals('F') || objEntidad.NumeroDoc.Substring(0, 1).Equals('B'))
                objOperacion.F_NotaIngresoSalidaCab_NotaCredito_Insert(objEntidad);
           //else
           //    objOperacion.F_NotaIngresoSalidaCab_NotaCredito_Insert_Proforma(objEntidad);
        ...
        public void P_AnularRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            //else
            //    objOperacion.F_NotaIngresoSalidaCab_Anulacion_NotaCredito_Proforma(objEntidad);
           ...
           ref Int32 CodMoneda, ref Decimal SubTotal, ref Decimal Igv, ref Decimal Total, ref String Cliente, ref Int32 CodDocumentoVenta,ref String Serie,ref String Numero)
        {
            ...
            dta_consulta = objOperacion.F_NotaIngresoSalidaCab_ListarXCodigo_NotaCredito_Alvarado(objEntidad);
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                objOperacion.F_NotaIngresoSalidaDet_InsertTemporal_Alvarado(objEntidad);
