<%@ Page Title="Cierre Caja" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="CajaChicaSalcedo.aspx.cs" Inherits="SistemaInventario.CajaChica.CajaChicaSalcedo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CajaChicaSalcedo.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server" >
    <div class='overlay' >
        ...
        <div id="divTabs">
            ...
            <div id="tabRegistro" style="width: 810px">
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                    ...
                    <div id="divConsultaArticulo">
                        ...
                        <div class="linea-button">
                                 ...
                                 <asp:Button ID="btnCuadreCaja" runat="server" Text="CUADRE CAJA" Font-Names="Arial"
                    ...
                    <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                        ...
                        <asp:TemplateField>
                            ...
                            <asp:TemplateField ItemStyle-Width="20px">
                               ...
                               <asp:TemplateField ItemStyle-Width="20px">
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" ID="imgCuadreCaja" ImageUrl="~/Asset/images/btnEdit.gif" ToolTip="VISUALIZAR CUADRE CAJA"
                                        OnClientClick="F_CuadreCajaEdicion(this); return false;" />
                                </ItemTemplate>
                            </asp:TemplateField>   
     ...
     <div id="divLiquidacion" style="display: none;">
      ...
      <div id="divCuadreCaja" style="display: none;">
         <div class="ui-jqdialog-content">
            <table cellpadding="0" cellspacing="0">
            <tr>
            <td  valign="top">
             <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 222px">
                            <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
                                Soles</div>
                              </div>  
             <table>
               ...
               <%-- <tr>
             <td>
             <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="width: 50px">
                                Valor
                   </div>         
             </td>
             <td>
             ...
             <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
               ...
               <div id="div_CuadreCajaSoles" style="padding-top: 1px;">
                     <asp:GridView ID="grvCuadreCajaSoles" runat="server" AutoGenerateColumns="False"
                                border="0" CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None"
                                Width="180px">
                                <Columns>
                                    <asp:TemplateField HeaderText="Valor">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblValorSoles" Text='<%# Bind("Valor") %>'  CssClass="detallesart"></asp:Label>
                                            <asp:HiddenField ID="hfValorSoles" runat="server" Value='<%# Bind("Valor") %>' />
                                            <asp:HiddenField ID="hfCantidadSoles" runat="server" Value='<%# Bind("Cantidad") %>' />
                                            <asp:HiddenField ID="hfTotalSoles" runat="server" Value='<%# Bind("Total") %>' />
                                            <asp:HiddenField ID="hfCodCuadreCajaSoles" runat="server" Value='<%# Bind("CodCuadreCajaDet") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Cantidad S/.">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                        <asp:TextBox runat="server" ID="txtCantidadSoles" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                    CssClass="ccsestilo" Font-Names="Arial"  ForeColor="Blue" Text='<%# Bind("Cantidad") %>'
                                                     onblur="SumaCuadreCajaSoles(this.id);"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                      <asp:TemplateField HeaderText="Total S/.">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                        <asp:TextBox runat="server" ID="txtTotalSoles" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                    CssClass="ccsestilo" Font-Names="Arial"  ForeColor="Blue" Text='<%# Bind("Total") %>'
            ...
            <td style="font-weight: bold">
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadS1" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                             ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>               
             </td>
             <td style="padding-left: 17px" >
              <div>
              <asp:TextBox ID="txtTotalS1" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadS2" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                             ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div> 
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalS2" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                           ReadOnly="true"  ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
          ...
          <td style="font-weight: bold">
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadS3" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                           ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalS3" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
            ...
            <td style="font-weight: bold">
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadS4" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                           ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalS4" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadS5" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                             ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalS5" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadS6" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalS6" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadS7" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalS7" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadS8" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                             ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalS8" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
           ...
           <td style="font-weight: bold">
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadS9" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalS9" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
            ...
            <td style="font-weight: bold">
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadS10" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                           ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalS10" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadS11" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                          ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalS11" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>--%>
         ...
         <%--    <tr>
            <td style="font-weight: bold">
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadD1" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                             ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalD1" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadD2" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalD2" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
          ...
          <td style="font-weight: bold">
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadD3" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalD3" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
            ...
            <td style="font-weight: bold">
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadD4" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                             ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalD4" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadD5" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                             ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalD5" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadD6" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalD6" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadD7" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalD7" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadD8" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalD8" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
           ...
           <td style="font-weight: bold">
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadD9" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalD9" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
            ...
            <td style="font-weight: bold">
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadD11" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalD11" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>
             ...
             <td>
              <td >
              <div>
              <asp:TextBox ID="txtCantidadD12" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </td>
             <td style="padding-left: 17px">
              <div>
              <asp:TextBox ID="txtTotalD12" runat="server" Width="55px" Font-Names="Arial" CssClass="Derecha"
                                            ReadOnly="true" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
              </div>                  
                                    </td>
             </tr>--%>
               <div id="div_CuadreCajaDolares">
                     <asp:GridView ID="grvCuadreCajaDolares" runat="server" AutoGenerateColumns="False"
                                border="0" CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None"
                                Width="180px">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Valor">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblValorDolares" Text='<%# Bind("Valor") %>'  CssClass="detallesart"></asp:Label>
                                            <asp:HiddenField ID="hfValorDolares" runat="server" Value='<%# Bind("Valor") %>' />
                                            <asp:HiddenField ID="hfCantidadDolares" runat="server" Value='<%# Bind("Cantidad") %>' />
                                            <asp:HiddenField ID="hfTotalDolares" runat="server" Value='<%# Bind("Total") %>' />
                                            <asp:HiddenField ID="hfCodCuadreCajaDolares" runat="server" Value='<%# Bind("CodCuadreCajaDet") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Cantidad $.">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                        <asp:TextBox runat="server" ID="txtCantidadDolares" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                    CssClass="ccsestilo" Font-Names="Arial"  ForeColor="Blue" Text='<%# Bind("Cantidad") %>'
                                                     onblur="SumaCuadreCajaDolares(this.id);"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
             ...
             <div class="linea-button">
                        <asp:Button ID="BtnGrabarCuadraCaja" runat="server" Text="GRABAR" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="120" />
                    </div>
       </div>
    ...
    <div id="dlgWait" style="background-color: #CCE6FF; text-align: center; display: none;">
     ...
     <input id="hfCodAlmacen" type="hidden" value="0" />
      ...
      <input id="hfcuadrecaja" type="hidden" value="0" />
</asp:Content>
