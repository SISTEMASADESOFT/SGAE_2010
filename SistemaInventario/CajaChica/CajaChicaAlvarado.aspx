<%@ Page Title="Cierre Caja" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="CajaChicaAlvarado.aspx.cs" Inherits="SistemaInventario.CajaChica.CajaChicaAlvarado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CajaChicaAlvarado.js" charset="UTF-8"></script>
                ...
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                    ...
                    <div id="divConsultaArticulo">
                        ...
                        <div class="linea-button">
                            ...
                            <asp:Button ID="btnExcelGenerar" runat="server" Text="EXCEL VISTA PRELIMINAR" Font-Names="Arial"
                    ...
                    <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                        ...
                        <asp:TemplateField>
                            ...
                            <asp:TemplateField ItemStyle-Width="20px" >
                             ...
                             <asp:TemplateField ItemStyle-Width="20px" HeaderText="FT">
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" ID="imgImprimirExcelFormal" ImageUrl="~/Asset/images/excel.gif" ToolTip="VISUALIZAR Excel"
                                        OnClientClick="F_ReporteDocumentosFormal_excel(720, this,0); return false;" />
                                </ItemTemplate>
                            </asp:TemplateField> 
                             <asp:TemplateField ItemStyle-Width="20px" HeaderText="NV">
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" ID="imgImprimirExcelInformal" ImageUrl="~/Asset/images/excel.gif" ToolTip="VISUALIZAR Excel"
                                        OnClientClick="F_ReporteDocumentosInformal_excel(721, this,0); return false;" />
                                </ItemTemplate>
                            </asp:TemplateField> 
                            <asp:TemplateField ItemStyle-Width="20px">
                                <ItemTemplate>
