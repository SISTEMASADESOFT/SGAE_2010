...
{
    public partial class CajaChicaSalcedo : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_BuscarCuadreCaja_NET);
            CallbackManager.Register(F_EdicionCuadreCaja_NET);
        ...
        public String F_BuscarCuadreCaja_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvCuadreCajaSoles_html = "";
            String str_grvCuadreCajaDolares_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_BuscarCuadreCaja_Soles(obj_parametros, ref grvCuadreCajaSoles);
                P_BuscarCuadreCaja_Dolares(obj_parametros, ref grvCuadreCajaDolares);
                ...
                str_grvCuadreCajaSoles_html = Mod_Utilitario.F_GetHtmlForControl(grvCuadreCajaSoles);
                str_grvCuadreCajaDolares_html = Mod_Utilitario.F_GetHtmlForControl(grvCuadreCajaDolares);
                int_resultado_operacion = 1;
            ...
            str_resultado =
                ...
                str_mensaje_operacion
                + "~" +
                str_grvCuadreCajaSoles_html
                + "~" +
                str_grvCuadreCajaDolares_html;
        ...
        public void P_BuscarCuadreCaja_Soles(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            DataTable dta_consulta = null;
            ...
            objEntidad.CodAlmacen = Convert.ToInt32(Session["CodUsuario"]);
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodSede"]);
            ...
            dta_consulta = objOperacion.F_BuscarCuadreCaja_Soles_LISTAR(objEntidad);
        ...
        public void P_BuscarCuadreCaja_Dolares(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            DataTable dta_consulta = null;
            ...
            dta_consulta = objOperacion.F_BuscarCuadreCaja_Dolares_LISTAR(objEntidad);

            GrillaBuscar.DataSource = dta_consulta;
            GrillaBuscar.DataBind();
        }

        public String F_EdicionCuadreCaja_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_EdicionCuadreCaja(obj_parametros, ref MsgError);
        ...
        public void P_EdicionCuadreCaja(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            String XmlSoles = "";
            ...
            dynamic jArr2 = Newtonsoft.Json.JsonConvert.DeserializeObject(objTablaFiltro["Filtro_XmlSoles"].ToString());

            foreach (dynamic item in jArr2)
            {
                XmlSoles = XmlSoles + "<D ";
                XmlSoles = XmlSoles + " CodCuadreCajaSoles = '" + item.CodCuadreCajaSoles + "'";
                XmlSoles = XmlSoles + " TotalSoles = '" + item.TotalSoles + "'";
                XmlSoles = XmlSoles + " ValorSoles = '" + item.ValorSoles + "'";
                XmlSoles = XmlSoles + " CantidadSoles = '" + item.CantidadSoles + "'";
                XmlSoles = XmlSoles + " />";
            }

            XmlSoles = "<R><XmlLC> " + XmlSoles + "</XmlLC></R>";

            dynamic jArr3 = Newtonsoft.Json.JsonConvert.DeserializeObject(objTablaFiltro["Filtro_XmlDolares"].ToString());

            foreach (dynamic item in jArr3)
            {
                XmlDolares = XmlDolares + "<D ";
                XmlDolares = XmlDolares + " CodCuadreCajaDolares = '" + item.CodCuadreCajaDolares + "'";
                XmlDolares = XmlDolares + " TotalDolares = '" + item.TotalDolares + "'";
                XmlDolares = XmlDolares + " ValorDolares = '" + item.ValorDolares + "'";
                XmlDolares = XmlDolares + " CantidadDolares = '" + item.CantidadDolares + "'";
                XmlDolares = XmlDolares + " />";
            }

            XmlDolares = "<R><XmlLC> " + XmlDolares + "</XmlLC></R>";
            ...
            objEntidad.XmlSoles = XmlSoles;
            objEntidad.XmlDolares = XmlDolares;

            objOperacion = new DocumentoVentaCabCN();

            objOperacion.F_EdicionCuadreCaja(objEntidad);
