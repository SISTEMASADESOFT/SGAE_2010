var AppSession = "../CajaChica/CajaChicaAlvarado.aspx";
...
$(document).ready(function () {
    ...
    $('#MainContent_btnGenerarCaja').click(function () {
     ...
     $('#MainContent_btnExcelGenerar').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;
        if (F_PermisoOpcion(CodigoMenu, 7000301, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
        try {
           
            F_vistaprevia_excel(722);
...
function F_ReporteDocumentosFormal_excel(CodMenu, Fila,CodMedioPago) {
    var imgID = Fila.id;
    var MedioPago = '';

    var lblCodigo = '#' + imgID.replace('imgImprimirExcelFormal' + MedioPago, 'lblCodigo');
    var Cuerpo = '#MainContent_';
    var Cadena = 'Ingresar los sgtes. Datos:';
    var Titulo = "DOCUMENTOS FORMALES";
    var NombreTabla = "CajaChicaDetalle";
    var NombreHoja = "Formales";
    var NombreArchivo = "Xls_Documentos_Formales.xlsx";
    var Mensaje = '';
    if ($(Cuerpo + 'txtDesde').val() == '')
        Cadena = Cadena + '<p></p>' + 'Desde';
    ...
    rptURL = rptURL + 'NombreHoja=' + NombreHoja + '&';
    rptURL = rptURL + 'DocumentoFormal=' + DocumentoFormal + '&';
    rptURL = rptURL + 'NombreArchivo=' + NombreArchivo + '&';
    rptURL = rptURL + 'Titulo=' + Titulo + '&';
    rptURL = rptURL + 'Mensaje=' + Mensaje + '&';
...
function F_ReporteDocumentosInformal_excel(CodMenu, Fila,CodMedioPago) {
    var imgID = Fila.id;
    var MedioPago = '';

    var lblCodigo = '#' + imgID.replace('imgImprimirExcelInformal' + MedioPago, 'lblCodigo');
    var Cuerpo = '#MainContent_';
    var Cadena = 'Ingresar los sgtes. Datos:';
    var Titulo = "DOCUMENTOS INFORMALES";
    var NombreTabla = "CajaChicaDetalle";
    var NombreHoja = "Informales";
    var NombreArchivo = "Xls_Documentos_Informales.xlsx";
    var Mensaje = '';
    if ($(Cuerpo + 'txtDesde').val() == '')
        Cadena = Cadena + '<p></p>' + 'Desde';
...
function F_vistaprevia_excel(CodMenu) {
    ...
    var NombreTabla = "CajaChicaDetalle";
    var NombreHoja = "CajaChicaDetalle";
    var NombreArchivo = "Xls_VistaPrevia.xlsx";
    var Mensaje = '';
    if ($(Cuerpo + 'txtDesde').val() == '')
        Cadena = Cadena + '<p></p>' + 'Desde';
