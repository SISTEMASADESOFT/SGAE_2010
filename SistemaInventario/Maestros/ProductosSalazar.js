...
function F_ValidarGrabarDocumento() {
    ...
    try {
        ...
        if ($(Cuerpo + 'txtCosto').val() == '')
            Cadena = Cadena + '<p></p>' + 'Costo INICIal';

        if ($(Cuerpo + 'txtPrecio1').val() == '')
            Cadena = Cadena + '<p></p>' + 'NORMAL';

        if ($(Cuerpo + 'txtPrecio2').val() == '')
            Cadena = Cadena + '<p></p>' + 'MECANICO';
...
function F_GrabarDocumento() {
    try {
        ...
        var objParams = {
            ...
            Filtro_CostoProducto: $(Contenedor + 'txtCosto').val(),  
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        $(Cuerpo + 'txtDescripcionEdicion').val($(lblProducto).text());
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        if ($(Contenedor + 'chkBloqueoMayoristaEdicion').is(':checked'))
            FlagBloqueoMayorista = 1;

        if ($(Contenedor + 'chkBloqueoExclusivoEdicion').is(':checked'))
            FlagBloqueoExclusivo = 1;
        ...
        var objParams = {
            ...
            Filtro_CostoProducto: parseFloat($(Contenedor + 'txtCostoEdicion').val()),  
