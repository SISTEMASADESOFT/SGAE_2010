<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="ProductosUnitarioChiquito.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosUnitarioChiquito" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosUnitarioChiquito.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    ...
                                    <tr style="display:none;">
                                     <td style="font-weight: bold">
                                                    ...
                                                    <td style ="padding-left:4px;">
                                                        <asp:TextBox ID="txtCodigo2" runat="server" Width="568px" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <tr>
                                        <td>
                                            <asp:TextBox ID="txtModeloAbreviado" runat="server" Width="244px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                             <td style="font-weight: bold">
                                                        Abreviatura
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtAbreviatura" runat="server" Width="240px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                        </tr>
                                        </table>
                                        ...
                                        <td style = "padding-left:4px;">
                                            <asp:TextBox ID="txtModelo" runat="server" Width="568px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td style = "padding-left:4px;">
                                            <asp:TextBox ID="txtCompatibilidad" runat="server" Width="568px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                ...
                                                <td style = "display:none;">
                                                        <asp:TextBox ID="txtMarca" runat="server" Width="101px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="CodigoInterno" HeaderText="Codigo">
                                          ...
                                          <asp:TemplateField HeaderText="MOd Abreviado" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblModeloAbreviado" Text='<%# Bind("ModeloAbreviado") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <asp:TemplateField HeaderText="Abreviatura" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblAbreviatura" Text='<%# Bind("Abreviatura") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Compatibilidad" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblCompatibilidad" Text='<%# Bind("Compatibilidad") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            <table cellpadding="0" cellspacing="0" class="form-inputs">
                                ...
                                <tr style = "DISPLAY:none;">
                                   <td style="font-weight: bold">
                                                ...
                                                <td style = "padding-left:4px;">
                                                    <asp:TextBox ID="txtCodigo2Edicion" runat="server" Width="568px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                </tr>
                                        ...
                                        <tr>
                                        <td>
                                            <asp:TextBox ID="txtModeloAbreviadoEdicion" runat="server" Width="244px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                             <td style="font-weight: bold">
                                                        Abreviatura
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtAbreviaturaEdicion" runat="server" Width="240px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                        </tr>
                                        </table>
   ...
   <td style="font-weight: bold">
                                    ...
                                    <td style="padding-left:4px;">
                                        ...
                                        <td style = "padding-left:4px;">
                                            <asp:TextBox ID="txtCompatibilidadEdicion" runat="server" Width="568px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight: bold">
                                                ...
                                                <td>
                                                    ...
                                                    <td style = "display:none;">
                                                    <asp:TextBox ID="txtMarcaEdicion" runat="server" Width="101px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
