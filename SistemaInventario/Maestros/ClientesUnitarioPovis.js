var AppSession = "../Maestros/ClientesUnitarioPovis.aspx";
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                      ...
                      F_Update_Division_HTML('div_VendedorEdicion', result.split('~')[12]);
                        ...
                        $('#MainContent_txtCiudad').css('background', '#FFFFE0');
                        $('#MainContent_txtCiudadEdicion').css('background', '#FFFFE0');
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_Placa: '',
            Filtro_Licencia: '',
            Filtro_Ciudad: $(Contenedor + 'txtCiudad').val()
        };
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var D3 = '#' + imgID.replace('imgEditarRegistro', 'hfD3');
        var hfCodigoCliente = '#' + imgID.replace('imgEditarRegistro', 'hfCodigoCliente');
        ...
        $(Cuerpo + 'txtCodigoEdicion').val($(hfCodigoCliente).val());
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_Codigo: $(Contenedor + 'txtCodigoEdicion').val(),
...
function F_EditarRegistroDireccion(Fila) {
    ...
    try {
        ...
        var hfCiudad = '#' + imgID.replace('imgEditarRegistro', 'hfCiudad');
        ...
        $(Cuerpo + 'txtCiudadEdicion').val($(hfCiudad).val());
...
function F_GrabarDireccionMultiple() {
    try {
        ...
        var objParams = {
            ...
            Filtro_GPSLong: (GPSLong == "")? 0 : GPSLong,
            Filtro_GPSLat: (GPSLat == "")? 0 : GPSLat,
            Filtro_Ciudad: $(Contenedor + 'txtCiudadEdicion').val()
        };
...
function F_Excel() {
    ...
    var TipoArchivo = 'application/pdf';
    var CodMenu = 1502;
    var NombreArchivo = 'Xls_Clientes_Listado.xlsx';
