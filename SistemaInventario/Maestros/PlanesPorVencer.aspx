<%@ Page Title="PLANES POR VENCER" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PlanesPorVencer.aspx.cs" 
Inherits="SistemaInventario.Maestros.PlanesPorVencer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="PlanesPorVencer.js" charset="UTF-8"></script>       
        ...
        <tr valign="top">
            <td style="width: 1100px" valign="top">
                <div class="titulo" style="width: 1045px">
                    ...
                    <asp:Label ID="Label3" runat="server" Text="PLANES POR VENCER" Font-Bold="False"
                ...
                <div id="divTabs" style="width: 1045px">
                    <ul>
                       ...
                       <%-- <li id="liRegistro"><a href="#tabRegistro" onclick="getContentTab();">Registro</a></li>--%>
                    </ul>
                                                     ...
                                                     <td>                                  
                                                         <div id="Div_direccion">
                                                            <asp:DropDownList ID="ddldireccionNueva" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="490" Font-Size="Small">
                                                            </asp:DropDownList>
                                                        </div>
                                                      </td>
                                                  <%--       <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td >
                                                        <asp:TextBox ID="txtObservacion" runat="server" Width="550px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" ReadOnly="False"></asp:TextBox>
                                                    </td>
                                               <td style="display: none">
                                                        <asp:CheckBox ID="ChkUnitarioGeneral" runat="server" Text="MOTOR"
                                                            Font-Bold="True"  />
                                                    </td>
                                                   <td style="font-weight: bold">
                                                        Cotizacion
                  ...
                  <table cellpadding="0" cellspacing="0" class="form-inputs">
                                ...
                                <asp:ImageButton runat="server" ID="ImageButton2" ImageUrl="../Asset/images/add_small.png"
                                    ToolTip="DIRECCION" OnClientClick="F_DireccionesTemporal(hfCodigoTemporal,hfCodProvincia,hfCodDistrito,hfCodDepartamento,MainContent_txtDireccionMultiple,MainContent_txtDistritoMultiple,3,1); return false;" />
                                                            ...
                                                            <td style="display: none">
                                                                <asp:TextBox ID="TextBox1" runat="server" Width="90px" Font-Names="Arial" ForeColor="Blue"
                                                                    Font-Bold="True" CssClass="Derecha" ReadOnly="True" Text="0.00"></asp:TextBox>
                                                            </td>
                                                            <td style="font-weight: bold; display: none">
                                                                ACUENTA NV
                                                            ...
                                                            <td style="display: none">
                                                                <asp:TextBox ID="TextBox2" runat="server" Width="90px" Font-Names="Arial" ForeColor="Blue"
                                                                    Font-Bold="True" CssClass="Derecha" ReadOnly="True" Text="0.00"></asp:TextBox>
                                                            </td>
                                                            ...
                                                            <td style="display: none" id="td4">
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td id="td5">
                                                                            <asp:TextBox ID="TextBox3" runat="server" Width="25px" ForeColor="Blue" Font-Names="Arial"
                                                                                Font-Bold="True"></asp:TextBox>
                                                                        </td>
                                                                        <td style="font-weight: bold;">
                                                                            Num.
                                                                        ...
                                                                        <td id="td6">
                                                                            <asp:TextBox ID="TextBox4" runat="server" Width="42px" ForeColor="Blue" Font-Names="Arial"
                                                                                Font-Bold="True"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtNumeroConsulta" runat="server" Width="50" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                            </td>
                                            <td>
                                          ...
                                          <td style="font-weight: bold">
                                            ...
                                            <td>
                                                <div id="div_Mantenimiento">
                                                    <asp:DropDownList ID="ddlMantenimiento" runat="server" Font-Names="Arial" ForeColor="Blue"
                        ...
                        <div id="div_consulta">
                            <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                                ...
                                <Columns>                        
                                  ...
                                  <asp:TemplateField >
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgEditarDocumento" ImageUrl="~/Asset/images/btnEdit.gif"
                                                ToolTip="AGENDAR MANTENIMIENTO" OnClientClick="F_EditarMantenimientoPopUP(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>                      
                                  ...
                                  <asp:TemplateField HeaderText="FT" Visible="false">
                                        <ItemTemplate>
                                  ...
                                  <asp:TemplateField HeaderText="CE" Visible="false">
                                        <ItemTemplate>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Panel ID="pnlOrdersObservacion" runat="server" Style="display: none">
                                    <asp:GridView ID="grvDetalleObservacion" runat="server" border="0" CellPadding="0"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="Observacion" HeaderText="Observacion Mantenimiento">
                                  ...
                                  <asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Numero" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hfCodTipoDoc" runat="server" Value='<%# Bind("CodTipoDoc") %>' />
                                            <asp:HiddenField ID="hfCodEstadoMantenimiento" runat="server" Value='<%# Bind("CodEstadoMantenimiento") %>' />
                                            <asp:HiddenField ID="hfObservacionMantenimiento" runat="server" Value='<%# Bind("ObservacionMantenimiento") %>' />
                                    ...
                                    <asp:BoundField DataField="Total" HeaderText="Total" HeaderStyle-HorizontalAlign="Center" >
                                        ...
                                        <asp:BoundField DataField="Celular" HeaderText="Celular" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:BoundField>                          
                                   <asp:BoundField DataField="TipoPlan" HeaderText="Plan" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:BoundField>                                           
 <asp:TemplateField HeaderText="Fec. Mant." HeaderStyle-HorizontalAlign="Center" >
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblMantenimiento" Text='<%# Bind("Mantenimiento") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
  <asp:TemplateField HeaderText="Placa" HeaderStyle-HorizontalAlign="Center" >
                      ...
                      <%--              <asp:TemplateField HeaderText="Estado" HeaderStyle-HorizontalAlign="Center" >
                                     ...
                                     <asp:TemplateField HeaderText="M.Agendado" HeaderStyle-HorizontalAlign="Center" >
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblAgendado" Text='<%# Bind("Agendado") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
    ...
    <div id="div_MantenimientoConsulta" style="display: none;">
        <div class="ui-jqdialog-content">
            <table cellpadding="0" cellspacing="0">
                  <tr>
                    <td colspan="2">
                        <asp:Button ID="btnGrabarMantenimiento" runat="server" Text="Grabar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="120" />
                    </td>
                </tr>
                <tr>
                ...
                <table>
                 ...
                 Mantemimiento
                  ...
                  <td>
                      <div id="div_MantenimientoEdicion">
                          <asp:DropDownList ID="ddlMantenimientoEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                              Font-Bold="True" Width="100">
                          </asp:DropDownList>
                      </div>
                  </td>
                 ...
                 Fecha Mantenmiento
                     ...
                     <td>
                     <asp:TextBox ID="txtAgenda" runat="server" Width="56px" CssClass="Jq-ui-dtp" Font-Names="Arial"
                         ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                 </td>
                 </table>
                 ...
                 COMENTARIO
                  ...
                  <tr>
                   ...
                   <td  colspan="2">
                        <asp:TextBox ID="txt_ObservacionMantenimiento" runat="server" Width="450px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" TextMode="MultiLine" Height="80"></asp:TextBox>
                    </td>
                  </tr>
                                ...
                                <td>
                                 ...
                                 <td>
                                                        <asp:CheckBox ID="chkConCodigoEdicion" runat="server" Text="CON CODIGO" Font-Bold="True" />
                                                         ...
                                                         <td style="display: none">
                                                        <asp:CheckBox ID="chkUnitario" runat="server" Text="MOTOR" Font-Bold="True" />
                                                    </td>
                </tr>
                </table>
                </td>
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="font-weight: bold; padding-left: 12px;color: #FF0000; font-size: small;">
                                                    Destino
                                                </td>
                                                <td style="padding-left: 15px;">
                                ...
                                <tr>
                                 ...
                                 C.AGENCIA
                                   ...
                                   Placa
                                                 ...
                                                 <td style="font-weight: bold">
                                                                <asp:TextBox ID="txtLicenciaGuiaEdicion" runat="server" Width="142" Font-Names="Arial" ForeColor="Blue"
                                                                    Font-Bold="True"></asp:TextBox>
                                                            </td> 
                                                </tr>
                                                </table>
                   ...
                   <table cellpadding="0" cellspacing="0" width="750" class="form-inputs">
                                ...
                                <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                             ...
                                             <td style="font-weight: bold;padding-left: 4px;">
                                                ...
                                                <tr>
                                                 <td style="padding-left:0px;">
                                    <asp:TextBox ID="TextBox3" runat="server" Width="80px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                 ...
                                 C.AGENCIA
                                                 ...
                                                 <td style="font-weight: bold;padding-left:0px;">
                                    <asp:TextBox ID="TextBox4" runat="server" Width="105px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                                 <td style="font-weight: bold;">
                                   Placa
...
--%>
    ...
    <div id="div_Mantenimiento2" style="display: none;">
        <div class="ui-jqdialog-content">
            <table cellpadding="0" cellspacing="0" class="form-inputs">
                <tr>
                    <td colspan="2">
...
<input id="hfCodTipoDoc_grilla" type="hidden" value="0" />
  ...
  <input id="hfCodTransportistaEdicion" type="hidden" value="0" />
   ...
   <input id="hfCodCtaCteTransportista" type="hidden" value="0" />
    ...
    <input id="hfCodEstadoMantenimiento" type="hidden" value="0" />
</asp:Content>
