var AppSession = "../Maestros/ClientesUnitarioKarina.aspx";
...
$(document).ready(function () {
    ...
    $('#MainContent_txtCelularDireccionEdicion').css('background', '#FFFFE0');
    $("#MainContent_txtCelularDireccionEdicion").ForceNumericOnly();
...
function F_EditarRegistroDireccion(Fila) {
    ...
    try {
        ...
        $(Cuerpo + 'txtCelularDireccionEdicion').val($(lblCelular).text());
...
function F_ValidarGrabarDireccionMultiple() {
    try {
        ...
        if ($(Cuerpo + 'txtDireccionEdicionMultiple').val() == '')
           ...
           if (F_ValidarCelular($(Cuerpo + 'txtCelularDireccionEdicion').val())!='')
        Cadena = Cadena + '<p></p>' + F_ValidarCelular($(Cuerpo + 'txtCelularDireccionEdicion').val());
...
function F_GrabarDireccionMultiple() {
    try {
        ...
        if ($(Contenedor + 'txtCelularDireccionEdicion').val() !='')
            Celular = '51' + $(Contenedor + 'txtCelularDireccionEdicion').val();
        ...
        F_GrabarDireccionMultiple_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente') {
                    ...
                    $(Contenedor + 'txtCelularDireccionEdicion').val('');
