<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="ProductosSalazar.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosSalazar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosSalazar.js" charset="UTF-8"></script>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtCodigoInterno" runat="server" Width="235px" Font-Names="Arial"
                                    ...
                                    <tr>
                                        <td style="font-weight: bold">
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                        <td>
                                            <asp:TextBox ID="txtDescripcion" runat="server" Width="546px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                 ...
                                                 <td>
                                                        <asp:TextBox ID="txtCosto" runat="server" Width="70px" Font-Names="Arial" ForeColor="Blue"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPrecio1" runat="server" Width="70px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        MECANICO
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPrecio3" runat="server" Width="70px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                            ...
                            <div id="div_consulta" style="padding-top: 5px;">
                                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Precio1Edicion" HeaderText="NORMAL" DataFormatString="{0:N2}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Precio2Edicion" HeaderText="MECANICO" DataFormatString="{0:N2}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                         <asp:BoundField DataField="Precio3Edicion" HeaderText="MAYORISTA" DataFormatString="{0:N2}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                        ...
                        <div class="ui-jqdialog-content" style="width: 700px">
                            <table cellpadding="0" cellspacing="0" class="form-inputs">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                     <td>
                                        <asp:TextBox ID="txtDescripcionEdicion" runat="server" Width="508px" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <div id="div_MonedaEdicion">
                                                        <asp:DropDownList ID="ddlMonedaEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                           Enabled="False"  Font-Bold="True" Width="65">
                                                        </asp:DropDownList>
                                                    </div>
                                                </td>
                                                <td style="font-weight: bold;">
                                                    ...
                                                    <td>   
                                                   <asp:TextBox ID="txtCostoEdicion" runat="server" Width="65px" Font-Names="Arial"
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtPrecio1Edicion" runat="server" Width="65px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                 mecanico
                                                ...
                                                <td >
                                                    <asp:TextBox ID="txtPrecio2Edicion" runat="server" Width="65px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                        ...
                                        Mayorista
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtPrecio3Edicion" runat="server" Width="65px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                               <td >
                                                  ...
                                                  <asp:TextBox ID="txtMarcaEdicion" runat="server" Width="120px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                                   <td>
