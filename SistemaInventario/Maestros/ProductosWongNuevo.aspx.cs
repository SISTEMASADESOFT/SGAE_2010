...
{
    public partial class ProductosWongNuevo : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlUMCompra,
                    ...
                    ref ddlCompraEdicion, ref ddlVentaEdicion, ref ddlMonedaEdicion, ref ddlMonedaCostoInicial, ref ddlMonedaCostoInicialEdicion);
            ...
            str_resultado =
                ...
                + "~" +
                str_ddl_costomonedaedicion_html;
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
                                            ...
                                            ref DropDownList ddl_combomonedacostoinicial, ref DropDownList ddl_combomonedacostoinicialedicion)
        {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("FamilitaTipoProducto", typeof(string));
            dta_consultaarticulo.Columns.Add("CodFamiliaTipoProducto", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodigoOem = Convert.ToString(objTablaFiltro["Filtro_CodigoOem"]);
            objEntidad.CodigoProveedor = Convert.ToString(objTablaFiltro["Filtro_Proveedor"]);
            objEntidad.CodigoFabrica = Convert.ToString(objTablaFiltro["Filtro_CodigoFabrica"]);
            objEntidad.CodFamiliaTipoProducto = Convert.ToInt32(objTablaFiltro["Filtro_CodFamiliaTipoProducto"]);
            objOperacion = new LGProductosCN();
            
            objOperacion.F_LGProductos_Insert_WONG_NUEVO(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodigoFabrica = Convert.ToString(objTablaFiltro["Filtro_CodigoFabrica"]);
            objEntidad.CodFamiliaTipoProducto = Convert.ToInt32(objTablaFiltro["Filtro_CodTipoProducto"]);

            objOperacion = new LGProductosCN();

            objOperacion.F_LGProductos_Update_Wong_Nuevo(objEntidad);
