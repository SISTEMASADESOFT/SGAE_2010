    ...
    <div id="divTabs" style="width: 1230px;">
                            ...
                            <div>
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    ...
                                    <tr style="display: none">
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtMedida2" runat="server" Width="211px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Posicion
                                    ...
                                    <tr>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                   <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtMedida" runat="server" Width="170px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>  
                                                   <td style="font-weight: bold">
                                              Categoria
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtObservacion1" runat="server" Width="568px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtObservacion2" runat="server" Width="568px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                   ...
                                   Ubicacion
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtUbicacionAlmacen" runat="server" Width="568px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
        ...
        <div id="tabConsulta">
            <div id='divConsulta' class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                ...
                <asp:Button ID="btnaplicacion" runat="server" Text="Aplicacion" CssClass="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        Font-Names="Arial" Width="120" />
                <asp:Button ID="btnReferencia" runat="server" Text="Referencia" CssClass="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        Font-Names="Arial" Width="120" />
...
<%--                                         <asp:ImageButton runat="server" ID="imgAgregar" ImageUrl="~/Asset/images/ok.gif"
                        ...
                        <asp:TemplateField>
                           ...
                           <%--                  <asp:BoundField DataField="Referencia" HeaderText="Referencia">
                                            ...
                                            <asp:BoundField DataField="Linea" HeaderText="Marca">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="Año" HeaderText="Año Inicial">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="AñoFinal" HeaderText="Año Final">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                              ...
                              <%--  <asp:HiddenField ID="hfCostoSoles" runat="server" Value='<%# Bind("CostoSoles") %>' />
                                ...
                                <asp:HiddenField ID="hfPrecioLista" runat="server" Value='<%# Bind("PrecioLista") %>' />
                                <asp:HiddenField ID="hfObservacion1" runat="server" Value='<%# Bind("Observacion1") %>' />
                                <asp:HiddenField ID="hfObservacion2" runat="server" Value='<%# Bind("Observacion2") %>' />
                                <asp:HiddenField ID="hfUbicacionAlmacen" runat="server" Value='<%# Bind("UbicacionAlmacen") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="Costo" HeaderText="U.C" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        
                        <asp:BoundField DataField="PrecioLista" HeaderText="P.L" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        ...
                        <div class="ui-jqdialog-content" style="width: 700px">
                            <table cellpadding="0" cellspacing="0" class="form-inputs">
                                ...
                                <tr style="display: none">
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtMedidaEdicion2" runat="server" Width="211px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    Posicion
                                ...
                                <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                   <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtMedidaEdicion" runat="server" Width="170px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>  
                                                     <td style="font-weight: bold">
                                              Categoria
                                       ...
                                       <tr>
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtObservacion1Edicion" runat="server" Width="568px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                       <tr>
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtObservacion2Edicion" runat="server" Width="568px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <td style="padding-left: 4px;">
                                        <asp:TextBox ID="txtUbicacionAlmacenEdicion" runat="server" Width="568px" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
    ...
    <div id="divProductosRelacionados" class="wrapper" style="display: none;">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtAñoFinal" runat="server" Width="500px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtPosicionDetalle" runat="server" Width="500px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="padding-top: 5px; font-weight: bold;display:none">
                        Caja Cambio
                    </td>
                        ...
                        <div id="div_ProductoDetalle">
                            <asp:GridView ID="grvProductoDetalle" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Año Inicio" HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblAño" Text='<%# Bind("Año") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Año Final" HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblAñoFinal" Text='<%# Bind("AñoFinal") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Posicion" HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblPosicion" Text='<%# Bind("Posicion") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Caja Cambio" HeaderStyle-HorizontalAlign="Center" Visible="false">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblCajaCambio" Text='<%# Bind("CajaCambio") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Transmision" HeaderStyle-HorizontalAlign="Center" Visible="false">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblTransmision" Text='<%# Bind("Transmision") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Filtro" HeaderStyle-HorizontalAlign="Center"  Visible="false">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtAñoFinalEdicion" runat="server" Width="370px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                 <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtPosicionDetalleEdicion" runat="server" Width="370px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
        ...
        <div id="div_Referencia" class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="display: none;">
            <div class="ui-jqdialog-content">
            <table cellpadding="0" cellspacing="0" class="form-inputs">
                <tr>
                    <td style="padding-top: 10px; font-weight: bold">
                    ...
                    <td style="padding-top: 10px;">
                        <asp:TextBox ID="txtCodReferencia" runat="server" Width="500px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtCodigoProducto" runat="server" Width="500px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtMarcaRefencia" runat="server" Width="500px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtFamiliaReferencia" runat="server" Width="500px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
            ...
            <div class="linea-button">
                        <asp:Button ID="btnbuscarrefencia" runat="server" Text="Buscar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="120" />
                        <asp:Button ID="btngrabarrefencia" runat="server" Text="GRABAR" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="120" />
            </div>
            <div style="padding-top: 5px;">
                <table cellpadding="0" cellspacing="0" align="center">
                    <tr>
                        ...
                        <td style="font-weight: bold">
                            <label id="lblNumeroReferencia">0
                            </label>
                        </td>
                    </tr>
                </table>
         ...
         <div>
            <div >
               <table>
                <tr>
                    <td style="padding-top: 5px;" colspan="2">
                        <div id="div_consultareferencia">
                            <asp:GridView ID="grvConsultareferencia" runat="server" AutoGenerateColumns="False"
                                border="0" CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None"
                                Width="660px" OnRowDataBound="grvConsultaReferencia_RowDataBound">
                                <Columns>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                                ToolTip="ELIMINAR DETALLE PRODUCTO" OnClientClick="F_EliminarReferenciaProducto(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgEditarRegistro" ImageUrl="../Asset/images/btnEdit.gif"
                                                ToolTip="EDITAR DETALLE PRODUCTO" OnClientClick="F_EditarReferenciaProducto(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Referencia" HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblReferencia" Text='<%# Bind("Referencia") %>' CssClass="detallesart"></asp:Label>
                                            <asp:HiddenField ID="hfCodReferencia" runat="server" Value='<%# Bind("CodReferencia") %>' />
                                            <asp:HiddenField ID="hfCodMarca" runat="server" Value='<%# Bind("CodMarca") %>' />
                                            <asp:HiddenField ID="hfCodProducto" runat="server" Value='<%# Bind("CodProducto") %>' />
                                            <asp:HiddenField ID="hfIdFamilia" runat="server" Value='<%# Bind("IdFamilia") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Codigo Producto" HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="left" />
                                        <ItemTemplate>
        ...
        <div id="div_ReferenciaEdicion" style="display: none;">
        <div  class="ui-jqdialog-content" >
            <table cellpadding="0" cellspacing="0" class="form-inputs">
                <tr>
                    <td style="padding-top: 10px; font-weight: bold">
                    ...
                    <td style="padding-top: 10px;">
                        <asp:TextBox ID="txtReferenciaEdicion" runat="server" Width="360px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtProductoReferenciaEdicion" runat="server" Width="360px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtMarcaRefenciaEdicion" runat="server" Width="360px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtFamiliaReferenciaEdicion" runat="server" Width="360px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True" ></asp:TextBox>
                    </td>
                </tr>
            </table>
        ...
        <div class="linea-button">
                        ...
                        <asp:Button ID="btnGrabarRefenciaEdicion" runat="server" Text="GRABAR" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="120" />
             
        </div>
        </div>
         <div id="div_AplicacionReferencia" class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="display: none;">
         <div>
          <table cellpadding="0" cellspacing="0" class="form-inputs">
                <tr>
                    <td style="padding-top: 10px; font-weight: bold">
                    ...
                    <td style="padding-top: 10px;">
                        <asp:TextBox ID="txtReferenciaAplicacion" runat="server" Width="500px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtModeloAplicacion" runat="server" Width="500px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtAñoInicialAplicacion" runat="server" Width="500px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                  <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtAñoFinalAplicacion" runat="server" Width="500px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtMotorAplicacion" runat="server" Width="500px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr style="display: none;">
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtCajaCambioAplicacion" runat="server" Width="500px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr style="display: none;">
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtTransmisionAplicacion" runat="server" Width="500px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr style="display: none;">
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtFiltroAplicacion" runat="server" Width="500px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
          ...
          <div class="linea-button">
                    <asp:Button ID="btnBuscaraplicacion" runat="server" Text="Buscar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="120" />
                        <asp:Button ID="btngrabaraplicacion" runat="server" Text="GRABAR" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="120" />
         </div>
         <div style="padding-top: 5px;">
                <table cellpadding="0" cellspacing="0" align="center">
                    <tr>
                        ...
                        <td style="font-weight: bold">
                            <label id="lblNumeroAplicaciones">0
                            </label>
                        </td>
                    </tr>
                </table>
       ...
       <table>
                <tr>
                    <td style="padding-top: 5px;" colspan="2">
                        <div id="div_ReferenciaAplicacion">
                            <asp:GridView ID="grvReferenciaAplicacion" runat="server" AutoGenerateColumns="False"
                                border="0" CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None"
                                Width="860px">
                                <Columns>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                                ToolTip="ELIMINAR DETALLE PRODUCTO" OnClientClick="F_EliminarAplicacionProducto(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgEditarRegistro" ImageUrl="../Asset/images/btnEdit.gif"
                                                ToolTip="EDITAR DETALLE PRODUCTO" OnClientClick="F_EditarAplicacionProducto(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Referencia" HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="left" />
                                    ...
                                    <asp:TemplateField HeaderText="Año Inicial"  HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblAñoInicial" Text='<%# Bind("Año") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Año Final" HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="Left" />
        ...
        <div id="div_AplicacionReferenciaEdicion" style="display: none;">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td style="padding-top: 10px; font-weight: bold">
                        Referencia
                    ...
                    <td style="padding-top: 10px;">
                        <asp:TextBox ID="txtReferenciaAplicacionEdicion" runat="server" Width="370px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtModeloAplicacionEdicion" runat="server" Width="370px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtAñoAplicacionInicialEdicion" runat="server" Width="370px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtAñoAplicacionFinalEdicion" runat="server" Width="370px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtMotorAplicacionEdicion" runat="server" Width="370px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr style="display: none;"> 
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtCajaCambioAplicacionEdicion" runat="server" Width="370px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr style="display: none;">
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtTransmisionAplicacionEdicion" runat="server" Width="370px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr style="display: none;">
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtFiltroAplicacionEdicion" runat="server" Width="370px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="padding-top: 10px;" align="right" colspan="2">
                        <asp:Button ID="btnaplicacionedicion" runat="server" Text="GRABAR" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" Width="120" />
                    </td>
                </tr>
            </table>
    ...
    <input id="hfCodMarcaReferencia" type="hidden" value="0" />
    <input id="hfCodProductoReferencia" type="hidden" value="0" />
    <input id="hfCodProductoReferenciaEdicion" type="hidden" value="0" />
    <input id="hfCodMarcaReferenciaEdicion" type="hidden" value="0" />
    <input id="hfCodProductoReferenciaCabEdicion" type="hidden" value="0" />
    <input id="hfCodProductoReferenciaCab" type="hidden" value="0" />
    <input id="hfCodReferenciaAplicacion" type="hidden" value="0" />
    <input id="hfCodModeloAplicacion" type="hidden" value="0" />
    <input id="hfCodModeloAplicacionEdicion" type="hidden" value="0" />
    <input id="hfCodReferenciaAplicacionEdicion" type="hidden" value="0" />
    <input id="hfReferencia" type="hidden" value="0" />
    <input id="hfidFamiliaReferencia" type="hidden" value="0" />
    <input id="hfidFamiliaReferenciaEdicion" type="hidden" value="0" />
    <input id="hfDescripcionproductoreferencia" type="hidden" value="0" />
    <input id="hfDescripcionproductoreferenciaedicion" type="hidden" value="0" />
</asp:Content>
