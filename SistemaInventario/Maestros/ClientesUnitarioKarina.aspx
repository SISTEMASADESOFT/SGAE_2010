<%@ Page Title="Clientes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientesUnitarioKarina.aspx.cs" Inherits="SistemaInventario.Maestros.ClientesUnitarioKarina" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ClientesUnitarioKarina.js" charset="UTF-8"></script>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-left: 2px; font-weight: bold">
                                            <asp:TextBox ID="txtGPSLongLat" runat="server" Width="327px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold">
                                            Categoria
                                ...
                                <asp:TemplateField HeaderText="Celular 3" HeaderStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblCelular3" Text='<%# Bind("Celular3") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Correo 1" HeaderStyle-HorizontalAlign="Center">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblCorreo1" Text='<%# Bind("Correo1") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                               <asp:TemplateField HeaderText="Correo 2" HeaderStyle-HorizontalAlign="Center">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblCorreo2" Text='<%# Bind("Correo2") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Correo 3" HeaderStyle-HorizontalAlign="Center">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
            ...
            <table cellpadding="0" cellspacing="0" class="form-inputs">               
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td style="padding-left: 5px; padding-top: 5px;">
                        <asp:TextBox ID="txtCelularDireccionEdicion" runat="server" Width="80px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" MaxLength="9"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="font-weight: bold">
