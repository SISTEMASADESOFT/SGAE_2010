...
namespace SistemaInventario.Maestros
{
    public partial class ProductosRoman : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlUMCompra,
                    ...
                    ref ddlCompraEdicion, ref ddlVentaEdicion, ref ddlMonedaEdicion, ref ddlEstado, ref ddlEstadoEdicion, ref ddlMarca);
            ...
            str_resultado =
                ...
                str_ddl_codestadoedicion_html+ "~" +
                str_ddl_marca_html; //14
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
                                            ...
                                            ref DropDownList ddl_comboestado, ref DropDownList ddl_comboestadoedicion, ref DropDownList ddl_combomarca)
        {
            ...
            ddl_combomarca.Items.Clear();
            string codFamilia = "0";
            dta_consulta = ObjProductosOperaciones.F_Marcas_Listar_Roman(codFamilia);
            ddl_combomarca.DataSource = dta_consulta;
            ddl_combomarca.DataTextField = "Marca";
            ddl_combomarca.DataValueField = "Marca";
            ddl_combomarca.DataBind();
            ddl_combomarca.Items.Insert(0, new ListItem("TODOS", "0"));
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            //dta_consultaarticulo.Columns.Add("Principal", typeof(string));
            dta_consultaarticulo.Columns.Add("CENTRAL", typeof(string));
            dta_consultaarticulo.Columns.Add("ATE", typeof(string));
            dta_consultaarticulo.Columns.Add("ABANCAY", typeof(string));
            dta_consultaarticulo.Columns.Add("VICTORIA", typeof(string));
            dta_consultaarticulo.Columns.Add("VES", typeof(string));
            dta_consultaarticulo.Columns.Add("CENTRALUbicacion", typeof(string));
            dta_consultaarticulo.Columns.Add("AteUbicacion", typeof(string));
            dta_consultaarticulo.Columns.Add("ABANCAYUbicacion", typeof(string));
            dta_consultaarticulo.Columns.Add("VICTORIA1Ubicacion", typeof(string));
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_LGProductos_Listar_Roman(objEntidad);
