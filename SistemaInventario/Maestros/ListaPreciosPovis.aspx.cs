    ...
    public partial class ListaPreciosPovis : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlFamilia, ref ddlcategoria);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofamilia, ref DropDownList ddl_combocategoria)
        {
            ...
            ddl_combocategoria.Items.Insert(0, new ListItem("--Todos--", "0"));
        ...
        public void P_Inicializar_GrillaVacia()
        {
            ...
            dta_consultaarticulo.Columns.Add("semaforo", typeof(string));
        ...
        public void P_Cargar_Grilla(Hashtable objTablaFiltro, ref GridView grvConsulta)
        {
            ...
            grvConsulta.DataSource = objOperacion.F_LGProductos_ListarProductosPrecios_Povis(objEntidad);
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " Preciolista   = '" + item.Preciolista + "'";
                XmlDetalle = XmlDetalle + " CodCategoria   = '" + item.CodCategoria + "'";
