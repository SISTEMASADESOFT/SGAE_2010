...
{
    public partial class ProductosCarbon : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlUMCompra,
                    ...
                    ref ddlCompraEdicion, ref ddlVentaEdicion, ref ddlMonedaEdicion, ref ddlMonedaCostoInicial, ref ddlMonedaCostoInicialEdicion,ref ddlservicio, ref ddlservicioEdicion);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
                                            ...
                                            ref DropDownList ddl_combomonedacostoinicial, ref DropDownList ddl_combomonedacostoinicialedicion, ref DropDownList ddl_comboServicio, ref DropDownList ddl_comboServicioEdicion)
        {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodDetraccion = Convert.ToInt32(objTablaFiltro["Filtro_Detraccion"]);

            objOperacion = new LGProductosCN();

           //objOperacion.F_LGProductos_Insert_Standard(objEntidad);
            objOperacion.F_LGProductos_Insert_Carbon(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Update_Carbon(objEntidad);
