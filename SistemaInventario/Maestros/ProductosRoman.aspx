                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 15px;">
                                                        <asp:TextBox ID="txtPosicion" runat="server" Width="250px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtAño" runat="server" Width="40px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    ...
                                                    <td style="padding-left: 5px">
                                                      ...
                                                      <td style="font-weight: bold; padding-left: 5px">
                                                         ...
                                                         <td style="">
                                                        <asp:TextBox ID="txtPrecio1" runat="server" Width="52px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr >
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtUbicacion" runat="server" Width="568px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                ...
                <div class="ui-jqdialog-content">
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        ...
                        <td style="font-weight: bold; ">
                            ...
                            <td>
                                <asp:TextBox ID="txtDescripcionConsulta" runat="server" Width="347" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
            ...
            <div id="div_consulta" style="padding-top: 5px;">
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                              ...
                              <%--  margeners--%>
                                ...
                                <asp:HiddenField ID="hfCENTRALUbicacion" runat="server" Value='<%# Bind("CENTRALUbicacion") %>' />
                                <asp:HiddenField ID="hfAteUbicacion" runat="server" Value='<%# Bind("AteUbicacion") %>' />
                                <asp:HiddenField ID="hfABANCAYUbicacion" runat="server" Value='<%# Bind("ABANCAYUbicacion") %>' />
                                <asp:HiddenField ID="hfVICTORIA1Ubicacion" runat="server" Value='<%# Bind("VICTORIA1Ubicacion") %>' />
                                <asp:HiddenField ID="hfVESUbicacion" runat="server" Value='<%# Bind("VESUbicacion") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="Precio1" HeaderText="Precio 1" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Precio2" HeaderText="Precio 2" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                      ...
                      <%--  <asp:BoundField DataField="Principal" HeaderText="PRINCIPAL" DataFormatString="{0:N0}">
                        ...
                        <asp:BoundField DataField="CENTRAL" HeaderText="CEN" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemStyle Width="50px" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="ABANCAY" HeaderText="ABA" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemStyle Width="50px" />
                        </asp:BoundField>
                                <asp:BoundField DataField="VICTORIA" HeaderText="LAVICTORIA" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemStyle Width="50px" />
                        </asp:BoundField>
                                ...
                                <tr>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtAñoEdicion" runat="server" Width="40px" Font-Names="Arial" ForeColor="Blue"
                                                        Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 3px; font-weight: bold;display: none">
                                                    UM COMPRA
                                                </td>
                                                ...
                                                <td style="padding-left: 2px; font-weight: bold ">
                                                    <asp:TextBox ID="txtPrecio1Edicion"   runat="server" Width="52px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr >
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding-left: 2px;">
                                                    <asp:TextBox ID="txtUbicacionEdicion" runat="server" Width="560px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold; padding-left: 5px;display: none">
                                                    Stock Min
