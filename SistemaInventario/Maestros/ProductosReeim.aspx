...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divTabs" style="width: 1200px; height: 500px">
                                     ...
                                     <tr >
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtstocktrans" runat="server" Width="75px" Font-Names="Arial"
                                                            CssClass="Derecha" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 2px; font-weight: bold">
                                                        M.S.TRAN
                                                    ...
                                                    <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtMStockTrans" runat="server" Width="75px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                     <td style="font-weight: bold">
                                                        ORIGEN
                                                    ...
                                                    <td style="padding-left: 33px;">
                                                        <div id="div_origen">
                                                            <asp:DropDownList ID="ddlorigen" runat="server" Font-Names="Arial" Width="110" ForeColor="Blue"
                                                                Font-Bold="True" >
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
        ...
        <div id="tabConsulta">
            <div id='divConsulta' class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 22px; font-weight: bold;">
                              ...
                              <td style="font-weight: bold">
                                                    ...
                                                    <td style="padding-left: 6px;">
                                                        <div id="div_origenConsulta">
                                                            <asp:DropDownList ID="ddlorigenConsulta" runat="server" Font-Names="Arial" Width="110" ForeColor="Blue"
                                                                Font-Bold="True" >
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                ...
                <div class="linea-button">
                 <asp:Button ID="btnAcceso" runat="server" Text="Acceso" CssClass="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                    ...
                    <Columns>
                        <asp:TemplateField ItemStyle-Width="85px">
                            <ItemTemplate>
                                ...
                                <asp:ImageButton runat="server" ID="imgDetalleProducto" ImageUrl="../Asset/images/texto.png"
                                    ToolTip="FACTOR PRODUCTO" OnClientClick="F_FactorProducto(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%--            <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Codigo">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfaccesomarca" runat="server" Value='<%# Bind("accesomarca") %>' />
                                <asp:HiddenField ID="hfaccesousuario" runat="server" Value='<%# Bind("accesousuario") %>' />
                                <asp:HiddenField ID="hfStockTransportista" runat="server" Value='<%# Bind("StockTransportista") %>' />
                                <asp:HiddenField ID="hfMargenStockTransportista" runat="server" Value='<%# Bind("MargenStockTransportista") %>' />
                                <asp:HiddenField ID="hfCodOrigen" runat="server" Value='<%# Bind("CodOrigen") %>' />
                                <asp:HiddenField ID="hfFOB" runat="server" Value='<%# Bind("FOB") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="Stock" HeaderText="Pri">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                          <asp:BoundField DataField="Stockcieneguilla" HeaderText="Cie">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                         <asp:BoundField DataField="StockVitrina" HeaderText="Vit">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                         <asp:BoundField DataField="StockMerma" HeaderText="Mer">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
    ...
    <div id="divEdicionRegistro" style="display: none;">
        <table cellpadding="0" cellspacing="0">
            <tr>
                    ...
                    <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 640px;">
                        ...
                        <div class="ui-jqdialog-content"> 
                            <table cellpadding="0" cellspacing="0" class="form-inputs">
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                         ...
                                         <%--       <td>
                                                ...
                                                <tr id="tdcostoSoles">
                                                 ...
                                                 <td style="padding-left: 150px; font-weight: bold">
                                                        Cost. C/Igv S/ 
                                                </td>
                                                 <td style="">
                                ...
                                <tr id="tdtrans" style="font-weight: bold">
                                        <td style="font-weight: bold;">
                                            STOCK TRANS.
                                        </td>
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtstocktransEdicion" runat="server" Width="75px" Font-Names="Arial"
                                                            CssClass="Derecha" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 3px; font-weight: bold">
                                                        M STK TRAN
                                                    ...
                                                    <td style="padding-left: 11px;">
                                                        <asp:TextBox ID="txtMStockTransEdicion" runat="server" Width="75px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                                 <td style="font-weight: bold">
                                                        ORIGEN
                                                    ...
                                                    <td style="padding-left: 27px;">
                                                        <div id="div_origenedicion">
                                                            <asp:DropDownList ID="ddlorigenEdicion" runat="server" Font-Names="Arial" Width="110" ForeColor="Blue"
                                                                Font-Bold="True" >
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                ...
                <td style="padding-left: 5px;" valign="top;display:none;">
                    <%--IMAGEN--%>
    ...
    <div id="Div_AccesoMarca" style="display: none;">
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td style="padding-top: 10px; font-weight: bold">
                    Usuario
               ...
               <td style="padding-left: 9px;">
                                                        <div id="div_usuariomarca">
                                                            <asp:DropDownList ID="ddlUsuarioMarca" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="538px">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
            </tr>
            <tr>
                ...
                <td style="padding-top: 5px;padding-left: 9px;">
                    <asp:TextBox ID="txtMarcaAcceso" runat="server" Width="534px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding-top: 5px;" colspan="2">
                  <div class="linea-button">
                                <asp:Button ID="btnGrabarAcceso" runat="server" Text="Grabar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                    Font-Names="Arial" Font-Bold="True" Width="120px" />
                            </div>
                    <div id="div_AccesoMarca">
                        <asp:GridView ID="grvAccesomarca" runat="server" AutoGenerateColumns="False"
                            border="0" CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None"
                            Width="600px">
                            <Columns>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton runat="server" ID="imgAnularAcceso" ImageUrl="~/Asset/images/EliminarBtn.png"
                                            ToolTip="ELIMINAR ACCESO MARCA" OnClientClick="F_EliminarAcceso(this); return false;" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Usuario" HeaderStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hfCodUsuarioMarca" runat="server" Value='<%# Bind("CodusuarioMarca") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
      ...
      <div id="div_FactorRedondeo" style="display: none;">
        <table cellpadding="0" cellspacing="0">
             ...
             <tr>
                ...
                <td style="padding-top: 10px;">
                      <div id="div_global">
                          <asp:DropDownList ID="ddlGlobalFactor" runat="server" Font-Names="Arial" ForeColor="Blue"
              ...
              <td style="padding-top: 10px;">
                    <asp:TextBox ID="txtProductoFactor" runat="server" Width="296px" Font-Names="Arial"
                        ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                </td>
             </tr>  
             <tr>
                ...
                <td style="padding-top: 10px;">
                      <div id="div_FactorRotacion">
                          <asp:DropDownList ID="ddlFactorRotacion" runat="server" Font-Names="Arial" ForeColor="Blue"
                              Font-Bold="True" Width="300">
                          </asp:DropDownList>
                      </div>
                </td>
             ...
             <tr>
                ...
                <td style="padding-top: 5px;">
                    <asp:TextBox ID="txtFactor" runat="server" Width="297px" Font-Names="Arial" ForeColor="Blue"
                        Font-Bold="True"></asp:TextBox>
                </td>
             </tr>
             <tr>
               <td style="padding-top: 5px; font-weight: bold">
                ...
                <td style="padding-top: 5px;">
                      <div id="div_SucursalFactor">
                           <asp:DropDownList ID="ddlSucursalFactor" runat="server" Font-Names="Arial" ForeColor="Blue"
                               Font-Bold="True" Width="300">
                           </asp:DropDownList>
                       </div>
                </td>
             ...
             <table>
                ...
                <td style="padding-top: 10px; color: black;font-size: 10px;">
                       <label id="lblleyenda">0
                            </label>
                </td>
            </table>
             </tr>
            ...
            <tr>
                <td style="padding-top: 5px;" align="right" colspan="2">
                    <asp:Button ID="btngrabarFactor" runat="server" Text="GRABAR" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        Font-Names="Arial" Font-Bold="True" Width="120" />
                </td>
            </tr>
            <tr>
                <td style="padding-top: 5px;" colspan="2">
                    <div id="div_ProductoFactor">
                        <asp:GridView ID="grvProductoFactor" runat="server" AutoGenerateColumns="False"
                            border="0" CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None"
                            Width="680px" OnRowDataBound="grvProductoFactor_RowDataBound">
                            <Columns>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                            ToolTip="ELIMINAR FACTOR PRODUCTO" OnClientClick="F_EliminarFactorProducto(this); return false;" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton runat="server" ID="imgEditarRegistro" ImageUrl="../Asset/images/btnEdit.gif"
                                            ToolTip="EDITAR FACTOR PRODUCTO" OnClientClick="F_EditarFactorProducto(this); return false;" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblProducto" Text='<%# Bind("Producto") %>'></asp:Label>
                                        <asp:HiddenField ID="hfCodProductoFactor" runat="server" Value='<%# Bind("CodProductoFactor") %>' />
                                        <asp:HiddenField ID="hfCodFactor" runat="server" Value='<%# Bind("CodFactor") %>' />
                                        <asp:HiddenField ID="hfCodFactorRotacion" runat="server" Value='<%# Bind("CodFactorRotacion") %>' />
                                        <asp:HiddenField ID="hfCodSucursal" runat="server" Value='<%# Bind("CodSucursal") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Factor Rotacion" HeaderStyle-HorizontalAlign="Center">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblFactorRotacion" Text='<%# Bind("FactorRotacion") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Sucursal" HeaderStyle-HorizontalAlign="Center">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
      ...
      <div id="div_FactorRedondeoEdicion" style="display: none;">
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="padding-top: 10px;">
                      <div id="div_FactorRotacionEdicion">
                          <asp:DropDownList ID="ddlFactorRotacionEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
             ...
             <tr>
                ...
                <td style="padding-top: 10px;">
                    <asp:TextBox ID="txtFactorEdicion" runat="server" Width="116px" Font-Names="Arial" ForeColor="Blue"
                        Font-Bold="True"></asp:TextBox>
                </td>
             </tr>
             <tr>
               <td style="padding-top: 10px; font-weight: bold">
                ...
                <td style="padding-top: 10px;">
                      <div id="div_SucursalEdicion">
                           <asp:DropDownList ID="ddlSucursalFactorEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                               Font-Bold="True" Width="120">
                           </asp:DropDownList>
                       </div>
                </td>
            ...
            <tr>
                <td style="padding-top: 10px;" align="right" colspan="2">
                    <asp:Button ID="btngrabarFactorEdicion" runat="server" Text="GRABAR" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        Font-Names="Arial" Font-Bold="True" Width="120" />
                </td>
            </tr>
        </table>
    ...
    <input id="hfCodMarcaAcceso" type="hidden" value="0" />
    <input id="hfCodFactor" type="hidden" value="0" />
</asp:Content>
