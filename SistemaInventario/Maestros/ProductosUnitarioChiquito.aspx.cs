...
{
    public partial class ProductosUnitarioChiquito : System.Web.UI.Page
    {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.ModeloAbreviado = Convert.ToString(objTablaFiltro["Filtro_ModeloAbreviado"]);
            objEntidad.Abreviatura = Convert.ToString(objTablaFiltro["Filtro_Abreviatura"]);
            objEntidad.Compatibilidad = Convert.ToString(objTablaFiltro["Filtro_Compatibilidad"]);
            ...
            objOperacion.F_LGProductos_Insert_Chiquito(objEntidad, "", "", "", "", "", "");
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Update_Chiquito(objEntidad, "", "", "", "", "", "");
