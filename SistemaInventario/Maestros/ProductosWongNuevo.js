var AppSession = "../Maestros/ProductosWongNuevo.aspx";
var myDropzone = null;
...
$(document).ready(function () {
 ...
 $('#MainContent_txtTipoProducto').autocomplete({
    source: function (request, response) {
        $.ajax({
            ...
            success: function (data) {
                response($.map(data.d, function (item) {
                    return {                            
                        val: item.split(',')[0],      // CodTipoProducto
                        label: item.split(',')[1],    // Descripcion
                        Codigo: item.split(',')[2],   // Codigo Interno
                        IDFamilia: item.split(',')[3], // IDFamilia
                        TipoProducto: item.split(',')[4] // TipoProducto
                    }
                }))
            },
            error: function (response) {
    ...
    select: function (e, i) {
        ...
        $('#MainContent_txtDescripcion').val(i.item.TipoProducto); 
        $('#MainContent_txtCodigoInterno').val(i.item.Codigo); 
        $('#MainContent_ddlFamilia').val(i.item.IDFamilia); // setear combo Familia
        $('#hfIdFamilia').val(i.item.IDFamilia);  
    },
    minLength: 3
});
 ...
 $('#MainContent_txtTipoProductoEdicion').autocomplete({
    ...
    select: function (e, i) {
        $('#hfCodTipoProducto').val(i.item.val);         
        $('#MainContent_txtDescripcionEdicion').val(i.item.TipoProducto); 
        $('#MainContent_txtCodigoInternoEdicion').val(i.item.Codigo); 
        $('#MainContent_ddlFamiliaEdicion').val(i.item.IDFamilia); // setear combo Familia
        $('#hfIdFamilia').val(i.item.IDFamilia);  
    },
    minLength: 3
});
    ...
    $('#MainContent_txtStockInicial').css('background', '#FFFFE0');
    $('#MainContent_txtStockInicialEdicion').css('background', '#FFFFE0');
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_MonedaCostoInicial', result.split('~')[13]);
                        F_Update_Division_HTML('div_MonedaCostoInicialEdicion', result.split('~')[14]);
                        ...
                        $('#MainContent_txtExclusivo').val('0');
                        $('#MainContent_txtStockInicial').val('0');
                        ...
                        $('#MainContent_ddlMonedaCostoInicial').css('background', '#FFFFE0');
                        $('#MainContent_ddlMonedaCostoInicialEdicion').css('background', '#FFFFE0');
                        $('#MainContent_txtCantidad').css('background', '#FFFFE0');
                        $('#MainContent_txtCodigoOmen').css('background', '#FFFFE0');
                        ...
                        $('#MainContent_txtCodigoOemEdicion').css('background', '#FFFFE0');
...
function F_GrabarDocumento() {
    try {
        ...
        var FlagBloqueoMayorista = 0; if ($(Contenedor + 'chkBloqueoMayorista').is(':checked')) FlagBloqueoMayorista = 1;
        var FlagBloqueoExclusivo = 0; if ($(Contenedor + 'chkBloqueoExclusivo').is(':checked')) FlagBloqueoExclusivo = 1;
        ...
        var objParams = {
            ...
            Filtro_Observacion : $(Contenedor+ 'txtObservacion').val().toUpperCase().trim(),
            Filtro_CodigoOem: $(Contenedor + 'txtCodigoOmen').val().toUpperCase().trim(),
            Filtro_Proveedor: $(Contenedor + 'txtProveedor').val().toUpperCase().trim(),
            Filtro_CodigoFabrica: $(Contenedor + 'txtCodigoFabrica').val().toUpperCase().trim(),
            Filtro_CodFamiliaTipoProducto: $('#hfCodTipoProducto').val(),
            Filtro_Observacion2: $(Contenedor + 'txtObservacion2').val().toUpperCase().trim()
        };
        ...
        F_GrabarDocumento_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente.') {
                    ...
                    $(Contenedor + 'ddlMonedaCostoInicial').val('1');
                    ...
                    $(Contenedor + 'chkBloqueoMayorista').prop('checked', false);
                    $(Contenedor + 'chkBloqueoExclusivo').prop('checked', false);
    ...
    try {
        ...
        F_Buscar_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                ...
                F_Grilla_Stock_Color('grvConsulta','lblProducto','lblStock',' .detallesart');    
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfCodigoInterno = '#' + imgID.replace('imgEditarRegistro', 'hfCodigoInterno');     
        var hfMarca = '#' + imgID.replace('imgEditarRegistro', 'hfMarca');
        var hfCodMoneda = '#' + imgID.replace('imgEditarRegistro', 'hfCodMoneda');
        var hfCodUnidadVenta = '#' + imgID.replace('imgEditarRegistro', 'hfCodUnidadVenta');
        var hfIdFamilia = '#' + imgID.replace('imgEditarRegistro', 'hfIdFamilia');
        var hfFactor = '#' + imgID.replace('imgEditarRegistro', 'hfFactor');      
        ...
        var hfPrecio1 = '#' + imgID.replace('imgEditarRegistro', 'hfPrecio1');
        var hfPrecio2 = '#' + imgID.replace('imgEditarRegistro', 'hfPrecio2');
        var hfPrecio3 = '#' + imgID.replace('imgEditarRegistro', 'hfPrecio3');
        var hfUbicacion = '#' + imgID.replace('imgEditarRegistro', 'hfUbicacion');  
        ...
        var hfCodigoOem = '#' + imgID.replace('imgEditarRegistro', 'hfCodigoOem');
        var hfCodigoProveedor = '#' + imgID.replace('imgEditarRegistro', 'hfCodigoProveedor');
        var hfCodigoFabrica = '#' + imgID.replace('imgEditarRegistro', 'hfCodigoFabrica');
        var hfFamilitaTipoProducto = '#' + imgID.replace('imgEditarRegistro', 'hfFamilitaTipoProducto');
        var hfFamilitaTipoProducto = '#' + imgID.replace('imgEditarRegistro', 'hfFamilitaTipoProducto');
        var hfCodFamiliaTipoProducto = '#' + imgID.replace('imgEditarRegistro', 'hfCodFamiliaTipoProducto');
        ...
        $(Cuerpo + 'txtDescripcionEdicion').val($.trim($(lblProducto).text().replace($(hfMarca).val(), '')));
        $(Cuerpo + 'txtMarcaEdicion').val($(hfMarca).val());
        $(Cuerpo + 'txtFactorEdicion').val($(hfFactor).val());
        $(Cuerpo + 'ddlMonedaEdicion').val($(hfCodMoneda).val());
        $(Cuerpo + 'ddlCompraEdicion').val($(hfCodUnidadVenta).val());
        $(Cuerpo + 'ddlVentaEdicion').val($(hfCodUnidadVenta).val());
        $(Cuerpo + 'txtExclusivoEdicion').val(parseFloat($(hfExclusivo).val()).toFixed(2));
        $(Cuerpo + 'txtPrecio1Edicion').val(Number($(hfPrecio1).val()).toFixed(2));
        $(Cuerpo + 'txtPrecio2Edicion').val(Number($(hfPrecio2).val()).toFixed(2));
        $(Cuerpo + 'txtPrecio3Edicion').val(Number($(hfPrecio3).val()).toFixed(2));
        ...
        $(Cuerpo + 'txtUbicacionEdicion').val($(hfUbicacion).val());
        ...
        $(Cuerpo + 'txtCodigoOemEdicion').val($(hfCodigoOem).val());
        $(Cuerpo + 'txtCodigoProveedorEdicion').val($(hfCodigoProveedor).val());
        $(Cuerpo + 'txtCodigoFabricaEdicion').val($(hfCodigoFabrica).val());
        $(Cuerpo + 'txtTipoProductoEdicion').val($(hfFamilitaTipoProducto).val());

        $('#hfCodTipoProducto').val($(hfCodFamiliaTipoProducto).val());
        ...
        if ($(hfFlagBloqueoExclusivo).val() == 0)
            $(Cuerpo + 'chkBloqueoExclusivoEdicion').prop('checked', false);
        else
            $(Cuerpo + 'chkBloqueoExclusivoEdicion').prop('checked', true);
...
function F_VisualizarRegistro(Fila) {
    ...
    var imgID = Fila.id;
    var Cuerpo = '#MainContent_';
    var lblcodproducto = '#' + imgID.replace('imgVisualizarRegistro', 'lblcodproducto');
    ...
    var CodProducto = $(lblcodproducto).val();
...
function F_EdicionRegistro() {
    try {
        ...
        var FlagBloqueoMayorista = 0; if ($(Contenedor + 'chkBloqueoMayoristaEdicion').is(':checked')) FlagBloqueoMayorista = 1;
        var FlagBloqueoExclusivo = 0; if ($(Contenedor + 'chkBloqueoExclusivoEdicion').is(':checked')) FlagBloqueoExclusivo = 1;
        ...
        var objParams = {
            ...
            Filtro_Descripcion: $(Contenedor + 'txtDescripcionConsulta').val().toUpperCase().trim(),
            Filtro_CodTipoProducto: 2,        
            ...
            Filtro_CodigoOem: (($(Contenedor + 'txtCodigoOemEdicion').val() || '')).toUpperCase().trim(),
            Filtro_CodigoProveedor: (($(Contenedor + 'txtCodigoProveedorEdicion').val() || '')).toUpperCase().trim(),
            Filtro_CodigoFabrica: (($(Contenedor + 'txtCodigoFabricaEdicion').val() || '')).toUpperCase().trim(),
            Filtro_CodTipoProducto: $('#hfCodTipoProducto').val(),
            Filtro_Observacion2: $(Contenedor + 'txtObservacion2Edicion').val().toUpperCase().trim()           
...
function F_ValidarEdicionDocumento() {
    try {
        ...
        if (parseFloat($(Cuerpo + 'txtExclusivoEdicion').val()) > 0 & parseFloat($(Cuerpo + 'txtPrecio1Edicion').val()) < parseFloat($(Cuerpo + 'txtExclusivoEdicion').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO 1 NO PUEDE SER MENOR QUE EL EXCLUSIVO';

        if (parseFloat($(Cuerpo + 'txtPrecio3Edicion').val()) > 0 & parseFloat($(Cuerpo + 'txtPrecio1Edicion').val()) < parseFloat($(Cuerpo + 'txtPrecio3Edicion').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO 1 NO PUEDE SER MENOR QUE EL MAYORISTA';
