<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="ProductosNarvaez.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosNarvaez" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosNarvaez.js" charset="UTF-8"></script>
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td style="font-weight: bold;padding-left: 49px;">
                                                        Mayorista
                                                    </td>
                                                    <td>
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtPrecio2Edicion" runat="server" Width="80px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                              ...
                                                              <td style="font-weight: bold;padding-left: 43px">
                                        Mayorista
                                    </td>
                                                <td>
