...
namespace SistemaInventario.Maestros
{
    public partial class Almacen : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlDireccionCliente_html = "";//
            String str_ddlDireccionClienteEdicion_html = "";//
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlEstado, ref ddlEstadoEdicion
                    , ref ddlEmpresa, ref ddlEmpresaEdicion, ref ddlEmpresaConsulta, ref ddlDireccionCliente, ref ddlDireccionClienteEdicion);
               ...
               str_ddlDireccionCliente_html = Mod_Utilitario.F_GetHtmlForControl(ddlDireccionCliente);//
               str_ddlEmpresaEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlEmpresaEdicion);
                ...
                str_ddlDireccionClienteEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlDireccionClienteEdicion);//
            ...
            str_ddlEmpresaConsulta_html + "~" + //5

             str_ddlDireccionCliente_html + "~" +

            str_ddlDireccionClienteEdicion_html;
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_comboestado, ref DropDownList ddl_comboestadoedicion,
                ref DropDownList ddl_comboempresa, ref DropDownList ddl_comboempresaedicion, ref DropDownList ddl_comboempresaconsulta, ref DropDownList ddl_DireccionCliente, ref DropDownList ddl_comboDireccionClienteEdicion)
        {
            ...
            int empresaId = Convert.ToInt32(Session["CodEmpresa"]);
            TCDocumentosCN objOperacionDocumento2 = new TCDocumentosCN();
            dta_consulta = objOperacionDocumento2.F_TCEMPRESA_LISTAR_DIRECCION_CLIENTE(empresaId);

            ddl_DireccionCliente.Items.Clear();
            ddl_DireccionCliente.DataSource = dta_consulta;
            ddl_DireccionCliente.DataTextField = "Ubigeo";
            ddl_DireccionCliente.DataValueField = "CodDireccion";
            ddl_DireccionCliente.DataBind();


            ddl_comboDireccionClienteEdicion.Items.Clear();
            ddl_comboDireccionClienteEdicion.DataSource = dta_consulta;
            ddl_comboDireccionClienteEdicion.DataTextField = "Ubigeo";
            ddl_comboDireccionClienteEdicion.DataValueField = "CodDireccion";
            ddl_comboDireccionClienteEdicion.DataBind();
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("Sunat", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.NombreClaveAzure = Convert.ToString(objTablaFiltro["Filtro_DescripcionAzure"]);
            ...
            objEntidad.CodigoEstablecimientoSunat = Convert.ToString(objTablaFiltro["Filtro_EstablecimientoSunat"]);
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);
            objEntidad.CodDireccion = Convert.ToInt32(objTablaFiltro["Filtro_CodDireccionCliente"]);
            objEntidad.SerieAntiguo = Convert.ToString(objTablaFiltro["Filtro_SerieAntiguo"]);
            objEntidad.SerieNuevo = Convert.ToString(objTablaFiltro["Filtro_SerieNuevo"]);
            objEntidad.NombreCorto = Convert.ToString(objTablaFiltro["Filtro_NombreCorto"]);

            objOperacion = new TCCuentaCorrienteCN();

            objOperacion.F_TCCuentaCorriente_Insert_Almacen(objEntidad);
