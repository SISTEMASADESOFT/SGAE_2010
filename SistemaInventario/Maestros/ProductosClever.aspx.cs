...
namespace SistemaInventario.Maestros
{
    public partial class ProductosClever : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlMonedaCostoInicial_html = "";
            String str_ddlMonedaCostoInicialEdicion_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlUMCompra,
                    ...
                    ref ddlCompraEdicion, ref ddlVentaEdicion, ref ddlMonedaEdicion, ref ddlMonedaCostoInicial, ref ddlMonedaCostoInicialEdicion, ref ddlEstadoEdicion);
                ...
                str_ddlMonedaCostoInicial_html = Mod_Utilitario.F_GetHtmlForControl(ddlMonedaCostoInicial);
                str_ddlMonedaCostoInicialEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlMonedaCostoInicialEdicion);
            ...
            str_resultado =
                ...
                Session["CodSede"].ToString()
                 + "~" +
                str_ddlMonedaCostoInicial_html
                + "~" +
                str_ddlMonedaCostoInicialEdicion_html
                + "~" +
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
                                            ...
                                            ref DropDownList ddl_comboestadoedicion)
        {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("CodMonedaCostoInicial", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Insert_Clever(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Update_Clever(objEntidad);
