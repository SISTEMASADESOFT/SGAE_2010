<%@ Page Title="Proveedores" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProveedoresUnitarioPovis.aspx.cs" Inherits="SistemaInventario.Maestros.ProveedoresUnitarioPovis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProveedoresUnitarioPovis.js" charset="UTF-8"></script>
                        ...
                        <tr>
                            ...
                            <tr>
                             <td style="padding-left: 2px;" colspan='5'>
                                <asp:TextBox ID="txtDireccion" runat="server" Width="317px" Font-Names="Arial" Font-Bold="True"
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                         ...
                                         <td style="padding-left: 2px; font-weight: bold">
                                            <asp:TextBox ID="txtPlacaEdicion" runat="server" Width="146px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ></asp:TextBox>
                                        </td>
                                         <td style="font-weight: bold">
                                            Licencia
                                        ...
                                        <td style="">
                                            <asp:TextBox ID="txtLicenciaEdicion" runat="server" Width="146px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ></asp:TextBox>
                                        </td>
                                         <td style="font-weight: bold">
                                            Estado
