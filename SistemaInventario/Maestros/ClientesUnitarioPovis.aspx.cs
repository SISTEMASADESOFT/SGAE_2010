...
{
    public partial class ClientesUnitarioPovis : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("CodigoCliente", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_Direcciones()
        {
            ...
            dta_consultaarticulo.Columns.Add("Ciudad", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_TCCuentaCorriente_Insert_Povis(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_TCCuentaCorriente_Update_Povis(objEntidad);
        ...
        public void P_GrabarDireccion_Direccion(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.GPSLong = Convert.ToDecimal(objTablaFiltro["Filtro_GPSLong"]);
            objEntidad.GPSLat = Convert.ToDecimal(objTablaFiltro["Filtro_GPSLat"]);
            objEntidad.Ciudad = Convert.ToString(objTablaFiltro["Filtro_Ciudad"]);

            objOperacion = new TCDistritoCN();

            objOperacion.F_TCDireccion_Editar_Povis(objEntidad);
