var AppSession = "../Maestros/ProductosUnitarioChiquito.aspx";
var myDropzone = null;
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_ModeloAbreviado: $(Contenedor + 'txtModeloAbreviado').val(),
            Filtro_Abreviatura: $(Contenedor + 'txtAbreviatura').val(),
            Filtro_Compatibilidad: $(Contenedor + 'txtCompatibilidad').val(),
        ...
        F_GrabarDocumento_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente.') {
                    ...
                    $(Contenedor + 'txtPosicion').val('');
                    $(Contenedor + 'txtCompatibilidad').val('');
                    $(Contenedor + 'txtAbreviatura').val('');
                    $(Contenedor + 'txtModeloAbreviado').val(''),
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var lblModeloAbreviado = '#' + imgID.replace('imgEditarRegistro', 'lblModeloAbreviado');
        var lblAbreviatura = '#' + imgID.replace('imgEditarRegistro', 'lblAbreviatura');
        var lblCompatibilidad = '#' + imgID.replace('imgEditarRegistro', 'lblCompatibilidad');
        ...
        $(Cuerpo + 'txtModeloEdicion').val($(lblModelo).text());
        ...
        $(Cuerpo + 'txtCompatibilidadEdicion').val($(lblCompatibilidad).text());
        $(Cuerpo + 'txtAbreviaturaEdicion').val($(lblAbreviatura).text());
        $(Cuerpo + 'txtModeloAbreviadoEdicion').val($(lblModeloAbreviado).text());
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_PermisoMayorista: PermisoMayorista,
            Filtro_CodigoMenu: CodigoMenu,
            Filtro_ModeloAbreviado: $(Contenedor + 'txtModeloAbreviadoEdicion').val(),
            Filtro_Abreviatura: $(Contenedor + 'txtAbreviaturaEdicion').val(),
            Filtro_Compatibilidad: $(Contenedor + 'txtCompatibilidadEdicion').val(),
            Filtro_Imagenes: Sys.Serialization.JavaScriptSerializer.serialize(arrImg)
        };
...
function F_Inicializar_Caja_Texto() {
    ...
    $('#MainContent_txtCompatibilidad').css('background', '#FFFFE0');
    $('#MainContent_txtAbreviatura').css('background', '#FFFFE0');
    $('#MainContent_txtModeloAbreviado').css('background', '#FFFFE0');
    $('#MainContent_txtModeloAbreviadoEdicion').css('background', '#FFFFE0');
    $('#MainContent_txtAbreviaturaEdicion').css('background', '#FFFFE0');
    $('#MainContent_txtCompatibilidadEdicion').css('background', '#FFFFE0');
    $('#MainContent_txtModelo').css('background', '#FFFFE0');
    $('#MainContent_txtModeloEdicion').css('background', '#FFFFE0');
