...
namespace SistemaInventario.Maestros
{
    public partial class FamiliasSalcedo : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("PermisoCodigoProducto", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoMotor", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoModeloVehiculo", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoAño", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoMarcaVehiculo", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoOtrosDetalles", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoPlato", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoDisco", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoCollarin", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoEspesor", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoMedidaA", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoMedidaB", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoMedidaC", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoMedidaD", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoPosicion", typeof(string));
            dta_consultaarticulo.Columns.Add("PermisoLado", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.ChkCodigoProducto = Convert.ToInt32(objTablaFiltro["Filtro_ChkCodigoProducto"]);
            objEntidad.ChkMotor          = Convert.ToInt32(objTablaFiltro["Filtro_ChkMotor"]);
            objEntidad.ChkModeloVehiculo = Convert.ToInt32(objTablaFiltro["Filtro_ChkModeloVehiculo"]);
            objEntidad.ChkAño            = Convert.ToInt32(objTablaFiltro["Filtro_ChkAño"]);
            objEntidad.ChkMarcaVehiculo  = Convert.ToInt32(objTablaFiltro["Filtro_ChkMarcaVehiculo"]);
            objEntidad.ChkOtroDetalles   = Convert.ToInt32(objTablaFiltro["Filtro_ChkOtroDetalles"]);
            objEntidad.ChkPlato          = Convert.ToInt32(objTablaFiltro["Filtro_ChkPlato"]);
            objEntidad.ChkDisco          = Convert.ToInt32(objTablaFiltro["Filtro_ChkDisco"]);
            objEntidad.ChkCollarin       = Convert.ToInt32(objTablaFiltro["Filtro_ChkCollarin"]);
            objEntidad.Chkespesor        = Convert.ToInt32(objTablaFiltro["Filtro_Chkespesor"]);
            objEntidad.ChkMedidasA       = Convert.ToInt32(objTablaFiltro["Filtro_ChkMedidasA"]);
            objEntidad.ChkMedidasB       = Convert.ToInt32(objTablaFiltro["Filtro_ChkMedidasB"]);
            objEntidad.ChkMedidasC       = Convert.ToInt32(objTablaFiltro["Filtro_ChkMedidasC"]);
            objEntidad.ChkMedidasD       = Convert.ToInt32(objTablaFiltro["Filtro_ChkMedidasD"]);
            objEntidad.ChkPosicion       = Convert.ToInt32(objTablaFiltro["Filtro_ChkPosicion"]);
            objEntidad.ChkLado           = Convert.ToInt32(objTablaFiltro["Filtro_ChkLado"]);
