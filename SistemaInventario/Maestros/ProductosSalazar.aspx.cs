...
{
    public partial class ProductosSalazar : System.Web.UI.Page
    {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CostoProducto = Convert.ToDecimal(objTablaFiltro["Filtro_CostoProducto"]);
            ...
            objOperacion.F_LGProductos_Insert_Salazar(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Update_Salazar(objEntidad);
