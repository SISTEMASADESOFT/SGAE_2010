                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtModelo" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Año
                                                    ...
                                                    <td style="padding-left: 32px;">
                                                        <asp:TextBox ID="txtAño" runat="server" Width="262px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="padding-left: 2px;">
                                            <asp:TextBox ID="txtDisco" runat="server" Width="244px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                                     <td style="font-weight: bold">
                                            Collarin
                                        ...
                                        <td style="padding-left: 2px;">
                                            <asp:TextBox ID="txtCollarin" runat="server" Width="262px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 5px;">
                                                        <asp:TextBox ID="txtMedidaB" runat="server" Width="262px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                     ...
                                     <tr >
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtMedidaC" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Medida D
                                                    ...
                                                    <td style="padding-left: 5px;">
                                                        <asp:TextBox ID="txtMedidaD" runat="server" Width="262px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                     ...
                                     <tr >
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtEspesor" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Posicion
                                                    ...
                                                    <td style="padding-left: 5px;">
                                                        <asp:TextBox ID="txtPosicion" runat="server" Width="262px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                     ...
                                     <tr >
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtLado" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Detalles
                                                    ...
                                                    <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtDetalles" runat="server" Width="262px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                    ...
                                    <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                        ...
                                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hfDetalles" runat="server" Value='<%# Bind("Detalles") %>' />
                                                <asp:HiddenField ID="hfMarcaVehi" runat="server" Value='<%# Bind("MarcaVehi") %>' />
                                                <asp:HiddenField ID="hfLado" runat="server" Value='<%# Bind("Lado") %>' />
                                                <asp:HiddenField ID="hfEspesor" runat="server" Value='<%# Bind("Espesor") %>' />
                                                <asp:HiddenField ID="hfMedidaD" runat="server" Value='<%# Bind("MedidaD") %>' />
                                                <asp:HiddenField ID="hfMedidaC" runat="server" Value='<%# Bind("MedidaC") %>' />
                                                <asp:HiddenField ID="hfMedidaB" runat="server" Value='<%# Bind("MedidaB") %>' />
                                                <asp:HiddenField ID="hfCollarin" runat="server" Value='<%# Bind("Collarin") %>' />
                                                <asp:HiddenField ID="hfDisco" runat="server" Value='<%# Bind("Disco") %>' />
                                                <asp:HiddenField ID="hfPlato" runat="server" Value='<%# Bind("Plato") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:BoundField DataField="Linea" HeaderText="Linea">
                                            <HeaderStyle HorizontalAlign="Center" />
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtModeloEdicion" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Año
                                                    ...
                                                    <td style="padding-left: 30px;">
                                                        <asp:TextBox ID="txtAñoEdicion" runat="server" Width="262px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="padding-left: 2px;">
                                            <asp:TextBox ID="txtDiscoEdicion" runat="server" Width="244px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                                     <td style="font-weight: bold">
                                            Collarin
                                        ...
                                        <td style="padding-left: 0px;">
                                            <asp:TextBox ID="txtCollarinEdicion" runat="server" Width="262px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr >
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtMedidaEdicion" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Medida B
                                                    ...
                                                    <td style="padding-left: 3px;">
                                                        <asp:TextBox ID="txtMedidaBEdicion" runat="server" Width="262px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                    ...
                                    <tr >
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtMedidaCEdicion" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Medida D
                                                    ...
                                                    <td style="padding-left: 3px;">
                                                        <asp:TextBox ID="txtMedidaDEdicion" runat="server" Width="262px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                    ...
                                    <tr >
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtEspesorEdicion" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Posicion
                                                    ...
                                                    <td style="padding-left: 3px;">
                                                        <asp:TextBox ID="txtPosicionEdicion" runat="server" Width="262px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                    ...
                                    <tr >
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtLadoEdicion" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Detalles
                                                    ...
                                                    <td style="padding-left: 0px;">
                                                        <asp:TextBox ID="txtDetallesEdicion" runat="server" Width="262px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
