...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                    ...
                                    <tr>
                                        <td style="font-weight: bold">
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                        <td>
                                            <asp:TextBox ID="txtDescripcion" runat="server" Width="500px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr>
                                         <td style="font-weight: bold">
                                           ...
                                           <td style="font-weight: bold;padding-left:4PX;">
                                                        <asp:TextBox ID="txtMarca" runat="server" Width="588px" Font-Names="Arial" ForeColor="Blue"
                                                ...
                                                <tr>
                                                 ...
                                                 <td style="padding-left: 5px;">
                                                    ...
                                                    <td style="padding-left: 4px">
                                                        <asp:TextBox ID="txtPrecio1" runat="server" Width="64px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Precio 2
                            ...
                            <div id="div_consulta" style="padding-top: 5px;">
                                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                                    ...
                                    <Columns>
                                       ...
                                       <asp:BoundField DataField="BloqueoMayorista" HeaderText="BM">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                          <asp:BoundField DataField="BloqueoExclusivo" HeaderText="BE">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                    </Columns>
    ...
    <div id="divEdicionRegistro" style="display: none;">
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 710px;">
                        ...
                        <div class="ui-jqdialog-content" style="width: 710px">
                            <table cellpadding="0" cellspacing="0" class="form-inputs">
                                ...
                                DESCRIPCION 2
                                      ...
                                      <td style="padding-left: 4px;">
                                                  <asp:TextBox ID="txtMarcaEdicion" runat="server" Width="592px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                </tr>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtPrecio1Edicion" runat="server" Width="72px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    Precio 2
                                                ...
                                                <td >
                                                    <asp:TextBox ID="txtPrecio2Edicion" runat="server" Width="72px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
