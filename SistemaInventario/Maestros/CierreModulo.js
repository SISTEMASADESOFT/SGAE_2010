var AppSession = "../Inventario/CierreModulo.aspx";
var CodigoMenu = 2000;
...
function F_GrabarDocumento() {
    try {
        ...
        var objParams = {
            ...
            Filtro_Modulo: $(Contenedor + 'ddlModulos').val(),
         };
        ...
        F_Controles_Inicializar_NET
            (
                ...
                function (result) {
                    ...
                    MostrarEspera(false);
                    if (str_resultado_operacion == "1") {
                        F_Update_Division_HTML('div_Modulo', result.split('~')[2]);
                        $('#MainContent_ddlModulos').css('background', '#FFFFE0');
