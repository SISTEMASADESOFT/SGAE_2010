var AppSession = "../Maestros/ListaPreciosPovis_antiguo.aspx";
var CodigoMenu = 1000;
        ...
        var objParams =
            {
                ...
                Filtro_Categoria: $('#MainContent_ddlcategoria').val(),
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        $('#MainContent_grvConsultaArticulo .chkSi :checkbox').each(function () {
                            ...
                            hfCodMoneda = chkSi.replace('chkOK', 'hfCodMoneda');
                            ddlMoneda = chkSi.replace('chkOK', 'ddlMoneda');
                            hfCodCategoria = chkSi.replace('chkOK', 'hfCodCategoria');
                            ddlCategoria = chkSi.replace('chkOK', 'ddlCategoria');
                            $(ddlMoneda).val($(hfCodMoneda).val());
                            $(ddlCategoria).val($(hfCodCategoria).val());
    ...
    try {
        ...
        $('#MainContent_grvConsultaArticulo .chkSi :checkbox').each(function () {
            ...
            if ($(chkSi).is(':checked')) {
                ...
                if ($(txtPreciolista).val() == '0.00')
                    cadena = cadena + "\n" + "Precio lista " + $(txtPreciolista).text();
        ...
        $('#MainContent_grvConsultaArticulo .chkSi :checkbox').each(function () {
            ...
            if ($(chkSi).is(':checked')) {
                var objDetalle = {
                    ...
                    CodCategoria: $(ddlCategoria).val(),
                    CodMoneda: 1,
                    CReal: $(lblCostoReal).val(),
                    Costo: 0,
                    Preciolista: $(txtPreciolista).val()
                };
...
function F_Margen1(ControlID) {
    ...
    var txtPreciolista = txtMargen.replace('txtM1', 'txtPreciolista');

        var Margen=parseFloat($(txtMargen).val())

        var Precio = (1 + (parseFloat($(txtMargen).val()) / 100)) * parseFloat($(txtPreciolista).val());
        var Margen = (parseFloat($(txtMargen).val()))

        if ($(txtPreciolista).val() == '' | $(txtPreciolista).val() == '0.00') {
...
//        }
        ...
        if ((parseFloat($(txtM3).val()) != 0) && (parseFloat($(txtM2).val()) != 0)) {
        ...
        if ((parseFloat($(txtMargen).val()) < parseFloat($(txtM3).val())) && (parseFloat($(txtM3).val()) != 0)) {
            toastr.warning("%P.MIN. NO PUEDE SER MAYOR A %P.C.");
            $(txtMargen).val($(HFM1).val());
            return false
        }

        if ((parseFloat($(txtMargen).val()) < parseFloat($(txtM2).val())) && (parseFloat($(txtM2).val()) != 0)) {
...
function F_Margen2(ControlID) {
    ...
    var txtPreciolista = txtMargen.replace('txtM2', 'txtPreciolista');
...
//        }
        ...
        if ((parseFloat($(txtM1).val()) < parseFloat($(txtMargen).val())) && (parseFloat($(txtM1).val())!=0)) {
...
function F_Margen3(ControlID) {
    ...
    var txtPreciolista = txtMargen.replace('txtM3', 'txtPreciolista');
...
//        }
        ...
        if ((parseFloat($(txtM1).val())!=0 )& (parseFloat($(txtM2).val())!=0  ))
        {
        ...
        if ((parseFloat($(txtM2).val()) < parseFloat($(txtMargen).val())) && (parseFloat($(txtM2).val())!=0)) {
            toastr.warning("%P.MIN. NO PUEDE SER MAYOR A %P.F.");
            $(txtMargen).val($(HFM3).val());
...
function F_COSTOMarginable(ControlID) {
    ...
    var hfCosto = txtCosto.replace('txtPreciolista', 'hfCosto');
    var txtPreciolista = txtCosto.replace('txtPreciolista', 'txtPreciolista');



    var hfCosto = txtCosto.replace('txtPreciolista', 'hfCosto');
    var txtM1 = txtCosto.replace('txtPreciolista', 'txtM1');
    var txtM2 = txtCosto.replace('txtPreciolista', 'txtM2');
    var txtM3 = txtCosto.replace('txtPreciolista', 'txtM3');
    var hfCostoOriginal = txtCosto.replace('txtPreciolista', 'hfCosto');


    var hfPrecioLista = txtCosto.replace('txtPreciolista', 'hfPrecioLista');
    var txtPrecioLista = txtCosto.replace('txtPreciolista', 'txtPreciolista');
    var txtPrecio1 = txtCosto.replace('txtPreciolista', 'txtPrecioLista1');
    var txtPrecio2 = txtCosto.replace('txtPreciolista', 'txtPrecioLista2');
    var txtPrecio3 = txtCosto.replace('txtPreciolista', 'txtPrecioLista3');
    var lblCostoOriginal = txtCosto.replace('txtPreciolista', 'lblCostoOriginal');
    var txtUltimoCosto = txtCosto.replace('txtPreciolista', 'txtCosto');


    var Costo = parseFloat($(txtCosto).val())


    if (parseFloat($(txtPrecioLista).val()) < parseFloat($(txtUltimoCosto).val())) {
        toastr.warning("EL PRECIO LISTA NO PUEDE SER MENOR AL COSTO");
        $(txtPrecioLista).val($(hfPrecioLista).val());
        return false;
    }
    ...
    if ($(txtM1).val()!=''){
        var Precio1 = (1 + (parseFloat($(txtM1).val()) / 100)) * parseFloat($(txtPreciolista).val());
    $(txtPrecio1).val(Precio1.toFixed(2));
    }

    if ($(txtM2).val()!=''){
        var Precio2 = (1+(parseFloat($(txtM2).val()) / 100)) * parseFloat($(txtPreciolista).val());
    $(txtPrecio2).val(Precio2.toFixed(2));
    }

if ($(txtM2).val() != '') {
    var Precio3 = (1 + (parseFloat($(txtM3).val()) / 100)) * parseFloat($(txtPreciolista).val());
