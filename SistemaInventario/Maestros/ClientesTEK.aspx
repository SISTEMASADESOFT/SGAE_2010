<%@ Page Title="Clientes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientesTEK.aspx.cs" Inherits="SistemaInventario.Maestros.ClientesTEK" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ClientesTEK.js" charset="UTF-8"></script>
                ...
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                   ...
                   <%--     <asp:TemplateField HeaderText="ID" HeaderStyle-Width="15px">
                        ...
                        <asp:TemplateField HeaderText="Retencion" HeaderStyle-HorizontalAlign="Center">
                         ...
                         <asp:BoundField DataField="LineaCredito" HeaderText="Linea" HeaderStyle-HorizontalAlign="Center"
                                        DataFormatString="{0:N2}">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:BoundField>
                                     <asp:BoundField DataField="DeudaCredito" HeaderText="Usado" HeaderStyle-HorizontalAlign="Center"
                                        DataFormatString="{0:N2}">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:BoundField>                        
                                        <asp:BoundField DataField="Saldo" HeaderText="Disponible" HeaderStyle-HorizontalAlign="Center"
                                        DataFormatString="{0:N2}">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:BoundField> 
                ...
                <asp:GridView ID="grvConsultaDetalle" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="COP" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20px">
                         ...
                         <asp:TemplateField HeaderText="ABR" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20px">
                            <ItemTemplate>
