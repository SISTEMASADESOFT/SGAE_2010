...
{
    public partial class ProductosKuyay : System.Web.UI.Page
    {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.RegistroSanitario = Convert.ToString(objTablaFiltro["Filtro_RegistroSanitario"]);
    
            objOperacion = new LGProductosCN();

            objOperacion.F_LGProductos_Insert_Kuyay(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Update_Kuyay(objEntidad);
