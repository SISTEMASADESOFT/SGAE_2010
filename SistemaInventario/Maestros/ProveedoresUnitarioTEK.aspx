<%@ Page Title="Proveedores" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProveedoresUnitarioTEK.aspx.cs" Inherits="SistemaInventario.Maestros.ProveedoresUnitarioTEK" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProveedoresUnitarioTEK.js" charset="UTF-8"></script>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                         ...
                                         <td style="padding-left: 2px; font-weight: bold">
                                            <asp:TextBox ID="txtPlaca" runat="server" Width="220px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ></asp:TextBox>
                                        </td>
                                         <td style="font-weight: bold">
                                            Licencia
                                        ...
                                        <td style="">
                                            <asp:TextBox ID="txtLicencia" runat="server" Width="220px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Documento" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfFlagRelacionado" runat="server" Value='<%# Bind("FlagRelacionado") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                     ...
                     <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                         ...
                                         <td style="padding-left: 2px; font-weight: bold">
                                            <asp:TextBox ID="txtPlacaEdicion" runat="server" Width="220px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ></asp:TextBox>
                                        </td>
                                         <td style="font-weight: bold">
                                            Licencia
                                        ...
                                        <td style="">
                                            <asp:TextBox ID="txtLicenciaEdicion" runat="server" Width="220px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <td style="font-weight: bold">
                                    ...
                                    <asp:DropDownList ID="ddlEstadoEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                      ...
                                      <asp:CheckBox ID="chkRelacionado" runat="server" Text ="Relacionado"
                                    Font-Bold="true" />
