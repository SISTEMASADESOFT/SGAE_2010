var AppSession = "../Maestros/ProductosCarbon.aspx";
var myDropzone = null;
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_servicioEdicion', result.split('~')[16]);
...
function F_GrabarDocumento() {
    try {
        ...
        var objParams = {
            ...
            Filtro_Detraccion: $(Contenedor + 'ddlservicio').val(),
...
function F_AnularRegistro(Fila) {
    ...
    try {
        ...
        var lblCodigo = '#' + imgID.replace('imgAnularDocumento', 'lblcodproducto');
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfDetraccionID = '#' + imgID.replace('imgEditarRegistro', 'hfDetraccion');
        var valDetraccion = $(hfDetraccionID).val();
        var Cuerpo = '#MainContent_';
        ...
        $(Cuerpo + 'txtPrecio1Edicion').val(Number($(hfPrecio1).val()).toFixed(3));
        $(Cuerpo + 'txtPrecio2Edicion').val(Number($(hfPrecio2).val()).toFixed(3));
        $(Cuerpo + 'txtPrecio3Edicion').val(Number($(hfPrecio3).val()).toFixed(3));
...
//        $(Cuerpo + 'ddlservicioEdicion').val($(hfDetraccion).val());
        $(Cuerpo + 'ddlservicioEdicion').val(valDetraccion || '0');
...
function F_EdicionRegistro() {
    try {
        ...
        var objParams = {
            ...
            Filtro_Detraccion: $(Contenedor + 'ddlservicioEdicion').val()
        };
