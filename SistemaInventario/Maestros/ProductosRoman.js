...
function F_GrabarDocumento() {
    try {
        ...
        if ($(Contenedor + 'txtPrecio1').val() == '') {
            $(Contenedor + 'txtPrecio1').val(0)
        }
        if ($(Contenedor + 'txtPrecio2').val() == '') {
            $(Contenedor + 'txtPrecio2').val(0)
        }

        if ($(Contenedor + 'txtPrecio3').val() == '') {
            $(Contenedor + 'txtPrecio3').val(0)
        }

        if ($(Contenedor + 'txtPrecio4').val() == '') {
            $(Contenedor + 'txtPrecio4').val(0)
        }

        if ($(Contenedor + 'txtPrecio5').val() == '') {
            $(Contenedor + 'txtPrecio5').val(0)
        }

        if ($(Contenedor + 'txtCosto').val() == '') {
            $(Contenedor + 'txtCosto').val(0)
        }

        if ($(Contenedor + 'txtMargen1').val() == '') {
            $(Contenedor + 'txtMargen1').val(0)
        }
        if ($(Contenedor + 'txtMargen2').val() == '') {
            $(Contenedor + 'txtMargen2').val(0)
        }
        if ($(Contenedor + 'txtMargen3').val() == '') {
            $(Contenedor + 'txtMargen3').val(0)
        }
        if ($(Contenedor + 'txtMargen4').val() == '') {
        ...
        var objParams = {
            ...
            Filtro_D1: $(Contenedor + 'txtD1').val().toUpperCase().trim(),
            Filtro_D2: $(Contenedor + 'txtD2').val().toUpperCase().trim(),
            Filtro_D3: $(Contenedor + 'txtD3').val().toUpperCase().trim(),
            Filtro_D4: $(Contenedor + 'txtD4').val().toUpperCase().trim(),
            Filtro_D5: $(Contenedor + 'txtD5').val().toUpperCase().trim(),
            Filtro_D6: $(Contenedor + 'txtD6').val().toUpperCase().trim(),
            Filtro_D7: $(Contenedor + 'txtD7').val().toUpperCase().trim(),
            Filtro_M1: $(Contenedor + 'txtM1').val().toUpperCase().trim(),
            Filtro_M2: $(Contenedor + 'txtM2').val().toUpperCase().trim(),
            Filtro_M3: $(Contenedor + 'txtM3').val().toUpperCase().trim(),
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        var objParams = {
                ...
                //Filtro_Margen4: $(Contenedor + 'txtMargen4Edicion').val()?0,
                Filtro_Margen4: $(Contenedor + 'txtMargen4Edicion').val() || 0,
...
//        if ($(Cuerpo + 'txtPrecio1Edicion').val() < Number(preciomin))
//            Cadena = Cadena + '<p></p>' + 'El precio 1 no puede ser menor que el Precio Minimo';
...
function F_Excel() {
    ...
    var TipoArchivo = 'application/pdf';
    var CodMenu = '714';
    var NombreArchivo = 'Xls_ProductoRoman.xlsx';
