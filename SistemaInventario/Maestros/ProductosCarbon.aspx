<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="ProductosCarbon.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosCarbon" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosCarbon.js" charset="UTF-8"></script>
                                    ...
                                    <tr>
                                        <td style="font-weight: bold">
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                        <td>
                                            <asp:TextBox ID="txtDescripcion" runat="server" Width="585px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                            ...
                            <div id="div_consulta" style="padding-top: 5px;">
                                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                                    ...
                                    <Columns>
                                                ...
                                                <center>
                                                   ...
                                                   <%-- <asp:ImageButton runat="server" ID="imgActivarProducto" ImageUrl="~/Asset/images/ok.gif"
                                                    ...
                                                    <asp:ImageButton runat="server" ID="imgAgregar" ImageUrl="~/Asset/images/ok.gif"
                                                        ToolTip="STOCK ALMACENES" OnClientClick="F_AgregarArticulo(this.id,1); return false;" Visible ="false" />
                                                    
                                                 <asp:ImageButton runat="server" ID="imgVisualizarRegistro" ImageUrl="../Asset/images/Viewx16.png"
                                        ToolTip="VISUALIZAR FOTOS DEL PRODUCTO" OnClientClick="F_VisualizarRegistro(this); return false;" Visible="false" />
                                                </center>
                                            </ItemTemplate>
                                        </asp:TemplateField>                                   
                                        ...
                                        <asp:BoundField DataField="Costo" HeaderText="Costo" DataFormatString="{0:N2}" Visible="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Precio1" HeaderText="Precio" DataFormatString="{0:N3}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Precio2" HeaderText="P2" DataFormatString="{0:N3}" Visible="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>    
                                        ...
                                        <asp:BoundField DataField="Stock" HeaderText="Stock" Visible="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 34px; font-weight: bold">
                                                    UM 
                                                </td>
