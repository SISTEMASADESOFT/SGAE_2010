<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="ProductosMonica.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosMonica" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosMonica.js" charset="UTF-8"></script>
        ...
        <div id="tabRegistro">
            <table cellpadding="0" cellspacing="0" class="form-inputs">
                <tr>
                    <td valign="top">
                        <%--DATOS DEL PRODUCTO--%>
                        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 730px;">
                                                ...
                                                <tr>
                                                   ...
                                                   <td style="font-weight: bold; display: none">
                                                    ...
                                                    <td style="display: none">
                                                        <asp:TextBox ID="txtCodigo2" runat="server" Width="265px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    ...
                                                    <td  style="padding-left:14px">
                                                        <asp:TextBox ID="txtMarca" runat="server" Width="265px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                    ...
                                    <tr>
                                        <td style="font-weight: bold">
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                        <td>
                                            <asp:TextBox ID="txtDescripcion" runat="server" Width="570px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                   </tr>
                                                    </table>
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                 ...
                                                 <td style="padding-left:10px" >
                                                               <asp:TextBox ID="txtModelo" runat="server" Width="262px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                 </tr>
                                            </table>
                                   ...
                                   <td style="font-weight: bold">
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td >
                                                       <asp:TextBox ID="txtUbicacion" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td >
                                                      ...
                                                      <td style="font-weight: bold">
                                                        <asp:TextBox ID="txtStockMinimo" runat="server" Width="76px" Font-Names="Arial" ForeColor="Blue"
                                                    ...
                                                    <td style="padding-left: 32px;">
                                                        <asp:TextBox ID="txtStockMaximo" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" Text="0.00" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                     ...
                                     <tr>
                                           ...
                                           Categoria IGV
                                                  ...
                                                  <td colspan='5'>
                                                    ...
                                                    <tr>
                                                        <td style="padding-left: 2px;">
                                                        <div id="div_CategoriaIgv">
                                                            <asp:DropDownList ID="ddlCategoriaIgv" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="246">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                                    ...
                                    <tr >
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                      <asp:TextBox ID="txtObservacion" runat="server" Width="570px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" TextMode="MultiLine" Height="25"></asp:TextBox>
                                ...
                                <asp:Panel ID="pnlOrdersObservacion" runat="server" Style="display: none">
                                    <asp:GridView ID="grvDetalleObservacion" runat="server" border="0" CellPadding="0"
                                        ...
                                        <Columns>
                                           ...
                                           <asp:TemplateField HeaderText="Cod Unico" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hfCodCategoria" runat="server" Value='<%# Bind("CodCategoriaIgv") %>' />
                                                <asp:HiddenField ID="hfCodServicio" runat="server" Value='<%# Bind("CodServicio") %>' />
                    ...
                    <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 700px;">
                        ...
                        <div class="ui-jqdialog-content" style="width: 700px">
                            <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="display:none">
                                                    <asp:TextBox ID="txtCodigo2Edicion" runat="server" Width="277px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                          ...
                                          <td style="font-weight: bold;">
                                                  ...
                                                  <td style="padding-left:15px">
                                                    <asp:TextBox ID="txtMarcaEdicion" runat="server" Width="276px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                     <td>
                                        <asp:TextBox ID="txtDescripcionEdicion" runat="server" Width="582px" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                            ...
                                            <tr>
                                               ...
                                               <td style="font-weight: bold;">
                                                ...
                                                <td  style="padding-left: 7px;">
                                                    <asp:TextBox ID="txtModeloEdicion" runat="server" Width="277px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>                                           
                                            </tr>
                                        </table>
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td  style="padding-left: 3px;">
                                                    <asp:TextBox ID="txtPosicionEdicion" runat="server" Width="277px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                     ...
                                     <td style="font-weight: bold;">
                                                ...
                                                <tr>
                                                    ...
                                                    <asp:TextBox ID="txtAñoEdicion" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                       ...
                                                       <td >
                                                    <asp:TextBox ID="txtUbicacionEdicion" runat="server" Width="244px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                       </td>
                        ...
                        <td style="font-weight: bold;">
                                             Stock Min
                                                         ...
                                                         <td >
                                                    <asp:TextBox ID="txtStockMinimoEdicion" runat="server" Width="74px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" Text="0.00" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold; padding-right:46px">
                                                    Stock Max
                                                </td>
                                                <td >
                                                    <asp:TextBox ID="txtStockMaximoEdicion" runat="server" Width="80px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" Text="0.00" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td >
                                                    <div id="div_CategoriaIgvEdicion">
                                                        <asp:DropDownList ID="ddlCategoriaIgvEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtObservacionEdicion" runat="server" Width="582px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" TextMode="MultiLine" Height="25"></asp:TextBox>
                                                </td>
