                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtT_Slogan" runat="server" Width="500px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ToolTip="Slogan" TextMode="MultiLine" Height="40"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-weight: bold; width: 110px;">
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                   <td>
                                                        <asp:TextBox ID="txtT_Celular" runat="server" Width="283px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold; text-align: center;">
                                                       ...
                                                       <td>
                                                        <asp:TextBox ID="txtT_Telefono" runat="server" Width="150px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Codigo" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfFlagBuenContribuyente" runat="server" Value='<%# Bind("FlagBuenContribuyente") %>' />
                    ...
                    <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 640px;
                        ...
                        <div>
                            <table cellpadding="0" cellspacing="0" class="form-inputs">
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 4px;">
                                        <asp:TextBox ID="txtT_SloganEdicion" runat="server" Width="500px" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True" ToolTip="Slogan" Height="40" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-weight: bold; width: 110px;">
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                              <td>
                                                    <asp:TextBox ID="txtT_CelularEdicion" runat="server" Width="282px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold; text-align: center; ">
                                                    Telefono 
                                             ...
                                             <td>
                                                    <asp:TextBox ID="txtT_TelefonoEdicion" runat="server" Width="150px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <td>
                                       <asp:CheckBox ID="chkBuenContribuyenteEdicion" runat="server" Text="Buen Contribuyente"  Font-Bold="True" /> 
                                 </td>
                                </tr>
                                <tr  style = "display:none;">
                                    <td style="font-weight: bold">
