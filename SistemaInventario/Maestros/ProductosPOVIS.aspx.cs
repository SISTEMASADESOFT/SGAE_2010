...
namespace SistemaInventario.Maestros
{
    public partial class ProductosPOVIS : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_LGProductosReferencia_Insert_NET);
            CallbackManager.Register(F_Buscar_Referencia_NET);
            CallbackManager.Register(F_LGProductosReferencia_Edicion_NET);
            CallbackManager.Register(F_Eliminar_Referencia_NET);
            CallbackManager.Register(F_GrabarAplicacion_NET);
            CallbackManager.Register(F_Buscar_Aplicacion_NET);
            CallbackManager.Register(F_ActualizarAplicacion_NET);
            CallbackManager.Register(F_Eliminar_Aplicacion_NET);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            P_Inicializar_GrillaVacia_Referencia();
            P_Inicializar_GrillaVacia_Aplicacion();
            Session["datos"] = true;
        }
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value != "")
                {
                    ...
                    dta_consultaarticulo.Columns.Add("AñoFinal", typeof(string));
        ...
        protected void grvConsultaReferencia_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                GridView grvDetalle = null;
                Label lblReferencia = null;
                HiddenField hfCodProducto = null;
                ImageButton imgBtnPrincipal = null;

                grvDetalle = (GridView)(e.Row.FindControl("grvConsultareferencia"));
                lblReferencia = (Label)(e.Row.FindControl("lblReferencia"));
                hfCodProducto = (HiddenField)(e.Row.FindControl("hfCodProducto"));
                imgBtnPrincipal = (ImageButton)(e.Row.FindControl("imgPrincipal"));

                if (lblReferencia.ToString() != "")
                {
                    if (hfCodProducto.Value == "0")
                    {
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                grvNombre = Convert.ToString(obj_parametros["Filtro_grvNombre"]);
                Col = Convert.ToInt32(obj_parametros["Filtro_Col"]);
                Referencia = Convert.ToString(obj_parametros["Filtro_Referencia"]);
                ...
                grvDetalle.DataSource = objOperacion.F_ProductoModelo_APLICACION_REFERENCIA(objEntidad);
                grvDetalle.DataBind();
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("UbicacionAlmacen", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("CostoInicial", typeof(string));
            dta_consultaarticulo.Columns.Add("CodMonedaInicial", typeof(string));
            dta_consultaarticulo.Columns.Add("PrecioLista", typeof(string));
            dta_consultaarticulo.Columns.Add("Observacion1", typeof(string));
            dta_consultaarticulo.Columns.Add("Observacion2", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_Referencia()
        {
            DataTable dta_consultaarticulo = null;
            DataRow dtr_consultafila = null;
            ...
            dta_consultaarticulo.Columns.Add("CodReferencia", typeof(string));
            dta_consultaarticulo.Columns.Add("Referencia", typeof(string));
            dta_consultaarticulo.Columns.Add("CodProducto", typeof(string));
            dta_consultaarticulo.Columns.Add("Marca", typeof(string));
            dta_consultaarticulo.Columns.Add("CodigoProducto", typeof(string));
            ...
            grvConsultareferencia.DataSource = dta_consultaarticulo;
            grvConsultareferencia.DataBind();
        }

        public void P_Inicializar_GrillaVacia_Aplicacion()
        {
            DataTable dta_consultaarticulo = null;
            DataRow dtr_consultafila = null;
            ...
            grvReferenciaAplicacion.DataSource = dta_consultaarticulo;
            grvReferenciaAplicacion.DataBind();
        }
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.Observacion1 = Convert.ToString(objTablaFiltro["Filtro_Observacion1"]);
            objEntidad.Observacion2 = Convert.ToString(objTablaFiltro["Filtro_Observacion2"]);
            objEntidad.UbicacionAlmacen = Convert.ToString(objTablaFiltro["Filtro_UbicacionAlmacen"]);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);
            objEntidad.Permiso = Convert.ToInt32(objTablaFiltro["Filtro_Permiso"]);

            objOperacion = new LGProductosCN();

            dta_consulta = objOperacion.F_LGProductos_Listar_Povis(objEntidad);
        ...
        public void P_ActualizarDetalle(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.AnioFinal = Convert.ToString(objTablaFiltro["Filtro_AnioFinal"]);
            objEntidad.Posicion = Convert.ToString(objTablaFiltro["Filtro_Posicion"]);
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);
        ...
        public String F_LGProductosReferencia_Insert_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                F_LGProductosReferencia_Insert(obj_parametros, ref MsgError);
                int_resultado_operacion = 1;
                if (MsgError == "") MsgError = "Se grabò correctamente";
                str_mensaje_operacion = MsgError;
        ...
        public void F_LGProductosReferencia_Insert(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodReferencia = Convert.ToInt32(objTablaFiltro["Filtro_CodReferencia"]);
            objEntidad.CodProducto = Convert.ToInt32(objTablaFiltro["Filtro_CodProducto"]);
            objEntidad.CodMarca = Convert.ToInt32(objTablaFiltro["Filtro_CodMarca"]);
            objEntidad.Marca = Convert.ToString(objTablaFiltro["Filtro_Marca"]);
            objEntidad.CodigoProducto = Convert.ToString(objTablaFiltro["Filtro_CodigoProducto"]);
            objEntidad.Familia = Convert.ToString(objTablaFiltro["Filtro_Familia"]);
            objEntidad.IdFamilia = Convert.ToInt32(objTablaFiltro["Filtro_IdFamilia"]);

            objOperacion = new LGProductosCN();

            objOperacion.F_LGProductosReferencia_Insert(objEntidad);

            MsgError = objEntidad.MsgError;

        }

        public String F_Buscar_Referencia_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvConsultareferencia_html = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_Buscar_Referencia(obj_parametros, ref grvConsultareferencia);
                if (grvConsultareferencia.Rows.Count == 0)
                {
                    P_Inicializar_GrillaVacia_Referencia();
                    str_mensaje_operacion = "No se encontraron registros.";
                }
                ...
                str_grvConsultareferencia_html = Mod_Utilitario.F_GetHtmlForControl(grvConsultareferencia);
                int_resultado_operacion = 1;
            ...
            str_resultado =
                ...
                str_mensaje_operacion
                + "~" +
                str_grvConsultareferencia_html;
        ...
        public void P_Buscar_Referencia(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objEntidad.CodProductoReferenciaCab = Convert.ToInt32(objTablaFiltro["Filtro_CodReferencia"]);

            objOperacion = new LGProductosCN();

            dta_consulta = objOperacion.F_Referencia_Listado(objEntidad);

            GrillaBuscar.DataSource = dta_consulta;
            GrillaBuscar.DataBind();
        }

        public String F_LGProductosReferencia_Edicion_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                F_LGProductosReferencia_Edicion_NET(obj_parametros, ref MsgError);
                int_resultado_operacion = 1;
                if (MsgError == "") MsgError = "Se grabò correctamente";
                str_mensaje_operacion = MsgError;
        ...
        public void F_LGProductosReferencia_Edicion_NET(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductosReferencia_Edicion(objEntidad);

            MsgError = objEntidad.MsgError;

        }

        public String F_Eliminar_Referencia_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_EliminarReferencia(obj_parametros, ref str_mensaje_operacion);
                int_resultado_operacion = 1;
            }
            catch (Exception ex)
            {
        ...
        public void P_EliminarReferencia(Hashtable objTablaFiltro, ref String MsgError)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objOperacion = new LGProductosCN();
            objOperacion.F_Referencia_Eliminar(objEntidad);

            MsgError = objEntidad.MsgError;
        }


         public String F_GrabarAplicacion_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_GrabarAplicacion(obj_parametros, ref MsgError);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
            }
            catch (Exception ex)
        ...
        public void P_GrabarAplicacion(Hashtable objTablaFiltro, ref String MsgError)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objEntidad.CodProductoReferenciaCab = Convert.ToInt32(objTablaFiltro["Filtro_CodProductoReferenciaCab"]);
            objEntidad.CodModeloVehiculo = Convert.ToInt32(objTablaFiltro["Filtro_CodModeloVehiculo"]);
            objEntidad.AñoInicial = Convert.ToInt32(objTablaFiltro["Filtro_AñoInicial"]);
            objEntidad.AñoFinal = Convert.ToInt32(objTablaFiltro["Filtro_AñoFinal"]);
            objEntidad.Motor = Convert.ToString(objTablaFiltro["Filtro_Motor"]);
            ...
            objOperacion.F_ProductoAplicacion_Insertar(objEntidad);

            MsgError = objEntidad.MsgError;
        }

        public String F_Buscar_Aplicacion_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvReferenciaAplicacion_html = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_Buscar_Aplicacion(obj_parametros, ref grvReferenciaAplicacion);
                if (grvReferenciaAplicacion.Rows.Count == 0)
                {
                    P_Inicializar_GrillaVacia_Aplicacion();
                    str_mensaje_operacion = "No se encontraron registros.";
                }
                ...
                str_grvReferenciaAplicacion_html = Mod_Utilitario.F_GetHtmlForControl(grvReferenciaAplicacion);
                int_resultado_operacion = 1;
            ...
            str_resultado =
                ...
                str_mensaje_operacion
                + "~" +
                str_grvReferenciaAplicacion_html;
        ...
        public void P_Buscar_Aplicacion(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            dta_consulta = objOperacion.F_ProductoAplicacion_Listado(objEntidad);

            GrillaBuscar.DataSource = dta_consulta;
            GrillaBuscar.DataBind();
        }

        public String F_ActualizarAplicacion_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_ActualizarAplicacion(obj_parametros, ref MsgError);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
            }
            catch (Exception ex)
        ...
        public void P_ActualizarAplicacion(Hashtable objTablaFiltro, ref String MsgError)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objOperacion = new LGProductosCN();
            objOperacion.F_Aplicacion_Actualizar(objEntidad);

            MsgError = objEntidad.MsgError;
        }

        public String F_Eliminar_Aplicacion_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_EliminarAplicacion(obj_parametros, ref str_mensaje_operacion);
                int_resultado_operacion = 1;
            }
            catch (Exception ex)
            {
        ...
        public void P_EliminarAplicacion(Hashtable objTablaFiltro, ref String MsgError)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objOperacion = new LGProductosCN();
            objOperacion.F_Aplicacion_Eliminar(objEntidad);
