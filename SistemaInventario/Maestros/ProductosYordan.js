            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        $('#MainContent_txtCostoInicial').css('background', '#FFFFE0');
                        $('#MainContent_ddlMonedaCostoInicial').css('background', '#FFFFE0');
                        $('#MainContent_txtCostoInicialEdicion').css('background', '#FFFFE0');
...
//          Filtro_CostoSoles: $(Contenedor + 'txtCosto').val(),
...
//          Filtro_CostoOriginal: $(Contenedor + 'txtCosto').val(),
            ...
            Filtro_Precio4: ($(Contenedor + 'txtPrecio4').val() === '' ? 0 : $(Contenedor + 'txtPrecio4').val()),
...
//          Filtro_Precio4Dolares: Precio4Dolares,
            ...
            Filtro_CostoInicial: $(Contenedor + 'txtCostoInicial').val(),
...
//                    $(Contenedor + 'ddlFamilia').val('007');
                    ...
                    $(Contenedor + 'txtCostoInicial').val('');
...
//        var hfCostoProducto = '#'+ imgID.replace ('imgEditarRegistro', 'hfCostoProducto') ;
...
//   $(Cuerpo + 'txtCodigoEdicion').val($(lblCodigoProducto).val());
        ...
        $(Cuerpo + 'ddlFamiliaEdicion').val($(hfIdFamilia_grilla).val());
         $(Cuerpo + 'txtDescripcionEdicion').val($.trim($(lblProducto).text()));
...
//        $(Cuerpo + 'txtCostoEdicion').val(parseFloat($(hfCostoProducto).val() || 0).toFixed(2));
        $(Cuerpo + 'txtCostoInicialEdicion').val(parseFloat($(hfCostoInicial).val() || 0).toFixed(2));
        $(Cuerpo + 'ddlMonedaCostoInicialEdicion').val($(hfCodMonedaInicial).val());
//      $(Cuerpo + 'txtCostoEdicion').val(parseFloat($(hfCostoProducto).val()).toFixed(2));
 //     $(Cuerpo + 'txtCostoInicialEdicion').val(parseFloat($(hfCostoInicial).val()).toFixed(2));
...
//      $(Cuerpo + 'txtCostoEdicion').val(CostoInicial);
...
//          Filtro_Anio: $(Contenedor + 'txtAñoEdicion').val(),
            ...
            Filtro_CostoInicialEdicion: $(Contenedor + 'txtCostoInicialEdicion').val(),
...
function F_ValidarEdicionDocumento() {
    ...
    try {
        ...
        if ($(Cuerpo + 'txtCostoEdicion').val() == '')
            ...
            if ($(Cuerpo + 'txtCostoInicialEdicion').val() == '')
            Cadena = Cadena + '<p></p>' + 'CostoInicial';
