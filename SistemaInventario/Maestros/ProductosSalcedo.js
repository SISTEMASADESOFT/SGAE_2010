        ...
        $('#MainContent_txtFamilia').autocomplete(
    {
        source: function (request, response) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: '../Servicios/Servicios.asmx/F_Familia_AUTOCOMPLETE_Salcedo',
                data: "{'Descripcion':'" + request.term + "'}",
                dataType: "json",
                async: true,
                success: function (data) {
                    response($.map(data.d, function (item) {
                        return {
                            ...
                            Codigo: item.split(',')[2],
                             ...
                             PermisoCodigoProducto: item.split(',')[4],
                             PermisoMotor: item.split(',')[5],
                             PermisoModeloVehiculo: item.split(',')[6],
                             PermisoAño: item.split(',')[7],
                             PermisoMarcaVehiculo: item.split(',')[8],
                             PermisoOtrosDetalles: item.split(',')[9],
                             PermisoPlato: item.split(',')[10],
                             PermisoDisco: item.split(',')[11],
                             PermisoCollarin: item.split(',')[12],
                             PermisoEspesor: item.split(',')[13],
                             PermisoMedidaA: item.split(',')[14],
                             PermisoMedidaB: item.split(',')[15],
                             PermisoMedidaC: item.split(',')[16],
                             PermisoMedidaD: item.split(',')[17],
                             PermisoPosicion: item.split(',')[18],
                             PermisoLado: item.split(',')[19]
                        }
                    }))
                },
                error: function (response) {
...
//            $('#MainContent_txtDescripcion').val(i.item.Descripcion);
            ...
            //permisos
         if (i.item.PermisoCodigoProducto == 1)
            $('#MainContent_txtCodigo').prop('disabled', false);
        else
            $('#MainContent_txtCodigo').prop('disabled', true);
             if (i.item.PermisoAño == 1)
            $('#MainContent_txtAño').prop('disabled', false);
        else
            $('#MainContent_txtAño').prop('disabled', true);
            if (i.item.PermisoMotor == 1)
            $('#MainContent_txtMotor').prop('disabled', false);
        else
            $('#MainContent_txtMotor').prop('disabled', true);
            if (i.item.PermisoModeloVehiculo == 1)
            $('#MainContent_txtModelo').prop('disabled', false);
        else
            $('#MainContent_txtModelo').prop('disabled', true);
            if (i.item.PermisoMarcaVehiculo == 1)
            $('#MainContent_txtChasis').prop('disabled', false);
        else
            $('#MainContent_txtChasis').prop('disabled', true);
            if (i.item.PermisoOtrosDetalles == 1)
            $('#MainContent_txtDetalles').prop('disabled', false);
        else
            $('#MainContent_txtDetalles').prop('disabled', true);
            if (i.item.PermisoPlato == 1)
            $('#MainContent_txtDescCom').prop('disabled', false);
        else
            $('#MainContent_txtDescCom').prop('disabled', true);
            if (i.item.PermisoDisco == 1)
            $('#MainContent_txtDisco').prop('disabled', false);
        else
            $('#MainContent_txtDisco').prop('disabled', true);
            if (i.item.PermisoCollarin == 1)
            $('#MainContent_txtCollarin').prop('disabled', false);
        else
            $('#MainContent_txtCollarin').prop('disabled', true);
            if (i.item.PermisoEspesor == 1)
            $('#MainContent_txtEspesor').prop('disabled', false);
        else
            $('#MainContent_txtEspesor').prop('disabled', true);
            if (i.item.PermisoMedidaA == 1)
            $('#MainContent_txtMedida').prop('disabled', false);
        else
            $('#MainContent_txtMedida').prop('disabled', true);
            if (i.item.PermisoMedidaB == 1)
            $('#MainContent_txtMedidaB').prop('disabled', false);
        else
            $('#MainContent_txtMedidaB').prop('disabled', true);
            if (i.item.PermisoMedidaC == 1)
            $('#MainContent_txtMedidaC').prop('disabled', false);
        else
            $('#MainContent_txtMedidaC').prop('disabled', true);
            if (i.item.PermisoMedidaD == 1)
            $('#MainContent_txtMedidaD').prop('disabled', false);
        else
            $('#MainContent_txtMedidaD').prop('disabled', true);
            if (i.item.PermisoPosicion == 1)
            $('#MainContent_txtPosicion').prop('disabled', false);
        else
            $('#MainContent_txtPosicion').prop('disabled', true);
            if (i.item.PermisoLado == 1)
            $('#MainContent_txtLado').prop('disabled', false);
        else
            $('#MainContent_txtLado').prop('disabled', true);
      ...
      $('#MainContent_txtCollarin').autocomplete(
    {
        source: function (request, response) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: '../Servicios/Servicios.asmx/F_Valores_AUTOCOMPLETE_Salcedo',
                data: "{'Descripcion':'" + request.term + "'}",
                dataType: "json",
                async: true,
                success: function (data) {
        ...
        select: function (e, i) {
            $('#MainContent_txtCollarin').val(i.item.Codigo);
//            $('#MainContent_txtDescripcion').val(i.item.Descripcion);
            //permisos
      ...
      $('#MainContent_txtDisco').autocomplete(
    {
        source: function (request, response) {
            $.ajax({
                type: "POST",
        ...
        select: function (e, i) {
            $('#MainContent_txtDisco').val(i.item.Codigo);
//            $('#MainContent_txtDescripcion').val(i.item.Descripcion);
            //permisos
      ...
      $('#MainContent_txtDescCom').autocomplete(
    {
        source: function (request, response) {
            $.ajax({
                type: "POST",
        ...
        select: function (e, i) {
            $('#MainContent_txtDescCom').val(i.item.Codigo);
//            $('#MainContent_txtDescripcion').val(i.item.Descripcion);
            //permisos
...
//        }
    ...
    $("#MainContent_txtModelo").blur(function () {
    F_Descripcion();
    });

    $("#MainContent_txtAño").blur(function () {
    F_Descripcion();
    });

    $("#MainContent_txtDisco").blur(function () {
    F_Descripcion();
    });

    $("#MainContent_txtCollarin").blur(function () {
    F_Descripcion();
    });

    $("#MainContent_txtMedida").blur(function () {
    F_Descripcion();
    });

    $("#MainContent_txtMedidaB").blur(function () {
    F_Descripcion();
    });

    $("#MainContent_txtMedidaC").blur(function () {
    F_Descripcion();
    });
    $("#MainContent_txtMedidaD").blur(function () {
    F_Descripcion();
    });

    $("#MainContent_txtEspesor").blur(function () {
    F_Descripcion();
    });
    $("#MainContent_txtPosicion").blur(function () {
    F_Descripcion();
    });
    $("#MainContent_txtLado").blur(function () {
    F_Descripcion();
    });
    $("#MainContent_txtDetalles").blur(function () {
    F_Descripcion();
    });
    ...
    $("#MainContent_txtModeloEdicion").blur(function () {
    F_DescripcionEdicion();
    });

    $("#MainContent_txtAñoEdicion").blur(function () {
    F_DescripcionEdicion();
    });

    $("#MainContent_txtDiscoEdicion").blur(function () {
    F_DescripcionEdicion();
    });

    $("#MainContent_txtCollarinEdicion").blur(function () {
    F_DescripcionEdicion();
    });

    $("#MainContent_txtMedidaEdicion").blur(function () {
    F_DescripcionEdicion();
    });

    $("#MainContent_txtMedidaBEdicion").blur(function () {
    F_DescripcionEdicion();
    });

    $("#MainContent_txtMedidaCEdicion").blur(function () {
    F_DescripcionEdicion();
    });
    $("#MainContent_txtMedidaDEdicion").blur(function () {
    F_DescripcionEdicion();
    });

    $("#MainContent_txtEspesorEdicion").blur(function () {
    F_DescripcionEdicion();
    });
    $("#MainContent_txtPosicionEdicion").blur(function () {
    F_DescripcionEdicion();
    });
    $("#MainContent_txtLadoEdicion").blur(function () {
    F_DescripcionEdicion();
    });
    $("#MainContent_txtDetallesEdicion").blur(function () {
    F_DescripcionEdicion();
    });
...
//            $('#MainContent_txtDescripcionEdicion').val(i.item.Descripcion);
            $('#hfDescripcionFamiliaEdicion').val(i.item.Descripcion);
              ...
              //permisos
         if (i.item.PermisoCodigoProducto == 1)
            $('#MainContent_txtCodigoEdicion').prop('disabled', false);
        else
            $('#MainContent_txtCodigoEdicion').prop('disabled', true);
             if (i.item.PermisoAño == 1)
            $('#MainContent_txtAñoEdicion').prop('disabled', false);
        else
            $('#MainContent_txtAñoEdicion').prop('disabled', true);
            if (i.item.PermisoMotor == 1)
            $('#MainContent_txtMotor').prop('disabled', false);
        else
            $('#MainContent_txtMotorEdicion').prop('disabled', true);
            if (i.item.PermisoModeloVehiculo == 1)
            $('#MainContent_txtModeloEdicion').prop('disabled', false);
        else
            $('#MainContent_txtModeloEdicion').prop('disabled', true);
            if (i.item.PermisoMarcaVehiculo == 1)
            $('#MainContent_txtChasis').prop('disabled', false);
        else
            $('#MainContent_txtChasisEdicion').prop('disabled', true);
            if (i.item.PermisoOtrosDetalles == 1)
            $('#MainContent_txtDetalles').prop('disabled', false);
        else
            $('#MainContent_txtDetallesEdicion').prop('disabled', true);
            if (i.item.PermisoPlato == 1)
            $('#MainContent_txtDescComEdicion').prop('disabled', false);
        else
            $('#MainContent_txtDescComEdicion').prop('disabled', true);
            if (i.item.PermisoDisco == 1)
            $('#MainContent_txtDiscoEdicion').prop('disabled', false);
        else
            $('#MainContent_txtDiscoEdicion').prop('disabled', true);
            if (i.item.PermisoCollarin == 1)
            $('#MainContent_txtCollarin').prop('disabled', false);
        else
            $('#MainContent_txtCollarinEdicion').prop('disabled', true);
            if (i.item.PermisoEspesor == 1)
            $('#MainContent_txtEspesor').prop('disabled', false);
        else
            $('#MainContent_txtEspesorEdicion').prop('disabled', true);
            if (i.item.PermisoMedidaA == 1)
            $('#MainContent_txtMedidaEdicion').prop('disabled', false);
        else
            $('#MainContent_txtMedidaEdicion').prop('disabled', true);
            if (i.item.PermisoMedidaB == 1)
            $('#MainContent_txtMedidaBEdicion').prop('disabled', false);
        else
            $('#MainContent_txtMedidaBEdicion').prop('disabled', true);
            if (i.item.PermisoMedidaC == 1)
            $('#MainContent_txtMedidaCEdicion').prop('disabled', false);
        else
            $('#MainContent_txtMedidaCEdicion').prop('disabled', true);
            if (i.item.PermisoMedidaD == 1)
            $('#MainContent_txtMedidaDEdicion').prop('disabled', false);
        else
            $('#MainContent_txtMedidaDEdicion').prop('disabled', true);
            if (i.item.PermisoPosicion == 1)
            $('#MainContent_txtPosicionEdicion').prop('disabled', false);
        else
            $('#MainContent_txtPosicionEdicion').prop('disabled', true);
            if (i.item.PermisoLado == 1)
            $('#MainContent_txtLadoEdicion').prop('disabled', false);
        else
            $('#MainContent_txtLadoEdicion').prop('disabled', true);
...
//            $('#MainContent_txtCodfamiliaEdicion').val(i.item.Codigo);
    ...
    $('#MainContent_txtDisco').css('background', '#FFFFE0');
    
    $('#MainContent_txtCollarin').css('background', '#FFFFE0');
    
    $('#MainContent_txtMedidaB').css('background', '#FFFFE0');
    
    $('#MainContent_txtMedidaC').css('background', '#FFFFE0');
    
    $('#MainContent_txtMedidaD').css('background', '#FFFFE0');
    
    $('#MainContent_txtEspesor').css('background', '#FFFFE0');
    
    $('#MainContent_txtLado').css('background', '#FFFFE0');
    
    
    $('#MainContent_txtDetalles').css('background', '#FFFFE0');
    
    
    
    $('#MainContent_txtDiscoEdicion').css('background', '#FFFFE0');
    
    $('#MainContent_txtCollarinEdicion').css('background', '#FFFFE0');
    
    $('#MainContent_txtMedidaBEdicion').css('background', '#FFFFE0');
    
    $('#MainContent_txtMedidaCEdicion').css('background', '#FFFFE0');
    
    $('#MainContent_txtMedidaDEdicion').css('background', '#FFFFE0');
    
    $('#MainContent_txtEspesorEdicion').css('background', '#FFFFE0');
    
    $('#MainContent_txtLadoEdicion').css('background', '#FFFFE0');
    
    
    $('#MainContent_txtDetallesEdicion').css('background', '#FFFFE0');
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_Motor: $(Contenedor + 'txtMotor').val().toUpperCase().trim(),
            Filtro_MarcaVehi: $(Contenedor + 'txtChasis').val().toUpperCase().trim(),
            Filtro_Modelo: $(Contenedor + 'txtModelo').val().toUpperCase().trim(),
            Filtro_Año: $(Contenedor + 'txtAño').val().toUpperCase().trim(),
            Filtro_Disco: $(Contenedor + 'txtDisco').val().toUpperCase().trim(),
            Filtro_Collarin: $(Contenedor + 'txtCollarin').val().toUpperCase().trim(),
            Filtro_Medida: $(Contenedor + 'txtMedida').val().toUpperCase().trim(),
            Filtro_MedidaB: $(Contenedor + 'txtMedidaB').val().toUpperCase().trim(),
            Filtro_MedidaC: $(Contenedor + 'txtMedidaC').val().toUpperCase().trim(),
            Filtro_MedidaD: $(Contenedor + 'txtMedidaD').val().toUpperCase().trim(),
            Filtro_Espesor: $(Contenedor + 'txtEspesor').val().toUpperCase().trim(),
            Filtro_Posicion: $(Contenedor + 'txtPosicion').val().toUpperCase().trim(),
            Filtro_Lado: $(Contenedor + 'txtLado').val().toUpperCase().trim(),
            Filtro_Detalles: $(Contenedor + 'txtDetalles').val().toUpperCase().trim(),
            Filtro_Plato: $(Contenedor + 'txtDescCom').val(),
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente.') {
                    ...
                    $(Contenedor + 'txtAño').val('   ');
                     $('#MainContent_txtDisco').val('');
    $('#MainContent_txtCollarin').val('');
    $('#MainContent_txtMedidaB').val('');
    $('#MainContent_txtMedidaC').val('');
    $('#MainContent_txtMedidaD').val('');
    $('#MainContent_txtEspesor').val('');
    $('#MainContent_txtLado').val('');
    $('#MainContent_txtDetalles').val('');
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfDetalles = '#' + imgID.replace('imgEditarRegistro', 'hfDetalles');
        var hfMarcaVehi = '#' + imgID.replace('imgEditarRegistro', 'hfMarcaVehi');
        var hfLado = '#' + imgID.replace('imgEditarRegistro', 'hfLado');
        var hfEspesor = '#' + imgID.replace('imgEditarRegistro', 'hfEspesor');
        var hfMedidaD = '#' + imgID.replace('imgEditarRegistro', 'hfMedidaD');
        var hfMedidaC = '#' + imgID.replace('imgEditarRegistro', 'hfMedidaC');
        var hfMedidaB = '#' + imgID.replace('imgEditarRegistro', 'hfMedidaB');
        var hfCollarin = '#' + imgID.replace('imgEditarRegistro', 'hfCollarin');
        var hfDisco = '#' + imgID.replace('imgEditarRegistro', 'hfDisco');
        var hfPlato = '#' + imgID.replace('imgEditarRegistro', 'hfPlato');
        ...
        $(Cuerpo + 'txtChasisEdicion').val($(hfMarcaVehi).val());
        $(Cuerpo + 'txtDescComEdicion').val($(hfPlato).val());
        ...
        $(Cuerpo + 'ddlRepreEstado').val($(hfCodEstado_grilla).val());
            ...
            $('#MainContent_txtDiscoEdicion').val($(hfDisco).val());
            $('#MainContent_txtCollarinEdicion').val($(hfCollarin).val());
            $('#MainContent_txtMedidaBEdicion').val($(hfMedidaB).val());
            $('#MainContent_txtMedidaCEdicion').val($(hfMedidaC).val());
            $('#MainContent_txtMedidaDEdicion').val($(hfMedidaD).val());
            $('#MainContent_txtEspesorEdicion').val($(hfEspesor).val());
            $('#MainContent_txtLadoEdicion').val($(hfLado).val());
            $('#MainContent_txtDetallesEdicion').val($(hfDetalles).val());
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        var objParams = {
            ...
            //
            Filtro_Motor: $(Contenedor + 'txtMotorEdicion').val().toUpperCase().trim(),
            Filtro_MarcaVehi: $(Contenedor + 'txtChasisEdicion').val().toUpperCase().trim(),
            Filtro_Modelo: $(Contenedor + 'txtModeloEdicion').val().toUpperCase().trim(),
            Filtro_Año: $(Contenedor + 'txtAñoEdicion').val().toUpperCase().trim(),
            Filtro_Disco: $(Contenedor + 'txtDiscoEdicion').val().toUpperCase().trim(),
            Filtro_Collarin: $(Contenedor + 'txtCollarinEdicion').val().toUpperCase().trim(),
            Filtro_Medida: $(Contenedor + 'txtMedidaEdicion').val().toUpperCase().trim(),
            Filtro_MedidaB: $(Contenedor + 'txtMedidaBEdicion').val().toUpperCase().trim(),
            Filtro_MedidaC: $(Contenedor + 'txtMedidaCEdicion').val().toUpperCase().trim(),
            Filtro_MedidaD: $(Contenedor + 'txtMedidaDEdicion').val().toUpperCase().trim(),
            Filtro_Espesor: $(Contenedor + 'txtEspesorEdicion').val().toUpperCase().trim(),
            Filtro_Posicion: $(Contenedor + 'txtPosicionEdicion').val().toUpperCase().trim(),
            Filtro_Lado: $(Contenedor + 'txtLadoEdicion').val().toUpperCase().trim(),
            Filtro_Detalles: $(Contenedor + 'txtDetallesEdicion').val().toUpperCase().trim(),
            Filtro_Plato: $(Contenedor + 'txtDescComEdicion').val(),
            Filtro_Imagenes: Sys.Serialization.JavaScriptSerializer.serialize(arrImg)
        };
...
function F_Descripcion(){
    ...
    var Año=$('#MainContent_txtAño').val();
    var Disco=$('#MainContent_txtDisco').val();
    var Collarin=$('#MainContent_txtCollarin').val();
    var Medida=$('#MainContent_txtMedida').val();
    var MedidaB=$('#MainContent_txtMedidaB').val();
    var MedidaC=$('#MainContent_txtMedidaC').val();
    var MedidaD=$('#MainContent_txtMedidaD').val();
    var Espesor=$('#MainContent_txtEspesor').val();
    var Posicion=$('#MainContent_txtPosicion').val();
    var Lado=$('#MainContent_txtLado').val();
    var Detalles=$('#MainContent_txtDetalles').val();

    
       $('#MainContent_txtDescripcion').val(Familia+' '+Motor+' '+Modelo+' '+Año+' '+Chasis+' '+DscCom+' '+Disco+' '+Collarin+' '+Medida+' '+MedidaB+' '+MedidaC+' '+MedidaD+' '+Espesor+' '+Posicion+' '+Lado+' '+Detalles);
...
function F_DescripcionEdicion(){
    ...
    var Detalles=$('#MainContent_txtDetalles').val();
       ...
       $('#MainContent_txtDescripcionEdicion').val(Familia+' '+Motor+' '+Modelo+' '+Año+' '+Chasis+' '+DscCom+' '+Disco+' '+Collarin+' '+Medida+' '+MedidaB+' '+MedidaC+' '+MedidaD+' '+Espesor+' '+Posicion+' '+Lado+' '+Detalles);
