<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="ProductosWongNuevo.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosWongNuevo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosWongNuevo.js" charset="UTF-8"></script>
                            ...
                            <div>
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 11px; display:none">
                                                        <div id="div_Familia" style="display:none">
                                                            <asp:DropDownList ID="ddlFamilia" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="225" Visible="false">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                                             <td style="font-weight: bold">
                                                        Codigo OEM
                                                             ...
                                                             <td>
                                            <asp:TextBox ID="txtCodigoOmen" runat="server" Width="204px" Font-Names="Arial"
                              ...
                              <tr>
                                        ...
                                        <td colspan='5'>
                                          ...
                                          <td>
                                                        <asp:TextBox ID="txtProveedor" runat="server" Width="242px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                     ...
                                                     <td>
                                                        <asp:TextBox ID="txtCodigoFabrica" runat="server" Width="243px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                   ...
                                                   <td>
                                                        <asp:TextBox ID="txtTipoProducto" runat="server" Width="585px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                     ...
                                     <tr>
                                        ...
                                        <td style="padding-left: 4px;">
                                                        <asp:TextBox ID="txtObservacion2" runat="server" Width="585px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td style="font-weight: bold;padding-left: 48px;display:none;">
                                                        MAYORISTA
                                                    </td>
                                    ...
                                    <Columns>
                                        ...
                                        ToolTip="VISUALIZAR FOTOS DEL PRODUCTO" OnClientClick="F_VisualizarRegistro(this); return false;" />
                                           ...
                                           <asp:TemplateField HeaderText="Codigo" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                             ...
                                             <asp:BoundField DataField="CodigoProveedor" HeaderText="Cod. Prov." >
                                        ...
                                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>                                                                
                                                ...
                                                <asp:HiddenField ID="hfCodigoOem" runat="server" Value='<%# Bind("CodigoOem") %>' />  
                                                <asp:HiddenField ID="hfCodigoProveedor" runat="server" Value='<%# Bind("CodigoProveedor") %>' />  
                                                <asp:HiddenField ID="hfCodigoFabrica" runat="server" Value='<%# Bind("CodigoFabrica") %>' />
                                                <asp:HiddenField ID="hfFamilitaTipoProducto" runat="server" Value='<%# Bind("FamilitaTipoProducto") %>' />
                                                <asp:HiddenField ID="hfCodFamiliaTipoProducto" runat="server" Value='<%# Bind("CodFamiliaTipoProducto") %>' />     
                                        ...
                                        <asp:BoundField DataField="Precio1" HeaderText="MIN" DataFormatString="{0:N2}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Precio2" HeaderText="MEC" DataFormatString="{0:N2}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>   
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                                ...
                                                <td style="padding-left: 10px;">
                                                    <div id="div_FamiliaEdicion">
                                                        <asp:DropDownList ID="ddlFamiliaEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" Width="207" Visible="false">
                                                        </asp:DropDownList>
                                                    </div>
                                                </td>
                                         ...
                                         <td style="font-weight: bold">
                                            Codigo OEM
                                                ...
                                                <td>
                                            <asp:TextBox ID="txtCodigoOemEdicion" runat="server" Width="175px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                ...
                                <tr>
                                        ...
                                        <td colspan='5'>
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                     ...
                                                     <td>
                                                        <asp:TextBox ID="txtCodigoProveedorEdicion" runat="server" Width="242px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    ...
                                                    <td style="font-weight: bold;">
                                                     ...
                                                     <td>
                                                        <asp:TextBox ID="txtCodigoFabricaEdicion" runat="server" Width="242px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                   ...
                                                   <td>
                                                        <asp:TextBox ID="txtTipoProductoEdicion" runat="server" Width="582px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                   ...
                                   <tr>
                                    ...
                                    <td colspan='5'>
                                        ...
                                        <td style="padding-left: 4px;">
                                                        <asp:TextBox ID="txtObservacion2Edicion" runat="server" Width="585px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                    </tr>
                                <tr>
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtPrecio2Edicion" runat="server" Width="80px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                              ...
                                                              <td style="font-weight: bold;padding-left: 41px;display:none;">
                                        MAYORISTA
                                    </td>
                                                <td  style="display:none;">
