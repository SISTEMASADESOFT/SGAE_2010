var AppSession = "../Maestros/ProductosMonica.aspx";
var myDropzone = null;
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_CategoriaIgv', result.split('~')[15]);
                        F_Update_Division_HTML('div_Servicios', result.split('~')[16]);
                        F_Update_Division_HTML('div_CategoriaIgvEdicion', result.split('~')[17]);
                        F_Update_Division_HTML('div_ServicioEdicion', result.split('~')[18]);
                        ...
                        $('#MainContent_ddlFamilia').css('background', '#FFFFE0');
                            $('#MainContent_ddlCategoriaIgvEdicion').css('background', '#FFFFE0');
                        ...
                        $('#MainContent_ddlMoneda').css('background', '#FFFFE0');
                         $('#MainContent_ddlCategoriaIgv').css('background', '#FFFFE0');
...
//            Cadena = Cadena + '<p></p>' + 'Costo';
        ...
        if ($(Cuerpo + 'ddlCategoriaIgv').val()=='0')
            Cadena = Cadena + '<p></p>' + 'Selecione Una Categoria'
...
function F_GrabarDocumento() {
    try {
        ...
        var objParams = {
            ...
            Filtro_CategoriaIgv: $(Contenedor + 'ddlCategoriaIgv').val(),
            Filtro_Servicio: $(Contenedor + 'ddlservicio').val(),
...
function F_AnularRegistro(Fila) {
    ...
    try {
        ...
        var lblcodproducto = '#' + imgID.replace('imgAnularDocumento', 'lblcodproducto');
        ...
        var objParams = {
            Filtro_CodProducto: $(lblcodproducto).val(),
            Filtro_Descripcion: $('#MainContent_txtDescripcionConsulta').val(),
            Filtro_IdFamilia: $('#MainContent_ddlFamiliaConsulta').val()
        };
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var lblCodigoProducto = '#' + imgID.replace('imgEditarRegistro', 'lblCodigoProducto');
        var lblCodigo2 = '#' + imgID.replace('imgEditarRegistro', 'hfCodigoAlternativo');
       var hfDescripcion = '#' + imgID.replace('imgEditarRegistro', 'hfDescripcion');
        ...
        var hfCodServicio = '#' + imgID.replace('imgEditarRegistro', 'hfCodServicio');
        ...
        $(Cuerpo + 'ddlCategoriaIgvEdicion').val($(hfCodCategoria).val());
        $(Cuerpo + 'ddlServicioEdicion').val($(hfCodServicio).val());
        ...
        $(Cuerpo + 'txtCodigoEdicion').val($(lblCodigoProducto).val());
        $(Cuerpo + 'txtCodigo2Edicion').val($(lblCodigo2).val());
...
function F_EdicionRegistro() {
    try {
        ...
        var txtFactorEdicion = 1;

//        $(Contenedor + 'txtFactorEdicion').val(1);
        var objParams = {
            Filtro_CodProducto: $('#hfCodProducto').val(),
            Filtro_CodigoInterno: $(Contenedor + 'txtCodigoInternoEdicion').val().toUpperCase().trim(),
            Filtro_CodProducto1: $(Contenedor + 'txtCodigoEdicion').val(),
            Filtro_CodProducto2: $(Contenedor + 'txtCodigo2Edicion').val(),
            ...
            Filtro_Compra: $(Contenedor + 'ddlCompraEdicion').val(),
            ...
            Filtro_CodTipoProducto: 2,
            Filtro_CategoriaIgv: $(Contenedor + 'ddlCategoriaIgvEdicion').val(),
...
function F_Consultar_Imagen(str_tipoConsulta) {
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset= utf-8",
        url: "ProductosKarinaNuevo.aspx/F_UltimaImagenTMP_JS",
        dataType: "json",
...
function F_Eliminar_Temporal_Imagen(id_Imagen, str_tipoConsulta) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ProductosKarinaNuevo.aspx/F_Eliminar_Temporal_Imagen',
        dataType: "json",
...
function F_Eliminar_Imagen(id_Imagen, str_tipoConsulta) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ProductosKarinaNuevo.aspx/F_Eliminar_Imagen',
        dataType: "json",
        data: JSON.stringify({ 'objEntidad': param }),
        success: function (dataObject, textStatus) {
            if (textStatus == "success") {
...
function F_ConsultarArticulosRelacionados(CodAlterno) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ProductosKarinaNuevo.aspx/F_LGProductosRelaciones_Listar_NET',
        dataType: "json",
