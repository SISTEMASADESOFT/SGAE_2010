<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="ProductosSanli.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosSanli" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosSanli.js" charset="UTF-8"></script>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtCodigoInterno" runat="server" Width="140px" Font-Names="Arial"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtCodigo2" runat="server" Width="126px" Font-Names="Arial" ForeColor="Blue"
                                    ...
                                    <Columns>
                                        ...
                                        ToolTip="VISUALIZAR FOTOS DEL PRODUCTO" OnClientClick="F_VisualizarRegistro(this); return false;" />
                                           ...
                                           <asp:TemplateField HeaderText="Codigo" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblCodigo2" Text='<%# Bind("CodigoAlternativo") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField DataField="Precio2" HeaderText="P2" DataFormatString="{0:N2}">
                                            ...
                                            <asp:BoundField DataField="Precio3" HeaderText="MAYO" DataFormatString="{0:N2}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>   
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtCodigoInternoEdicion" runat="server" Width="140px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                   <td style="font-weight: bold">
                                                    Codigo 2
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtCodigo2Edicion" runat="server" Width="109px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    Familia
