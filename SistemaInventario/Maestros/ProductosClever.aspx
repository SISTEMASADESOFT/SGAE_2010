...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                            ...
                            <div>
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                      <asp:TextBox ID="txtObservacion" runat="server" Width="568px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                        <asp:TextBox ID="txtUbicacion" runat="server" Width="292px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                    </tr>
                                    </table>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfCodMonedaCostoInicial" runat="server" Value='<%# Bind("CodMonedaCostoInicial") %>' />             
                                ...
                                <asp:HiddenField ID="hfPrecio1Edicion" runat="server" Value='<%# Bind("Precio1Edicion") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="Precio1" HeaderText="PRECIO" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
   ...
   <td>
                                                    <asp:TextBox ID="txtUbicacionEdicion" runat="server" Width="292px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
