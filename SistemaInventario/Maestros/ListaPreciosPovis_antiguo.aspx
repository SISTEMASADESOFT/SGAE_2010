<%@ Page Title="Lista Precios" Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="ListaPreciosPovis_antiguo.aspx.cs" Inherits="SistemaInventario.Maestros.ListaPreciosPovis_antiguo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ListaPreciosPovis_antiguo.js"   charset="UTF-8"></script>   
    ...
    <div id="tabRegistro" style="width: 1300px">
                    ...
                    <table cellpadding="0" cellspacing="0" width="1200" class="form-inputs">
                        <tr>
                           <td style="font-weight: bold">
                            ...
                            <td>
                                <asp:TextBox ID="txtArticulo" runat="server" Width="450px" Font-Names="Arial" ForeColor="Blue"
                                    Font-Bold="True"></asp:TextBox>
                            </td>
                            <td style="font-weight: bold">
                                Categoria
        ...
        <div id="div_grvConsultaArticulo" style="padding-top: 5px;">
            <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                ...
                Width="1300px" OnRowDataBound="grvConsultaArticulo_RowDataBound">
                <Columns>
                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                      ...
                      <asp:TemplateField HeaderText="U.C." ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                ...
                <%--    <asp:TemplateField HeaderText="C.M." ItemStyle-HorizontalAlign="Center">
                        ...
                        <asp:TemplateField HeaderText="P.L." ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtPreciolista" Width="60px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo"  onblur="F_COSTOMarginable(this.id);"
                       ...
                       <asp:TemplateField HeaderText="Categoria">
                        ...
                        <ItemTemplate>
                            <asp:DropDownList runat="server" ID="ddlCategoria" Font-Names="Arial" ForeColor="Blue"
                    ...
                    <asp:TemplateField HeaderText="%P.C." ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hfsemaforo" runat="server" Value='<%# Bind("semaforo") %>' />
