...
namespace SistemaInventario.Maestros
{
    public partial class ProductosYordan : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("CostoProducto", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CostoProducto = Convert.ToDecimal(objTablaFiltro["Filtro_CostoInicial"]);
            objEntidad.CostoSoles = Convert.ToDecimal(objTablaFiltro["Filtro_Costo"]); // 
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CostoProducto = Convert.ToDecimal(objTablaFiltro["Filtro_CostoInicialEdicion"]);
            objEntidad.CodEstado = Convert.ToInt32(objTablaFiltro["Filtro_CodEstado"]);
            objEntidad.CodMonedaCostoInicial = Convert.ToInt32(objTablaFiltro["Filtro_CodMonedaCostoInicial"]);
            ...
            objEntidad.CodMonedaCostoInicial = Convert.ToInt16(objTablaFiltro["Filtro_CodMonedaCostoInicial"].ToString());
            objEntidad.CodEstado = Convert.ToInt32(objTablaFiltro["Filtro_CodEstado"]);
