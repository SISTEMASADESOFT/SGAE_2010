                ...
                <div>
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                      <tr>
                            ...
                            <td>
                                <div id="div_DireccionCliente">
                                    <<asp:DropDownList ID="ddlDireccionCliente" runat="server" 
                                        Font-Names="Arial" ForeColor="Blue" Font-Bold="True" Width="354"
                                        onchange="F_ClienteRelacionado();" >
                                    </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold">
                                <asp:TextBox ID="txtNombreCorto" runat="server" Width="350px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                        </tr> 
                         ...
                         <tr style="display: none">
                            ...
                            <td>
                                <asp:TextBox ID="txtDescripcionAzure" runat="server" Width="350px" Font-Names="Arial "
                           ...
                           <tr>
                                ...
                                <td style="font-weight: bold; margin-right :10px">
                                    <asp:CheckBox ID="chkPrincipal" runat="server" Text="Principal" Font-Bold="True" />
                                    &nbsp;&nbsp;
                                    <span style="margin-left: 10px; margin-right: 10px;">Establecimiento Sunat:</span>
                                    <asp:TextBox ID="txtEstablecimientoSunat" runat="server" Width="109px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True" MaxLength="4 "></asp:TextBox>
                                </td>
                           </tr>
                       ...
                       <tr>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold">
                                <asp:TextBox ID="txtserieAntiguo" runat="server" Width="120px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"    MaxLength="3"></asp:TextBox>
                                &nbsp;&nbsp;
                                <span style="margin-left: 10px; margin-right: 10.5px;">Serie Nuevo:</span>
                                <asp:TextBox ID="txtserieNuevo" runat="server" Width="119px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"    MaxLength="3"></asp:TextBox>
                            </td>
                        </tr>           
                        ...
                        <asp:TemplateField HeaderText="descripcion" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                             ...
                             <asp:Label runat="server" ID="lblDscAlmacen" Text='<%# Bind("DscAlmacen") %>' CssClass="detallesart"></asp:Label>
                                ...
                                <asp:HiddenField ID="hfCodDireccion" runat="server" Value='<%# Bind("CodDireccion") %>' />
                                <asp:HiddenField ID="hfEstablecimientoSunat" runat="server" Value='<%# Bind("Sunat") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <div id="divEdicionRegistro" style="display: none;" >
            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 460px">
                ...
                <div>
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                      <tr>
                            ...
                            <td>
                                <div id="div_DireccionClienteEdicion">
                                    <asp:DropDownList ID="ddlDireccionClienteEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                        Font-Bold="True" Width="354">
                                    </asp:DropDownList>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold">
                                <asp:TextBox ID="txtNombreCortoEdicion" runat="server" Width="350px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                        </tr> 
                          ...
                          <tr style="display: none;">
                            ...
                            <td style="font-weight: bold" >
                                <asp:TextBox ID="txtDireccionEdicion" runat="server" Width="350px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                        </tr>
                         ...
                         <tr style="display: none">
                            ...
                            <td>
                                <asp:TextBox ID="txtxDescripcionAzureEdicion" runat="server" Width="350px" Font-Names="Arial "
                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true" ></asp:TextBox>
                            </td>
                        </tr>
                           ...
                           <tr>
                                ...
                                <td style="font-weight: bold; margin-right :10px">
                                    <asp:CheckBox ID="chkPrincipalEdicion" runat="server" Text="Principal" Font-Bold="True" />
                                    &nbsp;&nbsp;
                                    <span style="margin-left: 10px; margin-right: 10px;">Establecimiento Sunat:</span>
                                    <asp:TextBox ID="txtEstablecimientoSunatEdicion" runat="server" Width="109px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True" MaxLength="4 "></asp:TextBox>
                                </td>
                           </tr>
                       ...
                       <tr>
                            ...
                            <td style="font-weight: bold">
                                <asp:TextBox ID="txtCelularEdicion" runat="server" Width="350px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                        </tr> 
               ...
               <%--         <tr>
                            ...
                            <td style="font-weight: bold">
                                <asp:TextBox ID="txtSerieAntiguoEdicion" runat="server" Width="120px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"    MaxLength="3"></asp:TextBox>
                                &nbsp;&nbsp;
                                <span style="margin-left: 10px; margin-right: 10.5px;">Serie Nuevo:</span>
                                <asp:TextBox ID="txtSerieNuevoEdicion" runat="server" Width="119px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"    MaxLength="3"></asp:TextBox>
                            </td>
                        </tr>           
--%>
