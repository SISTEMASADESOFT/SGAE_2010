...
<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ProductosPOVIS_antiguo.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosPOVIS_antiguo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosPOVIS_antiguo.js" charset="UTF-8"></script>
...
<%--                                         <asp:ImageButton runat="server" ID="imgAgregar" ImageUrl="~/Asset/images/ok.gif"
         ...
         <div>
          <table cellpadding="0" cellspacing="0" class="form-inputs">
                ...
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtAñoAplicacion" runat="server" Width="500px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
        ...
        <div id="div_AplicacionReferenciaEdicion" style="display: none;">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td style="padding-top: 5px;">
                        <asp:TextBox ID="txtAñoAplicacionEdicion" runat="server" Width="370px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
    ...
    <input id="hfCodReferenciaEdicion" type="hidden" value="0" />
    <input id="hfCodReferencia" type="hidden" value="0" />
