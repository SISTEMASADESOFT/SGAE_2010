var AppSession = "../Maestros/ProductosSanli.aspx";
var myDropzone = null;
...
function F_Buscar() {
    ...
    try {
        var objParams = {
            ...
            Filtro_IdFamiliaConsulta: $('#MainContent_ddlFamiliaConsulta').val(),
...
function F_EdicionRegistro() {
    try {
        ...
        var objParams = {
            ...
            Filtro_IdFamiliaConsulta: $(Contenedor + 'ddlFamiliaConsulta').val()
        };
...
function F_Consultar_Imagen(str_tipoConsulta) {
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset= utf-8",
        url: "ProductosSanli.aspx/F_UltimaImagenTMP_JS",
        dataType: "json",
...
function F_Eliminar_Temporal_Imagen(id_Imagen, str_tipoConsulta) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ProductosSanli.aspx/F_Eliminar_Temporal_Imagen',
        dataType: "json",
...
function F_Eliminar_Imagen(id_Imagen, str_tipoConsulta) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ProductosSanli.aspx/F_Eliminar_Imagen',
        dataType: "json",
        data: JSON.stringify({ 'objEntidad': param }),
        success: function (dataObject, textStatus) {
            if (textStatus == "success") {
