var AppSession = "../Maestros/ClientesTEK.aspx";
    ...
    try {
        ...
        if ($(Cuerpo + 'ddlTipoCliente_Edicion').val() == '3') {
            $(Cuerpo + 'ddlTipoCliente_Edicion').prop('disabled', false);
               ...
               var Permiso = F_PermisoOpcion_SinAviso(CodigoMenu, 777006, '');

                      if (Permiso==0)
                        {
                            $('#MainContent_txtLineaCreditoEdicion').prop('disabled',true);
                            $('#MainContent_ddlMonedaEdicion').prop('disabled',true);
                        }                            
                        else
                        {
                            $('#MainContent_txtLineaCreditoEdicion').prop('disabled',false);
...
function F_GrabarDireccionMultiple() {
    ...
    try {
        ...
        var GPSLat=0;
            ...
            GPSLong=$('#MainContent_txtGPSLongLatEdicion').val().substring(0,19);
            GPSLat=$('#MainContent_txtGPSLongLatEdicion').val().substring(22,41);
