...
namespace SistemaInventario.Maestros
{
    public partial class ProductosTEK : System.Web.UI.Page
    {
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
                                            ...
                                            ref DropDownList ddl_combomonedacosto, ref DropDownList ddl_combomonedacostoedicion)
        {
            ...
            ddl_combomonedacosto.Items.Clear();
            
            ddl_combomonedacosto.DataSource = dta_consulta;
            ddl_combomonedacosto.DataTextField = "DscAbvConcepto";
            ddl_combomonedacosto.DataValueField = "CodConcepto";
            ddl_combomonedacosto.DataBind();

            ddl_combomonedacostoedicion.Items.Clear();
            
            ddl_combomonedacostoedicion.DataSource = dta_consulta;
            ddl_combomonedacostoedicion.DataTextField = "DscAbvConcepto";
            ddl_combomonedacostoedicion.DataValueField = "CodConcepto";
            ddl_combomonedacostoedicion.DataBind();
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Insert_Tek(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Update_Tek(objEntidad);
