                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 48px">
                                                        <asp:TextBox ID="txtPrecio4" runat="server" Width="112px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        ubicacion
                                                    ...
                                                    <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtUbicacion" runat="server" Width="280px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                   ...
                                   MONEDA COSTO 
                                    ...
                                    COSTO INICIAL
                                                    ...
                                                    <td>
                                                      <asp:TextBox ID="txtCostoInicial" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                ...
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        <asp:TemplateField ItemStyle-Width="40px">
                            <ItemTemplate>
                                <center>
                                    <asp:ImageButton runat="server"  Visible="false"  ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                        ToolTip="Eliminar Producto" OnClientClick="F_AnularRegistro(this); return false;" />
                                    <asp:ImageButton runat="server" Visible="false" ID="imgActivarProducto" ImageUrl="~/Asset/images/ok.gif"
                                    ...
                                    <asp:ImageButton runat="server" ID="imgDetalleProducto" ImageUrl="../Asset/images/texto.png"
                                        ToolTip="DETALLE PRODUCTO" Visible="false" OnClientClick="F_DetalleProducto(this); return false;" />
                                    <asp:ImageButton runat="server" Visible="false" ID="imgVisualizarRegistro" ImageUrl="../Asset/images/Viewx16.png"
                        ...
                        <asp:TemplateField ItemStyle-Width="20px" Visible="false">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgRefresh" Visible="false" ImageUrl="~/Asset/images/refresh-icon.png"
                        ...
                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                               ...
                               <asp:HiddenField ID="hfCostoSoles" runat="server" Value='<%# Bind("CostoSoles") %>' /> 
                                ...
                                <asp:HiddenField ID="hfCostoProducto" runat="server" Value='<%# Bind("CostoProducto") %>' />                             
                                ...
                                <asp:HiddenField ID="hfCodEstado" runat="server" Value='<%# Bind("CodEstado") %>' />
                                 <asp:HiddenField ID="hfCodMonedaInicial" runat="server" Value='<%# Bind("CodProductoAzure") %>' />
                                                ...
                                                <td style="padding-left: 14px;">
                                                    <div id="div_CompraEdicion">
                                                        <asp:DropDownList ID="ddlCompraEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" Width="100" Enabled="false">
                                                        </asp:DropDownList>
                                                    </div>
                                                </td>
                                                <td style="padding-left: 5px; font-weight: bold; display: none">
                                                ...
                                                <td style="padding-left: 2px; ">
                                                    <div id="div_MonedaEdicion">
                                                        <asp:DropDownList ID="ddlMonedaEdicion"  runat="server" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" Width="110px" Enabled="false">
                                                        </asp:DropDownList>
                                                    </div>
                                                </td>
                                        <%--        <td style="font-weight: bold; padding-left: 5px">
                                                ...
                                                <td style="padding-left: 5px" >
                                                    <asp:TextBox ID="txtCostoEdicion" runat="server" Width="95px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha" ReadOnly="false" ></asp:TextBox>
                                                </td>--%>
                                                <td style="font-weight: bold; padding-left: 5px">
                                                    Precio 1
                                                </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <div id="div_MonedaCostoInicialEdicion">
                                                            <asp:DropDownList ID="ddlMonedaCostoInicialEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="114px" Enabled="false">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                                   <td style="font-weight: bold">
                                    COSTO INICIAL
                                       ...
                                       <td>
                                         <asp:TextBox ID="txtCostoInicialEdicion" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                           Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                       </td>
