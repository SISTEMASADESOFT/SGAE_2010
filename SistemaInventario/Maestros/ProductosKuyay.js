var AppSession = "../Maestros/ProductosKuyay.aspx";
var myDropzone = null;
...
$(document).ready(function () {
    ...
    $('#MainContent_txtRegistroSanitario').css('background', '#FFFFE0');

    $('#MainContent_txtObservacionEdicion').css('background', '#FFFFE0');

    $('#MainContent_txtRegistroSanitarioEdicion').css('background', '#FFFFE0');
...
function F_ValidarGrabarDocumento() {
    ...
    try {
        ...
        if ($(Cuerpo + 'txtRegistroSanitario').val().trim() == '')
            Cadena = Cadena + '<p></p>' + 'RegistroSanitario';
...
function F_GrabarDocumento() {
    try {
        ...
        var objParams = {
            ...
            Filtro_RegistroSanitario: $(Contenedor + 'txtRegistroSanitario').val()
        };
        ...
        F_GrabarDocumento_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente.') {
                    ...
                    $(Contenedor + 'txtRegistroSanitario').val('');
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfRegistroSanitario = '#' + imgID.replace('imgEditarRegistro', 'hfRegistroSanitario');
        ...
        $(Cuerpo + 'txtRegistroSanitarioEdicion').val($(hfRegistroSanitario).val());
...
function F_EdicionRegistro() {
    try {
        ...
        var objParams = {
            ...
            Filtro_RegistroSanitario: $(Contenedor + 'txtRegistroSanitarioEdicion').val()
        };
...
function F_ValidarEdicionDocumento() {
    try {
        ...
        if ($(Cuerpo + 'txtRegistroSanitarioEdicion').val().trim() == '')
            Cadena = Cadena + '<p></p>' + 'RegistroSanitario';

        if ($(Cuerpo + 'txtMarcaEdicion').val().trim() == '')
