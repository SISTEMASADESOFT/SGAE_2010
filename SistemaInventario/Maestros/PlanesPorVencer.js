var AppSession = "../Maestros/PlanesPorVencer.aspx";
var Codtipodoc=1
var CodigoMenu = 1000;
...
$(document).ready(function () {
    ...
    F_AUTOCOMPLETEPLACA('#MainContent_txtPlaca1',$('hfCodCtaCte').val());
    ...
    $("#MainContent_chkGuia").click(function () {
        if ($(this).is(':checked'))
        {
            BloqueoTipoTransportista($(Cuerpo + 'ddlSerieGuia option:selected').text(),(Cuerpo + 'txtNumeroGuia'),(Cuerpo + 'txtFechaTraslado')
                 ...
                 ,'#hfCodConductor',(Cuerpo + 'txtMarcaGuia'),'#MainContent_ImageButton1','#MainContent_ImageButton2','#MainContent_chkGuia','#hfCodTransportista');
    ...
    $("#MainContent_chkGuiaEdicion").click(function () {
        if ($(this).is(':checked')) {
             ...
             BloqueoTipoTransportista($(Cuerpo + 'ddlSerieGuiaEdicion option:selected').text(),(Cuerpo + 'txtNumeroGuiaEdicion'),(Cuerpo + 'txtFechaTrasladoEdicion')
                 ...
                 ,'#hfCodConductor',(Cuerpo + 'txtMarcaGuiaEdicion')
                 ,'#MainContent_ImageButton3','#MainContent_ImageButton4','#MainContent_chkGuiaEdicion','#hfCodTransportistaEdicion');
...
//       
    ...
    $('#MainContent_btnGrabarMotor').click(function () {
     ...
     $('#MainContent_btnGrabarMantenimiento').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;
            try {
                if (($.trim($('#MainContent_txt_ObservacionMantenimiento').val()).length<10))
                {
                 toastr.warning("INGRESAR LA OBSERVACION (MINIMO 10 CARACTERES)");
                  return false;
                }
                F_AgendarMantenimiento();
                return false;
            }
            catch (e) {
                toastr.warning("Error Detectado: " + e);
...
$(document).on("change", "select[id $= 'MainContent_ddlSerieGuia']",function () {
     BloqueoTipoTransportista($(Cuerpo + 'ddlSerieGuia option:selected').text(),(Cuerpo + 'txtNumeroGuia'),(Cuerpo + 'txtFechaTraslado')
                 ...
                 $(Cuerpo + 'ImageButton1'),
                 $(Cuerpo +'ImageButton2'),
                 (Cuerpo + 'chkGuia'),'#hfCodTransportista');
});
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_Mantenimiento', result.split('~')[34]);
                        F_Update_Division_HTML('div_MantenimientoEdicion', result.split('~')[35]);
                        ...
                        $("#MainContent_ddlMantenimiento").css('background', '#FFFFE0');
                        $("#MainContent_ddlMantenimientoEdicion").css('background', '#FFFFE0');
                        ...
                        $('#MainContent_txtAgenda').css('background', '#FFFFE0');
                        $('#MainContent_txt_ObservacionMantenimiento').css('background', '#FFFFE0');
                        $('#MainContent_txtAtencion').val('');
                        $('#MainContent_txtReferencia').val('');
            ...
            $('#MainContent_txtFechaTraslado').prop('readonly', true);
             ...
             //direcciontemporal
                       ...
                       $('#MainContent_txtObservacionGuiaEdicion').css('background', '#FFFFE0');
                        ...
                        $('#MainContent_txtHasta').val(Date_AddDays($('#MainContent_txtDesde').val(), 7));                                 
        ...
        if (Campo == 'Edicion'){
         if (CodDoc==10)
           SerieDoc=$("#MainContent_ddlSerieGuiaEdicion option:selected").text();
            ...
            SerieDoc=$("#MainContent_ddlSerieEdicion option:selected").text();
        }
        else
        {
        if (CodDoc==10)
...
function F_GrabarDocumento(){
  try 
        ...
        var FlagUnitario=0; if ($(Contenedor + 'ChkUnitarioGeneral').is(':checked'))   FlagUnitario=1;
...
function F_Nuevo(){
    ...
    $('#MainContent_ddlTipoDoc').prop('disabled', false);
       ...
       $('#MainContent_txtKM').val('');
       $('#MainContent_chkNotaVentaANTIGUA').prop('checked', false);
       $('#MainContent_ChkUnitarioGeneral').prop('checked', false);
       $("#MainContent_txtUsuarioPrecio").val('');
       $("#MainContent_txtContraseñaPrecio").val('');
       $("#MainContent_txtObservacionPrecio").val('');
       $( "#accordion" ).accordion({
       ...
       try 
        {
              ...
              var objParams = {
                                ...
                                Filtro_CodMantenimiento: $('#MainContent_ddlMantenimiento').val(),
                                Filtro_Placa: $('#MainContent_txtPlaca1').val()
                               };
    ...
    F_DatosFactura_NET(arg, function (result) {
                    ...
                    if (result.split('~')[22] == "1")
                        ...
                        $('#MainContent_chkComisionableEdicion').prop('checked',false);
                          ...
                          if (result.split('~')[35] == "1")
                        $('#MainContent_chkUnitario').prop('checked',true);
                    else
                        $('#MainContent_chkUnitario').prop('checked',false);
...
function F_GuardarCambiosFactura() {
 try 
    ...
    var FlagConCodigo = 0; if ($('#MainContent_chkConCodigoEdicion').is(':checked')) {FlagConCodigo = 1; };
        ...
        var Peso = 0;
        var NroBultos=0;
          if ($.trim($(Contenedor + 'txtNuBultosEdicion').val())!='')
              NroBultos=$.trim($(Contenedor + 'txtNuBultosEdicion').val());

        if ($.trim($(Contenedor + 'txtPesoEdicion').val())!='')
              Peso=$.trim($(Contenedor + 'txtPesoEdicion').val());

    if($('#MainContent_txtNuBultosEdicion').val()==''){$('#MainContent_txtNuBultosEdicion').val() }
var arrDetalle = new Array();
     var F=0;
     var FlagUnitario=1;
     $('#MainContent_grvDetalleEdicion .ccsestilo').each(function () {
...
//            Cadena=Cadena + '<p></p>' + 'NUMERO OPERACION';
        ...
        if($('#hfCodtipodoc').val()==16 && $('#hfCodCtaCteEdicion').val()==0)
        {
         Cadena = Cadena  + '<p></p>' + 'Cliente';  
        }

          if($('#hfCodtipodoc').val()==16 && $('#MainContent_txtClienteEditar').val().trim()=='')
        {
         Cadena = Cadena  + '<p></p>' + 'Cliente';  
        }
...
function F_Imprimir (Fila, rplc, TipoImp, TipoDoc){
   ...
   var codigo; var nrodoc = ''; TipoDoc = '1';
    ...
    var TipoDoc = '#' + imgID.replace(rplc, 'hfCodTipoDoc');

    if ($(Guia).val() == 0 | $(lblGuia).text().substring(0,1)!='T')
    {
        F_VistaPreliminar(Fila,212,$(TipoDoc).val());
        return false;
    }
...
function F_VistaPreliminar(Fila,CodMenu,TipoDoc) {
    var imgID = Fila.id;
    var Codigo = '';
    ...
    F_ImprimirFactura (Codigo,CodMenu,TipoDoc);
    
    return false;
}

function F_ImprimirFactura(Codigo,CodMenu,TipoDoc) {    
        var rptURL = '';
        var Params = 'width=' + (screen.width * 0.48) + ', height=' + (screen.height * 0.40) + ', top=0, left=0, directories=no, menubar=no, toolbar=no, location=no, resizable=yes, scrollbars=yes, titlebar=yes';
        var TipoArchivo = 'application/pdf';
        var CodMenu = 212;
...
function F_InicializarCajaTexto()
{
    ...
    $("#MainContent_txtNuBultos").ForceNumericOnly();
...
function F_EditarMantenimientoPopUP(Fila) {
        if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Anular') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        var imgID = Fila.id;
        var lblCodigo = '#' + imgID.replace('imgEditarDocumento', 'lblCodigo');
        var lblEstado = '#' + imgID.replace('imgEditarDocumento', 'lblEstado');
        var lblnumero = '#' + imgID.replace('imgEditarDocumento', 'lblnumero');
        var lblcliente = '#' + imgID.replace('imgEditarDocumento', 'lblcliente');
        var hfCodTipoDoc = '#' + imgID.replace('imgEditarDocumento', 'hfCodTipoDoc'); 
        var hfCodEstadoMantenimiento = '#' + imgID.replace('imgEditarDocumento', 'hfCodEstadoMantenimiento'); 
        var lblAgendado = '#' + imgID.replace('imgEditarDocumento', 'lblAgendado'); 
        var hfObservacionMantenimiento = '#' + imgID.replace('imgEditarDocumento', 'hfObservacionMantenimiento'); 
        var lblMantenimiento = '#' + imgID.replace('imgEditarDocumento', 'lblMantenimiento'); 

        if($(lblAgendado).text().substr(0, 10)=='')
        {
        
          $('#MainContent_txtAgenda').datepicker('setDate', new Date());
        } else
        {
        $('#MainContent_txtAgenda').val($(lblAgendado).text().substr(0, 10) );
        }

        $('#hfCodTipoDocAnulacion').val($(hfCodTipoDoc).val()) ;
        $('#hfCodEstadoMantenimiento').val($(hfCodEstadoMantenimiento).val()) ;
        $('#hfCodDocumentoVentaAnulacion').val($(lblCodigo).val()) ;
        $('#hfClienteAnulacion').val($(lblcliente).text()) ;
        $('#hfNumeroAnulacion').val($(lblnumero).text()) ;
        $('#MainContent_ddlMantenimientoEdicion').val($(hfCodEstadoMantenimiento).val());
        $('#MainContent_txt_ObservacionMantenimiento').val($(hfObservacionMantenimiento).val());
        
//       $('.Jq-ui-dtp').datepicker($.datepicker.regional['es']);
//       $('.Jq-ui-dtp').datepicker('setDate', new Date());
        $('#div_MantenimientoConsulta').dialog({
               resizable: false,
               modal: true,
               title: "Agenda de Venta",
               title_html: true,
               height: 190,
               width: 470,
               autoOpen: false
           });          
        $('#div_MantenimientoConsulta').dialog('open');
}

function F_AgendarMantenimiento() {
   try 
        {
    if(!confirm("ESTA SEGURO DE GUARDAR"))
    return false;

     if($('#MainContent_ddlMantenimientoEdicion').val()==6)
     {
      alertify.log('ELIJA OTRO MANTENIMIENTO');
     return false;
     }
    ...
    var objParams = {
                          ...
                          Filtro_ChkFecha: chkFecha,
                          Filtro_ChkCliente: chkCliente,
                          Filtro_ObservacionMantenimiento: $('#MainContent_txt_ObservacionMantenimiento').val(),
                          Filtro_FechaAgendaMantenimiento: $('#MainContent_txtAgenda').val(),
                          Filtro_EstadoMantenimiento: $('#MainContent_ddlMantenimientoEdicion').val()

    };

    var arg = Sys.Serialization.JavaScriptSerializer.serialize(objParams);
    MostrarEspera(true);
    F_AgendaMantenimiento_Net(arg, function (result) {
        ...
        if (str_resultado_operacion == "1") {
                F_Update_Division_HTML('div_consulta', result.split('~')[2]);      
                $('#div_MantenimientoConsulta').dialog('close');
                alertify.log(result.split('~')[1]);
        }
        else {
             alertify.log(result.split('~')[1]);
