<%@ Page Title="Clientes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientesUnitarioPovis.aspx.cs" Inherits="SistemaInventario.Maestros.ClientesUnitarioPovis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ClientesUnitarioPovis.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divTabs">
                ...
                <div>
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNroRuc" runat="server" Width="72px" Font-Names="Arial" ForeColor="Blue"
                            ...
                            <td>
                                <asp:TextBox ID="txtNroDni" runat="server" Width="72px" Font-Names="Arial" ForeColor="Blue"
                            ...
                            <td>
                                <asp:TextBox ID="txtCodigo" runat="server" Width="72px" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <td  style="padding-left: 5px;">
                                            <div id="div_Zona">
                                                <asp:DropDownList ID="ddlZona" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" Width="117" BackColor="#FFFF99">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                            </tr>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-left: 2px; font-weight: bold">
                                            <asp:TextBox ID="txtGPSLongLat" runat="server" Width="319px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold">
                                            Categoria
                                        ...
                                        <td>
                                            <div id="div_Categoria">
                                                <asp:DropDownList ID="ddlCategoria" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" Width="114" BackColor="#FFFF99">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
     ...
     <td style="padding-left: 4px;">
                                <asp:TextBox ID="txtCiudad" runat="server" Width="500px" Font-Names="Arial" Font-Bold="True"
                                 ForeColor="Blue"></asp:TextBox>
                            </td>
                   ...
                   <%--     <asp:TemplateField HeaderText="ID" HeaderStyle-Width="15px">
                        ...
                        <asp:TemplateField HeaderText="Documento" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfCodigoCliente" runat="server" Value='<%# Bind("CodigoCliente") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Distrito" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfCiudad" runat="server" Value='<%# Bind("Ciudad") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <div class="ui-jqdialog-content">
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                 <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtRucEdicion" runat="server" Width="72px" Font-Names="Arial" ForeColor="Blue"
                        ...
                        <td>
                            <asp:TextBox ID="txtDniEdicion" runat="server" Width="72px" Font-Names="Arial" ForeColor="Blue"
                                Font-Bold="True" MaxLength="8"></asp:TextBox>
                        </td>
                             <td style="font-weight: bold">
                                Codigo
                            ...
                            <td>
                                <asp:TextBox ID="txtCodigoEdicion" runat="server" Width="72px" Font-Names="Arial" ForeColor="Blue"
                                    Font-Bold="True"></asp:TextBox>
                            </td>
                                        </tr>
                        </table>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <tr>
                         <td style="padding-left: 2px;">
                            <asp:TextBox ID="txtNombreComercialEdicion" runat="server" Width="357px" Font-Names="Arial"
                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                        </td>
                    ...
                    <td>
                      ...
                      <tr>
                        <td style="font-weight: bold">
                           ...
                           <td style="padding-left: 5px;">
                            <asp:TextBox ID="txtCiudadEdicion" runat="server" Width="360px" Font-Names="Arial"
                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                        </td>
