...
{
    public partial class ProductosMonica : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lblID = (HiddenField)(e.Row.FindControl("lblCodigo"));
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_costomoneda_html = "";
            String str_ddl_costomonedaedicion_html = "";
            String str_ddl_CategoriaIgv_html = "";
            String str_ddl_servicio_html = "";
            String str_ddl_CategoriaIgvEdicion_html = "";
            String str_ddl_ServicioEdicion_html = "";
            int PMayorista = 0;
            decimal TC = 0;
            int int_resultado_operacion = 0;
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlUMCompra,
                    ...
                    ref ddlCompraEdicion, ref ddlVentaEdicion, ref ddlMonedaEdicion, ref ddlMonedaCostoInicial, ref ddlMonedaCostoInicialEdicion, ref ddlCategoriaIgv, ref ddlservicio, ref ddlCategoriaIgvEdicion, ref ddlServicioEdicion);
                ...
                str_ddl_costomoneda_html = Mod_Utilitario.F_GetHtmlForControl(ddlMonedaCostoInicial);
                str_ddl_costomonedaedicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlMonedaCostoInicialEdicion);
                str_ddl_CategoriaIgv_html = Mod_Utilitario.F_GetHtmlForControl(ddlCategoriaIgv);
                str_ddl_servicio_html = Mod_Utilitario.F_GetHtmlForControl(ddlservicio);
                str_ddl_CategoriaIgvEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlCategoriaIgvEdicion);
                str_ddl_ServicioEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlServicioEdicion);
                int_resultado_operacion = 1;
                str_mensaje_operacion = "";
            ...
            str_resultado =
                ...
                Session["CodSede"].ToString()
                 + "~" +
                str_ddl_costomoneda_html
                + "~" +
                str_ddl_costomonedaedicion_html + "~" +//14
                str_ddl_CategoriaIgv_html + "~" +
                str_ddl_servicio_html + "~" +
                str_ddl_CategoriaIgvEdicion_html + "~" +
                str_ddl_ServicioEdicion_html;
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
                                            ...
                                            ref DropDownList ddl_combomonedacostoinicial, ref DropDownList ddl_combomonedacostoinicialedicion, ref DropDownList ddl_combocategoriaigv, ref DropDownList ddl_comboServicio, ref DropDownList ddl_combocategoriaigvEdicion, ref DropDownList ddl_comboServicioEdicion)
        {
            ...
            ddl_combomonedacostoinicial.Items.Clear();

            ddl_combomonedacostoinicial.DataSource = dta_consulta;
            ddl_combomonedacostoinicial.DataTextField = "DscAbvConcepto";
            ddl_combomonedacostoinicial.DataValueField = "CodConcepto";
            ddl_combomonedacostoinicial.DataBind();

            ddl_combomonedacostoinicialedicion.Items.Clear();

            ddl_combomonedacostoinicialedicion.DataSource = dta_consulta;
            ddl_combomonedacostoinicialedicion.DataTextField = "DscAbvConcepto";
            ddl_combomonedacostoinicialedicion.DataValueField = "CodConcepto";
            ddl_combomonedacostoinicialedicion.DataBind();
            ...
            ddl_combocategoriaigv.Items.Clear();

            ddl_combocategoriaigv.DataSource = dta_consulta;
            ddl_combocategoriaigv.DataTextField = "DscAbvConcepto";
            ddl_combocategoriaigv.DataValueField = "CodConcepto";
            ddl_combocategoriaigv.DataBind();


            ddl_combocategoriaigvEdicion.Items.Clear();

            ddl_combocategoriaigvEdicion.DataSource = dta_consulta;
            ddl_combocategoriaigvEdicion.DataTextField = "DscAbvConcepto";
            ddl_combocategoriaigvEdicion.DataValueField = "CodConcepto";
            ddl_combocategoriaigvEdicion.DataBind();
            ...
            ddl_comboServicio.Items.Insert(0, new ListItem("Sin Detraccion", "0"));
            ...
            ddl_comboServicioEdicion.Items.Insert(0, new ListItem("Sin Detraccion", "0"));
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("BloqueoMayorista", typeof(string));
            dta_consultaarticulo.Columns.Add("BloqueoExclusivo", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("CodServicio", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodCategoriaIgv = Convert.ToInt32(objTablaFiltro["Filtro_CategoriaIgv"]);
            objEntidad.CodServicioDetraccion = Convert.ToInt32(objTablaFiltro["Filtro_Servicio"]);


            objOperacion = new LGProductosCN();

            //objOperacion.F_LGProductos_Insert_Standard(objEntidad);
            //objOperacion.F_LGProductos_Insert_Karina_Nuevo(objEntidad);
            objOperacion.F_LGProductos_Insert_Monica(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_LGProductos_Listar_Alvarado(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodigoInterno = Convert.ToString(objTablaFiltro["Filtro_CodigoInterno"]);
            objEntidad.CodProducto = Convert.ToInt32(objTablaFiltro["Filtro_CodProducto"]);
            objEntidad.CodProducto1 = Convert.ToString(objTablaFiltro["Filtro_CodProducto1"]);
            objEntidad.CodProducto2 = Convert.ToString(objTablaFiltro["Filtro_CodProducto2"]);
            objEntidad.IdFamilia = Convert.ToInt32(objTablaFiltro["Filtro_IdFamilia"]);
            objEntidad.DscProducto = Convert.ToString(objTablaFiltro["Filtro_DscProducto"]);
            objEntidad.Marca = Convert.ToString(objTablaFiltro["Filtro_Marca"]);
            objEntidad.Ubicacion = Convert.ToString(objTablaFiltro["Filtro_Ubicacion"]);
            ...
            objEntidad.CostoProducto = Convert.ToDecimal(objTablaFiltro["Filtro_Costo"]);
            objEntidad.CodEstado = Convert.ToInt32(objTablaFiltro["Filtro_CodEstado"]);
            objEntidad.CodUnidadVenta = Convert.ToInt32(objTablaFiltro["Filtro_Compra"]);
            objEntidad.StockMaximo = Convert.ToDecimal(objTablaFiltro["Filtro_StockMaximo"]);
            objEntidad.StockMinimo = Convert.ToDecimal(objTablaFiltro["Filtro_StockMinimo"]);
            objEntidad.Medida = Convert.ToString(objTablaFiltro["Filtro_Medida"]);
            objEntidad.Posicion = Convert.ToString(objTablaFiltro["Filtro_Posicion"]);
            ...
            //objOperacion.F_LGProductos_Update_Standard(objEntidad);
           // objOperacion.F_LGProductos_Update_Karina(objEntidad);
            objOperacion.F_LGProductos_Update_Monica(objEntidad);
