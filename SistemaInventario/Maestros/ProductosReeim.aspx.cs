...
namespace SistemaInventario.Maestros
{
    public partial class ProductosReeim : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_GrabarAcceso_NET);
            CallbackManager.Register(F_BuscarAcceso_NET);
            CallbackManager.Register(F_Eliminar_Acceso_NET);
            CallbackManager.Register(F_Buscar_Factor_NET);
            CallbackManager.Register(F_GrabarFactor_NET);
            CallbackManager.Register(F_ActualizarFactor_NET);
            CallbackManager.Register(F_Eliminar_Factor_NET);
        ...
        public bool PermisoVerCostoFOB = false;
        protected void Page_Load(object sender, EventArgs e)
        {
            String Menu = Request.QueryString["Mn"]; String Opcion = Request.QueryString["Op"];
            Utilitarios.Menu.EstablecerPermisos(int.Parse(Session["CodUsuario"].ToString()));
            Utilitarios.Menu.ModificarAccesos((System.Web.UI.WebControls.Menu)Master.FindControl("NavigationMenu"), Convert.ToInt32((Session["CodUsuario"])));
            if (Utilitarios.Menu.F_ValidarPermisoOpcion(1000, 3000301, "") == "1")
                PermisoVerCostoFOB = true;
            P_Inicializar_GrillaVacia_Consulta();
            P_Inicializar_GrillaVacia_Detalle();
            P_Inicializar_GrillaVacia_UsuarioMarca();
            P_Inicializar_GrillaVacia_Factor();
            Session["datos"] = true;
        }
        ...
        protected void grvProductoFactor_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                GridView grvDetalle = null;
                Label lblfactorrotacion = null;
                HiddenField hfCodFactor = null;
                ImageButton imgBtnPrincipal = null;

                grvDetalle = (GridView)(e.Row.FindControl("grvProductoFactor"));
                lblfactorrotacion = (Label)(e.Row.FindControl("lblFactorRotacion"));
                hfCodFactor = (HiddenField)(e.Row.FindControl("hfCodFactor"));
                imgBtnPrincipal = (ImageButton)(e.Row.FindControl("imgPrincipal"));

                if (hfCodFactor.Value != "")
                {
                    if (lblfactorrotacion.Text == "ALTO")
                    {
                        imgBtnPrincipal.ImageUrl = "../Asset/images/Circle_Green.png";
                    }
                    else if (lblfactorrotacion.Text == "MEDIO")
                    {
                        imgBtnPrincipal.ImageUrl = "../Asset/images/Circle_Yellow.png";
                    }
                     else if (lblfactorrotacion.Text == "BAJO")
                    {
                        imgBtnPrincipal.ImageUrl = "../Asset/images/Circle_Red.png";
                    }
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlUsuarioMarca_html = "";
            String str_ddlSucursalFactor_html = "";
            String str_ddlGlobalFactor_html = "";
            String str_ddlFactorRotacion_html = "";
            String str_ddlFactorRotacionEdicion_html = "";
            String str_ddlSucursalFactorEdicion_html = "";
            String str_ddlOrigen_html = "";
            String str_ddlOrigenEdicion_html = "";
            String str_ddlOrigenConsulta_html = "";
            decimal TC = 0;
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlUMCompra,
                    ...
                    ref ddlCompraEdicion, ref ddlVentaEdicion, ref ddlMonedaEdicion, ref ddlEstadoEdicion, ref ddlUsuarioMarca,ref ddlSucursalFactor,
                    ref ddlFactorRotacion, ref ddlGlobalFactor, ref ddlSucursalFactorEdicion,
                    ref ddlFactorRotacionEdicion, ref ddlorigen, ref ddlorigenConsulta, ref ddlorigenEdicion);
                ...
                str_ddlUsuarioMarca_html = Mod_Utilitario.F_GetHtmlForControl(ddlUsuarioMarca);
                str_ddlSucursalFactor_html = Mod_Utilitario.F_GetHtmlForControl(ddlSucursalFactor);
                str_ddlFactorRotacion_html = Mod_Utilitario.F_GetHtmlForControl(ddlFactorRotacion);
                str_ddlGlobalFactor_html = Mod_Utilitario.F_GetHtmlForControl(ddlGlobalFactor);
                str_ddlFactorRotacionEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlFactorRotacionEdicion);
                str_ddlSucursalFactorEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlSucursalFactorEdicion);
                str_ddlOrigen_html = Mod_Utilitario.F_GetHtmlForControl(ddlorigen);
                str_ddlOrigenEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlorigenEdicion);
                str_ddlOrigenConsulta_html = Mod_Utilitario.F_GetHtmlForControl(ddlorigenConsulta);
            ...
            str_resultado =
                ...
                + "~" +
                str_ddlUsuarioMarca_html
                + "~" +
                str_ddlSucursalFactor_html
                + "~" +
                str_ddlFactorRotacion_html
                + "~" +
                str_ddlGlobalFactor_html
                + "~" +
                str_ddlFactorRotacionEdicion_html
                + "~" +
                str_ddlSucursalFactorEdicion_html
                 + "~" +
                str_ddlOrigen_html
                 + "~" +
                str_ddlOrigenEdicion_html
                 + "~" +
                str_ddlOrigenConsulta_html
                ;
        ...
        public String F_GrabarAcceso_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_GrabarAcceso(obj_parametros, ref MsgError);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
        ...
        public String F_ConsultaMovimiento_NET(String arg)
        {
            ...
            try
            {
                ...
                P_PermisoCosto(obj_parametros, ref PermisoCosto);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
            ...
            ref DropDownList ddl_comboUsuario, ref DropDownList ddlSucursalFactor, ref DropDownList ddlFactorRotacion, ref DropDownList ddlGlobalFactor, ref DropDownList ddlSucursalFactorEdicion, ref DropDownList ddlFactorRotacionEdicion, ref DropDownList ddl_Origen, ref DropDownList ddl_OrigenConsulta, ref DropDownList ddl_OrigenEdicion)
        {
            ...
            ddlGlobalFactor.Items.Clear();

            ddlGlobalFactor.DataSource = dta_consulta;
            ddlGlobalFactor.DataTextField = "DscAbvConcepto";
            ddlGlobalFactor.DataValueField = "CodConcepto";
            ddlGlobalFactor.DataBind();
            ...
            ddlFactorRotacion.Items.Clear();

            ddlFactorRotacion.DataSource = dta_consulta;
            ddlFactorRotacion.DataTextField = "DscAbvConcepto";
            ddlFactorRotacion.DataValueField = "CodConcepto";
            ddlFactorRotacion.DataBind();

            ddlFactorRotacionEdicion.Items.Clear();

            ddlFactorRotacionEdicion.DataSource = dta_consulta;
            ddlFactorRotacionEdicion.DataTextField = "DscAbvConcepto";
            ddlFactorRotacionEdicion.DataValueField = "CodConcepto";
            ddlFactorRotacionEdicion.DataBind();
            //origen
            dta_consulta = null;

            objEntidadConceptosDet.CodConcepto = 33;

            dta_consulta = objOperacionConceptosDet.F_TCConceptos_Select(objEntidadConceptosDet);

            ddl_Origen.Items.Clear();

            ddl_Origen.DataSource = dta_consulta;
            ddl_Origen.DataTextField = "DscAbvConcepto";
            ddl_Origen.DataValueField = "CodConcepto";
            ddl_Origen.DataBind();

            ddl_OrigenConsulta.Items.Clear();

            ddl_OrigenConsulta.DataSource = dta_consulta;
            ddl_OrigenConsulta.DataTextField = "DscAbvConcepto";
            ddl_OrigenConsulta.DataValueField = "CodConcepto";
            ddl_OrigenConsulta.DataBind();

            ddl_OrigenEdicion.Items.Clear();

            ddl_OrigenEdicion.DataSource = dta_consulta;
            ddl_OrigenEdicion.DataTextField = "DscAbvConcepto";
            ddl_OrigenEdicion.DataValueField = "CodConcepto";
            ddl_OrigenEdicion.DataBind();


            dta_consulta = null;

            TCAlmacenCE objEntidadSucursal = new TCAlmacenCE();

            objEntidadSucursal.CodEmpresa = Convert.ToInt32(Session["CodEmpresa"]); 

            TCAlmacenCN objOperacionSucursal = new TCAlmacenCN();
            

            ddlSucursalFactor.Items.Clear();

            dta_consulta = objOperacionSucursal.F_TCAlmacen_Listar(objEntidadSucursal);


            ddlSucursalFactor.DataSource = dta_consulta;
            ddlSucursalFactor.DataTextField = "DscAlmacen";
            ddlSucursalFactor.DataValueField = "CodAlmacen";
            ddlSucursalFactor.DataBind();

            ddlSucursalFactorEdicion.Items.Clear();

            dta_consulta = objOperacionSucursal.F_TCAlmacen_Listar(objEntidadSucursal);


            ddlSucursalFactorEdicion.DataSource = dta_consulta;
            ddlSucursalFactorEdicion.DataTextField = "DscAlmacen";
            ddlSucursalFactorEdicion.DataValueField = "CodAlmacen";
            ddlSucursalFactorEdicion.DataBind();

            UsuarioCE objEntidadusuario = new UsuarioCE();

            objEntidadusuario.CodAlmacen = 2;
            objEntidadusuario.CodEstado = 1;

            UsuarioCN objOperacionUsuario = null;

            objOperacionUsuario = new UsuarioCN();

            dta_consulta = objOperacionUsuario.F_UsuarioMarca_Listar(objEntidadusuario);

            ddl_comboUsuario.Items.Clear();

            ddl_comboUsuario.DataSource = dta_consulta;
            ddl_comboUsuario.DataTextField = "NombreUsuario";
            ddl_comboUsuario.DataValueField = "CodUsuario";
            ddl_comboUsuario.DataBind();
            ddl_comboUsuario.Items.Insert(0, new ListItem("--Seleccione--", "0"));
        }
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("Stockcieneguilla", typeof(string));
            dta_consultaarticulo.Columns.Add("StockVitrina", typeof(string));
            dta_consultaarticulo.Columns.Add("StockMerma", typeof(string));
            dta_consultaarticulo.Columns.Add("FOB", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("accesomarca", typeof(string));
            dta_consultaarticulo.Columns.Add("accesousuario", typeof(string));
            dta_consultaarticulo.Columns.Add("StockTransportista", typeof(string));
            dta_consultaarticulo.Columns.Add("MargenStockTransportista", typeof(string));
            dta_consultaarticulo.Columns.Add("CodOrigen", typeof(string));
            dta_consultaarticulo.Columns.Add("Origen", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_UsuarioMarca()
        {
            DataTable dta_consultaarticulo = null;
            DataRow dtr_consultafila = null;
            ...
            dta_consultaarticulo.Columns.Add("Marca", typeof(string));
            dta_consultaarticulo.Columns.Add("CodusuarioMarca", typeof(string));
            dtr_consultafila = dta_consultaarticulo.NewRow();
            ...
            grvAccesomarca.DataSource = dta_consultaarticulo;
            grvAccesomarca.DataBind();
        }
        ...
        public void P_Inicializar_GrillaVacia_Factor()
        {
            DataTable dta_consultaarticulo = null;
            DataRow dtr_consultafila = null;
            ...
            dta_consultaarticulo.Columns.Add("Producto", typeof(string));
            dta_consultaarticulo.Columns.Add("CodProductoFactor", typeof(string));
            dta_consultaarticulo.Columns.Add("CodFactor", typeof(string));
            dta_consultaarticulo.Columns.Add("FactorRotacion", typeof(string));
            dta_consultaarticulo.Columns.Add("Factor", typeof(string));
            dta_consultaarticulo.Columns.Add("Sucursal", typeof(string));
            dta_consultaarticulo.Columns.Add("CodSucursal", typeof(string));
            dta_consultaarticulo.Columns.Add("CodFactorRotacion", typeof(string));
            ...
            grvProductoFactor.DataSource = dta_consultaarticulo;
            grvProductoFactor.DataBind();
        }
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.StockTransportista = Convert.ToInt32(objTablaFiltro["Filtro_ST"]);
            objEntidad.MStockTransportista = Convert.ToDecimal(objTablaFiltro["Filtro_MST"]);
            objEntidad.CodOrigen = Convert.ToInt32(objTablaFiltro["Filtro_CodOrigen"]);
            ...
            objOperacion.F_LGProductos_Insert_Reeim(objEntidad, "", "", "", "", "", "");

            MsgError = objEntidad.MsgError;
        }


        public void P_GrabarAcceso(Hashtable objTablaFiltro, ref String MsgError)
        {
            LGProductosCE objEntidadBE = null;
            LGProductosCN objOperacion = null;

            objEntidadBE = new LGProductosCE();

            objEntidadBE.CodVendedor = Convert.ToInt32(objTablaFiltro["Filtro_CodUsuario"]);
            objEntidadBE.CodMarca = Convert.ToInt32(objTablaFiltro["Filtro_CodMarca"]);
            objEntidadBE.CodUsuario = Convert.ToInt32((Session["CodUsuario"]));
            
            objOperacion = new LGProductosCN();

            objOperacion.F_Acceso_Insert(objEntidadBE);

            MsgError = objEntidadBE.MsgError;
        }
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objEntidad.CodOrigen = Convert.ToInt32(objTablaFiltro["Filtro_Origen"]);
            objEntidad.Marca = Convert.ToString(objTablaFiltro["Filtro_Marca"]);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Update_Reeim(objEntidad, "", "", "", "", "", "");
        ...
        public String F_BuscarAcceso_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvAccesomarca_html = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_BuscarAcceso(obj_parametros, ref grvAccesomarca);
                if (grvConsulta.Rows.Count == 0)
                {
                    P_Inicializar_GrillaVacia_UsuarioMarca();
                    str_mensaje_operacion = "No se encontraron registros.";
                ...
                str_grvAccesomarca_html = Mod_Utilitario.F_GetHtmlForControl(grvAccesomarca);
                int_resultado_operacion = 1;
        ...
        public void P_BuscarAcceso(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            dta_consulta = objOperacion.F_AccesoMarca_Listar(objEntidad);

            GrillaBuscar.DataSource = dta_consulta;
            GrillaBuscar.DataBind();
        }

        public String F_Eliminar_Acceso_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_EliminarAcceso(obj_parametros, ref str_mensaje_operacion);
                int_resultado_operacion = 1;
            }
            catch (Exception ex)
            {
        ...
        public void P_EliminarAcceso(Hashtable objTablaFiltro, ref String MsgError)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objEntidad.codAccesoMarca = Convert.ToInt32(objTablaFiltro["Filtro_CodAccesoMarca"]);

            objOperacion = new LGProductosCN();
            objOperacion.F_AccesoMarca_Eliminar_Reeim(objEntidad);

            MsgError = objEntidad.MsgError;
        }

        public void P_PermisoCosto(Hashtable objTablaFiltro, ref Int32 PermisoCosto)
        {
            ...
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);
            objEntidad.Marca = Convert.ToString(objTablaFiltro["Filtro_Codmarca"]);

            objOperacion = new LGProductosCN();
            dtTabla = objOperacion.F_Permiso_Costo(objEntidad);
        ...
        public String F_Buscar_Factor_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvConsulta_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_Buscar_Factor(obj_parametros, ref grvProductoFactor);
                if (grvProductoFactor.Rows.Count == 0)
                {
                    P_Inicializar_GrillaVacia_Factor();
                    str_mensaje_operacion = "No se encontraron registros.";
                }
                ...
                str_grvConsulta_html = Mod_Utilitario.F_GetHtmlForControl(grvProductoFactor);
                int_resultado_operacion = 1;
        ...
        public void P_Buscar_Factor(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            dta_consulta = objOperacion.F_ProductoFactor_Listado(objEntidad);

            GrillaBuscar.DataSource = dta_consulta;
            GrillaBuscar.DataBind();
        }

        public String F_GrabarFactor_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_GrabarFactor(obj_parametros, ref MsgError);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
            }
            catch (Exception ex)
        ...
        public void P_GrabarFactor(Hashtable objTablaFiltro, ref String MsgError)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objEntidad.CodProducto = Convert.ToInt32(objTablaFiltro["Filtro_CodProducto"]);
            objEntidad.FactorRotacion = Convert.ToInt32(objTablaFiltro["Filtro_FactorRotacion"]);
            objEntidad.Factor = Convert.ToInt32(objTablaFiltro["Filtro_Factor"]);
            objEntidad.Sucursal = Convert.ToInt32(objTablaFiltro["Filtro_Sucursal"]);
            objEntidad.GlobalFactor = Convert.ToInt32(objTablaFiltro["Filtro_GlobalFactor"]);

            objOperacion = new LGProductosCN();

            objOperacion.F_ProductoFactor_Insertar_Reeim(objEntidad);

            MsgError = objEntidad.MsgError;
        }

        public String F_ActualizarFactor_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_ActualizarFactor(obj_parametros, ref MsgError);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
            }
            catch (Exception ex)
        ...
        public void P_ActualizarFactor(Hashtable objTablaFiltro, ref String MsgError)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objEntidad.CodFactor = Convert.ToInt32(objTablaFiltro["Filtro_CodFactor"]);
            objEntidad.CodProducto = Convert.ToInt32(objTablaFiltro["Filtro_CodProducto"]);
            objEntidad.FactorRotacion = Convert.ToInt32(objTablaFiltro["Filtro_FactorRotacion"]);
            objEntidad.Factor = Convert.ToInt32(objTablaFiltro["Filtro_Factor"]);
            objEntidad.Sucursal = Convert.ToInt32(objTablaFiltro["Filtro_Sucursal"]);
            ...
            objOperacion = new LGProductosCN();
            objOperacion.F_ProductoFactor_Actualizar_Reeim(objEntidad);

            MsgError = objEntidad.MsgError;
        }

        public String F_Eliminar_Factor_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_EliminarFactor(obj_parametros, ref str_mensaje_operacion);
                int_resultado_operacion = 1;
            }
            catch (Exception ex)
            {
        ...
        public void P_EliminarFactor(Hashtable objTablaFiltro, ref String MsgError)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objOperacion = new LGProductosCN();
            objOperacion.F_ProductoFactor_Eliminar(objEntidad);
