...
{
    public partial class PlanesPorVencer : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_AgendaMantenimiento_Net);
        }
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_CodMantenimiento_html = "";
            String str_ddl_CodMantenimientoEdicion_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlGratuito, ref ddlVendedorEdicion, ref ddlTipoTransportista, ref ddlTipoTransportistaEdicion, ref ddlcodunidadpeso, ref ddlcodunidadpesoedicion, ref ddlAlmacen, ref ddlMantenimiento, ref ddlMantenimientoEdicion);
                ...
                str_ddl_CodMantenimiento_html = Mod_Utilitario.F_GetHtmlForControl(ddlMantenimiento);
                str_ddl_CodMantenimientoEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlMantenimientoEdicion);
            ...
            str_resultado =
                ...
                str_ddl_CodMantenimiento_html + "~" +//34
                str_ddl_CodMantenimientoEdicion_html;//35
        ...
        //                                       ref GuiaAgencia, ref ClaveAgencia, ref codcomprobanteegreso, ref FlagConCodigo, ref CodDireccion);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref CodDireccionTransportista, ref FlagUnitario);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
            }
            catch (Exception ex)
        ...
        public String F_Observacion_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodTipoDoc = CodTipoDoc;
                objEntidad.ConexionGeneral = Convert.ToString(Session["ConexionGeneral"]);
                grvDetalle.DataSource = objOperacion.F_DOCUMENTOVENTACAB_OBSERVACION_Mantenimiento(objEntidad);
                grvDetalle.DataBind();
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_Gratuito, ref DropDownList ddl_VendedorEdicion, ref DropDownList ddl_TipoTransportista, ref DropDownList ddl_TipoTransportistaEdicion, ref DropDownList ddl_CodunidadPeso, ref DropDownList ddl_CodunidadPesoedicion
            , ref DropDownList ddl_Almacen, ref DropDownList ddl_Mantenimiento, ref DropDownList ddl_MantenimientoEdicion)
        {
            ...
            dta_consulta = objOperacionConceptosDet.F_TCConceptos_Mantenimiento(objEntidadConceptosDet);

            ddl_Mantenimiento.Items.Clear();

            ddl_Mantenimiento.DataSource = dta_consulta;
            ddl_Mantenimiento.DataTextField = "DscAbvConcepto";
            ddl_Mantenimiento.DataValueField = "CodConcepto";
            ddl_Mantenimiento.DataBind();
            ddl_Mantenimiento.Items.Insert(0, new ListItem("TODOS", "0"));

            ddl_MantenimientoEdicion.Items.Clear();

            ddl_MantenimientoEdicion.DataSource = dta_consulta;
            ddl_MantenimientoEdicion.DataTextField = "DscAbvConcepto";
            ddl_MantenimientoEdicion.DataValueField = "CodConcepto";
            ddl_MantenimientoEdicion.DataBind();
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("Mantenimiento", typeof(string));
            dta_consulta.Columns.Add("Agendado", typeof(string));
            dta_consulta.Columns.Add("Celular", typeof(string));
            dta_consulta.Columns.Add("CodEstadoMantenimiento", typeof(string));
            dta_consulta.Columns.Add("ObservacionMantenimiento", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodDocumentoVenta, ref Int32 CodTraslado)
        {
            ...
            switch (objEntidad.CodTipoDoc)
            {
                ...
                default: //Facturas y Boletas
                    ...
                    //objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Alvarado_Nuevo(objEntidad); //cuando se actualice el sistema se activa esta funcion
 ...
 //           objEntidad.Placa1 = Convert.ToString(objTablaFiltro["Filtro_Placa"]);
 //           objEntidad.Placa2 = Convert.ToString(objTablaFiltro["Filtro_Placa2"]);
 //           objEntidad.Placa3 = Convert.ToString(objTablaFiltro["Filtro_Placa3"]);
 //           objEntidad.Placa4 = Convert.ToString(objTablaFiltro["Filtro_Placa4"]);
 //           objEntidad.KM = Convert.ToString(objTablaFiltro["Filtro_KM"]);
 ...
 //           objEntidad.Correo = Convert.ToString(objTablaFiltro["Filtro_Correo"]);
 //           objEntidad.OrdenCompra = Convert.ToString(objTablaFiltro["Filtro_NroOC"]);
 //           objEntidad.NroOperacion = Convert.ToString(objTablaFiltro["Filtro_NroOperacion"]);
 ...
 //           objEntidad.RazonSocialTransportista = Convert.ToString(objTablaFiltro["Filtro_RazonSocialTransportista"]);
 //           objEntidad.PlacaTraslado = Convert.ToString(objTablaFiltro["Filtro_PlacaTraslado"]);
 //           objEntidad.MarcaVehiculo = Convert.ToString(objTablaFiltro["Filtro_Marca"]);
 //           objEntidad.Licencia = Convert.ToString(objTablaFiltro["Filtro_Licencia"]);
 //           objEntidad.NroBultos = Convert.ToInt32(objTablaFiltro["Filtro_NroBultos"]);
 //           objEntidad.Peso = Convert.ToDecimal(objTablaFiltro["Filtro_Peso"]);
 //           objEntidad.CodUnidadPeso = Convert.ToInt32(objTablaFiltro["Filtro_CodUnidadPeso"]);
 ...
 //       }
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objEntidad.CodMantenimiento = Convert.ToInt32(objTablaFiltro["Filtro_CodMantenimiento"]);
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_Listar_Mantenimiento(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento, ref Int32 FormaPago, ref String Placa1,
                             ...
                             ref int FlagConCodigo, ref String RucTransportista, ref String ObservacionGuia, ref String Observacion, ref Int32 CodEmpleado, ref Int32 CodDireccionDestino, ref int CodDireccionTransportista, ref int FlagUnitario)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                FlagUnitario = Convert.ToInt32(dta_consulta.Rows[0]["FlagUnitario"]);
            }
        }
        ...
        //    , ref int codcomprobanteegreso, ref int FlagConCodigo, ref int CodDireccion)
        //{
        //    DocumentoVentaCabCE objEntidad = null;
        //    DocumentoVentaCabCN objOperacion = null;
        ...
        //    objEntidad.CodTransportista = Convert.ToInt32(objTablaFiltro["Filtro_CodTransportista"]);
        //    objEntidad.CodDocumentoVentaDireccionTransportista = Convert.ToInt32(objTablaFiltro["Filtro_CodDocumentoVentaDireccionTransportista"]);
        //    objEntidad.RucTransportista = Convert.ToString(objTablaFiltro["Filtro_NroRucTransportista"]);
        //    objEntidad.RazonSocialTransportista = Convert.ToString(objTablaFiltro["Filtro_RazonSocialTransportista"]);
        //    objEntidad.PlacaTraslado = Convert.ToString(objTablaFiltro["Filtro_PlacaTraslado"]);
        //    objEntidad.MarcaVehiculo = Convert.ToString(objTablaFiltro["Filtro_MarcaVehiculo"]);
        //    objEntidad.Licencia = Convert.ToString(objTablaFiltro["Filtro_Licencia"]);
        ...
        public String F_GrabarDireccionTemporal_NET(String arg)
        {
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_GrabarDireccionTemporal(obj_parametros, ref CodDocumentoVentaDireccion, ref FlagTraslado, ref str_mensaje_operacion);
        ...
        public void P_GrabarDireccionTemporal(Hashtable objTablaFiltro, ref int CodDocumentoVentaDireccion, ref int FlagTraslado, ref String MsgError)
        {
        ...
        [WebMethod]
        public static DocumentoVentaCabCE F_Modificar_Motor_NET(int hfCodDetalleMotor, int hfMotorEdicion, string MotorSA,
            string MarcaMotor, string SerieMotor, string Cilindrado, string Cilindros, string Combustible,
            string Potencia,string Adicional1,string Adicional2,string Adicional3,string Adicional4,string Adicional5)
        {

            DocumentoVentaCabCN objOperacion = new DocumentoVentaCabCN();
            DocumentoVentaCabCE objEntidad = new DocumentoVentaCabCE()
            {
                CodDetalleMotor = hfCodDetalleMotor,
                MotorEdicion = hfMotorEdicion,
                MotorSA = MotorSA,
            ...
            return objOperacion.F_Modificar_Motor(objEntidad);
        }
        ...
        public String F_AgendaMantenimiento_Net(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvConsulta_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_AgendaMantenimiento(obj_parametros, ref str_mensaje_operacion);
                P_Buscar(obj_parametros, ref grvConsulta);
                str_grvConsulta_html = Mod_Utilitario.F_GetHtmlForControl(grvConsulta);
                int_resultado_operacion = 1;
        ...
        public void P_AgendaMantenimiento(Hashtable objTablaFiltro, ref String Mensaje)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            objEntidad.ObservacionMantenimiento = Convert.ToString(objTablaFiltro["Filtro_ObservacionMantenimiento"]);
            objEntidad.FechaAgendaMantenimiento = Convert.ToDateTime(objTablaFiltro["Filtro_FechaAgendaMantenimiento"]);
            objEntidad.CodEstadoMantenimiento = Convert.ToInt32(objTablaFiltro["Filtro_EstadoMantenimiento"]);
            objEntidad.CodDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_Codigo"]);
            objEntidad.CodUsuario = Convert.ToInt32((Session["CodUsuario"]));
            objEntidad.CodAlmacen = Convert.ToInt32(Session["CodSede"]);
            objEntidad.CodTipoDoc = Convert.ToInt32(objTablaFiltro["Filtro_CodTipoDoc"]);
            ...
            objOperacion.F_DocumentoVentaCab_AgendaMantenimiento(objEntidad);
