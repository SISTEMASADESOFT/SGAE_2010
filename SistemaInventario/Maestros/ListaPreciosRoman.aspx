...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 1060px">
        Lista Precios</div>
    <div id="tabRegistro" style="width: 1060px">
        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
            ...
            <div id="divConsultaArticulo">
                <div class="ui-jqdialog-content">
                    <table cellpadding="0" cellspacing="0" width="1000" class="form-inputs">
                        <tr>
            ...
            <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                 ...
                 <asp:TemplateField HeaderText="COSTO" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtCosto" disabled="disabled" Width="80px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" onblur="F_Costo(this.id);"
                                Text='<%# Bind("CostoUniOriginal") %>' ></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="MARGEN - 1" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtM1" disabled="disabled" Width="80px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" onblur="F_Precio2(this.id);"
                    ...
                    <asp:TemplateField HeaderText="PRECIO" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtP1" disabled="disabled" Width="80px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" onblur="F_Precio(this.id);"
                                Text='<%# Bind("Precio1") %>' ></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="PRECIO 2" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ReadOnly=true  disabled="disabled" ID="txtP2" Width="80px" Style="text-align: center;"
