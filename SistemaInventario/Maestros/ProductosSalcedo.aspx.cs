...
namespace SistemaInventario.Maestros
{
    public partial class ProductosSalcedo : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("Detalles", typeof(string));
            dta_consultaarticulo.Columns.Add("MarcaVehi", typeof(string));
            dta_consultaarticulo.Columns.Add("Lado", typeof(string));
            dta_consultaarticulo.Columns.Add("Espesor", typeof(string));
            dta_consultaarticulo.Columns.Add("MedidaD", typeof(string));
            dta_consultaarticulo.Columns.Add("MedidaC", typeof(string));
            dta_consultaarticulo.Columns.Add("MedidaB", typeof(string));
            dta_consultaarticulo.Columns.Add("Collarin", typeof(string));
            dta_consultaarticulo.Columns.Add("Disco", typeof(string));
            dta_consultaarticulo.Columns.Add("Plato", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.MarcaVehi    = Convert.ToString(objTablaFiltro["Filtro_MarcaVehi"]);
            objEntidad.Detalles     = Convert.ToString(objTablaFiltro["Filtro_Detalles"]);
            objEntidad.Lado         = Convert.ToString(objTablaFiltro["Filtro_Lado"]);
            objEntidad.Posicion     = Convert.ToString(objTablaFiltro["Filtro_Posicion"]);
            objEntidad.Espesor      = Convert.ToString(objTablaFiltro["Filtro_Espesor"]);
            objEntidad.MedidaD      = Convert.ToString(objTablaFiltro["Filtro_MedidaD"]);
            objEntidad.MedidaC      = Convert.ToString(objTablaFiltro["Filtro_MedidaC"]);
            objEntidad.MedidaB      = Convert.ToString(objTablaFiltro["Filtro_MedidaB"]);
            objEntidad.Medida       = Convert.ToString(objTablaFiltro["Filtro_Medida"]);
            objEntidad.Collarin     = Convert.ToString(objTablaFiltro["Filtro_Collarin"]);
            objEntidad.Disco        = Convert.ToString(objTablaFiltro["Filtro_Disco"]);
            objEntidad.Anio         = Convert.ToString(objTablaFiltro["Filtro_Año"]);
            objEntidad.Modelo       = Convert.ToString(objTablaFiltro["Filtro_Modelo"]);
            objEntidad.Plato        = Convert.ToString(objTablaFiltro["Filtro_Plato"]);
