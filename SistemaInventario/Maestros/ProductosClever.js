            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_EstadoEdicion', result.split('~')[15]);
...
//            Filtro_Imagenes: Sys.Serialization.JavaScriptSerializer.serialize(arrImg)
            ...
            Filtro_FlagBloqueoMayorista: 0,
            Filtro_FlagBloqueoExclusivo: 0,
            Filtro_CodMonedaCostoInicial: $(Contenedor + 'ddlMonedaCostoInicial').val()
        };
...
function F_EditarRegistro(Fila) {
    ...
    try {
        var imgID = Fila.id;
        var lblCodProducto = '#' + imgID.replace('imgEditarRegistro', 'lblCodProducto');
        ...
        var hfCodMonedaCostoInicial = '#' + imgID.replace('imgEditarRegistro', 'hfCodMonedaCostoInicial');
        ...
        var hfPrecio1Edicion = '#' + imgID.replace('imgEditarRegistro', 'hfPrecio1Edicion');
        ...
        $(Cuerpo + 'ddlCompraEdicion').val($(hfCodUnidadVenta_grilla).val()); 
        $(Cuerpo + 'txtPrecio1Edicion').val($(hfPrecio1).val());
        $(Cuerpo + 'txtPrecio2Edicion').val($(hfPrecio2).val());
        $(Cuerpo + 'txtPrecio3Edicion').val($(hfPrecio3).val());
        $('#hfCodProducto').val($(lblCodProducto).val());
        ...
        $(Cuerpo + 'ddlMonedaCostoInicialEdicion').val($(hfCodMonedaCostoInicial).val());
        $(Cuerpo + 'txtCostoEdicion').val($(hfCostoInicial).val());
        $(Cuerpo + 'txtPrecio1Edicion').val($(hfPrecio1Edicion).val()); 
...
function F_EdicionRegistro() {
    try {
        ...
        var objParams = {
            ...
            Filtro_Marca: '',
            Filtro_Observacion: $(Contenedor + 'txtObservacionEdicion').val().toUpperCase().trim(), 
