        ...
        F_Controles_Inicializar_NET
            (
                ...
                function (result) {
                    ...
                    //    var CodAlmacen = result.split('~')[27];
                        F_Update_Division_HTML('div_Sucursales', result.split('~')[26]);
...
function F_InicializarSucursal() {
    ...
    if (F_PermisoOpcion_SinAviso(CodigoMenu,777051, '') === "0") {
...
if (F_PermisoOpcion(CodigoMenu, 4, 'Consultar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
