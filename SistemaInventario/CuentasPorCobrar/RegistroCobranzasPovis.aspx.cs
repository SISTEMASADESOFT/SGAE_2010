...
{
    public partial class RegistroCobranzasPovis : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_LlenarGridDetalleLetra_NET);            
        ...
        protected void grvDetallado_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                GridView grvDetalladoCobranzas = null;
                GridView grvDetalle = null;
                GridView grvDetalleLetra = null;
                HiddenField lblCodigo = null;
                Label lblEstado = null;
                grvDetalladoCobranzas = (GridView)(e.Row.FindControl("grvDetalladoCobranzas"));
                grvDetalle = (GridView)(e.Row.FindControl("grvDetalleFactura"));
                grvDetalleLetra = (GridView)(e.Row.FindControl("grvDetalleLetra"));
                ...
                if (lblCodigo.Value.ToString() != "")
                {
                    ...
                    DataTable dta_consultaLetras = null;
                    DataRow dtr_consultafilaLetras = null;
                    dta_consultaLetras = new DataTable();
                    ...
                    dta_consultaLetras.Columns.Add("ID", typeof(string));
                    dta_consultaLetras.Columns.Add("Factura", typeof(string));
                    dta_consultaLetras.Columns.Add("Emision", typeof(string));
                    dta_consultaLetras.Columns.Add("Total", typeof(string));
                    dta_consultaLetras.Columns.Add("Moneda", typeof(string));

                    dtr_consultafilaLetras = dta_consultaLetras.NewRow();

                    dtr_consultafilaLetras[0] = "";
                    dta_consultaLetras.Rows.Add(dtr_consultafilaLetras);

                    grvDetalleLetra.DataSource = dta_consultaLetras;
                    grvDetalleLetra.DataBind();
                }
            }
        }
        ...
        public String F_LlenarGridDetalle_Detallado_NET(String arg)
        {
            ...
            try
            {
                ...
                Col = Convert.ToInt32(obj_parametros["Filtro_Col"]);
                Codigo = Convert.ToInt32(obj_parametros["Filtro_Codigo"]);
                TipoDoc = Convert.ToInt32(obj_parametros["Filtro_Tipodoc"]);
                ...
                objEntidad.CodTipoDoc = Convert.ToInt32(TipoDoc);
                grvDetalle.DataSource = objOperacion.F_DOCUMENTOVENTACAB_LISTAR_COBRANZAS_DETALLADO_Povis(objEntidad);
                grvDetalle.DataBind();
        ...
        public String F_LlenarGridDetalleLetra_NET(String arg)
        {
            int int_resultado_operacion = 0;
            String str_resultado = "";
            String str_mensaje_operacion = "";
            ...
            try
            {
                ...
                //Obtengo el Grid para llenarlo y dibujarlo
                GridView grvDetalle = (GridView)grvDetallado.Rows[0].FindControl("grvDetalleLetra");
                ...
                //consulta a la base de datos y se llena grid
                objEntidad.CodLetra = Codigo; objEntidad.CodTipoOperacion = CodTipoDoc;
        ...
        public void P_LlenarGrillaVacia_Detallado()
        {
            ...
            dta_consultaarticulo.Columns.Add("CodTipoDoc", typeof(string));
            dta_consultaarticulo.Columns.Add("Retraso", typeof(string));
            ...
            ref DropDownList ddl_combonrocuenta, ref DropDownList ddl_combonrocuenta_Edicion)
        {
            ...
            dta_consulta = objOperacion.F_Listar_NroCuenta_Povis(objEntidad);
        ...
        public void P_Buscar_Detallado(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            if (Convert.ToInt32(objTablaFiltro["Filtro_ChkRet"]) == 1)
                objEntidad.Retraso = Convert.ToInt32(objTablaFiltro["Filtro_Ret"]);
            else
                objEntidad.Retraso = 0;
