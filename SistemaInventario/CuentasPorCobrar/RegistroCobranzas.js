            ...
            (
                ...
                function (result) {
                    ...
                    {                        
                        ...
                        F_Update_Division_HTML('div_Sucursales', result.split('~')[33]);
...
function F_InicializarSucursal() {
    ...
    if (F_PermisoOpcion_SinAviso(CodigoMenu,777050, '') === "0") {
...
if (!F_SesionRedireccionar(AppSession)) return false;
 ...
 var sucursales = $('#MainContent_ddlSucursales').multipleSelect('getSelects');
    ...
    if ($('#MainContent_chkFiltroMonto').prop('checked') === true)
    {
        ...
        toastr.warning('SELECCIONE AL MENOS UNA SUCURSAL');
        $('#MainContent_ddlSucursales').multipleSelect('open');
        return false;
    }
...
var sucursales = $('#MainContent_ddlSucursales').multipleSelect('getSelects');
        ...
        try 
        {
            ...
            var objParams = {
                    ...
                    Filtro_Sucursales: sucursales.join(',')
...
if (F_PermisoOpcion(CodigoMenu, 5, 'Consultar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        ...
        var Titulo = "VOUCHER DE INGRESOS";
        var CodMenu = '3007';
        var NombreArchivo = 'Web_Reporte_Ventas_rptVaucher_A5.rpt';
