var AppSession = "../CuentasPorCobrar/RegistroCobranzasAlvarado.aspx";
...
var UrlCliente = '../Servicios/Servicios.asmx/F_ListarClientes_AutoComplete';
var CodTipoDoc = 0;
var CodTipoDocEdicion = 0;
...
$(document).on("change", "select[id $= 'MainContent_ddlTipoDocumentoProforma']",function () {  
          if ($('#MainContent_ddlTipoDocumentoProforma').val()==1)
               UrlCliente = '../Servicios/Servicios.asmx/F_ListarClientes_AutoComplete';
          else
               UrlCliente = '../Servicios/Servicios.asmx/F_ListarClientes_AutoComplete_Proforma';
            ...
            (
                ...
                function (result) {
                    ...
                    {                        
                        ...
                        F_Update_Division_HTML('div_SucursalProforma', result.split('~')[33]);
                      ...
                      //  F_InicializarSucursal();
                        ...
                        $('#MainContent_ddlFlagAcuenta').css('background', '#FFFFE0');
                        $('#MainContent_ddlTipoDocumentoProforma').css('background', '#FFFFE0');
                        $('#MainContent_ddlSucursalProforma').css('background', '#FFFFE0');
                        //Eliminados
...
//    var $ddlSucursal = $("[id$='ddlSucursalProforma']");
//    
...
if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Editar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        try {
            ...
            var hfCodTipoDoc = '#' + imgID.replace('imgEditar', 'hfCodTipoDoc');
            ...
            CodTipoDocEdicion = $(hfCodTipoDoc).val();
     ...
     txtTotalTarjeta = '#MainContent_grvDetalleEdicionComisionTarjeta_txtTotalTarjeta_'+F;
      ...
      var objDetalle = {
        ...
        var objParams = {   
            ...
            Filtro_XmlDetalle: Sys.Serialization.JavaScriptSerializer.serialize(arrDetalle),
            Filtro_CodTipoDoc: CodTipoDocEdicion
                         };
...
function F_LlenarGridDetalle_Detallado(Fila){
  try 
        {             
                ...
                var CodTipoDoc = $('#' + Fila.replace('pnlDetallado', 'hfCodTipoDoc')).val();
