...
{
    public partial class LetrasVentasPovis : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlFormaPago, ref ddlBanco, ref ddlEmpresa, ref ddlEmpresaConsulta, ref ddlEstado, ref ddlVendedor);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,ref DropDownList ddl_comboformapago,
            ...
            ref DropDownList ddl_comboVendedor)
        {
            ...
            ddl_comboVendedor.DataTextField = "NombreCompleto";
            ddl_comboVendedor.DataValueField = "CodEmpleado";
            ddl_comboVendedor.DataBind();
            //ddl_comboVendedor.Items.Add(new ListItem() { Value = "0", Text = "TODOS" });
        }
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.Vendedor = Convert.ToInt32(objTablaFiltro["Filtro_Vendedor"]);
            ...
            objOperacion.F_LetraCab_Insert_Povis(objEntidad);
        ...
        public void P_AgregarLetraTemporal(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            objOperacion.F_TemporalLetraCab_Insert_Povis(objEntidad);
