...
{
    public partial class LetrasVentasReeim : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("cantidadletras", typeof(string));
            dta_consulta.Columns.Add("CodTipoDoc", typeof(string));
            dta_consulta.Columns.Add("codletras", typeof(string));
        ...
        public void P_AgregarLetraTemporal(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            objOperacion.F_TemporalLetraCab_Insert_Reeim(objEntidad);
