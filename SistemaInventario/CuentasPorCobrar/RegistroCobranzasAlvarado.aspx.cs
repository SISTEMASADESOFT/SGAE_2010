...
{
    public partial class RegistroCobranzasAlvarado : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlSucursalProforma_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlMedioPago, ref ddlBanco, ref ddlBancoEdicion, ref ddlFiltroMoneda,
                    ...
                    ref ddlEmpresaConsulta3, ref ddlMedioPagoConsulta2, ref ddlAlmacenDetallado2, ref ddlCobrador, ref ddlVendedor, ref ddlRuta, ref ddlSucursalProforma);
                ...
                str_ddlSucursalProforma_html = Mod_Utilitario.F_GetHtmlForControl(ddlSucursalProforma);
                int_resultado_operacion = 1;
                str_mensaje_operacion = "";
            }
            catch (Exception ex)
            ...
            + "~" +
            str_ddlSucursalProforma_html;//33
            return str_resultado;
        }
        ...
        public String F_AgregarTemporal_NET(String arg)
        {
            ...
            try
            {
                ...
                P_CargarGrillaTemporal_Factura(obj_parametros, CodigoTemporalCobranzas, "C", ref grvFacturaCobranzas, ref TotalCobranzas,CodTipoDoc);
                P_CargarGrillaTemporal_Factura(obj_parametros, CodigoTemporalPagos, "P", ref grvFacturaPagos, ref TotalPagos,CodTipoDoc);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda, ref DropDownList ddl_combomediopago,
                ...
                ref DropDownList ddl_comboempresadetallado, ref DropDownList ddl_TipoDocDetallado, ref DropDownList ddl_comboAlmacenDetallado, 
                ref DropDownList ddl_tipodoc,ref DropDownList ddl_tipodoc2, ref DropDownList ddl_comboempresaconsulta3, ref DropDownList ddl_combomediopago2,
                ref DropDownList ddl_CajaFisicaConsulta2, ref DropDownList ddl_cobrador, ref DropDownList ddl_Vendedor, ref DropDownList ddl_Ruta,
                ref DropDownList ddl_SucursalProforma)
        {
            ...
            ddl_SucursalProforma.Items.Clear();
            ddl_SucursalProforma.DataSource = dta_consulta;
            ddl_SucursalProforma.DataTextField = "DscAlmacen";
            ddl_SucursalProforma.DataValueField = "CodAlmacen";
            ddl_SucursalProforma.DataBind();
            ddl_SucursalProforma.Items.Add(new ListItem() { Value = "0", Text = "TODOS" });
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref Int32 CodigoPagos, ref String MsgError)
        {
            ...
            if (Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]) == 0)
            {
                ...
                if (Convert.ToInt32(objTablaFiltro["Filtro_CodTipoDoc"])==16)
                    objOperacion.F_TemporalCodigoCobranzasCab_Insert_Proforma_Alvarado(objEntidad);
                else
            ...
            else
            {
                ...
                if (Convert.ToInt32(objTablaFiltro["Filtro_CodTipoDoc"]) == 16)
                    objOperacion.F_TemporalCodigoFacturaDet_Insert_Proforma_Alvarado(objEntidad);
                else
        ...
        public void P_EliminarTemporal_Factura(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            if (Convert.ToInt32(objTablaFiltro["Filtro_CodTipoDoc"]) == 16)
                objOperacion.F_TemporalCodigoFacturaDet_Eliminar_Proforma_Alvarado(objEntidad);
            else
        ...
        public void P_CargarGrillaTemporal_Factura(Hashtable objTablaFiltro, Int32 Codigo, String Tipo, ref GridView grvDetalle, ref Decimal TotalFactura, Int32 CodTipoDoc)
        {
            ...
            if (Codigo != 0)
            {
                ...
                if (CodTipoDoc==16)
                    dta_consulta = objOperacion.F_TemporalCodigoCobranzaPagoDet_Listar_Proforma_Alvarado(objEntidad);
                else
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            if (Convert.ToInt32(objTablaFiltro["Filtro_CodTipoDoc"])==16)
                objOperacion.F_Cobranzas_RegistroCobranzas_Proforma_Alvarado(objEntidad);
            else
