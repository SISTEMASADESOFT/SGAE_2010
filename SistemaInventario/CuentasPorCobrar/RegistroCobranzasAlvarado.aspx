<%@ Page Title="Cobranzas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="RegistroCobranzasAlvarado.aspx.cs" Inherits="SistemaInventario.CuentasPorCobrar.RegistroCobranzasAlvarado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCobranzasAlvarado.js" charset="UTF-8"></script>
                            ...
                            <td>
                                <table>
                                    <tr>
                                     ...
                                     <td>
                                            <div id="div_TipoDocumentoProforma">
                                                <asp:DropDownList ID="ddlTipoDocumentoProforma" runat="server" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <td>
                                            <div id="div_SucursalProforma">
                                                <asp:DropDownList ID="ddlSucursalProforma" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" Width="100">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
