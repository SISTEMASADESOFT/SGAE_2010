<%@ Page Title="Cobranzas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="RegistroCobranzasPovis.aspx.cs" Inherits="SistemaInventario.CuentasPorCobrar.RegistroCobranzasPovis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCobranzasPovis.js" charset="UTF-8"></script>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="chkRet" runat="server" Text="Ret. Mayor a" Font-Bold="True" />
                                            </td>
                                             <td>
                                                <asp:TextBox ID="txtRet" runat="server" Width="70" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                  ...
                  OnRowDataBound="grvDetallado_RowDataBound"  CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None" Width="1200px">                  
                    <Columns>   
                      <asp:TemplateField>
                            <ItemTemplate>
                             ...
                             <asp:TemplateField>
                                     ...
                                     <asp:TemplateField>
                                        <ItemTemplate>
                                            <img id="imgMas" alt="" style="cursor: pointer" src="../Asset/images/plus.gif" onclick="imgMas_Click_Letras(this);"
                                                title="Ver Detalle Letra" />
                                            <asp:Panel ID="pnlDetalleLetra" runat="server" Style="display: none">
                                                <asp:GridView ID="grvDetalleLetra" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                                    AutoGenerateColumns="False" GridLines="None" class="GridView">
                                                    <Columns>                                               
                      ...
                      <asp:BoundField DataField="Total" HeaderText="Total" DataFormatString="{0:N2}">
                        ...
                        <asp:BoundField DataField="Retraso" HeaderText="Ret.">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
