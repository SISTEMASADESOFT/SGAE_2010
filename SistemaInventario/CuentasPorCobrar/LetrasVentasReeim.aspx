<%@ Page Title="Letras - Ventas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="LetrasVentasReeim.aspx.cs" Inherits="SistemaInventario.CuentasPorCobrar.LetrasVentasReeim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="LetrasVentasReeim.js" charset="UTF-8"></script>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgPDFLetra" ImageUrl="~/Asset/images/pdf.png" ToolTip="GENERAR PDF LETRA"
                                    OnClientClick="F_ImprimirFacturaHTML(this, 'imgPDFLetra', 'PDF', 1); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="RazonSocial">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfCodigo" runat="server" Value='<%# Bind("Codigo") %>' />
                                <asp:HiddenField ID="hfCantidadDocumentos" runat="server" Value='<%# Bind("cantidadletras") %>' />
                                <asp:HiddenField ID="hfCodTipoDoc" runat="server" Value='<%# Bind("CodTipoDoc") %>' />
                                <asp:HiddenField ID="hfcodletras" runat="server" Value='<%# Bind("codletras") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Numero">
                            <ItemStyle HorizontalAlign="Right" />
