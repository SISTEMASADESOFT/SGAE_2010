...
namespace CapaNegocios
{
    public class TCConceptosDetCN
    {
        ...
        public DataTable F_ProductoMarca_Combo()
        {
            try
            {
                return obj.F_ProductoMarca_Combo();
            }
            catch (Exception ex)
            {
        ...
        public DataTable F_PAIS_LISTAR_COMBO()
        {
            try
            {
                return obj.F_PAIS_LISTAR_COMBO();
            }
            catch (Exception ex)
            {
        ...
        public DataTable F_TCConceptos_Almacen(TCConceptosDetCE objEntidadBE)
        {
            try
            {
                return obj.F_TCConceptos_Almacen(objEntidadBE);
            }
            catch (Exception ex)
            {
        ...
        public DataTable F_TCConceptos_Select_Formato_Povis(TCConceptosDetCE objEntidadBE)
        {
            try
            {
                return obj.F_TCConceptos_Select_Formato_Povis(objEntidadBE);
            }
            catch (Exception ex)
            {
        ...
        public DataTable F_TCConceptos_Mantenimiento(TCConceptosDetCE objEntidadBE)
        {
            try
            {
                return obj.F_TCConceptos_Mantenimiento(objEntidadBE);
            }
            catch (Exception ex)
            {
