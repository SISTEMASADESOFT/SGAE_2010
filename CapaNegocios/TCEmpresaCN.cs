...
namespace CapaNegocios
{
    public class TCEmpresaCN
    {
        ...
        public string RutaFacturadorPorCodEmpresa(int CodEmpresa, String Conexion)
        {
            string Ruta = "";

            try
            {
                Ruta = obj.F_RutaFacturadorPorCodEmpresa(CodEmpresa, Conexion).Rows[0][0].ToString();
            }
            catch (Exception ex) { }
        ...
        public DataTable F_DatosDocumento_Descarga_Grupal(DocumentoVentaCabCE objEntidad)
        {
            ...
            try
            {
                ...
                return obj.F_DatosDocumento_Descarga_Grupal(objEntidad);
