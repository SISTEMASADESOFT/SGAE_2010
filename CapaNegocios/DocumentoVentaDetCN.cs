...
namespace CapaNegocios
{
    public class DocumentoVentaDetCN
    {
        ...
        public DocumentoVentaDetCE F_TemporalFacturacionDet_Eliminar_Proforma_Alvarado(DocumentoVentaDetCE objEntidadBE)
        {
            try
            {
                return obj.F_TemporalFacturacionDet_Eliminar_Proforma_Alvarado(objEntidadBE);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataTable F_DocumentoVentaDet_Listar_Antiguo(DocumentoVentaDetCE objEntidadBE)
        {
            try
            {
                return obj.F_DocumentoVentaDet_Listar_Antiguo(objEntidadBE);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataTable F_DocumentoVentaDet_Listar_Reeim(DocumentoVentaDetCE objEntidadBE)
        {

            try
            {

                return obj.F_DocumentoVentaDet_Listar_Reeim(objEntidadBE);
        ...
        public DocumentoVentaDetCE F_TemporalCodigoFacturaDet_Eliminar_Proforma_Alvarado(DocumentoVentaDetCE objEntidadBE)
        {

            try
            {

                return obj.F_TemporalCodigoFacturaDet_Eliminar_Proforma_Alvarado(objEntidadBE);
        ...
        public DocumentoVentaDetCE F_TemporalFacturacionDet_Update_Proforma_Alvarado(DocumentoVentaDetCE objEntidadBE)
        {
            try
            {
                return obj.F_TemporalFacturacionDet_Update_Proforma_Alvarado(objEntidadBE);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DocumentoVentaDetCE F_TemporalFacturacionDet_Update_Factura_Kuyay(DocumentoVentaDetCE objEntidadBE)
        {
            try
            {
                return obj.F_TemporalFacturacionDet_Update_Factura_Kuyay(objEntidadBE);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DocumentoVentaDetCE F_TemporalFacturacionDet_Update_Kuyay(DocumentoVentaDetCE objEntidadBE)
        {
            try
            {
                return obj.F_TemporalFacturacionDet_Update_Kuyay(objEntidadBE);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DocumentoVentaDetCE F_ACTUALIZAR_MONTO_MONEDA_PROFORMA(DocumentoVentaDetCE objEntidadBE)
        {
            try
            {
                return obj.F_ACTUALIZAR_MONTO_MONEDA_PROFORMA(objEntidadBE);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataTable F_DOCUMENTOVENTACAB_OBSERVACION_Mantenimiento(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {

                return obj.F_DOCUMENTOVENTACAB_OBSERVACION_Mantenimiento(objEntidadBE);
        ...
        public DataTable F_DOCUMENTOVENTACAB_LISTAR_COBRANZAS_DETALLADO_Povis(DocumentoVentaDetCE objEntidadBE)
        {
            try
            {

                return obj.F_DOCUMENTOVENTACAB_LISTAR_COBRANZAS_DETALLADO_Povis(objEntidadBE);
        ...
        public DataTable F_MOVIMIENTOS_LISTAR_AJUSTE_MASIVO_PRODUCTO(DocumentoVentaDetCE objEntidadBE)
        {

            try
            {

                return obj.F_MOVIMIENTOS_LISTAR_AJUSTE_MASIVO_PRODUCTO(objEntidadBE);
        ...
        public DocumentoVentaDetCE F_TemporalFacturacionDet_Update_Guia(DocumentoVentaDetCE objEntidadBE)
        {
            try
            {
                return obj.F_TemporalFacturacionDet_Update_Guia(objEntidadBE);
            }
            catch (Exception ex)
            {
                throw ex;
