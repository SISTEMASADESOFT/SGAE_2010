  ...
  public class NotaIngresoSalidaDetCN
    {
      NotaIngresoSalidaDetCD obj = new NotaIngresoSalidaDetCD();
        ...
        public DataTable F_NotaIngresoSalidaDet_Select_Alvarado(NotaIngresoSalidaDetCE objEntidadBE)
        {
            try
            {
                return obj.F_NotaIngresoSalidaDet_Select_Alvarado(objEntidadBE);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataTable F_NotaCompraDet_Select(NotaIngresoSalidaDetCE objEntidadBE)
        {
            try
            {
                return obj.F_NotaCompraDet_Select(objEntidadBE);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataTable F_NotaIngresoInventarioDet_LISTAR_ALVARADO(NotaIngresoSalidaDetCE objEntidadBE)
        {

            try
            {

                return obj.F_NotaIngresoInventarioDet_LISTAR_ALVARADO(objEntidadBE);
        ...
        public DataTable F_NotaIngresoSalidaDet_Select_ANTIGUO(NotaIngresoSalidaDetCE objEntidadBE)
        {
            try
            {
                return obj.F_NotaIngresoSalidaDet_Select_ANTIGUO(objEntidadBE);
            }
            catch (Exception ex)
            {
                throw ex;
