  ...
  public  class TCDocumentosCN
    {
      ...
      public DataTable F_TCDocumentos_ListarFacturacion_Antiguo()
      {
          ...
          try
          {
              ...
              return obj.F_TCDocumentos_ListarFacturacion_Antiguo();
      ...
      public DataTable F_TCDocumentos_ListarFacturacion_Solo_Proforma()
      {
          ...
          try
          {
              ...
              return obj.F_TCDocumentos_ListarFacturacion_Solo_Proforma();
      ...
      public TCDocumentosCE F_VentaPerdida(TCDocumentosCE objEntidad)
      {
          try
          {
              return obj.F_VentaPerdida(objEntidad);
          }
          catch (Exception ex)
          {
              throw ex;
      ...
      public DataTable F_TCEMPRESA_LISTAR_DIRECCION_CLIENTE(int codEmpresa)
      {
          try
          {
              return obj.F_TCEMPRESA_LISTAR_DIRECCION_CLIENTE(codEmpresa);
          }
          catch (Exception ex)
          {
              throw ex;
