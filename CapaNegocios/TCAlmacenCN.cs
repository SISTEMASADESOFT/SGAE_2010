...
namespace CapaNegocios
{
    public class TCAlmacenCN
    {
        ...
        public DataTable F_TCALMACEN_LISTAR_TODOS_CLEVER(TCAlmacenCE objEntidadBE)
        {
            try
            {

                return obj.F_TCALMACEN_LISTAR_TODOS_CLEVER(objEntidadBE);
        ...
        public DataTable F_SucursalNP_Listar()
        {
            try
            {

                return obj.F_SucursalNP_Listar();
        ...
        //alamcen externo
        public DataTable F_TCAlmacen_Destino(TCAlmacenCE objEntidadBE)
        {
            try
            {

                return obj.F_TCAlmacen_Destino(objEntidadBE);
        ...
        public DataTable F_DestinoGuiaIntera(TCAlmacenCE objEntidad)
        {
            try
            {

                return obj.F_DestinoGuiaIntera(objEntidad);
        ...
        public DataTable F_TCAlmacenesExternos_LISTADO()
        {
            try
            {

                return obj.F_TCAlmacenesExternos_LISTADO();
        ...
        public List<TCAlmacenCE> F_TCAlmacenesExternos_LISTADO(int pTodos)
        {
            try
            {

                List<TCAlmacenCE> lDatos = new List<TCAlmacenCE>();
                DataTable dtDatos = obj.F_TCAlmacenesExternos_LISTADO();
                ...
                foreach (DataRow r in dtDatos.Rows)
                {
                    lDatos.Add(new TCAlmacenCE()
                    {
                        CodAlmacen = Convert.ToInt32(r["IdAlmacen"]),
                        DscAlmacen = r["Almacen"].ToString()
                    });
                };
