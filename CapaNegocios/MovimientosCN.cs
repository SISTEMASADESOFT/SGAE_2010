  ...
  public  class MovimientosCN
    {
      ...
      public MovimientosCE F_Movimientos_Kardex_InicialAjuste_Modificar_Roman(MovimientosCE objEntidadBE)
      {
          try
          {
              return obj.F_Movimientos_Kardex_InicialAjuste_Modificar_Roman(objEntidadBE);
          }
          catch (Exception ex)
          {
              throw ex;
      ...
      public DataTable F_Movimientos_Kardex_Roman(MovimientosCE objEntidadBE)
      {
          try
          {
              return obj.F_Movimientos_Kardex_Roman(objEntidadBE);
          }
          catch (Exception ex)
          {
              throw ex;
      ...
      public MovimientosCE F_Movimientos_Kardex_SaldoInicial_Modificar_Roman(MovimientosCE objEntidadBE)
      {
          try
          {
              return obj.F_Movimientos_Kardex_SaldoInicial_Modificar_Roman(objEntidadBE);
          }
          catch (Exception ex)
          {
              throw ex;
