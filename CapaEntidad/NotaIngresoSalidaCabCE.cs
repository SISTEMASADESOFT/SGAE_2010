...
public class NotaIngresoSalidaCabCE
{
    ...
    public string NroRucPartida { get; set; }
    public string NroRucDestino { get; set; }
    ...
    public int SoloMercaderia { get; set; }
    public string EmisionStr { get; set; }
    public Int64 CodigoTransaccion { get; set; }
    ...
    public List<NotaIngresoSalidaDetCE> lnotaingresosalidaDet { get; set; }
    ...
    public int ORDENESCOMPRAHOY { get; set; }

    public List<NotaIngresoSalidaDetCE> OrdenCompraDet { get; set; }
